...
contract AIUno is PausableToken {

  string public constant name = "AI Uno"; // solium-disable-line uppercase
  string public constant symbol = "AIU"; // solium-disable-line uppercase
