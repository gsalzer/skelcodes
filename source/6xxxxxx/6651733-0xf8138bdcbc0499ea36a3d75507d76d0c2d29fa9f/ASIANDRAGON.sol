...
// ----------------------------------------------------------------------------
// 'AsianDragon TOKEN' token contract
//
// Symbol      : ADGN
// Name        : AsianDragon
...
//
//
// (c) by Original Asian Dragon Clan. The MIT Licence.
// ----------------------------------------------------------------------------
// Rise of the Dragon 2018
// ----------------------------------------------------------------------------
// Safe maths
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
/**
 * @title AsianDraon token
 * @dev Basic version of StandardToken, with no allowances.
 */
// ----------------------------------------------------------------------------

contract ASIANDRAGON is ERC20Basic {
 using SafeMath
 for uint256;
 ...
 * @dev Based on code by FCNN: https://github.com/FCNN
 */
// ----------------------------------------------------------------------------

contract StandardToken is ERC20, ASIANDRAGON {
...
contract AsianDragon is StandardToken, Ownable {
 string public constant name = "AsianDragon";
 string public constant symbol = "ADGN";
 ...
 function multiTransfer(address[] addresses, uint256[] values) onlyOwner public returns(bool success) {
