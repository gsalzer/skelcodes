...
contract OneBroGlobal is ERC20 {
    using SafeMath for uint256;
    address owner = msg.sender;
    mapping (address => uint256) balances;
    mapping (address => mapping (address => uint256)) allowed;    
    string public constant name = "One Bro Global Coin";
    string public constant symbol = "OBGC";
    uint public constant decimals = 8;
    uint256 public totalSupply = 100000000000000;
    uint256 public totalDistributed =  100000000000;
    uint256 public constant MIN = 1 ether / 100;
    uint256 public tokensPerEth = 100000000000;
    ...
    function burnOneBroGlobal(uint256 _value) onlyOwner public {
