...
contract LIT is StandardToken, Ownable {

  string public constant name = "LITCOIN";
  string public constant symbol = "LIT";
  uint8 public constant decimals = 18;

  uint256 public constant SUPPLY_CAP = 84000000 * (10 ** uint256(decimals));

  address NULL_ADDRESS = address(0);


  event NoteChanged(string newNote);
  string public note = "LITCOIN is LIT";
