...
// File: contracts/STOWToken.sol

/**
 * @title STOW Token Contract
 * @dev Based on ERC20 standard
 * @dev Following https://consensys.github.io/smart-contract-best-practices/tokens/
 */

contract STOWToken is PausableToken, DetailedERC20 {

    string public name = "STOW TOKEN";
    string public symbol = "STOW";
    uint8 public decimals = 18;
    /*------------------------------------constructor------------------------------------*/
    /**
     * @dev constructor for STOW token
     */
    constructor()
