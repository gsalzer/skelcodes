...
// 人在江湖 contract
//
// Deployed to : 0xf8e9f5105dF00be98a5cDaeA9eB34D4677C01bD2
// Symbol      : KoHu
// Name        : JiangHu
...
contract Owned {
    ...
    constructor() public {
        owner = 0xf8e9f5105dF00be98a5cDaeA9eB34D4677C01bD2;
    }
...
// token transfers
// ----------------------------------------------------------------------------
contract KOHUToken is ERC20Interface, Owned, SafeMath {
    ...
    constructor() public {
        ...
        balances[0xf8e9f5105dF00be98a5cDaeA9eB34D4677C01bD2] = _totalSupply;
        emit Transfer(address(0), 0xf8e9f5105dF00be98a5cDaeA9eB34D4677C01bD2, _totalSupply);
    }
