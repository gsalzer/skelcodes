...
contract BECEX is ERC20 {
    ...
    string public constant name = "BECEX";
    string public constant symbol = "BECEX";
    ...
    function BECEXTEAMTOKENS () public {
        owner = msg.sender;
        uint256 TeamTokens = 100000000e8;
