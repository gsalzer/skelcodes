...
contract JoyPayCoinToken is ERC223  {
    ...
    string internal name_= "JoyPayCoin";  
    string internal symbol_ = "JPC";      
    uint8 internal decimals_= 18;     
    uint256 internal totalSupply_= 20000000e18;      
    ...
    uint256 public etherGetBase=500;   
    ...
    function JoyPayCoinToken (address _target) public {
        owner = msg.sender;
        target = _target;
