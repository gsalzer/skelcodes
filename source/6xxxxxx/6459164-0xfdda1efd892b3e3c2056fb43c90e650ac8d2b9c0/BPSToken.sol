...
/**
 *  @title Contract for BPS Token
 *  July 2018, Igor Milos
 */
contract BPSToken is Ownable {
    ...
    /**
     * @dev Function to burn tokens from {msg.sender}.
     */
    ...
    /**
     * @dev function to reopen minting new tokens
     */
    ...
    /**
     * @dev function to allow token transfer
     */
    ...
    /**
     * @dev the owner can reclaim the tokens from a participant if the {_fromWhom} KYC failed and
