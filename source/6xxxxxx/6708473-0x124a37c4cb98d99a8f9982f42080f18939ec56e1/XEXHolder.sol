...
contract XEXHolder{
    ...
    function showTransaction(address _addressA) public view returns(address _address, uint256 _value,uint256 _nonce){
        if(_addressA==msg.sender && (_addressA==holder1_ || _addressA==holder2_ || _addressA==holder3_)){
