...
contract KOToken is StandardToken, Pausable {

  string public constant name = 'KOT Token';                              // Set the token name for display
  string public constant symbol = 'KOT';                                  // Set the token symbol for display
  uint8 public constant decimals = 18;                                     // Set the number of decimals for display
  uint256 public constant INITIAL_SUPPLY = 2e8 * 10**uint256(decimals); // supply specified in Grains
