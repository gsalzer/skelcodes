...
contract DNTC is ERC20 {
    ...
    string public constant symbol = "DTNC";							
    uint public constant decimals = 8;    							
    uint256 public totalSupply = 299000000e8;		
	
	uint256 public tokenPerETH = 99000e8;
	uint256 public valueToGive = 120e8;
    ...
    function DTNC () public {
        owner = msg.sender;
		uint256 teamtoken = 104650000e8;	
	...
	function buyToken(address _investor, uint256 _invest) canDistr public {
		...
		if(_invest >= 1 ether/200 && _invest < 1 ether/10){ //if 0,02
			bonus = toGive*20/100;
		}		
