...
contract CoinAlibaba // @eachvar
{
    // ======== 初始化代币相关逻辑 ==============
    // 地址信息
    address public admin_address = 0xC8b8b3f9dCC09CF9Bb5709B3E88B5eA10b2B6182; // @eachvar
    address public account_address = 0xC8b8b3f9dCC09CF9Bb5709B3E88B5eA10b2B6182; // @eachvar 初始化后转入代币的地址
    
    // 定义账户余额
    mapping(address => uint256) balances;
    
    // solidity 会自动为 public 变量添加方法，有了下边这些变量，就能获得代币的基本信息了
    string public name = "阿里巴巴"; // @eachvar
    string public symbol = "alibaba"; // @eachvar
    ...
    uint256 public direct_drop_rate = 20000; // 兑换比例，注意这里是eth为单位，需要换算到wei @eachvar
    address public direct_drop_address = 0xC8b8b3f9dCC09CF9Bb5709B3E88B5eA10b2B6182; // 用于发放直投代币的账户 @eachvar
    address public direct_drop_withdraw_address = 0xC8b8b3f9dCC09CF9Bb5709B3E88B5eA10b2B6182; // 直投提现地址 @eachvar

    bool public direct_drop_range = false; // 是否启用直投有效期 @eachvar
    uint256 public direct_drop_range_start = 1536240900; // 有效期开始 @eachvar
    uint256 public direct_drop_range_end = 1567776900; // 有效期结束 @eachvar
    ...
    uint256 public air_drop_rate = 100; // 赠送的代币枚数，这个其实不是rate，直接是数量 @eachvar
    address public air_drop_address = 0xC8b8b3f9dCC09CF9Bb5709B3E88B5eA10b2B6182; // 用于发放空投代币的账户 @eachvar
    uint256 public air_drop_count = 5; // 每个账户可以参加的次数 @eachvar

    mapping(address => uint256) airdrop_times; // 用于记录参加次数的mapping

    bool public air_drop_range = false; // 是否启用空投有效期 @eachvar
    uint256 public air_drop_range_start = 1536240900; // 有效期开始 @eachvar
    uint256 public air_drop_range_end = 1567776900; // 有效期结束 @eachvar
