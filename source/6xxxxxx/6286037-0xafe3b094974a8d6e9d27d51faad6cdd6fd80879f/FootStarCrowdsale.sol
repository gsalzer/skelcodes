...
contract FootStarCrowdsale is Ownable {
    ...
    address public constant WALLET = 0xc3757c9F09D515542F779D50639e9F7A01d04e51;
    // Wallet for founders tokens
    address public constant FOUNDERS_WALLET = 0x95aef253432b7c86c1220F79501a7F41c919fD89;
    // Wallet for advisors tokens
    address public constant ADVISORS_WALLET = 0xe8DEBAA4f6DdC77260a58A6f4218d26109D3fd22;
    // Wallet for company and team tokens
    address public constant COMPANY_WALLET = 0x1Fb645E80854a849Eb0F8d94cF60aAad1ADD2E7E;
    // Wallet for bounty tokens
    address public constant BOUNTY_WALLET = 0x50a27C4B2944308E2b6412F5A2AE45Ae5f1df9d4;
    ...
    uint256 public constant START_TIME = 1536314400; // 07/09/2018 10:00:00 +0000
    uint256 public constant RATE = 5100;  // 1 ETH = 5100 FTST

    uint256 public itoEndTime = 1546250400; // 31/12/2018 10:00:00 +0000
    ...
    */
    ...
    function FootStarCrowdsale() public {
        stages.push(Stage({ till: 1537610400, bonus: 55, cap: 2079850551e18 }));    // 22/09/2018 10:00:00 +0000
        stages.push(Stage({ till: 1539511200, bonus: 34, cap: 0 }));                // 14/10/2018 10:00:00 +0000
        stages.push(Stage({ till: 1541066400, bonus: 21, cap: 0 }));                // 01/11/2018 10:00:00 +0000
        stages.push(Stage({ till: 1542794400, bonus: 13, cap: 0 }));                // 21/11/2018 10:00:00 +0000
        stages.push(Stage({ till: 1544522400, bonus: 8, cap: 0 }));                 // 11/12/2018 10:00:00 +0000
        stages.push(Stage({ till: 1546250400, bonus: 5, cap: 0 }));                 // 31/12/2018 10:00:00 +0000
        stages.push(Stage({ till: ~uint64(0), bonus: 0, cap: 0 }));                             // unlimited

        token = FootStarToken(0x4509FcBBE90F82B6E10de7bA1C88D9524D1046C7);
