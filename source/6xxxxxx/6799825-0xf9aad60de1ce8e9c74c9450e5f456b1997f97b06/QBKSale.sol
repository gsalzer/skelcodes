...
contract QBKSale is PausingQashbackSale, PoolQashbackCrowdsale, CountingQashbackCrowdsale, WhitelistQashbackCrowdsale {
    ...
    constructor(QBKToken _token, Whitelist _whitelist, uint256 _usdEthRate)
        ...
        registerPool("Category_2", SUPPLY_HARD_CAP, 1529496000, 1, 100); //06/20/2018 @ 12:00pm (UTC)
        registerPool("Category_3", SUPPLY_HARD_CAP, 1545480000, 1, 100); //12/22/2018 @ 12:00pm (UTC
        registerPool("Category_4", SUPPLY_HARD_CAP, 1545566400, 1, 100); //12/23/2018 @ 12:00pm (UTC)
        registerPool("Category_5", SUPPLY_HARD_CAP, 1546084800, 1, 100); //12/29/2018 @ 12:00pm (UTC)
        registerPool("Category_6", SUPPLY_HARD_CAP, 1548072000, 1, 100); //01/21/2019 @ 12:00pm (UTC)
        registerPool("Category_7", SUPPLY_HARD_CAP, 1553256000, 1, 100); //03/22/2019 @ 12:00pm (UTC)
        registerPool("Category_8", SUPPLY_HARD_CAP, 1561032000, 1, 100); //06/20/2019 @ 12:00pm (UTC)
        registerPool("Category_9", SUPPLY_HARD_CAP, 1568808000, 1, 100); //09/18/2019 @ 12:00pm (UTC)
        registerPool("Category_10", SUPPLY_HARD_CAP, 1577016000, 1, 100); //12/22/2019 @ 12:00pm (UTC)
    }
