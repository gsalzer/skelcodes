...
contract SavingsProxy is ConstantAddresses {
    ...
    event Deposit(address indexed sender, SavingsProtocol protocol, uint amount);
    event Withdraw(address indexed sender, SavingsProtocol protocol, uint amount);
    event Swap(address indexed sender, SavingsProtocol fromProtocol, SavingsProtocol toProtocol, uint amount);
