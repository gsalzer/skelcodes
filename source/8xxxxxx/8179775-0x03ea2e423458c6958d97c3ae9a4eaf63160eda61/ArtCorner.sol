...
// File: contracts\ArtCorner.sol

pragma solidity ^0.5.0;
/**
 * @title ArtCorner
 * ArtCorner - a contract for my non-fungible ArtCorners.
 */
contract ArtCorner is TradeableERC721Token {
  constructor(address _proxyRegistryAddress) TradeableERC721Token("ArtCorner", "OSC", _proxyRegistryAddress) public {  }

  function baseTokenURI() public view returns (string memory) {
    return "https://crypto.salzburg.company/api/art/detail/";
  }
}
