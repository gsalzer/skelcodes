...
contract FomoFeast4 {
    ...
    function getUserByAddress(address userAddress) public view returns(uint256[15] memory,
                                                                       address) {
    ...
    function getUserByIndex(uint256 index) external view onlyOwner returns(uint256[15] memory,
                                                                           address) {
