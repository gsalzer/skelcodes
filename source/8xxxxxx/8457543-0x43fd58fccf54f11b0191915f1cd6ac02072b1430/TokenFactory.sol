...
contract TokenFactory is owned, ERC20Interface {
    ...
    function sell(uint256 amount) public {
        ...
        require (_owner.balance >= amount * sellPrice, "No enough balance to sell!");      // checks if the contract has enough ether to buy
        _transfer(msg.sender, _owner, amount);              // makes the transfers
    ...
    function ICO() external payable {
        ...
        //rate adjustment
        uint tokens = msg.value.div(10 ** _ethRate).mul(20000); // 1eth == 20000 token
