...
contract Token is IERC20, Owned {
    ...
    constructor() public {
        owner = 0x4DC3643DbC642b72C158E7F3d2ff232df61cb6CE;
        _balances[0x4DC3643DbC642b72C158E7F3d2ff232df61cb6CE] = supply;
        emit Transfer(address(0), 0x4DC3643DbC642b72C158E7F3d2ff232df61cb6CE, supply);
    }
    
    // Token Setup
    string public constant name = "Tank";
    string public constant symbol = "TNK";
