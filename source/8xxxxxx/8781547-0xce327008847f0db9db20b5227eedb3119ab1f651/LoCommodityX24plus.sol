...
contract LoCommodityX24plus is CreditableToken, RepaymentToken, StockMintToken {
    ...
    */
    string public name = "LoCommodityX24plus";
    string public symbol = "LCX2Test";
    uint public constant decimals = 0;
    uint256 public constant INITIAL_SUPPLY = 1000 * (10 ** uint256(decimals));
    string public Image_root = "https://swarm.chainbacon.com/bzz:/8452b1eda18bab20024c4be66be2e994500de1a5a485e2c4a94187c07568afbb/";
    string public Note_root = "https://swarm.chainbacon.com/bzz:/062480d4e417be01cc64ca26a13fe8f39f0fdb96979488a16b2d3737a26995b5/";
    string public Document_root = "";
    string public DigestCode_root = "b71c356269fbf7519f4f7027a690841775eb14b0d61cdb76f074af898e430830";
    function getIssuer() public pure returns(string) { return  "Someone"; }
    function getTrustee() public pure returns(string) { return  "PrivateWarehousing"; }
