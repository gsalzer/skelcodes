...
// File: contracts/FiretysToken.sol
...
/**
 * @title Firetys ERC20 Token Contract
 * @author BitFinance / Firetys Team
 * @dev Implementation of the FiretysToken.
 */
contract FiretysToken is Ownable, ERC20Pausable, ERC20Detailed, ERC20Capped {
    
    using SafeMath for uint256;
    
    uint8 constant DECIMALS = 8;
    uint256 constant CAP = 500000000;
    ...
    public
    ERC20Detailed('Firetys Token', 'FTY', DECIMALS)
