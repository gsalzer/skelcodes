...
contract INMGToken is PausableToken {
    ...
    */
    ...
    /*
    * @dev This IEO has parts of token total supply distributed between for bounty program, team, advisors
    * The owner of contract can assign tokens to certain benefitiars. 
    * These assigned tokens are locked up initially and are gradually unlocked over time by 33% per 6 month
    */
    ...
    /*
    * @dev modified balanceOf function to be affected by holder's locked tokens
    */
    function balanceOf(address _owner) public view returns (uint256 balance) {
    ...
    /*
    * @dev Get how many tokens are still locked up
    * @param _holder address The address owning locked tokens
    */
    ...
    /*
    * @dev Calculates how much months has passed since _since timestamp
    * @params uint256 _since The moment of time
    */
    ...
    /*
    * @dev This function allows owner of the contract to assign tokens to benefitiar, which are locked up initially and are unlocked over time
    * @param _benefitiary address The new holder of tokens
    * @param _amount uint256 The amount of tokens assigned and locked to benefitiar
    */
