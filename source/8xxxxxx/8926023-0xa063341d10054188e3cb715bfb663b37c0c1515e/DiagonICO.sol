...
contract DiagonICO is DiagonToken {
    ...
    uint public coinTradeStart = saleEnd; // Tokens transferable in a week after salesEnd
    ...
    function invest() payable public returns(bool){
        // Invest only in ICO running state
        ...
        // Add tokens to investor's balance from founder balance
        balances[msg.sender] += tokens;
    ...
    // Invest function from an external address
