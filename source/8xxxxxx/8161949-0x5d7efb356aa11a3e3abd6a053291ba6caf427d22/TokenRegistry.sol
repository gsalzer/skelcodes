...
contract TokenRegistry is Initializable, Ownable {
  ...
  event TokenAdded(bytes32 name, address tokenAddress);
  mapping(bytes32 => address) private tokensByName;
  ...
  function addToken(bytes32 name, address tokenAddress) onlyOwner public {
