...
contract BettToken is Ownable, IERC20 {
    using SafeMath for uint256;

    string  private  _name     = "BETT Erc20 Token";
    string  private  _symbol   = "BETT";
    uint8   private  _decimals = 3;              // 3 decimals
    uint256 private  _cap      = 1000000000000;   // 1 billion cap, that is 1000000000.000
