...
contract Gacha is Ownable {
    ...
    function isApprovedForAll(address _game, uint256 _tokenId) public view returns (bool){
        ...
        address tokenOwner = erc721Address.ownerOf(_tokenId);
        return erc721Address.isApprovedForAll(tokenOwner, address(this));
    }
    ...
    function setAward(address _user, address _game, uint256 _tokenId) public onlyOwner{
        ...
        require(erc721.getApproved(_tokenId) == address(this) || erc721.isApprovedForAll(erc721.ownerOf(_tokenId), address(this)));
