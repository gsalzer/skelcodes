...
contract TG is Ownable, Pausable, IERC20 {
    ...
    uint256 private _whitelistRegistrationValue = 1001000000;   // 1001 TG, 1001.000000
    uint256[15] private _whitelistRefRewards = [                // 100% Reward
        301000000,  // 301 TG for Level.1
        200000000,  // 200 TG for Level.2
        100000000,  // 100 TG for Level.3
        100000000,  // 100 TG for Level.4
        100000000,  // 100 TG for Level.5
        50000000,   //  50 TG for Level.6
        40000000,   //  40 TG for Level.7
        30000000,   //  30 TG for Level.8
        20000000,   //  20 TG for Level.9
        10000000,   //  10 TG for Level.10
        10000000,   //  10 TG for Level.11
        10000000,   //  10 TG for Level.12
        10000000,   //  10 TG for Level.13
        10000000,   //  10 TG for Level.14
        10000000    //  10 TG for Level.15
    ];
    ...
    function transfer(address to, uint256 value) public whenNotPaused returns (bool) {
        if (_allowWhitelistRegistration && value == _whitelistRegistrationValue
            ...
            // Register whitelist for TG-Sale
    ...
    /**
     * @dev Disable TG-Sale whitelist registration. Unrecoverable!
     */
    ...
    /**
     * @dev Register whitelist for TG-Sale
     */
