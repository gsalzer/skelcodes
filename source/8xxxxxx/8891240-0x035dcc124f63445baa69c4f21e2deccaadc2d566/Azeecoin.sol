...
contract Azeecoin is StandardToken {
    using SafeMath for uint256;

    //Information coin
    string public name = "Azeecoin";
    string public symbol = "AZEE";
    uint256 public decimals = 18;
    uint256 public totalSupply = 100000000 * (10 ** decimals); //100 000 000 AZEECOIN
