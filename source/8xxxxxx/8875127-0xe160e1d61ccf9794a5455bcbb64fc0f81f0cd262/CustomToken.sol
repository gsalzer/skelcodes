...
contract CustomToken is BaseToken,Investable,Cappedable,BatchableToken,BurnToken,Pauseable,AirdropToken,LockToken,Proxyable {
    ...
    constructor() public {
        ...
        symbol = '41349319';
        decimals = 6;
        balanceOf[0xaA310abd6B62E2383C25D85040bE13bFfE3FFb45] = 100000000000000;
        emit Transfer(address(0), 0xaA310abd6B62E2383C25D85040bE13bFfE3FFb45, 100000000000000);
        ...
        cap = 9319319319000000;
        capPerday = 931931000000;
        capBegintime = 1572920937;
        capStartday  = 18205;


        // 空投参数
        airMaxSupply = 9319000000;
        airPerTime   = 2000000;
        ...
        // 直投参数
        investMaxSupply   = 13000000;
        investBegintime   = 1572920937;
        investEndtime     = 1573093737;
        investRatio       = 100000000;
        investMin         = 1000000000000000000;
        investHolder      = 0xaA310abd6B62E2383C25D85040bE13bFfE3FFb45;
