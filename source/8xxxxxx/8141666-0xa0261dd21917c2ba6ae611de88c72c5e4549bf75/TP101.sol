...
contract TP101 is MintableToken, BurnableToken  {
    ...
    */
    string public name = "TP101";
    string public symbol = "tp101";
    uint public constant decimals = 8;
    uint256 public constant INITIAL_SUPPLY = 10100000 * (10 ** uint256(decimals));
    string public Image_root = "undefined";
    string public Note_root = "";
    string public DigestCode_root = "d212313bd6f14e360b9d697a5650f3c997f26e9fdcce11abe8e2d221ba1dbe6d";
    function getIssuer() public pure returns(string) { return  "Taipei"; }
    function getSource() public pure returns(string) { return  "https://swarm-gateways.net/bzz:/ca19921e54096156939f13e1a0651fff01f06f95d71fd7086a699442ea450bea/"; }
