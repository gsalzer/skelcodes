...
contract TokenBankFactory {
  ...
  function newTokenBank(string memory name, address token_contract, address[] memory s) public returns(ERC20TokenBank){
    ERC20TokenBank addr = new ERC20TokenBank(name, token_contract, s);
