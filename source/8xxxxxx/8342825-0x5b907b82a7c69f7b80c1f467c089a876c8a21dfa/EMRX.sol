...
contract EMRX is IERC20, ERC20Pausable, Ownable {
    using SafeMath for uint256;
    ...
    function burnLimit() public view returns(uint256){
        return _burnLimit;
    }
    ...
    function initialize() public {
        ...
        _symbol = "EMRX";
        _initialized = true;
        _burnLimit = 250000000 * (10 ** uint256(decimals()));
        _mint(msg.sender, 500000000 * (10 ** uint256(decimals())));
    }
   ...
   /**
    ...
    function burn(uint256 amount) public whenNotPaused {
        require(totalSupply().sub(amount) >= burnLimit(), "Burn limit exceeded");
