...
contract FomoFeastBet {
    ...
    // threshold. On rare occasions bet.fomofeast.top croupier may fail to invoke
    ...
    // Funds withdrawal to cover costs of bet.fomofeast.top operation.
    ...
    //                    by the bet.fomofeast.top croupier bot in the settleBet transaction. Supplying
    ...
    // in a situation like this, just contact the bet.fomofeast.top support, however nothing
