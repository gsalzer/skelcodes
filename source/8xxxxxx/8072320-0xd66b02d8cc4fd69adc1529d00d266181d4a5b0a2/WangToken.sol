...
contract WangToken is StandardToken, SafeMath {

    // metadata
    string  public constant name = "WangCoins";
    string  public constant symbol = "WANG";
    ...
    uint256 public tokenExchangeRate = 520;           // 625 BILIBILI 兑换 1 ETH
