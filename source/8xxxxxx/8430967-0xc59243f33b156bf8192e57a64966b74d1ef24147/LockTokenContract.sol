...
contract LockTokenContract {
    ...
    // address public AddressOne = address(0x8Af6F7A42ebbc7bF7EC386505ecEC4344dB565FC);
    // address public AddressTwo = address(0x4cB827B58C8d7FCbaC177974da7d1F501a60cF24);
    // address public GubiTokenAddress  = address(0x12b2B2331A72d375c453c160B2c8A7010EeA510A);
    // uint256 AddressOneMaxWithdrawalAmount = 21000000 * 1e18;
    ...
    // uint256 public releaseTime = 1583683200; // 2020-03-09 00:00:00
    uint256 public releaseTime = now + 3600 * 24; // now
