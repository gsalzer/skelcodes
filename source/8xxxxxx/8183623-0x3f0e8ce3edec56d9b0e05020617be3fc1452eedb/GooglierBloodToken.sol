...
contract GooglierBloodToken is StandardToken, SafeMath {
    ...
    uint public transferLockup = 0; //transfers are locked for this many blocks after endBlock (assuming 14 second blocks, this is 2 months)
    uint public founderLockup = 0; //founder allocation cannot be created until this many blocks after endBlock (assuming 14 second blocks, this is 1 year)
    ...
    bool public bountyAllocated = true; //this will change to true when the bounty fund is allocated
    bool public ecosystemAllocated = true; //this will change to true when the ecosystem fund is allocated
    bool public founderAllocated = true; //this will change to true when the founder fund is allocated
