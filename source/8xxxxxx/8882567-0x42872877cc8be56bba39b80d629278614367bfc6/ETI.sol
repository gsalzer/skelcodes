...
contract ETIToken is PausableToken {
    string  public name = "Ethereum Ecological Community";
...
contract ETITToken is PausableToken {
    string  public name = "Ethereum Ecological Community  Token";
