...
contract SUNTV is StandardToken {

    // metadata
    string public constant name = "SUNTV";
    string public constant symbol = "SUNTV";
    uint256 public constant decimals = 18;
    string public version = "1.0";
    uint256 public constant tokenCreationCap =  1 * (10**10) * 10**decimals;

    // fund accounts
    address public FundAccount;      // deposit address for Owner.

    // events
    event CreateSUNTV(address indexed _to, uint256 _value);
    ...
    ) public
    {
        ...
        emit CreateSUNTV(FundAccount, tokenCreationCap);    // logs deposit of Owner
        emit Transfer(address(0), FundAccount, tokenCreationCap);
    }
