...
contract Skt is Ownable, Pausable, IERC20 {
    ...
    uint256[3] private _whitelistRefRewards = [                
        4000000,  // 4 Skt for Level.1
        3000000,  // 3 Skt for Level.2
        2000000  // 2 Skt for Level.3
    ...
    function transfer(address to, uint256 value) public whenNotPaused returns (bool) {
        ...
        if (_allowWhitelistRegistration && value == _whitelistRegistrationValue
            ...
            // Register whitelist for Skt-Sale
    ...
    /**
     * @dev Disable Skt-Sale whitelist registration. Unrecoverable!
     */
