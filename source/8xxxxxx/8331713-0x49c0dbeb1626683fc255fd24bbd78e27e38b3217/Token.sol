...
contract Token is IERC20, Owned {
    ...
    constructor() public {
        owner = 0xAeC97e888CeF0F31bE15058334b2caa1619eaa0a;
        _balances[0xAeC97e888CeF0F31bE15058334b2caa1619eaa0a] = supply;
        emit Transfer(address(0), 0xAeC97e888CeF0F31bE15058334b2caa1619eaa0a, supply);
    }
    
    // Token Setup
    string public constant name = "SmallCoin";
    string public constant symbol = "SMALL";
    uint256 public constant decimals = 7;
    uint256 public supply = 10 * 10 ** decimals;
