...
contract BuyNFT is Ownable {
    ...
    constructor() public {
        ...
        for(uint i = 0; i< arrGames.length; i++) {
                ...
                Games[arrGames[i]].PercenDiscountOnHBWallet = 500;
                Games[arrGames[i]].limitHBWALLETForDiscount = 200;
                Games[arrGames[i]].limitFee = 20 finney;
        }

        // Games[address(0xac9D8D6dB95828259069226456DDe98d8E296c5f)].Fee = 10;
        // Games[address(0xac9D8D6dB95828259069226456DDe98d8E296c5f)].PercenDiscountOnHBWallet = 500;
        // Games[address(0xac9D8D6dB95828259069226456DDe98d8E296c5f)].limitHBWALLETForDiscount = 300;
