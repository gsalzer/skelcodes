...
contract Card {
    ...
    string public sex;
    int256 public birthday;
    
    constructor(string n, string a, uint256 totalSupplyToUse, string firstNameToUse, string middleNameToUse, string lastNameToUse, string leagueToUse, string teamToUse, string positionToUse, string sexToUse, int256 birthdayToUse) public {
        name = n;
        symbol = a;
