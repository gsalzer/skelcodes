...
contract Strategy is ConvexStable {
    ...
    constructor(address _vault) public ConvexStable(_vault) {
        curve = address(0xEB16Ae0052ed37f479f7fe63849198Df1765a733);
        id = 26;
        ...
        pathTarget[0] = dai; // crv path target
        pathTarget[1] = dai; // cvx path targe
        pathTarget[2] = dai; // aave path target
        ...
        )
    {
        ...
        if (_dai > 0) {
            ICurveFi(curve).add_liquidity([_dai, 0], 0, true);
        }
