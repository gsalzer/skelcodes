...
pragma solidity ^0.6.12;
    ...
    contract SkimpyContract is Context, IERC20, Ownable {
        ...
        string private _name = 'Blue Origin';
        string private _symbol = 'BLUORG';
        ...
        uint256 private _maxTxAmount = 1000000000 * 10**6 * 10**9;
        ...
        function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
            require(maxTxAmount >= (100000 * 10**6 * 10**9) , 'maxTxAmount should be greater than 100000000000 * 10**9');
