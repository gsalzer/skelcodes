...
contract EthereumHaven is Context, IERC20, Ownable {
    ...
    string private constant _name = 'EthereumHaven (https://t.me/EthereumHaven)';
    string private constant _symbol = 'eHaven';
