...
/**
 * @title CMT_v2_B_TR_TAX_NC_X
 * @dev Implementation of the CMT_v2_B_TR_TAX_NC_X
 */
contract CMT_v2_B_TR_TAX_NC_X is Context, IERC20, ERC20Ownable, Helper {
    ...
    constructor(
        ...
        address __cmt_router,
        uint8 __cmt_tax_reflection,
        uint8 __cmt_tax_wallet,
        uint8 __cmt_tax_burn,
        uint8 __cmt_tax_liquidity,
        uint8 __cmt_tax_buyback
    ) payable {
        _name = __cmt_name;
        _symbol = __cmt_symbol;
        _decimals = __cmt_decimals;
        _tTotal = __cmt_initial;
        _rTotal = (MAX - (MAX % _tTotal));

        buyBackUpperLimit = __cmt_initial.mul(1).div(10000);
        ...
        numTokensSellToAddToLiquidity = __cmt_initial.mul(1).div(10000);

        IUniswapV2Router02 _pcsV2Router = IUniswapV2Router02(__cmt_router);
        ...
        _taxFee = __cmt_tax_reflection;
        _liquidityFee = __cmt_tax_liquidity;
        _burnFee = __cmt_tax_burn;
        _buybackFee = __cmt_tax_buyback;
        _walletFee = __cmt_tax_wallet;
