...
contract Crusaders3D is ERC721Enumerable, Ownable {
    ...
    // Truth.
    constructor(string memory baseURI) ERC721("3DCrusaders", "3DCrusaders") {
        setBaseURI(baseURI);
    }

    function mintMyCrusader(uint256 numberOfcrusaders)
        public
        payable
        onlyOwner
    {
        ...
        if (totalSupply() < GIVE_AWAY_COUNT) {
            ...
            require(numberOfcrusaders <= 50, "Exceeds 50!");
        }
