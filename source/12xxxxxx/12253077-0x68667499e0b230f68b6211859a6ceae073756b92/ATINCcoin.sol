...
contract ATINCcoin is StandardToken {
  string public constant symbol = "ATINC";
  string public constant name = "ATINC Coin";
  uint256 public constant decimal = 18;

  uint256 internal constant tokenUnit = 10**18;
  uint256 internal constant oneBillion = 10**9;
  uint256 internal constant maxTokens = 8 * oneBillion * tokenUnit;
