...
contract STARFLIGHT is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 374643905701 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tBurnTotal;

    string private _name = '⭐️STARFLIGHT⭐';
    string private _symbol = '⭐️STARFLIGHT⭐';
