...
contract wsOHM is ERC20 {
    ...
    constructor( address _staking, address _index, address _OHM, address _sOHM ) ERC20( 'Wrapped sOHM', 'wsOHM' ) {
    ...
    function wrapFromOHM( uint _amount ) external returns ( uint ) {
        ...
        uint value = sOHMTowsOHM( _amount );
    ...
    function unwrapToOHM( uint _amount ) external returns ( uint ) {
        ...
        uint value = wsOHMTosOHM( _amount );
