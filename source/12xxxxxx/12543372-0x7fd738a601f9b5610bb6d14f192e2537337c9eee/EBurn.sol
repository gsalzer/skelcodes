// Ethereum BURN
// Telegram t.me/ethereumburn - 1st channel
// Telegram t.me/ethereumburntoken - 2nd channel

// INSPIRED FROM eSUPREME
// 
//        '||'''|,  '||   ||` '||'''|, '||\   ||` 
//         ||   ||   ||   ||   ||   ||  ||\\  ||  
// .|''|,  ||;;;;    ||   ||   ||...|'  || \\ ||  
...
contract EBurn is Context, IERC20, Ownable {
    ...
    string private _name = 'Ethereum Burn';
    string private _symbol = 'eBURN';
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(delay && !ignoreDelay[sender]){
            require(block.number > waitTime[sender] || amount < _tTotal.div(100),"Please wait");
        }
