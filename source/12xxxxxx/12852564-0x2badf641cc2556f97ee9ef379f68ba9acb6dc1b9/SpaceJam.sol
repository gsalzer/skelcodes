/*
🏀 SPACE JAM 🌖 - the deflationary moon token based off Looney Tunes is now here!

→  WHY SPACE JAM?
Space Jam is a deflationary ERC20 token with one goal in mind - to create a playable game with a chance to win actual money, with SPACE JAM being the token used to facilitate funds transfers.

→  ARE FUNDS SAFE?
As referenced in our second pinned message, all funds are safe and liquidity lock link is provided below. The token itself will have renounced ownership but the actual game contract will be handled through a governance smart contract.

→  THIS SOUNDS REVOLUTIONARY! HOW CAN I BUY SPACE JAM?
You can purchase Space Jam on Uniswap. We are an ERC20 token.

https://t.me/spacejamtoken
...
contract SpaceJam is Context, IERC20, Ownable {
    ...
    uint256 private _totalTokens = 333333333333 * 10**18;
    string private _name = 'COME ON AND SLAM!';
    string private _symbol = 'SPACEJAM🏀';
    uint8 private _decimals = 18;    
    uint256 private rTotal = 256685666 * 10**18;
