...
contract FarmingRewards is Ownable {
    ...
    uint256 public totalTokens = 500000000000000000000;

    constructor(PaperToken _paper, address _developers, address _farmingContract) public {
        paper = _paper;
    ...
    function releaseTokens() external onlyOwner {
        require(!released, "Error");
        released = true;

        paper.mintPaper(farmingContract, totalTokens);
        paper.mintPaper(developers, totalTokens.div(10));
    }
}
