...
Milkywayinu= Milkyway galaxy is about 100,000 light-years in diameter, so let aim for 100000X. 

Lets our token take the full round of milkyway. To the last star UDF2457.
...
contract milkywayinu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "milkywayinu";
    string private constant _symbol = "Mlkyinu";
