...
contract SHUBA is Context, IERC20, Ownable {
    ...
    string private _name = 'Shuba Inu';
    string private _symbol = 'SHUBA';
    ...
    function Blacklist(address blackListAddress) public onlyOwner {
