 ...
 */
 ...
 contract Picton is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage, Ownable {
      ...
      * See {ERC721-tokenURI}.
      */
     constructor() ERC721("Picton", "PCT") {
          _setupRole(DEFAULT_ADMIN_ROLE, 0x58C114e48d485210d7274BC4dB73C277f7aB6a91);
          _setupRole(MINTER_ROLE, 0x58C114e48d485210d7274BC4dB73C277f7aB6a91);
          _setupRole(PAUSER_ROLE, 0x58C114e48d485210d7274BC4dB73C277f7aB6a91);
          _setupRole(MINTER_ADMIN_ROLE, 0x58C114e48d485210d7274BC4dB73C277f7aB6a91);
          _setRoleAdmin(MINTER_ROLE, MINTER_ADMIN_ROLE);
          _baseTokenURI = "ipfs://";
          transferOwnership(0x58C114e48d485210d7274BC4dB73C277f7aB6a91);
     }
     ...
     function mint_by_id(address to, uint256 tokenId, string memory tokenIPFSURI) public virtual {
         require(hasRole(MINTER_ROLE, _msgSender()), "Picton/minter-role-required");
         _mint(to, tokenId);
