...
// BAGToken with Governance.
contract BAGToken is ERC20("Blockchain Adventurers Guild", "BAG"), Ownable {
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (BagBang).
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying BAGs (not scaled);
