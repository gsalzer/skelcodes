...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0x82b4B56f81f33c43b2279947EDB9858A6353782D;
...
contract ShibaGold is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "SHIBA INU GOLD";
    string private _symbol = "SHIBAGOLD";
    ...
    uint256 internal _tokenTotal = 500_000_000_000_000e18;
    ...
    uint256 public _liquidityFee = 2; // means 4% add liquidity on each buy and sell
    uint256 public _burnFee = 5; // means 3% it burns from each buy and sell
