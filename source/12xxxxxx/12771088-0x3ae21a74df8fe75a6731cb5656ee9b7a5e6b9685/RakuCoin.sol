...
pragma solidity ^0.6.12;
    ...
    contract RakuCoin is Context, IERC20, Ownable {
        ...
        uint256 private _buystaketaxFee = 4; 
        uint256 private _buyMarketingPoolFee = 3;
        uint256 private _selltaxFee = 5; 
        uint256 private _sellstaketaxFee = 7; 
        uint256 private _sellMarketingPoolFee = 3;
        ...
        uint256 public walletlimit = 10000 * 10**18;
        uint256 private _maxTxAmount = 5000 * 10**18;
        // We will set a minimum amount of tokens to be swaped => 500K
        uint256 private _numOfTokensToExchangeForMarketingPool = 1 * 10**18;
    ...
    // List of front-runner & sniper bots from t.me/FairLaunchCalls
        ...
        function _setbuyTaxFee(uint256 buytaxFee) external onlyOwner() {
            require(buytaxFee >= 0 && buytaxFee <= 10, 'taxFee should be in 0 - 10');
            _buytaxFee = buytaxFee;
        }
        
        function _setsellTaxFee(uint256 selltaxFee) external onlyOwner() {
            require(selltaxFee >= 0 && selltaxFee <= 10, 'taxFee should be in 0 - 10');
        ...
        function _setbuystakeFee(uint256 buystakeFee) external onlyOwner() {
            require(buystakeFee >= 0 && buystakeFee <= 11, 'stakeFee should be in 0 - 11');
            _buystaketaxFee = buystakeFee;
        }
        function _setsellstakeFee(uint256 sellstakeFee) external onlyOwner() {
            require(sellstakeFee >= 0 && sellstakeFee <= 11, 'stakeFee should be in 0 - 11');
        ...
        function _setbuyMarketingPoolFee(uint256 buyMarketingPoolFee) external onlyOwner() {
            require(buyMarketingPoolFee >= 0 && buyMarketingPoolFee <= 11, 'MarketingPoolFee should be in 0 - 11');
        ...
        function _setsellMarketingPoolFee(uint256 sellMarketingPoolFee) external onlyOwner() {
            require(sellMarketingPoolFee >= 0 && sellMarketingPoolFee <= 11, 'MarketingPoolFee should be in 0 - 11');
