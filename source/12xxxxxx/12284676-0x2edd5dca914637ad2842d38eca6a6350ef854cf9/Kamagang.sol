...
contract Kamagang is ERC721, Ownable {
    ...
    constructor() ERC721("Kamagang","KAMA")  {
        ...
        // marketingBitch
        _safeMint(address(0x1d2D8fc9540E73906c6fae482FC241468B20691f), 1);  
        // marketingBitch
        _safeMint(address(0x1d2D8fc9540E73906c6fae482FC241468B20691f), 2);  
        }
    ...
    function calculatePrice() public view returns (uint256) {
        ...
        if (currentSupply == 3163) {
            return 69000000000000000000;
        } else if (currentSupply >= 3160) {
            return 3600000000000000000;
        } else if (currentSupply >= 3150) {
            return 2690000000000000000;
        } else if (currentSupply >= 3130) {
            return 1690000000000000000;
        } else if (currentSupply >= 3080) {
            return 1090000000000000000;
            ...
            return 590000000000000000;
        } else if (currentSupply >= 1500) {
            return 490000000000000000;
        } else if (currentSupply >= 1000) {
            return 390000000000000000;        
        } else if (currentSupply >= 500) {
            return 290000000000000000;
   ...
   function mintKAMA(uint256 numKamas) public payable {
        require(totalSupply() < MAX_KAMAS, "Sale has already ended");
        require(numKamas > 0 && numKamas <= 5, "You can adopt minimum 1, maximum 5 KAMAS");
