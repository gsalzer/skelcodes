...
contract KiiADefi{
    ...
    function unlock(address _beneficiary,uint _planId, uint _depositId) public {
        // Only owner can call this function
        require(msg.sender == owner, "caller must be the owner");
        require(islocked[_beneficiary][_planId][_depositId]==true,"User account already unlocked");
        // Unlock
    ...
    function setLock(address _beneficiary,uint _planId, uint _depositId) public {
        // Only owner can call this function
        require(msg.sender == owner, "caller must be the owner");
        require(islocked[_beneficiary][_planId][_depositId]==false,"User account already in lock status");
        // Unlock
