...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3dD7A81bFA8499A20D5893Fe151b836B548C9189;
...
contract ShibaKiyo is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress =0x3dD7A81bFA8499A20D5893Fe151b836B548C9189 ;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 2000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Shiba Kiyo";
    string private _symbol = "Sikiyo";
