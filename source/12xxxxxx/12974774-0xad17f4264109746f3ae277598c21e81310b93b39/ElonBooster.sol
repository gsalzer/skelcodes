...
pragma solidity ^0.6.12;
    ...
    contract ElonBooster is Context, IERC20, Ownable {
        ...
        string private _name = '70m Elon Booster';
        string private _symbol = '70EB';
        ...
        uint256 private _maxBuy = 100000000000 * 10**9;
        ...
        function _setTeamFee(uint256 teamFee) external onlyOwner() {
            require(teamFee >= 1 && teamFee <= 40, 'teamFee should be in 1 - 40');
            _teamFee = teamFee;
        }
