...
contract HashScapes is ERC721Enumerable, Ownable {
    ...
    uint public constant MAX_SCAPES = 7777;
    uint public constant numReserved = 20;
    uint private curIndex = 21;
    ...
    function reserve() public onlyOwner {
        ...
        for (uint i = 1111; i <= MAX_SCAPES; i += 1111) {
            _safeMint(owner(), i);
        }
    }
