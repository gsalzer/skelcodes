//Doge needs help getting to the moon
//Enter: The DOGELAUNCHER!
//Join us at https://t.me/DogeLauncher
...
contract DogeLauncher is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 42069 * 10**9 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'DogeLauncher';
    string private _symbol = 'DOGELAUNCH';
    uint8 private _decimals = 18;
    
    uint256 private _taxFee = 5;
    uint256 private _burnFee = 5;
    uint256 private _maxTxAmount = 42069 * 10 **9 * 10**18;
