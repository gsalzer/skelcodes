...
pragma solidity ^0.6.12;
    ...
    contract AMOON is Context, IERC20, Ownable {
        ...
        uint256 private _tTotal = 158000000 * 10**18;
        uint256 private _rTotal = (MAX - (MAX % _tTotal));
        uint256 private _tFeeTotal;

        string private _name = 'ALIEN MOONS';
        string private _symbol = 'AMOON';
        uint8 private _decimals = 18;

        uint256 private _taxFee = 8;
        uint256 private _MarketingPoolFee = 4;
        ...
        uint256 private _maxTxAmount = 1580000 * 10**18;
        uint256 private _numOfTokensToExchangeForMarketingPool = 1 * 10**6 * 10**18;
        ...
        function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
            require(maxTxAmount >= 1580000000 , 'maxTxAmount should be greater than 158000000');
