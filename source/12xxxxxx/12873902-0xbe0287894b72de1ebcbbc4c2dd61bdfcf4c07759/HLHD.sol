...
// File: verified-sources/0x111b322f194456623782e271f071bf3c866ff4f0/sources/verified-sources/0x7a16d66204909e018855346517f388795b2a0ace/sources/contracts/HLHD.sol
...
contract HLHD is AccessControl, ERC721Enumerable {
    using Strings for uint256;
    using SafeMath for uint256;
    using Counters for Counters.Counter;

    uint public constant MAX_HLHD = 9975;
    uint private constant RESERVED_HLHD =25;
    uint public constant FRO_LIMIT = 20;
    ...
    constructor(address owner_, string memory uri_) ERC721("Happy Little Hairdos", "HLHD")  {
    ...
    function setActive(bool isActive) public onlyRole(DEFAULT_ADMIN_ROLE) {
    _isActive = isActive;
  }
...
function setContractURI(string memory URI) public onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function reservedHLHD(address _to, uint _count) public onlyRole(DEFAULT_ADMIN_ROLE) {
