...
contract DigicolStaking is AccessControl {
    using SafeMath for uint256;

    string public constant NAME = "Digicol Staking Contract";
    ...
    struct Stake {
        ...
        uint16 _stakeRewardType; // 0 for native coin reward, 1 for DGCL stake reward
    }
    ...
    struct YieldType {
        ...
        uint256 _packageDGCLReward; // the number of Digicol token received for each native token staked
    }
    ...
    uint256 digicolRewardUnits = 1000000; // Digicol reward for 1.000.000 tokens staked
    ...
    constructor(address _stakedToken) {
        ...
        _definePackage("Silver Package", 29, 29, 2843615, 0); // in 30 days you receive: 2.843615 % of staked token OR 0 Digicol for 1 token staked || 6 decimals
    }
    ...
    function stakeTokens(
        ...
        require(
            ...
            "reward type not known: 0 is native token, 1 is DGCL"
        );
        ...
        returns (uint256 yieldReward, uint256 timeDiff)
    {
        require(
            ...
            "use checkStakeReward for stakes accumulating reward in DGCL"
        );
