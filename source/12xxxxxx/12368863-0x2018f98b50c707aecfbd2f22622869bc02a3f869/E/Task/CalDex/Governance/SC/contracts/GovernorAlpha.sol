...
contract GovernorAlpha is Initializable {
    ...
    string public constant name = "VOTX Governor Alpha";

    /// @notice The number of votes in support of a proposal required in order for a quorum to be reached and for a vote to succeed
    function quorumVotes() public view returns (uint256) {
        return votx.totalSupply() / 4;
    } // 25% of Total Supply

    /// @notice The number of votes required in order for a voter to become a proposer
    function proposalThreshold() public view returns (uint256) {
        return votx.totalSupply() / 100;
    } // 1% of Total Supply
    ...
    /// @notice The address of the VOTX Timelock
    ...
    function propose(
        ...
        require(
            votx.getPriorVotes(msg.sender, sub256(block.number, 1)) >
                proposalThreshold(),
    ...
    function cancel(uint256 proposalId) public {
        ...
        require(
            msg.sender == guardian ||
                votx.getPriorVotes(proposal.proposer, sub256(block.number, 1)) <
                proposalThreshold(),
    ...
    function _castVote(
        ...
        uint256 votes = votx.getPriorVotes(voter, proposal.startBlock);
