...
contract SafuInvestmentsFactory {
    ...
    function createPresale(
        ...
        uint256 maxLiqPoolTokenAmount = (maxEthPoolTokenAmount.mul(tokenDecimals)).div(_uniInfo.listingPriceInWei);

        uint256 maxTokensToBeSold = (_info.hardCapInWei.mul(tokenDecimals)).div(_info.tokenPriceInWei);
