...
// Part: iearn-finance/yearn-vaults@0.3.2-1/HealthCheck
...
// Part: iearn-finance/yearn-vaults@0.3.2-1/VaultAPI
...
// Part: iearn-finance/yearn-vaults@0.3.2-1/BaseStrategy
...
contract Strategy is BaseStrategy {
    ...
    address public constant mcd_join_yfi_a = address(0x3ff33d9162aD47660083D7DC4bC02Fb231c81677);
    ...
    OracleSecurityModule public constant yfi_usd_osm_proxy = OracleSecurityModule(0x208EfCD7aad0b5DD49438E0b6A0f38E951A50E5f);
    OracleSecurityModule public constant yfi_usd_osm = OracleSecurityModule(0x5F122465bCf86F45922036970Be6DD7F58820214);
    EACAggregatorProxy public constant yfi_usd_chainlink = EACAggregatorProxy(0xA027702dbb89fbd58938e4324ac03B58d812b0E1);  // yfi-usd.data.eth
    address public constant yvdai = address(0xdA816459F1AB5631232FE5e97a05BBBb94970c95);

    address public constant uniswap = address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    address public constant sushiswap = address(0xd9e1cE17f2641f24aE83637ab66a2cca9C378B9F);

    uint public constant DENOMINATOR = 10000;
    bytes32 public constant ilk = "YFI-A";
    ...
    modifier onlyManagement() {
        require(msg.sender == vault.management() || msg.sender == governance(), "!management");
        _;
    }
    ...
    function name() external view override returns (string memory) {
        return "MakerYFI-DAIv0.4.3Delegate";
    }

    function setBorrowCollateralizationRatio(uint _c) external onlyManagement {
        c = _c;
    }

    function setBuffer(uint _buffer) external onlyManagement {
        buffer = _buffer;
    }
        ...
        returns (uint256 _liquidatedAmount, uint256 _loss)
    {
        ...
        _freeGEMandWipeDAI(_liquidatedAmount, 0);
