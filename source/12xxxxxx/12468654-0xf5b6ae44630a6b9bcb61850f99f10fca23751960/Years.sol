...
contract ERC2309 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable, IERC2309 {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return string(abi.encodePacked(base, ((tokenId + 1) * 7 + 2101).toString(), ".json"));
    }

    function baseURI() public view virtual returns (string memory) {
        return "https://nftyears.com/images/";
    }
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        ...
        require(_msgSender() == owner || ERC2309.isApprovedForAll(owner, _msgSender()),
    ...
    function _isApprovedOrOwner(address spender, uint256 tokenId) internal view virtual returns (bool) {
        ...
        address owner = ERC2309.ownerOf(tokenId);
        return (spender == owner || getApproved(tokenId) == spender || ERC2309.isApprovedForAll(owner, spender));
    }

    function _transfer(address from, address to, uint256 tokenId) internal virtual {
        require(ERC2309.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own"); // internal owner
    ...
    function _approve(address to, uint256 tokenId) private {
        ...
        emit Approval(ERC2309.ownerOf(tokenId), to, tokenId); // internal owner
    }
...
contract Years is ERC2309 {
    constructor () ERC2309("Years", "YEARS") public {
        _init(msg.sender, 2101);
    }
}
