...
abstract contract Freezable is Context {
    ...
    function frozen(address holder) public view virtual returns (bool) {
        return _frozenAccount[holder];
    }

    function _freezeAccount(address holder) internal virtual returns (bool) {
    ...
    function _unfreezeAccount(address holder) internal virtual returns (bool) {
        require(frozen(holder));
...
contract CTPL is ERC20, Pausable, Freezable, ERC20Burnable {

    constructor() ERC20("Cultiplan", "CTPL") {
