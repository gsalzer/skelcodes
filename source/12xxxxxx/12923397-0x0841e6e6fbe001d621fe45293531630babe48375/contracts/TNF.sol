...
contract TNF is FactoryERC721, Ownable {
    ...
    string public baseURI = "https://companions.thenemesis.io/api/v1/factory/";



    uint256 MAX_SUPPLY = 8000; //MAX SUPPLY
    ...
    function name() override external pure returns (string memory) {
        return "The Nemesis Companions Factory";
    }
