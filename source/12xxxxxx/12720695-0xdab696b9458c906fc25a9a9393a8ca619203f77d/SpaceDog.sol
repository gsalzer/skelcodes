...
// congrats nerd
// take a bite of this delicious bone 🦴
// and DM Gutter Cat Gang a "Love. Cats. Woof-woof!"
contract SpaceDog is ERC721, Ownable {
    using SafeMath for uint256;

    uint256 public constant TOTAL_SUPPLY = 10000;

    uint256 public constant dogPrice = 80000000000000000;
    ...
    event SpaceDogCatapulted(uint tokenId, address sender);
    ...
    function reserveSpaceDogs() public onlyOwner {
    ...
    function mintSpaceDogs(uint numberOfTokens) public payable {
        require(getSaleIsActive(), "Mint is not available right now");
        ...
        require(dogPrice.mul(numberOfTokens) <= msg.value, "Value is incorrect");
        ...
        for (uint i = 0; i < numberOfTokens; i++) {
            ...
            if (newTokenId <= TOTAL_SUPPLY) {
                ...
                emit SpaceDogCatapulted(newTokenId, msg.sender);
            }
        }
    }
