...
// File: contracts\token\NewX.sol

// contracts/token/NewX.sol
...
contract NewX is Context,
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "NewX: must have admin role to mint");
        _mint(to, amount);
    }

    function burn(address from, uint256 amount) public virtual {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "NewX: must have admin role to burn");
        _burn(from, amount);
    }

    function pause() public virtual {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "NewX: must have admin role to pause");
        _pause();
    }

    function unpause() public virtual {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "NewX: must have admin role to unpause");
        _unpause();
    }
