...
contract ERC20Factory{
    ...
    mapping (uint => address) public ERC20Addresses;
    ...
    function realeaseToken(string memory name, string memory symbol, uint8 decimals, address receiver, uint amountInWei) public {
        
        Token newToken = new Token(name, symbol, decimals, receiver,amountInWei);
        addressID += 1;
        ERC20Addresses[addressID] = address(newToken);
