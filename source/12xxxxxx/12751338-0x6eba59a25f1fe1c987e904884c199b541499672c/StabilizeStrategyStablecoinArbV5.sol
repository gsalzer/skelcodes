...
// File: contracts/strategies/StabilizeStrategyStablecoinArbV5.sol
...
contract StabilizeStrategyStablecoinArbV5 is Ownable {
    ...
    function expectedProfit(bool inWETHForExecutor) external view returns (uint256) {
        ...
        if(inWETHForExecutor == true){
            ...
            interestGain = vault.viewWETHProfit(interestGain.mul(DIVISION_FACTOR.sub(percentDepositor)).div(DIVISION_FACTOR)); // Will return profit as WETH
        }
