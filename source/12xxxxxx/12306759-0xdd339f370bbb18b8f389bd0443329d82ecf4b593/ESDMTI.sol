...
/**
* Elon Safe Doge Moon Tokyo Inu
* Total Supply
* Supply: 1,000,000,000,000,000
* Mechanics
* 11% Total Tax: 5% fee redistributed to all existing holders. 5% fee added as a liquidity pair on Uniswap. 1% is the development fee.
* AntiBot Ssetting
* The listing bot takes away the profit of the token holders. ESDMTI burns all the tokens purchased using the listing bot to protect the investors.
* Fair Launch
* Maximum buy limit, meaning no whales. The perfect meme token on erc by the community, for the community.
* Join Us
* WebSite: https://elonsafedogemoontokyoinu.com
* Telegram: https://t.me/ElonSafeDogeMoon
**/
...
contract ESDMTI is Context, IERC20, Ownable {
    ...
    string private _name = "ElonSafeDogeMoonTokyoInu";
    string private _symbol = "ESDMTI";
    ...
    function _transfer(
        ...
        // restricted transactions between 20 blocks only
