...
// File contracts/FreeERC20.sol

pragma solidity ^0.6.0;

contract MintersERC20 is ERC20 {
    mapping (address => bool) public minters;
    address public owner;

    constructor(string memory name_, string memory symbol_, uint8 decimals_, address[] memory minters_, uint256 initMintAmount_) ERC20(name_, symbol_) public {
        _setupDecimals(decimals_);
        
        owner = msg.sender;
        _mint(msg.sender, initMintAmount_);
