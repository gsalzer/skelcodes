...
// File contracts/digg-oracles/CentralizedOracle.sol
...
contract CentralizedOracle is AccessControlUpgradeable, PausableUpgradeable {
    ...
    function initialize(address medianOracle_, address initialAdmin_, address initialGuardian_, address[] memory initialOracles_) external initializer {
        ...
        for (uint i = 0; i < initialOracles_.length; i++) {
