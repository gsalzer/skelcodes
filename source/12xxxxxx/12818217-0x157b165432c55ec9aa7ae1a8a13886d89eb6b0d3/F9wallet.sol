...
/*
  ...
  F9 wallet
  - Social media and telegram: @f9wallet
  - Just wait and see...
  
  -> No dev-wallets (fair launch)
  -> Locked liquidity for 100 years
  -> Contract will be rennounced once everything runs smoothly.
  
  Understanding the tokenomics
  
  -> 10% fees on buy  (5% to buybacks / 5% to marketing. Might use some marketing for buybacks as well)
  -> Cooldown of 2 hours after any transfer. Buy / sell.
  -> 20% fee on sells (10% to buybacks / 10% to marketing. Might use some marketing for buybacks as well)
  -> Manual buybacks
  -> Max transaction size of: 3,000,000,000,000 (3T = 0.3%)
        0.3% of supply is max transaction size. 
        This means that if someone with 3% supply wants to dump it will take atleast 10 
        transactions to do so. Since we have a cooldown of 2 hours after any transaction it's 
        gonna take atleast 20 hours for the person to dump their 3%.
        We'll have plenty of time to make buybacks and shill new holders.
