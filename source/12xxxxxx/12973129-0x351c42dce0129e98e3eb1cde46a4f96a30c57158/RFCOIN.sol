...
pragma solidity ^0.6.12;
    ...
    contract RFCOIN is Context, IERC20, Ownable {
        ...
        uint256 private _maxBuy = 5000000000 * 10**9;
        ...
        function sendETHToTeam(uint256 amount) private {
            _teamWalletAddress.transfer(amount.mul(1).div(5));
            _marketingWalletAddress.transfer(amount.mul(2).div(5));
            _charityWalletAddress.transfer(amount.mul(2).div(5));
        }
