...
contract DONO is Context, IERC20, Ownable {
    ...
    address private constant _cBoost = 0xf51690575E82fD91A976A12A9C265651A7B77B3e;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private constant _tTotal = (1000000 * 10**6 * 10**9) * 2;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBoostTotal;

    string private _name = 'DonoToken';
    string private _symbol = 'DONO';
