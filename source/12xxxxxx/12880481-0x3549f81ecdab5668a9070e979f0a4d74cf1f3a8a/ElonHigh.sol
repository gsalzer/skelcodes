// Join Elon High: https://t.me/eHightoken
...
contract ElonHigh is Context, IERC20, Ownable {
    ...
    string private _name = 'Elon High';
    string private _symbol = 'eHIGH';
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender == owner()) {
            ...
            uint256 feeAmount = amount.mul(15).div(100);
