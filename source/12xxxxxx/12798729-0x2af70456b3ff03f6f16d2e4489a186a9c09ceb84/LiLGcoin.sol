...
contract DetailedERC20 is ERC20 {
  ...
  constructor(string _name, string _symbol, uint8 _decimals, uint256 _initialSupply, uint256 _totalSupply) public {
    name = _name;
    symbol = _symbol;
    decimals = _decimals;
...
// File: contracts/token/LiLGcoin.sol

contract LiLGcoin is StandardToken, DetailedERC20("LiLGcoin", "LGX", 16, 975000, 7500000),
    MintableToken, BurnableToken, FreezableToken, PausableToken, OwnableContract {
