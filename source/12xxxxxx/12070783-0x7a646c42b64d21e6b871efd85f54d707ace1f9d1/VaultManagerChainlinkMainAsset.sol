...
// File: localhost/vault-managers/VaultManagerChainlinkMainAsset.sol
...
/**
 * @title VaultManagerChainlinkMainAsset
 **/
contract VaultManagerChainlinkMainAsset is ReentrancyGuard {
    using SafeMath for uint;
    ...
    **/
     ...
     * @param _chainlinkOracleWrapperMainAsset The address of chainlink-based oracle wrapper for main asset
     **/
    constructor(address _vaultManagerParameters, address _chainlinkOracleWrapperMainAsset) public {
        ...
        oracle = ChainlinkedOracleSimple(_chainlinkOracleWrapperMainAsset);
    }
