...
import "../dependencies/uniswap-v2-periphery/contracts/dependencies/uniswap-v2-core/contracts/libraries/SafeMath.sol";
...
library RenaswapV1Library {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'c346c428cf4a1855040b9f552358dc5437d9879f85fea3b4a793682741bcec03' // init code hash
            ))));
    }
