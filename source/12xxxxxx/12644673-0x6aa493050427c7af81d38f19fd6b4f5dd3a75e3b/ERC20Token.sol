...
contract ERC20Token is ERC20, Ownable {
    ...
    constructor (string memory _name, string memory _symbol, uint8 _decimals, uint256 _totalSupply, address mintAddress) ERC20 (_name, _symbol, _decimals) {
    ...
    */
    ...
    /**
    * Destroy tokens
    * Remove `burnedAmount` tokens from the system irreversibly
    * @param burnedAmount the amount of money to burn
    */
    function burnToken(uint256 burnedAmount) external {
        _burn(msg.sender,burnedAmount);
    }
    
    /**
     * @notice Function to rescue funds
     * Owner is assumed to be governance or ERC20 Token trusted party for helping users
