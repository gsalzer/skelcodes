...
contract MonetaryPolicyV1 is IMonetaryPolicy, BlockNumber, AccessControl {
  ...
  /**
   * @notice Provides the ETH-USD exchange rate e.g. 1.5e18 would mean 1 ETH = $1.5
   ...
   * @dev We start with dynamicPricing disabled.
   */
  ...
  function _updateTargetPrice(
    ...
    // Note that target price direction only depends on basketFactor.
