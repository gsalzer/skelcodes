...
contract Shiba_Ken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Shiba Ken Inu";
    ...
    uint256 internal _tokenTotal = 500000 *10**18;
    ...
    address public charityAddress = owner();
