...
contract ERC20 is IERC20 {
    ...
    */
    function _transfer(address from, address to, uint256 value) internal {
        ...
        require(to != address(this), "ERC20: transfer to this contract address");
...
contract Zodium is ERC20Detailed, ERC20Pausable {
    ...
    constructor() ERC20Detailed("Zodium", "ZODI", 18) public {
        _mint(msg.sender, 888888888 * (10 ** 18));
    }
    ...
    function setGateway(address _mainchainGateway) public onlyOwner returns (bool) {
