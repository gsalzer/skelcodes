    ...
    Freezable
{
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "AWNEX/transfer : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "AWNEX/transferFrom : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            spender != address(0),
            "AWNEX/approve : Should not approve zero address"
        );
