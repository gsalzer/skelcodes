/**
 * 
  _   __ _ __ ___  _  __ _   __  _    _   _  __
 ///7/ //// // _/ / |/ // \,' /,' \ ,' \ / |/ /
| V V // ` // _/ / || // \,' // o |/ o |/ || / 
|_n_,'/_n_//___//_/|_//_/ /_/ |_,' |_,'/_/|_/                                                  
                                                   
   Telegram: t.me/whenmoonerc20
   Twitter: @whenmoonerc20
   
 * TOKENOMICS:
 * 1,000,000,000,000 tokens
 * 3,000,000,000 max buy / 45-second buy cooldown (these limitations are lifted automatically two minutes post-launch)
...
contract WHENMOON is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"WHEN MOON?";
    string private constant _symbol = unicode"WHENMOON ";
