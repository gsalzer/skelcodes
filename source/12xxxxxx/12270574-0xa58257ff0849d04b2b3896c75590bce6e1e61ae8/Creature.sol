...
//--------------------------==
/**IERC721Full is IERC721, IERC721Enumerable, IERC721Metadata
 * @title ERC721 Non-Fungible Token Standard basic implementation
 * @dev see https://eips.ethereum.org/EIPS/eip-721
 */
contract ERC721 is Context, IERC721Full, ERC165 {
    ...
    function transferFrom(
        ...
        //console.log("[sc] ERC721: transferFrom()");
    ...
    function safeTransferFrom(
        ...
        //console.log("[sc] ERC721: safeTransferFrom()");
        safeTransferFrom(from, to, tokenId, "");
    }

    /**
     * @dev See {IERC721-safeTransferFrom}. virtual
     */
    function safeTransferFrom(
        address from,
        address to,
        ...
        //console.log("[sc] ERC721: safeTransferFrom(data)");
        require(
            _isApprovedOrOwner(_msgSender(), tokenId),
            "ERC721: transfer caller is not owner nor approved"
        );
    ...
    function _safeMint(
        ...
        require(
            _checkOnERC721Received(address(this), to, tokenId, _data),
            "ERC721: transfer to non ERC721Receiver implementer"
        );
        _mint(to, tokenId);
    }
    ...
    function _checkOnERC721Received(
        ...
        if (!to.isContract()) {
            //console.log("[sc] not a contract");
            return true;
        }
        //console.log("[sc] check ERC721Receiver");
...
contract ERC721Tradable is ERC721, Ownable {
    ...
    function mintTo(address _to) public onlyOwner {
        ...
        require(newTokenId <= maxTokenId, "maxTokenId has been reached");
    ...
    function checkOwner(address eoa1)
        public
        view
        returns (bool[] memory arrayOut)
    {
        //console.log("checkOwner");
        arrayOut = new bool[](_currentTokenId);
        //console.log("ck1", arrayOut[9], ", _currentTokenId:", _currentTokenId);
    ...
    function mintAll(address _to) external onlyOwner {
        //console.log("[sc] mintAll()");
