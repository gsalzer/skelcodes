...
pragma solidity ^0.6.12;
    ...
    contract PAINAL is Context, IERC20, Ownable {
        ...
        string private _name = 'PAINAL.Finance';
        string private _symbol = 'PAINAL';
        ...
        function _setTaxFee(uint256 taxFee) external onlyOwner() {
            require(taxFee >= 1 && taxFee <= 11, 'taxFee should be in 1 - 10');
            _taxFee = taxFee;
        }
