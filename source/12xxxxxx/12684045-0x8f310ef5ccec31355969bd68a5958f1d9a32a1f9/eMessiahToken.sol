// Ethereum Messiah ($eMessiah)

// Twitter: https://twitter.com/EthereumMessiah
// Telegram: https://t.me/emessiahtoken
...
contract eMessiahToken is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Ethereum Messiah";
    string private constant _symbol = "eMessiah";
    ...
    function _transfer(
        ...
        if (from != owner() && to != owner()) {
            ...
            if (!inSwap && from != uniswapV2Pair && swapEnabled) {
                require(block.timestamp >= _lastSellTime + 2 minutes, "ERR: Try 2 minutes later");
