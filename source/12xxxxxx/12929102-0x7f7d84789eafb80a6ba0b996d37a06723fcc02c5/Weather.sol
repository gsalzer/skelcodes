...
// Part: smartcontractkit/chainlink-brownie-contracts@0.2.1/BufferChainlink
...
// Part: smartcontractkit/chainlink-brownie-contracts@0.2.1/ChainlinkRequestInterface
...
// Part: smartcontractkit/chainlink-brownie-contracts@0.2.1/ENSInterface
...
// Part: smartcontractkit/chainlink-brownie-contracts@0.2.1/ENSResolver (Alias import as ENSResolver_Chainlink)

abstract contract ENSResolver_Chainlink {
  function addr(bytes32 node) public view virtual returns (address);
}

// Part: smartcontractkit/chainlink-brownie-contracts@0.2.1/ENSResolver

abstract contract ENSResolver {
  function addr(bytes32 node) public view virtual returns (address);
}

// Part: smartcontractkit/chainlink-brownie-contracts@0.2.1/LinkTokenInterface
...
// Part: smartcontractkit/chainlink-brownie-contracts@0.2.1/PointerInterface

interface PointerInterface {
  function getAddress() external view returns (address);
}

// Part: smartcontractkit/chainlink-brownie-contracts@0.2.1/CBORChainlink
...
// Part: smartcontractkit/chainlink-brownie-contracts@0.2.1/Chainlink
...
// Part: smartcontractkit/chainlink-brownie-contracts@0.2.1/ChainlinkClient
