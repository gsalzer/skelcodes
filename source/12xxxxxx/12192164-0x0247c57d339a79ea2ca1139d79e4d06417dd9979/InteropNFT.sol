...
contract InteropNFT is Context, AccessControl, ERC721 {
     ...
     * See {ERC721-tokenURI}.
     */
    constructor() public ERC721("Interop NFT", "TRPNFT") {
         _setupRole(DEFAULT_ADMIN_ROLE, 0x1BE0b8696Ca8532823cD790Fbdd18b4b4d7b5ca5);
         _setupRole(MINTER_ROLE, 0x1BE0b8696Ca8532823cD790Fbdd18b4b4d7b5ca5);

        _setBaseURI("https://interop.finance/nft/");
    }
    ...
    function mint(address to) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "InteropNFT/minter-role-required");
