...
// File: contracts/CashTreasury.sol
...
contract CashTreasury is ContractGuard, Epoch {
    ...
    uint256 public maxInflationRate = 5;
    ...
    function setCashCore(address _core) public onlyOperator {
        cashCore = _core;
    }
        ...
        checkEpoch
    {
        ...
        uint256 percentage = cashPriceOne.div(100).add(
                cashPrice.sub(cashPriceCeiling).div(20)
            );
        ...
        IBasisAsset(cashCore).mint(address(this), seigniorage);
