...
contract EthereumUltra is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100_000_000_000_000 * 10**12;
    ...
    uint256 private _numTokensSellToAddToLiquidity = 1000000000 * 10**12;
    ...
    function _setNumTokensSellToAddToLiquidity(uint256 numTokensSellToAddToLiquidity) external onlyOwner() {
        require(numTokensSellToAddToLiquidity >= 10**12 , 'numTokensSellToAddToLiquidity should be greater than total 1e12');
        _numTokensSellToAddToLiquidity = numTokensSellToAddToLiquidity;
    }

    function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= 10**12 , 'maxTxAmount should be greater than total 1e12');
