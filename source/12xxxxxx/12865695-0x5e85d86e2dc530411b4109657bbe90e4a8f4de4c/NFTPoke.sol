...
contract NFTPoke is Ownable, ERC721URIStorage, MerkleProof {
    ...
    event SetBaseUri(address indexed _owner, string initialBaseURI, string finalBaseURI);
    ...
    event MintedMultiple(address indexed _owner, uint256 price, uint256 tokenLength);
    ...
    /**
     * @dev Return the value of the current price to mint a NFT
     ...
     * @param tokenURI string to be verified
     * @return bool value
     */
     ...
     * @param tokenURI string for which to calculate the hash
    ...
    * We can flush those funds to the destination address.
     ...
     */
    function mintItems(string[] memory tokenURIs, bytes32[][]memory proofs) public payable returns (uint256[]memory) {
        require(tokenURIs.length == proofs.length, "The input number of token URIs length is not the same as the number of proofs");
