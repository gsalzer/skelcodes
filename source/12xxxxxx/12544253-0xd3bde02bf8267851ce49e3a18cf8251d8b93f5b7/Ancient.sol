...
contract Ancient is Ownable, ERC165, ERC721 {
    // Libraries
    ...
    constructor() ERC721("Chosen Ancient Bonsai", "ABNSI") {
        _setBaseURI("https://us-central1-zenft-65a6d.cloudfunctions.net/app/ancient/");
        ownerMint(6);
        folder = "";
    }
    ...
    // Admin methods
    function ownerMint(uint256 quantity) public onlyOwner notLocked {
