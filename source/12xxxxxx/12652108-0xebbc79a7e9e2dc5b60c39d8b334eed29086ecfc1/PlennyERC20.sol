...
// File: contracts/interfaces/IPlennyERC20.sol
...
// File: contracts/interfaces/IArbGateway.sol
...
interface IArbGateway {
    ...
    function registerTokenToL2(address l2CustomTokenAddress, uint256 maxGas, uint256 gasPriceBid, uint256 maxSubmissionCost) external returns (uint256);
}

// File: contracts/interfaces/IArbRouter.sol
...
// File: contracts/PlennyBasePausable.sol
...
// File: contracts/PlennyBaseERC20.sol
...
/**
 * @title PlennyBaseERC20
 * @dev Plenny ERC20 utility token
 */
abstract contract PlennyBaseERC20 is ERC20Upgradeable, ERC20CappedUpgradeable, PlennyBasePausable {
    ...
    // Mint token only to whitelisted addresses
    function _mintWhitelisted(address addr, uint256 amount) internal whenNotPaused {
...
// File: contracts/PlennyERC20.sol
