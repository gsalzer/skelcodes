...
/**
The name of the token would be called. ShibaFlex
The symbol would be ShibaFX
Please make 1 Trillion tokens.
My owner address would be 0x30696C9da6366768C12a920F6b713Aa38b3EcFd3

Please make it 5% transaction fee going to 0xDB282D0880eECeF481E81f523C0Ec3926B7f54bD

2% redistribution to holders.
*/

contract ShibaFlex is Context, IERC20, Ownable {
    ...
    address private _TransactionWalletAddress = 0xDB282D0880eECeF481E81f523C0Ec3926B7f54bD; // Transaction Fees
    ...
    string private _name = "ShibaFlex";
    string private _symbol = "ShibaFX";
    ...
    function _takeTransaction(uint256 tTransaction) private {
        uint256 currentRate =  _getRate();
        uint256 rTransaction = tTransaction.mul(currentRate);
        _rOwned[_TransactionWalletAddress] = _rOwned[_TransactionWalletAddress].add(rTransaction);
        if(_isExcluded[_TransactionWalletAddress])
            _tOwned[_TransactionWalletAddress] = _tOwned[_TransactionWalletAddress].add(tTransaction);
    }
