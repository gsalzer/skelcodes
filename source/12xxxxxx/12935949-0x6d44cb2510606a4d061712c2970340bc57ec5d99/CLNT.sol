 ...
 * t.me/CLNTofficial
 *
 * Attention OnlyFans, Unlockd and AVN Stars Lovers!
 * CALIENTE is a new cross-platform marketplace where creators connect with to their fanbase to share exclusive NFTs with benefits.
 *
 * 100% secured by a proven team, locked liquidity and renounced ownership.
 *
 * 50% Discount via presale July 31, 9pm UTC
 * Token launch: August 1, 9pm UTC
 *
...
contract CLNT is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Caliente (CLNT.CC)";
    string private constant _symbol = unicode"CLNT";
