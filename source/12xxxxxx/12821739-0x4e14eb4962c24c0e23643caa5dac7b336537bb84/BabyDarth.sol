...
contract BabyDarth is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 500000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tBurnTotal;

    string private _name = 'Baby Darth';
    string private _symbol = '$DARTH';
