...
contract Picklz is ERC721, Ownable, IMintedBeforeReveal {
    ...
    // Truth.
    string public constant R = "Some of our pickles are looking for love, others just want to watch the world burn. WE ARE THE OG PICKLZ";
    ...
    */
      function reserveGiveaway(uint256 numPicklz) public onlyOwner {
        uint currentSupply = totalSupply();
        require(totalSupply() + numPicklz <= 50, "For Aidrop to Previous Pickle Farmers");
        uint256 index;
