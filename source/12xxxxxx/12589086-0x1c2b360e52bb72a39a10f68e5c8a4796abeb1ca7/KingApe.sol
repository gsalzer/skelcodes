/*
    🐵🐵🐵🐵 Website: https://kingape.net/
    🐵🐵🐵🐵 Telegram: https://t.me/KingAPE_Announcement
    
    $KingAPE is coming to Uniswap through a fair launch!

    - Fair launch
    - Anti-whale and Anti-bot mechanisms!
    - Liquidity will be locked
    - Ownership will be renounced
    - Community will provide input into the direction of $KingAPE
...
contract KingApe is Context, IERC20, Ownable {
    ...
    string private _name = 'King Ape';
    string private _symbol = 'KingApe';
