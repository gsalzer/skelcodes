...
pragma solidity ^0.6.12;
    ...
    contract DeltaV is Context, IERC20, Ownable {
        ...
        string private _name = 'deltaV.finance';
        string private _symbol = 'DELTAV';
        uint8 private _decimals = 18;

        uint256 private _taxFee = 5;
        uint256 private _MarketingPoolFee = 5;
        ...
        function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
            require(maxTxAmount >= 1000000000 , 'maxTxAmount should be greater than 100000000000');
