...
contract CpuConstraintPoly {
    ...
    // ----------------------- end of input data - -------------------------
    // [0x49e0, 0x4a00) - composition_degree_bound.
    // [0x4a00, 0x4a20) - intermediate_value/cpu/decode/opcode_rc/bit_0.
    // [0x4a20, 0x4a40) - intermediate_value/cpu/decode/opcode_rc/bit_2.
    // [0x4a40, 0x4a60) - intermediate_value/cpu/decode/opcode_rc/bit_4.
    // [0x4a60, 0x4a80) - intermediate_value/cpu/decode/opcode_rc/bit_3.
    // [0x4a80, 0x4aa0) - intermediate_value/cpu/decode/flag_op1_base_op0_0.
    // [0x4aa0, 0x4ac0) - intermediate_value/cpu/decode/opcode_rc/bit_5.
    // [0x4ac0, 0x4ae0) - intermediate_value/cpu/decode/opcode_rc/bit_6.
    // [0x4ae0, 0x4b00) - intermediate_value/cpu/decode/opcode_rc/bit_9.
    // [0x4b00, 0x4b20) - intermediate_value/cpu/decode/flag_res_op1_0.
    // [0x4b20, 0x4b40) - intermediate_value/cpu/decode/opcode_rc/bit_7.
    // [0x4b40, 0x4b60) - intermediate_value/cpu/decode/opcode_rc/bit_8.
    // [0x4b60, 0x4b80) - intermediate_value/cpu/decode/flag_pc_update_regular_0.
    // [0x4b80, 0x4ba0) - intermediate_value/cpu/decode/opcode_rc/bit_12.
    // [0x4ba0, 0x4bc0) - intermediate_value/cpu/decode/opcode_rc/bit_13.
    // [0x4bc0, 0x4be0) - intermediate_value/cpu/decode/fp_update_regular_0.
    // [0x4be0, 0x4c00) - intermediate_value/cpu/decode/opcode_rc/bit_1.
    // [0x4c00, 0x4c20) - intermediate_value/npc_reg_0.
    // [0x4c20, 0x4c40) - intermediate_value/cpu/decode/opcode_rc/bit_10.
    // [0x4c40, 0x4c60) - intermediate_value/cpu/decode/opcode_rc/bit_11.
    // [0x4c60, 0x4c80) - intermediate_value/cpu/decode/opcode_rc/bit_14.
    // [0x4c80, 0x4ca0) - intermediate_value/memory/address_diff_0.
    // [0x4ca0, 0x4cc0) - intermediate_value/rc16/diff_0.
    // [0x4cc0, 0x4ce0) - intermediate_value/pedersen/hash0/ec_subset_sum/bit_0.
    // [0x4ce0, 0x4d00) - intermediate_value/pedersen/hash0/ec_subset_sum/bit_neg_0.
    // [0x4d00, 0x4d20) - intermediate_value/pedersen/hash1/ec_subset_sum/bit_0.
    // [0x4d20, 0x4d40) - intermediate_value/pedersen/hash1/ec_subset_sum/bit_neg_0.
    // [0x4d40, 0x4d60) - intermediate_value/pedersen/hash2/ec_subset_sum/bit_0.
    // [0x4d60, 0x4d80) - intermediate_value/pedersen/hash2/ec_subset_sum/bit_neg_0.
    // [0x4d80, 0x4da0) - intermediate_value/pedersen/hash3/ec_subset_sum/bit_0.
    // [0x4da0, 0x4dc0) - intermediate_value/pedersen/hash3/ec_subset_sum/bit_neg_0.
    // [0x4dc0, 0x4de0) - intermediate_value/rc_builtin/value0_0.
    // [0x4de0, 0x4e00) - intermediate_value/rc_builtin/value1_0.
    // [0x4e00, 0x4e20) - intermediate_value/rc_builtin/value2_0.
    // [0x4e20, 0x4e40) - intermediate_value/rc_builtin/value3_0.
    // [0x4e40, 0x4e60) - intermediate_value/rc_builtin/value4_0.
    // [0x4e60, 0x4e80) - intermediate_value/rc_builtin/value5_0.
    // [0x4e80, 0x4ea0) - intermediate_value/rc_builtin/value6_0.
    // [0x4ea0, 0x4ec0) - intermediate_value/rc_builtin/value7_0.
    // [0x4ec0, 0x4ee0) - intermediate_value/ecdsa/signature0/doubling_key/x_squared.
    // [0x4ee0, 0x4f00) - intermediate_value/ecdsa/signature0/exponentiate_generator/bit_0.
    // [0x4f00, 0x4f20) - intermediate_value/ecdsa/signature0/exponentiate_generator/bit_neg_0.
    // [0x4f20, 0x4f40) - intermediate_value/ecdsa/signature0/exponentiate_key/bit_0.
    // [0x4f40, 0x4f60) - intermediate_value/ecdsa/signature0/exponentiate_key/bit_neg_0.
    // [0x4f60, 0x51e0) - expmods.
    // [0x51e0, 0x5480) - denominator_invs.
    // [0x5480, 0x5720) - denominators.
    // [0x5720, 0x5860) - numerators.
    // [0x5860, 0x5b40) - adjustments.
    ...
    fallback() external {
        ...
        assembly {
            ...
            mstore(0x49e0, mul(2, /*trace_length*/ mload(0x80)))
...

            {
              ...
              mstore(0x4f60, expmod(point, /*trace_length*/ mload(0x80), PRIME))

              // expmods[1] = point^(trace_length / 16).
              mstore(0x4f80, expmod(point, div(/*trace_length*/ mload(0x80), 16), PRIME))

              // expmods[2] = point^(trace_length / 2).
              mstore(0x4fa0, expmod(point, div(/*trace_length*/ mload(0x80), 2), PRIME))

              // expmods[3] = point^(trace_length / 8).
              mstore(0x4fc0, expmod(point, div(/*trace_length*/ mload(0x80), 8), PRIME))

              // expmods[4] = point^(trace_length / 256).
              mstore(0x4fe0, expmod(point, div(/*trace_length*/ mload(0x80), 256), PRIME))

              // expmods[5] = point^(trace_length / 512).
              mstore(0x5000, expmod(point, div(/*trace_length*/ mload(0x80), 512), PRIME))

              // expmods[6] = point^(trace_length / 128).
              mstore(0x5020, expmod(point, div(/*trace_length*/ mload(0x80), 128), PRIME))

              // expmods[7] = point^(trace_length / 4096).
              mstore(0x5040, expmod(point, div(/*trace_length*/ mload(0x80), 4096), PRIME))

              // expmods[8] = point^(trace_length / 32).
              mstore(0x5060, expmod(point, div(/*trace_length*/ mload(0x80), 32), PRIME))

              // expmods[9] = point^(trace_length / 8192).
              mstore(0x5080, expmod(point, div(/*trace_length*/ mload(0x80), 8192), PRIME))

              // expmods[10] = trace_generator^(15 * trace_length / 16).
              mstore(0x50a0, expmod(/*trace_generator*/ mload(0x360), div(mul(15, /*trace_length*/ mload(0x80)), 16), PRIME))

              // expmods[11] = trace_generator^(16 * (trace_length / 16 - 1)).
              mstore(0x50c0, expmod(/*trace_generator*/ mload(0x360), mul(16, sub(div(/*trace_length*/ mload(0x80), 16), 1)), PRIME))

              // expmods[12] = trace_generator^(2 * (trace_length / 2 - 1)).
              mstore(0x50e0, expmod(/*trace_generator*/ mload(0x360), mul(2, sub(div(/*trace_length*/ mload(0x80), 2), 1)), PRIME))

              // expmods[13] = trace_generator^(trace_length - 1).
              mstore(0x5100, expmod(/*trace_generator*/ mload(0x360), sub(/*trace_length*/ mload(0x80), 1), PRIME))

              // expmods[14] = trace_generator^(255 * trace_length / 256).
              mstore(0x5120, expmod(/*trace_generator*/ mload(0x360), div(mul(255, /*trace_length*/ mload(0x80)), 256), PRIME))

              // expmods[15] = trace_generator^(63 * trace_length / 64).
              mstore(0x5140, expmod(/*trace_generator*/ mload(0x360), div(mul(63, /*trace_length*/ mload(0x80)), 64), PRIME))

              // expmods[16] = trace_generator^(trace_length / 2).
              mstore(0x5160, expmod(/*trace_generator*/ mload(0x360), div(/*trace_length*/ mload(0x80), 2), PRIME))

              // expmods[17] = trace_generator^(128 * (trace_length / 128 - 1)).
              mstore(0x5180, expmod(/*trace_generator*/ mload(0x360), mul(128, sub(div(/*trace_length*/ mload(0x80), 128), 1)), PRIME))

              // expmods[18] = trace_generator^(251 * trace_length / 256).
              mstore(0x51a0, expmod(/*trace_generator*/ mload(0x360), div(mul(251, /*trace_length*/ mload(0x80)), 256), PRIME))

              // expmods[19] = trace_generator^(8192 * (trace_length / 8192 - 1)).
              mstore(0x51c0, expmod(/*trace_generator*/ mload(0x360), mul(8192, sub(div(/*trace_length*/ mload(0x80), 8192), 1)), PRIME))
...

            {
              ...
              mstore(0x5480,
                     addmod(/*point^trace_length*/ mload(0x4f60), sub(PRIME, 1), PRIME))
              ...
              mstore(0x54a0,
                     addmod(
                       /*point^(trace_length / 16)*/ mload(0x4f80),
                       sub(PRIME, /*trace_generator^(15 * trace_length / 16)*/ mload(0x50a0)),
                       PRIME))
              ...
              mstore(0x54c0,
                     addmod(/*point^(trace_length / 16)*/ mload(0x4f80), sub(PRIME, 1), PRIME))
              ...
              mstore(0x5500,
                     addmod(
                       point,
                       sub(PRIME, /*trace_generator^(16 * (trace_length / 16 - 1))*/ mload(0x50c0)),
                       PRIME))
              ...
              mstore(0x5520,
                     addmod(/*point^(trace_length / 2)*/ mload(0x4fa0), sub(PRIME, 1), PRIME))
              ...
              mstore(0x55a0,
                     addmod(/*point^(trace_length / 256)*/ mload(0x4fe0), sub(PRIME, 1), PRIME))
              ...
              mstore(0x55c0,
                     addmod(
                       /*point^(trace_length / 256)*/ mload(0x4fe0),
                       sub(PRIME, /*trace_generator^(63 * trace_length / 64)*/ mload(0x5140)),
                       PRIME))
              ...
              mstore(0x55e0,
                     addmod(
                       /*point^(trace_length / 256)*/ mload(0x4fe0),
                       sub(PRIME, /*trace_generator^(255 * trace_length / 256)*/ mload(0x5120)),
                       PRIME))
              ...
              mstore(0x5600,
                     addmod(/*point^(trace_length / 512)*/ mload(0x5000), sub(PRIME, 1), PRIME))
              ...
              mstore(0x5620,
                     addmod(/*point^(trace_length / 128)*/ mload(0x5020), sub(PRIME, 1), PRIME))
              ...
              mstore(0x5640,
                     addmod(/*point^(trace_length / 32)*/ mload(0x5060), sub(PRIME, 1), PRIME))
              ...
              mstore(0x5660,
                     addmod(
                       /*point^(trace_length / 8192)*/ mload(0x5080),
                       sub(PRIME, /*trace_generator^(251 * trace_length / 256)*/ mload(0x51a0)),
                       PRIME))
              ...
              mstore(0x56a0,
                     addmod(
                       /*point^(trace_length / 4096)*/ mload(0x5040),
                       sub(PRIME, /*trace_generator^(251 * trace_length / 256)*/ mload(0x51a0)),
                       PRIME))
              ...
              mstore(0x56e0,
                     addmod(/*point^(trace_length / 8192)*/ mload(0x5080), sub(PRIME, 1), PRIME))
              ...
              mstore(0x5700,
                     addmod(/*point^(trace_length / 4096)*/ mload(0x5040), sub(PRIME, 1), PRIME))
...

            {
              ...
              for { let partialProductPtr := 0x51e0 }
              ...
              let firstPartialProductPtr := 0x51e0
...

            {
              ...
              mstore(0x57c0,
                     addmod(
                       /*point^(trace_length / 512)*/ mload(0x5000),
                       sub(PRIME, /*trace_generator^(trace_length / 2)*/ mload(0x5160)),
                       PRIME))
              ...
              mstore(0x57e0,
                     addmod(
                       point,
                       sub(PRIME, /*trace_generator^(128 * (trace_length / 128 - 1))*/ mload(0x5180)),
                       PRIME))
              ...
              mstore(0x5840,
                     addmod(
                       point,
                       sub(PRIME, /*trace_generator^(8192 * (trace_length / 8192 - 1))*/ mload(0x51c0)),
                       PRIME))
              ...
              mstore(0x5860,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), mul(2, sub(/*trace_length*/ mload(0x80), 1)), div(/*trace_length*/ mload(0x80), 16), /*trace_length*/ mload(0x80)), PRIME))
              ...
              mstore(0x5880,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 16)), PRIME))

              // Adjustment polynomial for constraints 'cpu/decode/flag_op1_base_op0_bit', 'cpu/decode/flag_res_op1_bit', 'cpu/decode/flag_pc_update_regular_bit', 'cpu/decode/fp_update_regular_bit', 'cpu/operands/mem_dst_addr', 'cpu/operands/mem0_addr', 'cpu/operands/mem1_addr', 'cpu/operands/ops_mul', 'cpu/operands/res', 'cpu/opcodes/call/push_fp', 'cpu/opcodes/call/push_pc', 'cpu/opcodes/call/off0', 'cpu/opcodes/call/off1', 'cpu/opcodes/call/flags', 'cpu/opcodes/ret/off0', 'cpu/opcodes/ret/off2', 'cpu/opcodes/ret/flags', 'cpu/opcodes/assert_eq/assert_eq'.
              // adjustments[2] = point^degreeAdjustment(composition_degree_bound, 2 * (trace_length - 1), 0, trace_length / 16).
              mstore(0x58a0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 0, div(/*trace_length*/ mload(0x80), 16)), PRIME))
              ...
              mstore(0x58c0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 1, div(/*trace_length*/ mload(0x80), 16)), PRIME))

              // Adjustment polynomial for constraints 'initial_ap', 'initial_fp', 'initial_pc', 'final_ap', 'final_fp', 'final_pc', 'memory/multi_column_perm/perm/last', 'memory/initial_addr', 'rc16/perm/last', 'rc16/minimum', 'rc16/maximum', 'pedersen/init_addr', 'rc_builtin/init_addr', 'ecdsa/init_addr'.
              // adjustments[4] = point^degreeAdjustment(composition_degree_bound, trace_length - 1, 0, 1).
              mstore(0x58e0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), sub(/*trace_length*/ mload(0x80), 1), 0, 1), PRIME))
              ...
              mstore(0x5900,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 0, 1), PRIME))
              ...
              mstore(0x5920,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 1, div(/*trace_length*/ mload(0x80), 2)), PRIME))
              ...
              mstore(0x5940,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 8)), PRIME))
              ...
              mstore(0x5960,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 1, /*trace_length*/ mload(0x80)), PRIME))
              ...
              mstore(0x5980,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 0, div(/*trace_length*/ mload(0x80), 256)), PRIME))
              ...
              mstore(0x59a0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), mul(2, sub(/*trace_length*/ mload(0x80), 1)), div(/*trace_length*/ mload(0x80), 256), /*trace_length*/ mload(0x80)), PRIME))

              // Adjustment polynomial for constraints 'pedersen/hash0/ec_subset_sum/bit_extraction_end', 'pedersen/hash0/ec_subset_sum/zeros_tail', 'pedersen/hash1/ec_subset_sum/bit_extraction_end', 'pedersen/hash1/ec_subset_sum/zeros_tail', 'pedersen/hash2/ec_subset_sum/bit_extraction_end', 'pedersen/hash2/ec_subset_sum/zeros_tail', 'pedersen/hash3/ec_subset_sum/bit_extraction_end', 'pedersen/hash3/ec_subset_sum/zeros_tail'.
              // adjustments[11] = point^degreeAdjustment(composition_degree_bound, trace_length - 1, 0, trace_length / 256).
              mstore(0x59c0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 256)), PRIME))
              ...
              mstore(0x59e0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), sub(/*trace_length*/ mload(0x80), 1), div(/*trace_length*/ mload(0x80), 512), div(/*trace_length*/ mload(0x80), 256)), PRIME))
              ...
              mstore(0x5a00,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 512)), PRIME))
              ...
              mstore(0x5a20,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), sub(/*trace_length*/ mload(0x80), 1), 1, div(/*trace_length*/ mload(0x80), 128)), PRIME))
              ...
              mstore(0x5a40,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 128)), PRIME))
              ...
              mstore(0x5a60,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), mul(2, sub(/*trace_length*/ mload(0x80), 1)), div(/*trace_length*/ mload(0x80), 4096), div(/*trace_length*/ mload(0x80), 16)), PRIME))
              ...
              mstore(0x5a80,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), mul(2, sub(/*trace_length*/ mload(0x80), 1)), div(/*trace_length*/ mload(0x80), 8192), div(/*trace_length*/ mload(0x80), 32)), PRIME))
              ...
              mstore(0x5aa0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 8192)), PRIME))
              ...
              mstore(0x5ac0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 4096)), PRIME))
              ...
              mstore(0x5ae0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 0, div(/*trace_length*/ mload(0x80), 8192)), PRIME))
              ...
              mstore(0x5b00,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 0, div(/*trace_length*/ mload(0x80), 4096)), PRIME))
              ...
              mstore(0x5b20,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x49e0), sub(/*trace_length*/ mload(0x80), 1), 1, div(/*trace_length*/ mload(0x80), 8192)), PRIME))
...

            {
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  addmod(
                    addmod(
                      /*intermediate_value/cpu/decode/opcode_rc/bit_2*/ mload(0x4a20),
                      /*intermediate_value/cpu/decode/opcode_rc/bit_4*/ mload(0x4a40),
                      PRIME),
                    /*intermediate_value/cpu/decode/opcode_rc/bit_3*/ mload(0x4a60),
                    PRIME)),
                PRIME)
              mstore(0x4a80, val)
              }
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  addmod(
                    addmod(
                      /*intermediate_value/cpu/decode/opcode_rc/bit_5*/ mload(0x4aa0),
                      /*intermediate_value/cpu/decode/opcode_rc/bit_6*/ mload(0x4ac0),
                      PRIME),
                    /*intermediate_value/cpu/decode/opcode_rc/bit_9*/ mload(0x4ae0),
                    PRIME)),
                PRIME)
              mstore(0x4b00, val)
              }
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  addmod(
                    addmod(
                      /*intermediate_value/cpu/decode/opcode_rc/bit_7*/ mload(0x4b20),
                      /*intermediate_value/cpu/decode/opcode_rc/bit_8*/ mload(0x4b40),
                      PRIME),
                    /*intermediate_value/cpu/decode/opcode_rc/bit_9*/ mload(0x4ae0),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  addmod(
                    /*intermediate_value/cpu/decode/opcode_rc/bit_12*/ mload(0x4b80),
                    /*intermediate_value/cpu/decode/opcode_rc/bit_13*/ mload(0x4ba0),
                    PRIME)),
                PRIME)
              mstore(0x4bc0, val)
              }
              ...
              let val := addmod(
                1,
                sub(PRIME, /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_0*/ mload(0x4cc0)),
                PRIME)
              mstore(0x4ce0, val)
              }
              ...
              let val := addmod(
                1,
                sub(PRIME, /*intermediate_value/pedersen/hash1/ec_subset_sum/bit_0*/ mload(0x4d00)),
                PRIME)
              mstore(0x4d20, val)
              }
              ...
              let val := addmod(
                1,
                sub(PRIME, /*intermediate_value/pedersen/hash2/ec_subset_sum/bit_0*/ mload(0x4d40)),
                PRIME)
              mstore(0x4d60, val)
              }
              ...
              let val := addmod(
                1,
                sub(PRIME, /*intermediate_value/pedersen/hash3/ec_subset_sum/bit_0*/ mload(0x4d80)),
                PRIME)
              mstore(0x4da0, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value0_0*/ mload(0x4dc0),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value1_0*/ mload(0x4de0),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value2_0*/ mload(0x4e00),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value3_0*/ mload(0x4e20),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value4_0*/ mload(0x4e40),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value5_0*/ mload(0x4e60),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value6_0*/ mload(0x4e80),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_0*/ mload(0x4ee0)),
                PRIME)
              mstore(0x4f00, val)
              }
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_0*/ mload(0x4f20)),
                PRIME)
              mstore(0x4f40, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/cpu/decode/opcode_rc/bit_0*/ mload(0x4a00),
                  /*intermediate_value/cpu/decode/opcode_rc/bit_0*/ mload(0x4a00),
                  PRIME),
                sub(PRIME, /*intermediate_value/cpu/decode/opcode_rc/bit_0*/ mload(0x4a00)),
                PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[0]*/ mload(0x400),
                                       mulmod(/*coefficients[1]*/ mload(0x420),
                                              /*adjustments[0]*/mload(0x5860),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[2]*/ mload(0x440),
                                       mulmod(/*coefficients[3]*/ mload(0x460),
                                              /*adjustments[1]*/mload(0x5880),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[4]*/ mload(0x480),
                                       mulmod(/*coefficients[5]*/ mload(0x4a0),
                                              /*adjustments[1]*/mload(0x5880),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/cpu/decode/flag_op1_base_op0_0*/ mload(0x4a80),
                  /*intermediate_value/cpu/decode/flag_op1_base_op0_0*/ mload(0x4a80),
                  PRIME),
                sub(PRIME, /*intermediate_value/cpu/decode/flag_op1_base_op0_0*/ mload(0x4a80)),
                PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[6]*/ mload(0x4c0),
                                       mulmod(/*coefficients[7]*/ mload(0x4e0),
                                              /*adjustments[2]*/mload(0x58a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/cpu/decode/flag_res_op1_0*/ mload(0x4b00),
                  /*intermediate_value/cpu/decode/flag_res_op1_0*/ mload(0x4b00),
                  PRIME),
                sub(PRIME, /*intermediate_value/cpu/decode/flag_res_op1_0*/ mload(0x4b00)),
                PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[8]*/ mload(0x500),
                                       mulmod(/*coefficients[9]*/ mload(0x520),
                                              /*adjustments[2]*/mload(0x58a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/cpu/decode/flag_pc_update_regular_0*/ mload(0x4b60),
                  /*intermediate_value/cpu/decode/flag_pc_update_regular_0*/ mload(0x4b60),
                  PRIME),
                sub(PRIME, /*intermediate_value/cpu/decode/flag_pc_update_regular_0*/ mload(0x4b60)),
                PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[10]*/ mload(0x540),
                                       mulmod(/*coefficients[11]*/ mload(0x560),
                                              /*adjustments[2]*/mload(0x58a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/cpu/decode/fp_update_regular_0*/ mload(0x4bc0),
                  /*intermediate_value/cpu/decode/fp_update_regular_0*/ mload(0x4bc0),
                  PRIME),
                sub(PRIME, /*intermediate_value/cpu/decode/fp_update_regular_0*/ mload(0x4bc0)),
                PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[12]*/ mload(0x580),
                                       mulmod(/*coefficients[13]*/ mload(0x5a0),
                                              /*adjustments[2]*/mload(0x58a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[14]*/ mload(0x5c0),
                                       mulmod(/*coefficients[15]*/ mload(0x5e0),
                                              /*adjustments[2]*/mload(0x58a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  addmod(
                    addmod(
                      mulmod(
                        /*intermediate_value/cpu/decode/opcode_rc/bit_1*/ mload(0x4be0),
                        /*column21_row8*/ mload(0x4460),
                        PRIME),
                      mulmod(
                        addmod(
                          1,
                          sub(PRIME, /*intermediate_value/cpu/decode/opcode_rc/bit_1*/ mload(0x4be0)),
                          PRIME),
                        /*column21_row0*/ mload(0x4360),
                        PRIME),
                      PRIME),
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[16]*/ mload(0x600),
                                       mulmod(/*coefficients[17]*/ mload(0x620),
                                              /*adjustments[2]*/mload(0x58a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[18]*/ mload(0x640),
                                       mulmod(/*coefficients[19]*/ mload(0x660),
                                              /*adjustments[2]*/mload(0x58a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[20] + coefficients[21] * adjustments[2]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[20]*/ mload(0x680),
                                       mulmod(/*coefficients[21]*/ mload(0x6a0),
                                              /*adjustments[2]*/mload(0x58a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := addmod(
                mulmod(
                  addmod(
                    1,
                    sub(PRIME, /*intermediate_value/cpu/decode/opcode_rc/bit_9*/ mload(0x4ae0)),
                    PRIME),
              ...
              // res += val * (coefficients[22] + coefficients[23] * adjustments[2]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[22]*/ mload(0x6c0),
                                       mulmod(/*coefficients[23]*/ mload(0x6e0),
                                              /*adjustments[2]*/mload(0x58a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[24]*/ mload(0x700),
                                       mulmod(/*coefficients[25]*/ mload(0x720),
                                              /*adjustments[3]*/mload(0x58c0),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[26]*/ mload(0x740),
                                       mulmod(/*coefficients[27]*/ mload(0x760),
                                              /*adjustments[3]*/mload(0x58c0),
                      PRIME)),
                      PRIME),
                      PRIME)
                ...
                sub(
                  ...
                  addmod(
                    addmod(
                      mulmod(
                        /*intermediate_value/cpu/decode/flag_pc_update_regular_0*/ mload(0x4b60),
                        /*intermediate_value/npc_reg_0*/ mload(0x4c00),
                        PRIME),
                      mulmod(
                        /*intermediate_value/cpu/decode/opcode_rc/bit_7*/ mload(0x4b20),
                        /*column21_row12*/ mload(0x44e0),
              ...
              // res += val * (coefficients[28] + coefficients[29] * adjustments[3]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[28]*/ mload(0x780),
                                       mulmod(/*coefficients[29]*/ mload(0x7a0),
                                              /*adjustments[3]*/mload(0x58c0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := mulmod(
                ...
                addmod(
                  /*column19_row16*/ mload(0x4000),
                  sub(PRIME, /*intermediate_value/npc_reg_0*/ mload(0x4c00)),
                  PRIME),
                PRIME)
              ...
              // res += val * (coefficients[30] + coefficients[31] * adjustments[3]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[30]*/ mload(0x7c0),
                                       mulmod(/*coefficients[31]*/ mload(0x7e0),
                                              /*adjustments[3]*/mload(0x58c0),
                      PRIME)),
                      PRIME),
                      PRIME)
                  ...
                  addmod(
                    addmod(
                      addmod(
                        /*column21_row0*/ mload(0x4360),
                        mulmod(
                          /*intermediate_value/cpu/decode/opcode_rc/bit_10*/ mload(0x4c20),
                          /*column21_row12*/ mload(0x44e0),
                          PRIME),
                        PRIME),
                      /*intermediate_value/cpu/decode/opcode_rc/bit_11*/ mload(0x4c40),
                      PRIME),
                    mulmod(/*intermediate_value/cpu/decode/opcode_rc/bit_12*/ mload(0x4b80), 2, PRIME),
                    PRIME)),
                PRIME)
              ...
              // res += val * (coefficients[32] + coefficients[33] * adjustments[3]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[32]*/ mload(0x800),
                                       mulmod(/*coefficients[33]*/ mload(0x820),
                                              /*adjustments[3]*/mload(0x58c0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[34] + coefficients[35] * adjustments[3]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[34]*/ mload(0x840),
                                       mulmod(/*coefficients[35]*/ mload(0x860),
                                              /*adjustments[3]*/mload(0x58c0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[36] + coefficients[37] * adjustments[2]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[36]*/ mload(0x880),
                                       mulmod(/*coefficients[37]*/ mload(0x8a0),
                                              /*adjustments[2]*/mload(0x58a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[38] + coefficients[39] * adjustments[2]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[38]*/ mload(0x8c0),
                                       mulmod(/*coefficients[39]*/ mload(0x8e0),
                                              /*adjustments[2]*/mload(0x58a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[40]*/ mload(0x900),
                                       mulmod(/*coefficients[41]*/ mload(0x920),
                                              /*adjustments[2]*/mload(0x58a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[42]*/ mload(0x940),
                                       mulmod(/*coefficients[43]*/ mload(0x960),
                                              /*adjustments[2]*/mload(0x58a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[44]*/ mload(0x980),
                                       mulmod(/*coefficients[45]*/ mload(0x9a0),
                                              /*adjustments[2]*/mload(0x58a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[46]*/ mload(0x9c0),
                                       mulmod(/*coefficients[47]*/ mload(0x9e0),
                                              /*adjustments[2]*/mload(0x58a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[48] + coefficients[49] * adjustments[2]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[48]*/ mload(0xa00),
                                       mulmod(/*coefficients[49]*/ mload(0xa20),
                                              /*adjustments[2]*/mload(0x58a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[50] + coefficients[51] * adjustments[2]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[50]*/ mload(0xa40),
                                       mulmod(/*coefficients[51]*/ mload(0xa60),
                                              /*adjustments[2]*/mload(0x58a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_rc/bit_14*/ mload(0x4c60),
                addmod(
                  /*column19_row9*/ mload(0x3fa0),
              ...
              // res += val * (coefficients[52] + coefficients[53] * adjustments[2]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[52]*/ mload(0xa80),
                                       mulmod(/*coefficients[53]*/ mload(0xaa0),
                                              /*adjustments[2]*/mload(0x58a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[54]*/ mload(0xac0),
                                       mulmod(/*coefficients[55]*/ mload(0xae0),
                                              /*adjustments[4]*/mload(0x58e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              // res += val * (coefficients[56] + coefficients[57] * adjustments[4]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[56]*/ mload(0xb00),
                                       mulmod(/*coefficients[57]*/ mload(0xb20),
                                              /*adjustments[4]*/mload(0x58e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[58] + coefficients[59] * adjustments[4]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[58]*/ mload(0xb40),
                                       mulmod(/*coefficients[59]*/ mload(0xb60),
                                              /*adjustments[4]*/mload(0x58e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[60] + coefficients[61] * adjustments[4]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[60]*/ mload(0xb80),
                                       mulmod(/*coefficients[61]*/ mload(0xba0),
                                              /*adjustments[4]*/mload(0x58e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[62]*/ mload(0xbc0),
                                       mulmod(/*coefficients[63]*/ mload(0xbe0),
                                              /*adjustments[4]*/mload(0x58e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[64]*/ mload(0xc00),
                                       mulmod(/*coefficients[65]*/ mload(0xc20),
                                              /*adjustments[4]*/mload(0x58e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[66] + coefficients[67] * adjustments[5]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[66]*/ mload(0xc40),
                                       mulmod(/*coefficients[67]*/ mload(0xc60),
                                              /*adjustments[5]*/mload(0x5900),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              // res += val * (coefficients[68] + coefficients[69] * adjustments[6]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[68]*/ mload(0xc80),
                                       mulmod(/*coefficients[69]*/ mload(0xca0),
                                              /*adjustments[6]*/mload(0x5920),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[70]*/ mload(0xcc0),
                                       mulmod(/*coefficients[71]*/ mload(0xce0),
                                              /*adjustments[4]*/mload(0x58e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/memory/address_diff_0*/ mload(0x4c80),
                  /*intermediate_value/memory/address_diff_0*/ mload(0x4c80),
                  PRIME),
                sub(PRIME, /*intermediate_value/memory/address_diff_0*/ mload(0x4c80)),
                PRIME)
              ...
              // res += val * (coefficients[72] + coefficients[73] * adjustments[6]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[72]*/ mload(0xd00),
                                       mulmod(/*coefficients[73]*/ mload(0xd20),
                                              /*adjustments[6]*/mload(0x5920),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := mulmod(
                addmod(/*intermediate_value/memory/address_diff_0*/ mload(0x4c80), sub(PRIME, 1), PRIME),
              ...
              // res += val * (coefficients[74] + coefficients[75] * adjustments[6]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[74]*/ mload(0xd40),
                                       mulmod(/*coefficients[75]*/ mload(0xd60),
                                              /*adjustments[6]*/mload(0x5920),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[76] + coefficients[77] * adjustments[4]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[76]*/ mload(0xd80),
                                       mulmod(/*coefficients[77]*/ mload(0xda0),
                                              /*adjustments[4]*/mload(0x58e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[78] + coefficients[79] * adjustments[7]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[78]*/ mload(0xdc0),
                                       mulmod(/*coefficients[79]*/ mload(0xde0),
                                              /*adjustments[7]*/mload(0x5940),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              // res += val * (coefficients[80] + coefficients[81] * adjustments[7]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[80]*/ mload(0xe00),
                                       mulmod(/*coefficients[81]*/ mload(0xe20),
                                              /*adjustments[7]*/mload(0x5940),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[82] + coefficients[83] * adjustments[5]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[82]*/ mload(0xe40),
                                       mulmod(/*coefficients[83]*/ mload(0xe60),
                                              /*adjustments[5]*/mload(0x5900),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[84] + coefficients[85] * adjustments[8]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[84]*/ mload(0xe80),
                                       mulmod(/*coefficients[85]*/ mload(0xea0),
                                              /*adjustments[8]*/mload(0x5960),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              // res += val * (coefficients[86] + coefficients[87] * adjustments[4]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[86]*/ mload(0xec0),
                                       mulmod(/*coefficients[87]*/ mload(0xee0),
                                              /*adjustments[4]*/mload(0x58e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc16/diff_0*/ mload(0x4ca0),
                  /*intermediate_value/rc16/diff_0*/ mload(0x4ca0),
                  PRIME),
                sub(PRIME, /*intermediate_value/rc16/diff_0*/ mload(0x4ca0)),
                PRIME)
              ...
              // res += val * (coefficients[88] + coefficients[89] * adjustments[8]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[88]*/ mload(0xf00),
                                       mulmod(/*coefficients[89]*/ mload(0xf20),
                                              /*adjustments[8]*/mload(0x5960),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[90] + coefficients[91] * adjustments[4]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[90]*/ mload(0xf40),
                                       mulmod(/*coefficients[91]*/ mload(0xf60),
                                              /*adjustments[4]*/mload(0x58e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[92] + coefficients[93] * adjustments[4]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[92]*/ mload(0xf80),
                                       mulmod(/*coefficients[93]*/ mload(0xfa0),
                                              /*adjustments[4]*/mload(0x58e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[94]*/ mload(0xfc0),
                                       mulmod(/*coefficients[95]*/ mload(0xfe0),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              // res += val * (coefficients[96] + coefficients[97] * adjustments[9]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[96]*/ mload(0x1000),
                                       mulmod(/*coefficients[97]*/ mload(0x1020),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[98] + coefficients[99] * adjustments[9]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[98]*/ mload(0x1040),
                                       mulmod(/*coefficients[99]*/ mload(0x1060),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[100]*/ mload(0x1080),
                                       mulmod(/*coefficients[101]*/ mload(0x10a0),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[102]*/ mload(0x10c0),
                                       mulmod(/*coefficients[103]*/ mload(0x10e0),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[104]*/ mload(0x1100),
                                       mulmod(/*coefficients[105]*/ mload(0x1120),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_0*/ mload(0x4cc0),
                addmod(
                  /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_0*/ mload(0x4cc0),
                  sub(PRIME, 1),
                  PRIME),
              ...
              // res += val * (coefficients[106] + coefficients[107] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[106]*/ mload(0x1140),
                                       mulmod(/*coefficients[107]*/ mload(0x1160),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              // res += val * (coefficients[108] + coefficients[109] * adjustments[11]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[108]*/ mload(0x1180),
                                       mulmod(/*coefficients[109]*/ mload(0x11a0),
                                              /*adjustments[11]*/mload(0x59c0),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[110]*/ mload(0x11c0),
                                       mulmod(/*coefficients[111]*/ mload(0x11e0),
                                              /*adjustments[11]*/mload(0x59c0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[112] + coefficients[113] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[112]*/ mload(0x1200),
                                       mulmod(/*coefficients[113]*/ mload(0x1220),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[114] + coefficients[115] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[114]*/ mload(0x1240),
                                       mulmod(/*coefficients[115]*/ mload(0x1260),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[116] + coefficients[117] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[116]*/ mload(0x1280),
                                       mulmod(/*coefficients[117]*/ mload(0x12a0),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_neg_0*/ mload(0x4ce0),
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[118]*/ mload(0x12c0),
                                       mulmod(/*coefficients[119]*/ mload(0x12e0),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[120]*/ mload(0x1300),
                                       mulmod(/*coefficients[121]*/ mload(0x1320),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[122] + coefficients[123] * adjustments[12]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[122]*/ mload(0x1340),
                                       mulmod(/*coefficients[123]*/ mload(0x1360),
                                              /*adjustments[12]*/mload(0x59e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              // res += val * (coefficients[124] + coefficients[125] * adjustments[12]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[124]*/ mload(0x1380),
                                       mulmod(/*coefficients[125]*/ mload(0x13a0),
                                              /*adjustments[12]*/mload(0x59e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[126] + coefficients[127] * adjustments[13]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[126]*/ mload(0x13c0),
                                       mulmod(/*coefficients[127]*/ mload(0x13e0),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              // res += val * (coefficients[128] + coefficients[129] * adjustments[13]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[128]*/ mload(0x1400),
                                       mulmod(/*coefficients[129]*/ mload(0x1420),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[130]*/ mload(0x1440),
                                       mulmod(/*coefficients[131]*/ mload(0x1460),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[132]*/ mload(0x1480),
                                       mulmod(/*coefficients[133]*/ mload(0x14a0),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[134] + coefficients[135] * adjustments[9]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[134]*/ mload(0x14c0),
                                       mulmod(/*coefficients[135]*/ mload(0x14e0),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[136] + coefficients[137] * adjustments[9]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[136]*/ mload(0x1500),
                                       mulmod(/*coefficients[137]*/ mload(0x1520),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[138] + coefficients[139] * adjustments[9]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[138]*/ mload(0x1540),
                                       mulmod(/*coefficients[139]*/ mload(0x1560),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[140] + coefficients[141] * adjustments[9]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[140]*/ mload(0x1580),
                                       mulmod(/*coefficients[141]*/ mload(0x15a0),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash1/ec_subset_sum/bit_0*/ mload(0x4d00),
                addmod(
                  /*intermediate_value/pedersen/hash1/ec_subset_sum/bit_0*/ mload(0x4d00),
                  sub(PRIME, 1),
                  PRIME),
              ...
              // res += val * (coefficients[142] + coefficients[143] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[142]*/ mload(0x15c0),
                                       mulmod(/*coefficients[143]*/ mload(0x15e0),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[144] + coefficients[145] * adjustments[11]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[144]*/ mload(0x1600),
                                       mulmod(/*coefficients[145]*/ mload(0x1620),
                                              /*adjustments[11]*/mload(0x59c0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[146] + coefficients[147] * adjustments[11]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[146]*/ mload(0x1640),
                                       mulmod(/*coefficients[147]*/ mload(0x1660),
                                              /*adjustments[11]*/mload(0x59c0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[148] + coefficients[149] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[148]*/ mload(0x1680),
                                       mulmod(/*coefficients[149]*/ mload(0x16a0),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[150] + coefficients[151] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[150]*/ mload(0x16c0),
                                       mulmod(/*coefficients[151]*/ mload(0x16e0),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[152] + coefficients[153] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[152]*/ mload(0x1700),
                                       mulmod(/*coefficients[153]*/ mload(0x1720),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash1/ec_subset_sum/bit_neg_0*/ mload(0x4d20),
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[154]*/ mload(0x1740),
                                       mulmod(/*coefficients[155]*/ mload(0x1760),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[156]*/ mload(0x1780),
                                       mulmod(/*coefficients[157]*/ mload(0x17a0),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[158] + coefficients[159] * adjustments[12]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[158]*/ mload(0x17c0),
                                       mulmod(/*coefficients[159]*/ mload(0x17e0),
                                              /*adjustments[12]*/mload(0x59e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[160] + coefficients[161] * adjustments[12]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[160]*/ mload(0x1800),
                                       mulmod(/*coefficients[161]*/ mload(0x1820),
                                              /*adjustments[12]*/mload(0x59e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[162] + coefficients[163] * adjustments[13]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[162]*/ mload(0x1840),
                                       mulmod(/*coefficients[163]*/ mload(0x1860),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[164] + coefficients[165] * adjustments[13]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[164]*/ mload(0x1880),
                                       mulmod(/*coefficients[165]*/ mload(0x18a0),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[166] + coefficients[167] * adjustments[9]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[166]*/ mload(0x18c0),
                                       mulmod(/*coefficients[167]*/ mload(0x18e0),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[168] + coefficients[169] * adjustments[9]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[168]*/ mload(0x1900),
                                       mulmod(/*coefficients[169]*/ mload(0x1920),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[170] + coefficients[171] * adjustments[9]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[170]*/ mload(0x1940),
                                       mulmod(/*coefficients[171]*/ mload(0x1960),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[172] + coefficients[173] * adjustments[9]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[172]*/ mload(0x1980),
                                       mulmod(/*coefficients[173]*/ mload(0x19a0),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[174] + coefficients[175] * adjustments[9]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[174]*/ mload(0x19c0),
                                       mulmod(/*coefficients[175]*/ mload(0x19e0),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[176] + coefficients[177] * adjustments[9]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[176]*/ mload(0x1a00),
                                       mulmod(/*coefficients[177]*/ mload(0x1a20),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash2/ec_subset_sum/bit_0*/ mload(0x4d40),
                addmod(
                  /*intermediate_value/pedersen/hash2/ec_subset_sum/bit_0*/ mload(0x4d40),
                  sub(PRIME, 1),
                  PRIME),
              ...
              // res += val * (coefficients[178] + coefficients[179] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[178]*/ mload(0x1a40),
                                       mulmod(/*coefficients[179]*/ mload(0x1a60),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[180] + coefficients[181] * adjustments[11]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[180]*/ mload(0x1a80),
                                       mulmod(/*coefficients[181]*/ mload(0x1aa0),
                                              /*adjustments[11]*/mload(0x59c0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[182] + coefficients[183] * adjustments[11]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[182]*/ mload(0x1ac0),
                                       mulmod(/*coefficients[183]*/ mload(0x1ae0),
                                              /*adjustments[11]*/mload(0x59c0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[184] + coefficients[185] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[184]*/ mload(0x1b00),
                                       mulmod(/*coefficients[185]*/ mload(0x1b20),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[186] + coefficients[187] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[186]*/ mload(0x1b40),
                                       mulmod(/*coefficients[187]*/ mload(0x1b60),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[188] + coefficients[189] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[188]*/ mload(0x1b80),
                                       mulmod(/*coefficients[189]*/ mload(0x1ba0),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash2/ec_subset_sum/bit_neg_0*/ mload(0x4d60),
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[190]*/ mload(0x1bc0),
                                       mulmod(/*coefficients[191]*/ mload(0x1be0),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[192]*/ mload(0x1c00),
                                       mulmod(/*coefficients[193]*/ mload(0x1c20),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[194]*/ mload(0x1c40),
                                       mulmod(/*coefficients[195]*/ mload(0x1c60),
                                              /*adjustments[12]*/mload(0x59e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[196] + coefficients[197] * adjustments[12]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[196]*/ mload(0x1c80),
                                       mulmod(/*coefficients[197]*/ mload(0x1ca0),
                                              /*adjustments[12]*/mload(0x59e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[198] + coefficients[199] * adjustments[13]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[198]*/ mload(0x1cc0),
                                       mulmod(/*coefficients[199]*/ mload(0x1ce0),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[200]*/ mload(0x1d00),
                                       mulmod(/*coefficients[201]*/ mload(0x1d20),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[202] + coefficients[203] * adjustments[9]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[202]*/ mload(0x1d40),
                                       mulmod(/*coefficients[203]*/ mload(0x1d60),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[204] + coefficients[205] * adjustments[9]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[204]*/ mload(0x1d80),
                                       mulmod(/*coefficients[205]*/ mload(0x1da0),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[206] + coefficients[207] * adjustments[9]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[206]*/ mload(0x1dc0),
                                       mulmod(/*coefficients[207]*/ mload(0x1de0),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[208] + coefficients[209] * adjustments[9]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[208]*/ mload(0x1e00),
                                       mulmod(/*coefficients[209]*/ mload(0x1e20),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[210] + coefficients[211] * adjustments[9]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[210]*/ mload(0x1e40),
                                       mulmod(/*coefficients[211]*/ mload(0x1e60),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[212] + coefficients[213] * adjustments[9]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[212]*/ mload(0x1e80),
                                       mulmod(/*coefficients[213]*/ mload(0x1ea0),
                                              /*adjustments[9]*/mload(0x5980),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash3/ec_subset_sum/bit_0*/ mload(0x4d80),
                addmod(
                  /*intermediate_value/pedersen/hash3/ec_subset_sum/bit_0*/ mload(0x4d80),
                  sub(PRIME, 1),
                  PRIME),
              ...
              // res += val * (coefficients[214] + coefficients[215] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[214]*/ mload(0x1ec0),
                                       mulmod(/*coefficients[215]*/ mload(0x1ee0),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[216] + coefficients[217] * adjustments[11]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[216]*/ mload(0x1f00),
                                       mulmod(/*coefficients[217]*/ mload(0x1f20),
                                              /*adjustments[11]*/mload(0x59c0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[218] + coefficients[219] * adjustments[11]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[218]*/ mload(0x1f40),
                                       mulmod(/*coefficients[219]*/ mload(0x1f60),
                                              /*adjustments[11]*/mload(0x59c0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[220] + coefficients[221] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[220]*/ mload(0x1f80),
                                       mulmod(/*coefficients[221]*/ mload(0x1fa0),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[222] + coefficients[223] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[222]*/ mload(0x1fc0),
                                       mulmod(/*coefficients[223]*/ mload(0x1fe0),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[224] + coefficients[225] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[224]*/ mload(0x2000),
                                       mulmod(/*coefficients[225]*/ mload(0x2020),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash3/ec_subset_sum/bit_neg_0*/ mload(0x4da0),
              ...
              // res += val * (coefficients[226] + coefficients[227] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[226]*/ mload(0x2040),
                                       mulmod(/*coefficients[227]*/ mload(0x2060),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[228] + coefficients[229] * adjustments[10]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[228]*/ mload(0x2080),
                                       mulmod(/*coefficients[229]*/ mload(0x20a0),
                                              /*adjustments[10]*/mload(0x59a0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[230]*/ mload(0x20c0),
                                       mulmod(/*coefficients[231]*/ mload(0x20e0),
                                              /*adjustments[12]*/mload(0x59e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[232]*/ mload(0x2100),
                                       mulmod(/*coefficients[233]*/ mload(0x2120),
                                              /*adjustments[12]*/mload(0x59e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[234]*/ mload(0x2140),
                                       mulmod(/*coefficients[235]*/ mload(0x2160),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[236]*/ mload(0x2180),
                                       mulmod(/*coefficients[237]*/ mload(0x21a0),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[238]*/ mload(0x21c0),
                                       mulmod(/*coefficients[239]*/ mload(0x21e0),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[240]*/ mload(0x2200),
                                       mulmod(/*coefficients[241]*/ mload(0x2220),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[242]*/ mload(0x2240),
                                       mulmod(/*coefficients[243]*/ mload(0x2260),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[244]*/ mload(0x2280),
                                       mulmod(/*coefficients[245]*/ mload(0x22a0),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[246] + coefficients[247] * adjustments[14]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[246]*/ mload(0x22c0),
                                       mulmod(/*coefficients[247]*/ mload(0x22e0),
                                              /*adjustments[14]*/mload(0x5a20),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              // res += val * (coefficients[248] + coefficients[249] * adjustments[4]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[248]*/ mload(0x2300),
                                       mulmod(/*coefficients[249]*/ mload(0x2320),
                                              /*adjustments[4]*/mload(0x58e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[250] + coefficients[251] * adjustments[13]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[250]*/ mload(0x2340),
                                       mulmod(/*coefficients[251]*/ mload(0x2360),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[252] + coefficients[253] * adjustments[13]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[252]*/ mload(0x2380),
                                       mulmod(/*coefficients[253]*/ mload(0x23a0),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[254] + coefficients[255] * adjustments[13]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[254]*/ mload(0x23c0),
                                       mulmod(/*coefficients[255]*/ mload(0x23e0),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[256] + coefficients[257] * adjustments[13]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[256]*/ mload(0x2400),
                                       mulmod(/*coefficients[257]*/ mload(0x2420),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[258] + coefficients[259] * adjustments[15]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[258]*/ mload(0x2440),
                                       mulmod(/*coefficients[259]*/ mload(0x2460),
                                              /*adjustments[15]*/mload(0x5a40),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              // res += val * (coefficients[260] + coefficients[261] * adjustments[13]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[260]*/ mload(0x2480),
                                       mulmod(/*coefficients[261]*/ mload(0x24a0),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[262] + coefficients[263] * adjustments[13]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[262]*/ mload(0x24c0),
                                       mulmod(/*coefficients[263]*/ mload(0x24e0),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[264] + coefficients[265] * adjustments[13]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[264]*/ mload(0x2500),
                                       mulmod(/*coefficients[265]*/ mload(0x2520),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[266] + coefficients[267] * adjustments[13]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[266]*/ mload(0x2540),
                                       mulmod(/*coefficients[267]*/ mload(0x2560),
                                              /*adjustments[13]*/mload(0x5a00),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[268]*/ mload(0x2580),
                                       mulmod(/*coefficients[269]*/ mload(0x25a0),
                                              /*adjustments[15]*/mload(0x5a40),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := addmod(
                /*intermediate_value/rc_builtin/value7_0*/ mload(0x4ea0),
              ...
              // res += val * (coefficients[270] + coefficients[271] * adjustments[15]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[270]*/ mload(0x25c0),
                                       mulmod(/*coefficients[271]*/ mload(0x25e0),
                                              /*adjustments[15]*/mload(0x5a40),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[272] + coefficients[273] * adjustments[14]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[272]*/ mload(0x2600),
                                       mulmod(/*coefficients[273]*/ mload(0x2620),
                                              /*adjustments[14]*/mload(0x5a20),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[274] + coefficients[275] * adjustments[4]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[274]*/ mload(0x2640),
                                       mulmod(/*coefficients[275]*/ mload(0x2660),
                                              /*adjustments[4]*/mload(0x58e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := addmod(
                addmod(
                  addmod(
                    addmod(
                      /*intermediate_value/ecdsa/signature0/doubling_key/x_squared*/ mload(0x4ec0),
                      /*intermediate_value/ecdsa/signature0/doubling_key/x_squared*/ mload(0x4ec0),
                      PRIME),
                    /*intermediate_value/ecdsa/signature0/doubling_key/x_squared*/ mload(0x4ec0),
                    PRIME),
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[276]*/ mload(0x2680),
                                       mulmod(/*coefficients[277]*/ mload(0x26a0),
                                              /*adjustments[16]*/mload(0x5a60),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[278]*/ mload(0x26c0),
                                       mulmod(/*coefficients[279]*/ mload(0x26e0),
                                              /*adjustments[16]*/mload(0x5a60),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[280] + coefficients[281] * adjustments[16]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[280]*/ mload(0x2700),
                                       mulmod(/*coefficients[281]*/ mload(0x2720),
                                              /*adjustments[16]*/mload(0x5a60),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[282]*/ mload(0x2740),
                                       mulmod(/*coefficients[283]*/ mload(0x2760),
                                              /*adjustments[17]*/mload(0x5a80),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              // res += val * (coefficients[284] + coefficients[285] * adjustments[18]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[284]*/ mload(0x2780),
                                       mulmod(/*coefficients[285]*/ mload(0x27a0),
                                              /*adjustments[18]*/mload(0x5aa0),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              // res += val * (coefficients[286] + coefficients[287] * adjustments[18]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[286]*/ mload(0x27c0),
                                       mulmod(/*coefficients[287]*/ mload(0x27e0),
                                              /*adjustments[18]*/mload(0x5aa0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[288]*/ mload(0x2800),
                                       mulmod(/*coefficients[289]*/ mload(0x2820),
                                              /*adjustments[17]*/mload(0x5a80),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[290] + coefficients[291] * adjustments[17]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[290]*/ mload(0x2840),
                                       mulmod(/*coefficients[291]*/ mload(0x2860),
                                              /*adjustments[17]*/mload(0x5a80),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[292]*/ mload(0x2880),
                                       mulmod(/*coefficients[293]*/ mload(0x28a0),
                                              /*adjustments[17]*/mload(0x5a80),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[294]*/ mload(0x28c0),
                                       mulmod(/*coefficients[295]*/ mload(0x28e0),
                                              /*adjustments[17]*/mload(0x5a80),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_neg_0*/ mload(0x4f00),
                addmod(
                  /*column21_row39*/ mload(0x4680),
              ...
              // res += val * (coefficients[296] + coefficients[297] * adjustments[17]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[296]*/ mload(0x2900),
                                       mulmod(/*coefficients[297]*/ mload(0x2920),
                                              /*adjustments[17]*/mload(0x5a80),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[298] + coefficients[299] * adjustments[17]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[298]*/ mload(0x2940),
                                       mulmod(/*coefficients[299]*/ mload(0x2960),
                                              /*adjustments[17]*/mload(0x5a80),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[300] + coefficients[301] * adjustments[16]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[300]*/ mload(0x2980),
                                       mulmod(/*coefficients[301]*/ mload(0x29a0),
                                              /*adjustments[16]*/mload(0x5a60),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[302]*/ mload(0x29c0),
                                       mulmod(/*coefficients[303]*/ mload(0x29e0),
                                              /*adjustments[19]*/mload(0x5ac0),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              // res += val * (coefficients[304] + coefficients[305] * adjustments[19]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[304]*/ mload(0x2a00),
                                       mulmod(/*coefficients[305]*/ mload(0x2a20),
                                              /*adjustments[19]*/mload(0x5ac0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[306] + coefficients[307] * adjustments[16]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[306]*/ mload(0x2a40),
                                       mulmod(/*coefficients[307]*/ mload(0x2a60),
                                              /*adjustments[16]*/mload(0x5a60),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[308] + coefficients[309] * adjustments[16]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[308]*/ mload(0x2a80),
                                       mulmod(/*coefficients[309]*/ mload(0x2aa0),
                                              /*adjustments[16]*/mload(0x5a60),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[310] + coefficients[311] * adjustments[16]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[310]*/ mload(0x2ac0),
                                       mulmod(/*coefficients[311]*/ mload(0x2ae0),
                                              /*adjustments[16]*/mload(0x5a60),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[312] + coefficients[313] * adjustments[16]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[312]*/ mload(0x2b00),
                                       mulmod(/*coefficients[313]*/ mload(0x2b20),
                                              /*adjustments[16]*/mload(0x5a60),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_neg_0*/ mload(0x4f40),
                addmod(
                  /*column21_row25*/ mload(0x4620),
              ...
              // res += val * (coefficients[314] + coefficients[315] * adjustments[16]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[314]*/ mload(0x2b40),
                                       mulmod(/*coefficients[315]*/ mload(0x2b60),
                                              /*adjustments[16]*/mload(0x5a60),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[316] + coefficients[317] * adjustments[16]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[316]*/ mload(0x2b80),
                                       mulmod(/*coefficients[317]*/ mload(0x2ba0),
                                              /*adjustments[16]*/mload(0x5a60),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[318]*/ mload(0x2bc0),
                                       mulmod(/*coefficients[319]*/ mload(0x2be0),
                                              /*adjustments[18]*/mload(0x5aa0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[320]*/ mload(0x2c00),
                                       mulmod(/*coefficients[321]*/ mload(0x2c20),
                                              /*adjustments[18]*/mload(0x5aa0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[322] + coefficients[323] * adjustments[19]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[322]*/ mload(0x2c40),
                                       mulmod(/*coefficients[323]*/ mload(0x2c60),
                                              /*adjustments[19]*/mload(0x5ac0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[324] + coefficients[325] * adjustments[19]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[324]*/ mload(0x2c80),
                                       mulmod(/*coefficients[325]*/ mload(0x2ca0),
                                              /*adjustments[19]*/mload(0x5ac0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[326] + coefficients[327] * adjustments[20]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[326]*/ mload(0x2cc0),
                                       mulmod(/*coefficients[327]*/ mload(0x2ce0),
                                              /*adjustments[20]*/mload(0x5ae0),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              // res += val * (coefficients[328] + coefficients[329] * adjustments[20]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[328]*/ mload(0x2d00),
                                       mulmod(/*coefficients[329]*/ mload(0x2d20),
                                              /*adjustments[20]*/mload(0x5ae0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[330] + coefficients[331] * adjustments[20]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[330]*/ mload(0x2d40),
                                       mulmod(/*coefficients[331]*/ mload(0x2d60),
                                              /*adjustments[20]*/mload(0x5ae0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[332] + coefficients[333] * adjustments[20]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[332]*/ mload(0x2d80),
                                       mulmod(/*coefficients[333]*/ mload(0x2da0),
                                              /*adjustments[20]*/mload(0x5ae0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[334] + coefficients[335] * adjustments[20]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[334]*/ mload(0x2dc0),
                                       mulmod(/*coefficients[335]*/ mload(0x2de0),
                                              /*adjustments[20]*/mload(0x5ae0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[336] + coefficients[337] * adjustments[20]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[336]*/ mload(0x2e00),
                                       mulmod(/*coefficients[337]*/ mload(0x2e20),
                                              /*adjustments[20]*/mload(0x5ae0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[338] + coefficients[339] * adjustments[20]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[338]*/ mload(0x2e40),
                                       mulmod(/*coefficients[339]*/ mload(0x2e60),
                                              /*adjustments[20]*/mload(0x5ae0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[340] + coefficients[341] * adjustments[20]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[340]*/ mload(0x2e80),
                                       mulmod(/*coefficients[341]*/ mload(0x2ea0),
                                              /*adjustments[20]*/mload(0x5ae0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[342] + coefficients[343] * adjustments[21]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[342]*/ mload(0x2ec0),
                                       mulmod(/*coefficients[343]*/ mload(0x2ee0),
                                              /*adjustments[21]*/mload(0x5b00),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              // res += val * (coefficients[344] + coefficients[345] * adjustments[20]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[344]*/ mload(0x2f00),
                                       mulmod(/*coefficients[345]*/ mload(0x2f20),
                                              /*adjustments[20]*/mload(0x5ae0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[346] + coefficients[347] * adjustments[20]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[346]*/ mload(0x2f40),
                                       mulmod(/*coefficients[347]*/ mload(0x2f60),
                                              /*adjustments[20]*/mload(0x5ae0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[348] + coefficients[349] * adjustments[4]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[348]*/ mload(0x2f80),
                                       mulmod(/*coefficients[349]*/ mload(0x2fa0),
                                              /*adjustments[4]*/mload(0x58e0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[350] + coefficients[351] * adjustments[18]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[350]*/ mload(0x2fc0),
                                       mulmod(/*coefficients[351]*/ mload(0x2fe0),
                                              /*adjustments[18]*/mload(0x5aa0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[352] + coefficients[353] * adjustments[22]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[352]*/ mload(0x3000),
                                       mulmod(/*coefficients[353]*/ mload(0x3020),
                                              /*adjustments[22]*/mload(0x5b20),
                      PRIME)),
                      PRIME),
                      PRIME)
              }
              ...
              // res += val * (coefficients[354] + coefficients[355] * adjustments[18]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[354]*/ mload(0x3040),
                                       mulmod(/*coefficients[355]*/ mload(0x3060),
                                              /*adjustments[18]*/mload(0x5aa0),
                      PRIME)),
                      PRIME),
                      PRIME)
              ...
              // res += val * (coefficients[356] + coefficients[357] * adjustments[18]).
              res := addmod(res,
                            mulmod(val,
                                   add(/*coefficients[356]*/ mload(0x3080),
                                       mulmod(/*coefficients[357]*/ mload(0x30a0),
                                              /*adjustments[18]*/mload(0x5aa0),
                      PRIME)),
                      PRIME),
                      PRIME)
