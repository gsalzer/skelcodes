...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x0F3876874A31c353509dc12F3638dDFD7662C9d6;
...
contract APE is Context, IERC20, Ownable {
    ...
    //set to 0 at the start, will be changed post-launch
    uint256 public _maxTxAmount = 0 * 10**15 * 10**9;
    ...
    function setBurnWalletAddress(address burnWalletAddress) external onlyOwner(){
