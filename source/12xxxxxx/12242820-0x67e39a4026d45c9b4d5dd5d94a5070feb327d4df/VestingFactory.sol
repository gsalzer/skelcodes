...
contract VestingFactory is Ownable {
    ...
    uint256 public constant START  = 1618461892; // start time
    
    uint256 public constant CLIFF  = 86400 * 30; //30 days
    
    uint256 public constant DURATION  = 86400 * 180; //180 days
    
    uint256 public constant PRICE = 610000000000000; // 0.00061 ETH or roughly 1.5 USD 
    ...
    function purchase(uint256 amount) public payable {
        uint256 cost = SafeMath.mul(amount, PRICE);
        ...
        IERC20(LIX).transfer(address(newVestingContract), amount);
