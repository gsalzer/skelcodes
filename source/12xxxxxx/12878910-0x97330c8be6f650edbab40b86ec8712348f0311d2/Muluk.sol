...
contract Muluk is Initializable, ERC721Full, ERC721Pausable, ERC721Burnable, ERC721Mintable {

  function initialize(address sender) public initializer {
   ERC721.initialize();
   ERC721Metadata.initialize('Muluk', 'MULK');
   ERC721Enumerable.initialize();
   ERC721Mintable.initialize(sender);
   ERC721Pausable.initialize(sender);
   _setBaseURI('https://nooxcommunity.com/tokens/getMetadata/');
  }
