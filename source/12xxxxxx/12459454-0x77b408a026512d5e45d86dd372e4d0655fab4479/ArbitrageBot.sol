...
contract ArbitrageBot is AccessControl {
    ...
    string private constant INVALID_ADDRESS = "Invalid address";
    ...
    event TokensUpdated(address token);

    address public constant _bPool = 0x1Dc2948B6dB34E38291090B825518C1E8346938B;
    address public constant _deus = 0x3b62F3820e0B035cc4aD602dECe6d796BC325325;
    address public constant _dea = 0x80aB141F324C3d6F2b18b030f1C4E95d4d658778;
    address public constant _sdea = 0xd8C33488B76D4a2C06D5cCB75574f10F6ccaC3D7;
    address public constant _suni_dd = 0x2EdE9CB92a6dE0916889E5936B1aAd0e99ddf242;
    address public constant _suni_de = 0x670431fCdAf39280deE488C6D8277B9865E22d08;
    address public constant _suni_du = 0xB7b52c3523Af9c237817a49D17E656283cC59678;
    address public constant _sdeus = 0xc586AeA83A96d57764A431B9F4e2E84844075a01;


    /**
     * @dev sets the pool and the tokens addresses
     */
    constructor() public {
        bPool = IBPool(_bPool);
    ...
    * @notice Reclaim tokens of the specified type sent to the safe account
    ...
    /**
    * @notice Update pool tokens
     * @param token The new token address
     */
    function updateTokens(address token)
        external
    {
        require(hasRole(WITHDRAWAL_ROLE, _msgSender()), UNAUTHORIZED_USER);
