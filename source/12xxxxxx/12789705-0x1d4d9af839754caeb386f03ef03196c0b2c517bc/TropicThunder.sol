/**
 * https://t.me/TropicThunder_ETH
 * 
 * 
 * Tropic Thunder is a meme token with a twist!  
 * Tropic Thunder has no sale limitations, which benefits whales and minnows alike, and an innovative dynamic reflection tax rate which increases proportionate to the size of the sell.
 * 
 * TOKENOMICS:
...
contract TropicThunder is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"TropicThunder | t.me/TropicThunder_ETH";
    string private constant _symbol = unicode"TropicThunder";
