...
contract JAMESBOND is Context, IERC20, Ownable {
    ...
    string private _name = "James Bond";
    ...
    uint256 public _maxTxAmount = 250000 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 100 * 10**6 * 10**9;

    address payable public marketingpoolAddress = 0x589CE1EE011e9e9a3f032147D90bfb8Fb41717Cd; // Marketing Wallet
    ...
    function setMarketingpoolFeePercent(uint256 CharitypoolFee) external onlyOwner() {
