...
www.fatcatco.org
t.me/fatcatcoin
FatCat Loves you. Ape Responsibly 
*/
...
pragma solidity ^0.6.12;
    ...
    contract FatCat is Context, IERC20, Ownable {
        ...
        string private _name = 'FatCat😺';
        string private _symbol = 'FatCat😺';
        ...
        function _setTaxFee(uint256 taxFee) external onlyOwner() {
            require(taxFee >= 1 && taxFee <= 10, 'taxFee should be in 1 - 12');
            _taxFee = taxFee;
        }

        function _setCharityFee(uint256 charityFee) external onlyOwner() {
            require(charityFee >= 1 && charityFee <= 11, 'charityFee should be in 1 - 12');
