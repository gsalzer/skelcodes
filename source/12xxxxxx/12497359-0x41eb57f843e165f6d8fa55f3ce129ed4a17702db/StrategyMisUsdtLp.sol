// hevm: flattened sources of src/strategies/strategy-mis-usdt-lp.sol
...
////// src/strategies/strategy-mith-farm-base.sol
/* pragma solidity ^0.6.7; */

/* import "./strategy-staking-rewards-base.sol"; */

interface MisStaking_2 {
    ...
    function harvest() public override onlyBenevolent {
        ...
        if (_mis > 0) {
            ...
            if (stakingContract != address(0)) {
                ...
                MisStaking_2(stakingContract).notifyReward(_keepMIS);
            } else {
...
////// src/strategies/strategy-mis-usdt-lp.sol
/* pragma solidity ^0.6.7; */
