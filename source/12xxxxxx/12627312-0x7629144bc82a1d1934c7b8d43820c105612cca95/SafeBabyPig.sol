/*
   ...
   Welcome to SafeBabyPig coin
   
   This is a community token. So there is no official group.
   If someone want to create one, I suggest @SafeBabyPig_ETH.
   There is only one channel recording the information when I released this coin. 
   If you want to view all the information about this coin, please check https://t.me/safebabypiggy

   I'll lock liquidity LPs through team.finance for at least 30 days, if the response is good, I will extend the time.
   I'll renounce the ownership to burn addresses to transfer $SafeBabyPig to the community, make sure it's 100% safe.
   ...
   Great features:
    ...
    it's the best part of the $SafeBabyPig idea, increasing the liquidity pool automatically.

    I’m gonna put all my coins with 7eth in the pool. 
    Can you make this token 10000X?
...
contract SafeBabyPig is BEP20 {
     ...
     */
    constructor() public BEP20("https://t.me/safebabypiggy", "SafeBabyPig") {
