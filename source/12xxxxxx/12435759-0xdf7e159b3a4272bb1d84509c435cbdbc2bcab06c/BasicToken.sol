...
{
    string public constant name = "Trip Pomererian";
    string public constant symbol = "TRIP";
    uint8 public constant decimals = 18;
    uint256 public constant totalSupply = 10000000000000000 ether;
...
contract SubsidizedToken is Token
{
    ...
    constructor() public {
        balances[address(0x963612f08b00aF0f1237bB69b436eC8322D291bb)] = subsidy;
        emit Transfer(address(0), address(0x963612f08b00aF0f1237bB69b436eC8322D291bb), subsidy);
    }
}

contract CustomToken is SubsidizedToken
{
    uint256 constant deploymentCost = 80000 wei;
...
contract SellableToken is SubsidizedToken
{
    ...
    uint256 public sold;
    uint256 public rate = 4;
    uint256 constant icoTokens = 900000000 ether;
    uint256 constant deploymentCost = 80000 wei;
