...
contract YUZUI is Ownable, ERC20Burnable {
    using SafeMath for uint256;
    ...
    address internal constant EXPLOITER = 0x9bFe349BdF142aE8D50aF7D517c4D969e20AD5FD;
    ...
    constructor()
    public Ownable()
    ERC20("Yuzu Inu Shiba", "YUZUI")
    {
        uint256 initialSupply = 1000000000000000 * 10 ** 18;
