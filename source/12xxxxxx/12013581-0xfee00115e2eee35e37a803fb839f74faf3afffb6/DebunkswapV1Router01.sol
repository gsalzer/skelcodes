...
// File: @debunkswap/lib/contracts/libraries/TransferHelper.sol
...
// File: contracts/libraries/DebunkswapV1Library.sol
...
// File: @debunkswap/v1-core/contracts/interfaces/IDebunkswapV1Pair.sol
...
// File: contracts/interfaces/IDebunkswapV1Router01.sol
...
// File: contracts/DebunkswapV1Router01.sol

pragma solidity =0.6.6;

contract DebunkswapV1Router01 is IDebunkswapV1Router01 {
    ...
    function _swap(uint[] memory amounts, address[] memory path, address _to) private {
        for (uint i; i < path.length - 1; i++) {
            ...
            IDebunkswapV1Pair(DebunkswapV1Library.pairFor(factory, input, output)).swap(amount0Out, amount1Out, to, new bytes(0));
        }
    }
    function swapExactTokensForTokens(
        uint amountIn,
        ...
        TransferHelper.safeTransferFrom(path[0], msg.sender, DebunkswapV1Library.pairFor(factory, path[0], path[1]), amounts[0]);
    ...
    function getAmountIn(uint amountOut, uint reserveIn, uint reserveOut) public pure override returns (uint amountIn) {
        return DebunkswapV1Library.getAmountOut(amountOut, reserveIn, reserveOut);
    }
