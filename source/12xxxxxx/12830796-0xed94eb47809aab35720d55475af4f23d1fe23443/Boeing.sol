...
contract Boeing is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Boeing Token";
    string private constant _symbol = unicode"Boeing🛫";
