  ...
  EIP712MetaTransaction("ERC721Token", "1")
{
  ...
  event BulkTokensMinted(uint256 amount, address owner, uint[] tokenIds);
  ...
  function bulkMintTo(uint256 _amount, string memory _tokenId, address _finalOwner) public {
  ...
  function _msgSender() override internal view virtual returns (address payable) {
