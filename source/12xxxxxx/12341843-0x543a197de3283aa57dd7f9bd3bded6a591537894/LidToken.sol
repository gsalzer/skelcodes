    ...
    Ownable
{
    ...
    function initialize(
        ...
        _addMinter(0x0be0eCC301a1c0175f07A66243cfF628c24DB852);

        ERC20Pausable.initialize(address(this));
        _removePauser(address(this));
        _addPauser(0x0be0eCC301a1c0175f07A66243cfF628c24DB852);

        daoFund = _daoFund;
        lidStaking = _lidStaking;
        addTrustedContract(address(0x0be0eCC301a1c0175f07A66243cfF628c24DB852));
        setTaxExemptStatus(address(0x0be0eCC301a1c0175f07A66243cfF628c24DB852), true);
        //Due to issue in oz testing suite, the msg.sender might not be owner
        _transferOwnership(owner);
    }
