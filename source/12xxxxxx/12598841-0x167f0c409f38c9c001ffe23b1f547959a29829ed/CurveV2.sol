...
contract CurveV2 is IExchange {
...

  {
    ...
    if (curveV2Data.underlyingSwap) {
      ICurveV2Pool(exchange).exchange_underlying(curveV2Data.i, curveV2Data.j, fromAmount, toAmount);
    }
    else {
      ICurveV2Pool(exchange).exchange(curveV2Data.i, curveV2Data.j, fromAmount, toAmount);
    }
  ...
  function getKey() public override pure returns(bytes32) {
    return keccak256(abi.encodePacked("CURVEV2", "1.0.0"));
  }
