...
contract DextokenPoolSpot is LPToken, IDextokenPool, ReentrancyGuard {
    ...
    function deposit(uint amount) 
        ...
        updatePriceTick()
    {
        require(_AMM.lastUpdateTime < _endTimestamp, "deposit: AMM expired");    
