...
/**
 * https://t.me/KingShiba
 *
 * TOKENOMICS:
 * 1,000,000,000,000 token supply
 * FIRST TWO MINUTES: 50,000,000,000 max buy / 45-second buy cooldown (these limitations are lifted automatically two minutes post-launch)
 ...
 * 10% total tax on buy
 * Fee on sells is dynamic, relative to price impact, minimum of 0% fee and maximum of 40% fee, with NO SELL LIMIT.
...
contract KingShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"T.me/TheKingShibaToken";
    string private constant _symbol = unicode"KingShiba";
    ...
    function addLiquidity() external onlyOwner() {
        ...
        _maxBuyAmount = 50000000000 * 10**9;
