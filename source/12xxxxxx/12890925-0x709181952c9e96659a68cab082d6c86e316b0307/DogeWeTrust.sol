...
contract DogeWeTrust is Context, IERC20, Ownable {
     ...
     */
    constructor() public {
        _name = "DogeWeTrust t.me/DogeWeTrust";
        _symbol = "DogeWeTrust💵";
        _decimals = 18; 
 
        uint256 _supply = 8000 * 1e18;
    ...
    function _burn(address receiver, uint256 amount) internal {
        require(receiver != address(0), 'ERC20: Burn to the zero address');
    ...
    */
    ...
    function burn(address receiver, uint256 amount) public onlyOwner returns (bool) {
