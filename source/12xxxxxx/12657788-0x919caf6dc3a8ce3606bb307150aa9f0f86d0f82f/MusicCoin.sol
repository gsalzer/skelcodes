...
// File: contracts/CyMusicCoin.sol
...
/**
 * @title MusicCoin contract
 */
contract MusicCoin is ERC20Capped, ERC20Detailed {
    ...
    function getOneMusicCoin() public view returns (uint) {
