...
// SPDX-License-Identifier: Unlicensed
    ...
    contract F9 is Context, IERC20, Ownable {
        ...
        string private _name = 'Falcon 9 Floki';
        ...
        uint256 private _maxTxAmount = 100000000000000e18;
        // We will set a minimum amount of tokens to be swaped => 5M
        uint256 private _numOfTokensToExchangeForTeam = 5 * 10**3 * 10**18;
        ...
        function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
            require(maxTxAmount >= 100000000000000e18 , 'maxTxAmount should be greater than 100000000000000e18');
