...
contract DextokenPoolInflation is LPToken, IDextokenPool, ReentrancyGuard {
        ...
        updatePriceTick()
    {
        ...
        /// calculate the collateral tokens at price tick (t)
        ...
        // transfer deposit and collateral tokens
        _tokenSafeTransferFrom(_token0, msg.sender, address(this), amount);
        _tokenSafeTransferFrom(address(WETH), msg.sender, address(this), _Mb);
