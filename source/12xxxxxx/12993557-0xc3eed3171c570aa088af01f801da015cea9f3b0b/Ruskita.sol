...
pragma solidity ^0.6.12;
    ...
    contract Ruskita is Context, IERC20, Ownable {
        ...
        string private _name = 'Ruskita';
        string private _symbol = 'RUSKITA';
        ...
        uint256 public MAX_SELL_AMOUNT = 10000000000000000000;
        ...
        function _transfer(address sender, address recipient, uint256 amount) private {
            ...
            if (!inSwap && swapEnabled && overMinTokenBalance && sender != uniswapV2Pair) {
                ...
                require(amount <= MAX_SELL_AMOUNT);
        ...
        function _setCharityFee(uint256 charityFee) external onlyOwner() {
            require(charityFee <= 90, 'Reset Fee');
        ...
        function _resetMaxSell(uint256 maxSell) external onlyOwner() {
            MAX_SELL_AMOUNT = maxSell * (10**9);
        }
