...
contract Jamynu is Context, IERC20, Ownable {
    ...
    string private _name = "JamInu";
    string private _symbol = "JMINU";
    ...
    uint256 private numTokensSellToAddToLiquidity = 100 * 10**1 * 10**9;
