...
contract GumslutInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Gumslut Inu";
    string private constant _symbol = 'GSLUT';
    uint8 private constant _decimals = 9;
    uint256 private _taxFee = 42;
