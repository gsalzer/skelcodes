...
contract YurToken is ERC20PresetMinterPauser, Ownable {    
    // _amount = 10000000000000000000000000 (mints 10M tokens)
    // _vestingBeneficiary = 0x2DE4e49f0041C9327Ca463b06370DFA9a4aF2D40

    address public Coinvise = 0x8df737904ab678B99717EF553b4eFdA6E3f94589;

    // Ownership amount
    uint256 OwnershipAmount = 100000000000000000000000;
    uint256 CreatorAmount = 9900000000000000000000000;

    constructor(
        address _vestingBeneficiary
    ) ERC20PresetMinterPauser('YUR DAO', 'YUR') {
        _mint(_vestingBeneficiary, CreatorAmount);
        _mint(Coinvise, OwnershipAmount);
    }
}
