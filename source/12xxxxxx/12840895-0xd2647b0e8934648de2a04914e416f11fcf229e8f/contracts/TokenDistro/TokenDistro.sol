    ...
    AccessControlEnumerableUpgradeable
{
    ...
    bool cancelable; // Variable that allows the ADMIN_ROLE to cancel an allocation
    ...
    function cancelAssign(address distributor) public {
        require(
            hasRole(DEFAULT_ADMIN_ROLE, msg.sender),
        ...
        balances[distributor].allocatedTokens = 0;

        emit CancelAssign(msg.sender, distributor);
    }
