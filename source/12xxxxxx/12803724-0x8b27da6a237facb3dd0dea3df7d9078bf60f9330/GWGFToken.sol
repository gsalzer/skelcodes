...
contract GWGFToken is ERC20 {
    string public constant name = "THE GREAT WILD GINSENG FIRM HOLDINGS";
    string public constant symbol = "GWGF";
    uint8 public constant decimals = 18;
    uint256 public constant initialSupply = 3800503853 * (10 ** uint256(decimals));
