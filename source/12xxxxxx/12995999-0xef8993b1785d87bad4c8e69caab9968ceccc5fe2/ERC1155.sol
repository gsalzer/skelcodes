...
/////////////////////////////////////////// ERC1155 //////////////////////////////////////////////
    ...
    */
    function safeBatchTransferFrom(address _from, address _to, uint256[] calldata _ids, uint256[] calldata _values, bytes calldata _data) external {
        ...
        require(_to != address(0x0), "ERC1155: destination address must be non-zero.");
        require(_ids.length == _values.length, "ERC1155:  _ids and _values array length must match.");
        require(_from == msg.sender || operatorApproval[_from][msg.sender] == true, "ERC1155: need operator approval for 3rd party transfers.");
