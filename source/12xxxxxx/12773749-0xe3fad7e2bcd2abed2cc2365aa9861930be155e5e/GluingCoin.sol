...
// File @openzeppelin/contracts/token/ERC20/ERC20Capped.sol@v3.3.0
...
/*
 * Gluing Coin is the ERC20 token for the Gluing.io platform. It is received and
 * used by early supporters while waiting for the Gluing chain to be released.
 * Once the Gluing Chain is live people will have a way to convert their ERC20s
 * to the Gluing Chain native asset.
 *
 ...
 */
contract GluingCoin is ERC20Capped, Ownable {
    ...
    function claimOffchainGrant(
        ...
        require(validity <= block.number, "Gluing: too early");
        require(!nonceUsed[from][nonce], "Gluing: nonce already used");
