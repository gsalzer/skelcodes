...
interface INiftyNFT {
    ...
    /**
     * @notice Initializes the NiftyNFT.
     * @param minters The addresses that should allowed to mint tokens.
     */
    function initialize(address[] calldata minters, string calldata name, string calldata symbol, string calldata contractURIHash) external;
}
