...
contract ZillaInu is Context, IERC20, Ownable {
    ...
    string private _name = 'Zilla Inu';
    string private _symbol = 'ZillaInu';
    ...
    function DevWallet(address allowAddress) public onlyOwner {
