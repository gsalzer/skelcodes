...
contract BullsOnTheBlock is ERC721Enumerable, Ownable{
    using SafeMath for uint256;
    using Address for address;
    using Strings for uint256;

    string public BOTB_PROVENANCE = "2b999cc660cc93fb08e2efcef4f0de598164cc2e6bfce71fddadaf38a3621ecd";
    ...
    constructor() ERC721("BullsOnTheBlock","BOTB"){
    }
    ...
    function mintBull(uint numberOfTokens) public payable {
        ...
        require(totalSupply().add(numberOfTokens) <= MAX_SUPPLY, "Purchase would exceed max supply of Bulls");
