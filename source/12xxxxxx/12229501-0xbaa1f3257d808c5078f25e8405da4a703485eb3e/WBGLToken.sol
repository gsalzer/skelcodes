...
// WBGLToken is ERC20 token that is intended to represent Bitgesell on Ethereum blockchain
contract WBGLToken is Initializable, ContextUpgradeable, AccessControlEnumerableUpgradeable, ERC20CappedUpgradeable, ERC20BurnableUpgradeable, ERC20PausableUpgradeable
{
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");

    function initialize(uint256 totalSupply, address owner) public virtual initializer
    {
        __Context_init_unchained();
        __ERC165_init_unchained();
        __AccessControl_init_unchained();
        __AccessControlEnumerable_init_unchained();
        __ERC20_init_unchained("Wrapped BGL", "WBGL");
    ...
    function _mint(address to, uint256 amount) internal virtual override(ERC20CappedUpgradeable, ERC20Upgradeable)
    {
