/*
 ClienteleCoin 👟 @clientelegram

👟  Introducing the Worlds First "Streetwear Crypto Currency" 

👟  This Coin Will Be Revolutionary; Different From Any You’ve Ever Seen. 

👟  This Coin Will Be Anti-Bot, Anti-Whale, And Will Have Real Utility, With The Ability To Receive Exclusive Real World And Digital Items Just For Holding! 
*/
...
contract Clientele is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x0a3cFD4dD2E8a6f8EFDEb6f1A0b162968E590CCC); // Marketing Address
    ...
    uint256 private _tTotal = 137000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Clientele Coin";
    string private _symbol = "Clientele";
    ...
    uint256 public _intervalMinutesForSwap = 60 * 1 minutes;
    ...
    uint256 public _maxTxAmount = 137000000 * 10**6 * 10**9;
