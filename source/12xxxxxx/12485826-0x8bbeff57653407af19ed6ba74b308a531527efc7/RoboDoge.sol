...
// -------------------------------------------------------------------------------
// RoboDoge Token contract with following features:
//      => ERC20 Compliance;
...
// Decimals    : 18
//
// Contract designed by - EtherAuthority
// Deployed by - @FuegoNFT
...
contract RoboDoge is owned {
    ...
    string constant public name = "RoboDoge";
    string constant public symbol = "ROBO";
