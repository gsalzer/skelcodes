...
contract Invent is ERC20 {
    ...
    uint256 public totalSupply = 2000000000 * 10**9;
    ...
    function distributeHNC(address[] addresses, uint256 _value, uint256 _ethbal) onlyOwner canDistr public {
