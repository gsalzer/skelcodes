...
contract STTToken is StandardToken {
    ...
    uint public poolBounty = 150000 * (10 ** uint(decimals));//Bounty pool
    uint public poolPresale = 700000 * (10 ** uint(decimals));//Presale pool
    uint public poolSale = 14150000 * (10 ** uint(decimals));//Sale pool
	uint public ownerInitialBalance = 3850000 * (10 ** uint(decimals));//Add reserved pool tokens to the owner address
