...
contract SyndiCoin is BurnableToken, Ownable {
 
  string public constant name = "SyndiCoin";
  ...
  /* Constructor function - initialize SyndiCoin */
  function SyndiCoin() {
    totalSupply = 35000000 * (10 ** uint256(decimals)); // Total initial supply is 35M
