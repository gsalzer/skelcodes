...
contract MintableToken is StandardToken, Ownable {
  ...
  uint256 amountOneHundred = 100000;
...
contract RewardsToken is MintableToken,BurnableToken {
    string public constant name = "RewardsToken";
