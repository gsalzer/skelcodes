/*
You should inherit from StandardToken or, for a token like you would want to deploy
...
contract MOMOToken is StandardToken {
    ...
    function MOMOToken()
    {
        ...
        balances[MOMO_FOUNDATION_WALLET] = totalSupply;              // Give the creator all initial tokens
    }
}
