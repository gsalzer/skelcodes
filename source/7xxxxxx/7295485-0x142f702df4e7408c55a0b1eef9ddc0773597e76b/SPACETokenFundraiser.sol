...
contract SPACETokenSafe is TokenSafe {
    ...
    public
  {
    ...
    init(
      1, // Group Id
      1551747600 // Release date = 2019-03-05 01:00 UTC
    );
    add(
      1, // Group Id
      0x80C82349860c720e1A2197bA603FF69E396021fc,  // Token Safe Entry Address
      1000000000000000000  // Allocated tokens
    );
  }
}
...
contract SPACETokenFundraiser is MintableTokenFundraiser, PresaleFundraiser, IndividualCapsFundraiser, ForwardFundsFundraiser, TieredFundraiser, GasPriceLimitFundraiser {
        ...
        public
    {
        ...
        MintableToken(token).mint(address(tokenSafe), 1000000000000000000);

        initializeBasicFundraiser(
            1551916800, // Start date = 2019-03-07 00:00 UTC
        ...
        initializePresaleFundraiser(
            ...
            1551744000, // Start = 2019-03-05 00:00 UTC
            1551916740,   // End = 2019-03-06 23:59 UTC
            1
        );
    ...
    function getConversionRate() public view returns (uint256) {
        ...
        if (now >= 1551744000 && now < 1556668740)
