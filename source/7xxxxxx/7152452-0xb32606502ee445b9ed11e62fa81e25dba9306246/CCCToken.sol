...
contract StandardToken is Token, Stoppable {
    ...
    function approve(address _spender, uint256 _value) stoppable returns (bool success) {
...
contract CCCToken is StandardToken {
    ...
    */
    string public name = 'Coinchat Coin';                   //fancy name: eg Simon Bucks
    uint8 public decimals = 18;                //How many decimals to show. ie. There could 1000 base units with 3 decimals. Meaning 0.980 SBX = 980 base units. It's like comparing 1 wei to 1 ether.
    string public symbol = 'CCC';                 //An identifier: eg SBX
    string public version = 'v201901311334';       //human 0.1 standard. Just an arbitrary versioning scheme.
    ...
    function CCCToken() {
        ...
        name = "Coinchat Coin";                                   // Set the name for display purposes
