...
/**
 * @title ERC20 token contract of Peer-to-Peer Energy Protocol
 */
contract ERC20Token is ERC20, ERC20Detailed, Ownable, ERC20Burnable {
  uint8 public constant DECIMALS = 18;
  uint256 public constant INITIAL_SUPPLY = 532221000 * (10 ** uint256(DECIMALS));

  /**
    * @dev Constructor that gives msg.sender all of existing tokens.
    */
  constructor () public ERC20Detailed("Peer-to-Peer Energy Protocol", "P2PEP", DECIMALS) {
