...
contract BithInternalInterest is ERC20 {
    ...
    string public constant name = "BithInternalInterest";
    string public constant symbol = "BIHD";
    uint public constant decimals = 8;
    uint256 _Rate = 10 ** decimals; 
    uint256 public totalSupply = 500 * _Rate;
...
//    uint256 public totalRemaining = totalSupply.sub(totalDistributed);
    ...
    modifier onlyPayloadSize(uint size) {
     ...
     function BithInternalInterest () public {
        owner = msg.sender;
