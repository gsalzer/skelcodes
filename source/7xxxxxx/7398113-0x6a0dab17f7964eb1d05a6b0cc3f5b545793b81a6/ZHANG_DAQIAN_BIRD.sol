...
contract ZHANG_DAQIAN_BIRD is StandardToken {
    function () {
    ...
    */
    string public name = "ZHANG.DAQIAN.BIRD";
    string public DigestCode_root = "ba6df74f00b561c6bc656d7dccfea9848eb083674fee6991bd64dc30fcaa62a7";
    string public TxHash_root = "genesis";
    string public Image_root = "https://swarm-gateways.net/bzz:/2efff8a1c2053bee211eca949b80050128ea693e07cd45c7dad48a6876cb2fd2/";
    string public Note_root= 'https://swarm-gateways.net/bzz:/55ee1dc685f307714bc802311eb077223adbd9e92f52cf468122b577376f6b6e/';
    string public ContractSource = "";
    string public CodeVersion = "v0.1";

    string public symbol = "InkArt.BIRD";
    ...
    function ZHANG_DAQIAN_BIRD() public {
        totalSupply = INITIAL_SUPPLY;
        balances[msg.sender] = INITIAL_SUPPLY;
    }
    
    function getIssuer() public view returns(string) { return "greatartistagency"; }
    function getArtist() public view returns(string) { return "ZHANG DAQIAN"; }
