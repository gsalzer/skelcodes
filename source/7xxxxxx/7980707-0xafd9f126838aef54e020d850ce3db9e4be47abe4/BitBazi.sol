...
contract BitBazi is MintableToken, PausableToken, BurnableToken {
    string public name = "BitBaazi";
    string public symbol = "BBZ";
    uint8 public constant decimals = 18; 
    uint256 public constant initialSupply = 180000000 * (10 ** uint256(decimals));
    // Constructor
    constructor() public{
