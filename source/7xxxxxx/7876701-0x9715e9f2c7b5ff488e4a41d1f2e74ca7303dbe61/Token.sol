...
contract Token is StandardToken {
    string public constant NAME = "Fileox";
    string public constant SYMBOL = "FOX";
    uint public constant DECIMALS = 18;

    /// During token sale, we use one consistent price: 3000 FOX/ETH.
    ...
    /// Each phase contains exactly 390000 Ethereum blocks, which is roughly 30 days,
    /// which makes this 2-phase sale period roughly 60 days.
    uint32 public constant BLOCKS_PER_PHASE = 390000;
    ...
    /// Indicates whether unsold token have been issued. This part of FOX token
    ...
    uint256 public constant GOAL = 500 ether;

    /// Maximum amount of fund to be raised, the sale ends on reaching this amount.
    uint256 public constant HARD_CAP = 50000 ether;

    /// Base exchange rate is set to 1 ETH = 3000 FOX.
    uint256 public constant BASE_RATE = 3000;
    ...
    /// @dev Compute the amount of FOX token that can be purchased.
    /// @param ethAmount Amount of Ether to purchase FOX.
    /// @return Amount of FOX token to purchase
