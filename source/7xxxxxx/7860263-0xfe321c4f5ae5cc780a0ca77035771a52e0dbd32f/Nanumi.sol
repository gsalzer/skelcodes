...
// File: contracts\Nanumi.sol

contract Nanumi is ERC20 {
    string public constant name = "Nanumi"; // solium-disable-line uppercase
    string public constant symbol = "Na"; // solium-disable-line uppercase
