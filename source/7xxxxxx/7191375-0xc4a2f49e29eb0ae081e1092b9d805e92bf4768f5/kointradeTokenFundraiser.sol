...
/**
 * @title kointradeToken
 */

contract kointradeToken is MintableToken {
    constructor(address _minter)
        StandardToken(
            "kointrade",   // Token name
            "KTE", // Token symbol
            18  // Token decimals
        )
...
/**
 * @title kointradeTokenFundraiser
 */

contract kointradeTokenFundraiser is MintableTokenFundraiser, PresaleFundraiser, IndividualCapsFundraiser, ForwardFundsFundraiser, GasPriceLimitFundraiser {
        ...
        public
    {
        ...
        initializeBasicFundraiser(
            1558346400, // Start date = 2019-05-20 10:00 UTC
            1566295200,  // End date = 2019-08-20 10:00 UTC
            4000, // Conversion rate = 4000 KTE per 1 ether
            0x351734eB6aD3a773dbF999812D1D800deDe624FF     // Beneficiary
        );

        initializeIndividualCapsFundraiser(
            (0.05 ether), // Minimum contribution
            (500 ether)  // Maximum individual cap
        );
        ...
        initializePresaleFundraiser(
            ...
            1550224800, // Start = 2019-02-15 10:00 UTC
            1557914400,   // End = 2019-05-15 10:00 UTC
            5000
        );
