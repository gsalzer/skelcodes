...
/* 
	...
	*Note:
	*
	*Holds all 3d created art in the form 
	*of an ERC721 Ethereum token
	***********************************
 ...
 * @dev see https://github.com/ethereum/EIPs/blob/master/EIPS/eip-721.md
 */
contract VoV is SupportsInterfaceWithLookup, ERC721BasicToken, ERC721, Ownable, Fallback {
  ...
  /*** CONSTANTS ***/
  string public constant project = "Brainfactory, VoV";
