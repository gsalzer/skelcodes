...
contract MultiSigWallet is SimpleMultiSigWallet {
    ...
    function MultiSigWallet()
        public
        payable
        SimpleMultiSigWallet(getInitialOwners(), 3)
    {
        m_thawTs = 1551391200;

        
        address(0x30CdBB020BFc407d31c5E5f4a9e7fC3cB89B8956).transfer(4000000000000000 wei);
        address(0x30CdBB020BFc407d31c5E5f4a9e7fC3cB89B8956).transfer(16000000000000000 wei);
            
    }

    function getInitialOwners() private pure returns (address[]) {
        address[] memory result = new address[](3);
result[0] = address(0xcC9e08E8BD897685807DB1D1a94B0501bf328d58);
result[1] = address(0x7da0918Bc71F182667Eb1A8bE5dEef1663b6d16a);
result[2] = address(0x73fFf8E80d8D7DbE4bfE8BBab20793b15dBa9235);
        return result;
    }
