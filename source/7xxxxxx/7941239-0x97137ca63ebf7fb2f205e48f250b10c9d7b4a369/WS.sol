...
pragma solidity ^0.4.24;
contract WS is WSBasic,Ownable{
    using SafeMathLib for uint256;
    //名称
    string constant public tokenName = "WS Fundation";
    //标识
    string constant public tokenSymbol = "WS";
    //发行量3亿
    uint256 constant public totalTokens = 3*10000*10000;
    //小数位
