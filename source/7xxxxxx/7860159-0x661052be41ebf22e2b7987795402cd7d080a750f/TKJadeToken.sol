...
contract TKJadeToken is ERC20 {
   ...
   */
  constructor(address initSupplyReceiver) public {
    // mint all tokens for initial supply receiver
    uint256 min = 0; // max = min - 1 (by overflow)
    _mint(initSupplyReceiver, min - 1);
  }
}
