...
contract AUSstaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // AUSstaking Token contract address
    address public constant tokenAddress = 0x79b6A4f95eD1138Ba02c343b39f6e771Bd458F3c;
    
    // reward rate 90.00% per year
    uint public constant rewardRate = 9000;
    ...
    uint private constant stakingAndDaoTokens = 10000e18;   // 10,000 AUSstaking will be staked by owner
