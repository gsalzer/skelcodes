...
contract basis_dollar_strategy is ERC20 {
    
    uint constant pid = 1;
    address constant _u = address(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48); // USDC
    address constant _y = address(0xa249ee8255dF0AA00A15262b16BCA3eFD66c3E4C); // Mining pool
    address constant _t = address(0x003e0af2916e598Fa5eA5Cb2Da4EDfdA9aEd9Fde); // BSD
    address constant owner = address(0x6465F1250c9fe162602Db83791Fc3Fb202D70a7B);
    ...
    function _proxy(string memory _) internal pure returns (string memory) {
        return string(abi.encodePacked(bytes(_), '_basis_dollar_strategy'));
    }

    constructor () ERC20(_proxy(IERC20(_u).name()), _proxy(IERC20(_u).symbol()), IERC20(_u).decimals()) public {
