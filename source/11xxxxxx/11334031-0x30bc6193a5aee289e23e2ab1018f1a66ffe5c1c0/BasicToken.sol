...
contract MintToken is BasicToken, Ownable {
...
contract PANDOCOIN is BurnableToken,MintToken, DetailedERC20, ERC20Token,Pausable{
	using SafeMath for uint256;
	...
	function transferFrom(address _from, address _to, uint256 _value) public whenNotPaused returns (bool){
		require(balances[_from] - _value >= locker[_from]);
