...
library SafeMath {
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        // benefit is lost if 'b' is also KAFIRed.
...
contract LPTokenWrapper {
    ...
    IERC20 public lp = IERC20(0xe724A0581ab5B4394da26bC3Ea06Eb15F00a7C11);
...
contract Unipool is LPTokenWrapper, IRewardDistributionRecipient {
    ...
    IERC20 public KAFIR = IERC20(0xe724A0581ab5B4394da26bC3Ea06Eb15F00a7C11);
    ...
    function getReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            KAFIR.safeTransfer(msg.sender, reward);
