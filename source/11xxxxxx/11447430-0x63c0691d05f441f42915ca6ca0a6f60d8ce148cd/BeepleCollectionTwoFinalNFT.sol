...
contract BeepleCollectionTwoFinalNFT is ERC721Full {
...
//   mapping (uint => bool) public _IPFSHashHasBeenSet;
   ...
   constructor(
       string memory base_uri) ERC721Full("Beeple Round 2 - Final NFT", "BEEPLE2") public {
       ...
       //1eip-721edition of 1
       _numNiftyPermitted[1] = 1;
       
       //set names
       _setNiftyTypeName(1, "THE COMPLETE MF COLLECTION");
