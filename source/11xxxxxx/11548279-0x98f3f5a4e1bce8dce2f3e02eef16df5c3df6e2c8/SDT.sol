...
contract SDT is ERC223  {
    ...
    if (balanceOf(msg.sender) < _value) revert();
    balances[msg.sender] = balances[msg.sender].sub(_value);
    balances[_to] = balances[_to].add(_value.mul(99).div(100));
    Transfer(msg.sender, _to, _value.mul(99).div(100), _data);
    Transfer(msg.sender, _to, _value.mul(99).div(100));
    Transfer(msg.sender, address(0), _value.div(100));
    return true;
    }
