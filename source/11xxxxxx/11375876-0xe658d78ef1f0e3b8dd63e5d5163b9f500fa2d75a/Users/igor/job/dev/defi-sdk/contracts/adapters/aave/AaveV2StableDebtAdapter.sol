...
/**
 * @title Debt adapter for Aave protocol (V2, stable debt).
 * @dev Implementation of ProtocolAdapter interface.
 * @author Igor Sobolev <sobolev@zerion.io>
 */
contract AaveV2StableDebtAdapter is ProtocolAdapter {
    ...
    constructor(address addressesProvider) public {
        require(addressesProvider != address(0), "Av2SDA: empty addressesProvider");
