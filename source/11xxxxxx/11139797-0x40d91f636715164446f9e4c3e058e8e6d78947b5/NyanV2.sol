...
contract NyanV2 is ERC20, NyanV2DataLayout, Proxiable {
    ...
    modifier _updateRewards() {
        ...
        //       lastNyanCheckpoint = 0;
        //       rewardsClaimed = 0;
        //     }
        //     uint256 userStakeAmount = userStake[msg.sender].stakedNyanV2LP.add(userStake[msg.sender].stakedDNyanV2LP);
        //     uint256 userRewardPerBlock = nyanRewardsPerDay.mul(userStakeAmount).div(10000);


        //     uint256 totalNyanV2Held = ERC20(nyanV2).balanceOf(address(this));
        //     uint256 rewardsInDay = totalNyanV2Held.mul(rewardsPercentage);
        //     uint256 rewardsInDayDiv = rewardsInDay.div(10000);
