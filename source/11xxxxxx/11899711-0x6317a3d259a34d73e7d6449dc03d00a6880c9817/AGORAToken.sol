 ...
 **/
contract AGORAToken is StandardToken, Pausable {
    string public constant name = " AGORA Pharmaceuticals ";
    string public constant symbol = "AGR";
    uint256 public constant decimals = 18;
	 uint256 public constant INITIAL_SUPPLY = 640000000 * (10 ** uint256(decimals));
