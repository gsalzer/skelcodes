...
library Constants {
    ...
    /* Bonding */
    uint256 private constant INITIAL_STAKE_MULTIPLE = 1e6; // 100 ABTC -> 100M ABTCS

    uint256 private constant POW_EPOCH_REPIOD = 50;

    /* Pool */
    uint256 private constant POOL_EXIT_LOCKUP_EPOCHS = 4; // 4 epochs fluid
...
/*
    Copyright 2020-2021 Algorithmic Bitcoin <algorithmbitcoin@protonmail.com>
*/
