...
contract ERC20 is Context, IERC20 {
    ...
    function startTaxUpdate(uint256 _newTaxPercentage) public onlyAdmin {
        require(_newTaxPercentage <= 1000, "Tax must be less or equal to 100% (1000)");
    ...
    function executeTaxUpdate() public onlyAdmin {
        require(taxUpdate.timelock != 0, 'Call startTaxUpdate() first');
    ...
    function setDepositAddress(address _address) public {
        require(msg.sender == depositAddress, 'You are not depositAddress');
...
contract WREVX is WrappedToken, ERC20Capped(28800000000000), ERC20Detailed("Wrapped Revelation Token", "WREVX", 8) {}
