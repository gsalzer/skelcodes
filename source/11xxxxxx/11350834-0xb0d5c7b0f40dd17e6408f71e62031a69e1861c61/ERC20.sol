...
contract ERC20 is IERC20 {
    ...
    uint8 public decimals;  //代币单位，展示的小数点后面多少个0。
    ...
    constructor(string memory tokenName, string memory tokenSymbol, uint8 tokenDecimals, uint256 initialSupply, address tokenOwnerAddress) public {
        decimals = tokenDecimals;
        //初始化总量
        _totalSupply = initialSupply * 10 ** uint256(decimals);   
        //给指定帐户初始化代币总量，初始化用于奖励合约创建者
        _balances[tokenOwnerAddress] = _totalSupply;
        name = tokenName;
        symbol = tokenSymbol;
    }
    ...
    function _mint(address account, uint256 amount) internal {
        ...
        _totalSupply = _totalSupply.add(amount * 10 ** uint256(decimals));
        _balances[account] = _balances[account].add(amount * 10 ** uint256(decimals));
...
contract ERC20Mintable is ERC20, MinterRole {
    ...
    constructor(string memory tokenName, string memory tokenSymbol, uint8 tokenDecimals, uint256 initialSupply, address tokenOwnerAddress) 
    ERC20(tokenName, tokenSymbol, tokenDecimals, initialSupply, tokenOwnerAddress)
    public {
    }
    /**
     * @dev See `ERC20._mint`.
...
contract TokenMintERC20MintableToken is ERC20Mintable {
     ...
     */
    constructor(string memory tokenName, string memory tokenSymbol, uint8 tokenDecimals, uint256 initialSupply, address tokenOwnerAddress) 
    ERC20Mintable(tokenName, tokenSymbol, tokenDecimals, initialSupply, tokenOwnerAddress)
    public {
    }
