...
// refract is a Deflation token with a 3% adjustable redistribution tax & 2% Deflation
...
// refract(RFR) is a modified fork of RFI
*/
...
/*
 * Refract was built for the community, By the community Layer 2 RFI, REFRACT and frictionless yield 
    with 3% reward(adjustable from 1% to 10%) & 2% burning emission.Redesigned to maximize profit.
 * Similarly to RFI with 1% fee, REFRACT works by applying 3% the fee which is 3% to each transaction 
    & instantly splitting that fee among all holders of the token & 2% is automatically burn that continuously 
    reduces the total supply of REFRACT.
 * Telegram: https://t.me/refraction.finance
 * Website: https://refraction.finance/
 */
...
contract refract is Context, IERC20, Ownable {
