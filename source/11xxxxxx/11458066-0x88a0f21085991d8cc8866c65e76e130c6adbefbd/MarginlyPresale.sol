...
contract MarginlyPresale is TimedCrowdsale, IncreasingPriceCrowdsale, Ownable {
  constructor
  (
  ...
  // Release tokens for burn once presale concludes
  function releaseTokensForBurn() onlyOwner public {
    require(this.hasClosed());
