...
contract ERC20 is Context, IERC20 {
     ...
     * construction.
     */
    constructor (string memory name, string memory symbol, uint8 decimals, uint256 supply, string memory goodName, string memory manufacturer, string memory ipfs,  string memory initPrice) public {
        _creator = _msgSender();
        _name = name;
        _symbol = symbol;
     ...
     */
    function good() public view returns (string memory, string memory, string memory, string memory, string memory, string memory, string memory) {
        return (_goodName, _manufacturer, _ipfs, _year, _size, _squareFeet, _media);
    }
