...
contract StrategyCurveUSDPVoterProxy {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;

    address public constant want = address(0x7Eb40E450b9655f4B3cC4259BCC731c63ff55ae6);
    address public constant crv = address(0xD533a949740bb3306d119CC777fa900bA034cd52);

    address public constant curve = address(0x3c8cAee4E09296800f8D29A68Fa3837e2dae4940);
    address public constant gauge = address(0x055be5DDB7A925BfEF3417FC157f53CA77cA7222);
    ...
    function getName() external pure returns (string memory) {
        return "StrategyCurveUSDPVoterProxy";
    }
