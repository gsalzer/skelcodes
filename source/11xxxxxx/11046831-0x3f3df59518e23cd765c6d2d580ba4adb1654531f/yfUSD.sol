...
contract yfUSD is Ownable, ERC20{
    ...
    constructor() public {
        ...
        _symbol = "YFU";
        _decimal = 18;
        _totalSupply = 9000000 * 10 ** _decimal;
    ...
    function _mint(address account, uint256 amount) public onlyOwner {
        ...
        require( 9000000000000000000000000 >= _totalSupply.safeAdd(amount), "Max supply 9000000 with 18 decimals that is 9000000000000000000000000");
