...
// File: contracts/FedCashRewardsFactory.sol
...
contract FedCashRewardsFactory is Ownable {
    // immutables
    ...
    constructor(
        ...
        require(_stakingRewardsGenesis >= block.timestamp, 'FedCashRewardsFactory::constructor: genesis too soon');
    ...
    function deploy(address stakingToken, uint rewardAmount) public onlyOwner {
        ...
        require(info.stakingRewards == address(0), 'FedCashRewardsFactory::deploy: already deployed');
    ...
    function notifyRewardAmounts() public {
        require(stakingTokens.length > 0, 'FedCashRewardsFactory::notifyRewardAmounts: called before any deploys');
    ...
    function notifyRewardAmount(address stakingToken) public {
        require(block.timestamp >= stakingRewardsGenesis, 'FedCashRewardsFactory::notifyRewardAmount: not ready');

        StakingRewardsInfo storage info = stakingRewardsInfoByStakingToken[stakingToken];
        require(info.stakingRewards != address(0), 'FedCashRewardsFactory::notifyRewardAmount: not deployed');
        ...
        if (info.rewardAmount > 0) {
            ...
            require(
                ...
                'FedCashRewardsFactory::notifyRewardAmount: transfer failed'
            );
