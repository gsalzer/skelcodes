...
// File: contracts/EnhancedERC20.sol
...
/*
  Above this line is original Openzeppelin code from ERC20UpgradeSafe.

  Below are changes required necessary to expose private variables 
  or hooks to make the contract more flexible or gas-efficient.
*/
     ...
     */
    function transferBatch(address[] calldata recipients, uint256[] calldata amounts) external virtual returns (bool) {
...
// File: contracts/ManagedEnhancedERC20.sol
