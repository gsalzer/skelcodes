...
/**
 * @title The CCIToken project contract.
 * @author https://grox.solutions
 */
contract CCIToken is LockableToken {

    // name of the token
    string private _name = "Cryptocurrency Index";
    // symbol of the token
    ...
    // initial supply
    uint256 internal constant INITIAL_SUPPLY = 1000000 * (10 ** 8);
