...
contract LPToSHABU is Ownable {
    ...
    ShabuVault private shabu = ShabuVault(0xDA8DD97b9C0a4f4691e8C88Fe47c740b70D5A449);
    IERC20 private lpToken = IERC20(0xDA8DD97b9C0a4f4691e8C88Fe47c740b70D5A449); // CHANGE TO LP TOKEN ADDRESS WHEN UNISWAP LISTED
    ...
    uint256 public initReward = 10750 * 1e18;
    ...
    uint256 public devFundAmount = 1500 * 1e18;
    ...
    function changeLP(address _address) external onlyOwner {
