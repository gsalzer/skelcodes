...
contract FeeApprover is OwnableUpgradeSafe {
    ...
    function initialize(
        ...
        kernelTokenAddress = _KERNELAddress;
        WETHAddress = _WETHAddress;
        tokenUniswapPair = IUniswapV2Factory(_uniswapFactory).getPair(WETHAddress, kernelTokenAddress);
        feePercentX10 = 15;
    ...
    address kernelTokenAddress;
    address kernelVaultAddress;
    uint8 public feePercentX10;  // max 255 = 25.5% artificial clamp
    ...
    function setFeeMultiplier(uint8 _feeMultiplier) public onlyOwner {
        feePercentX10 = _feeMultiplier;
    }

    function setKernelVaultAddress(address _kernelVaultAddress) public onlyOwner {
        kernelVaultAddress = _kernelVaultAddress;
    }
    ...
    function calculateAmountsAfterFee(
        ...
        ) public  returns (uint256 transferToAmount, uint256 transferToFeeDistributorAmount)
        {
            ...
            if(sender == kernelVaultAddress  || sender == tokenUniswapPair ) { 
                ...
                transferToFeeDistributorAmount = amount.mul(feePercentX10).div(1000);
