...
contract MultiplierToken is ERC20("pizzerias.finance", "pizzerias"), Ownable {
    using SafeMath for uint256;
    ...
    constructor() public {
        ...
        _mint(msg.sender, uint256(2500).mul(1e18));
    ...
    function startGame(address _liquidityPool, uint _seed1) external onlyOwner {
        ...
        require(_liquidityPool != address(0), 'Need the Pizzerias liquidity pool address');
