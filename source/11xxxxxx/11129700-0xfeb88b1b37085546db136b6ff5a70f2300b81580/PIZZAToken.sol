...
contract PIZZAToken is ERC777Pausable, IERC777Sender, IERC777Recipient, Ownable {
    constructor(uint256 initialSupply) public ERC777(){
    ...
    // callback of sent
    function tokensToSend(address operator, address from, address to, uint256 amount, bytes calldata userData, bytes calldata operatorData) public override {
    }
