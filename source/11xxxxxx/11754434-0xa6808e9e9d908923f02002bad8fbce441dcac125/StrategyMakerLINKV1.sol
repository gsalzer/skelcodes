...
abstract contract StrategyBase {
    ...
    function _swapUniswap(
        ...
        uint256 _sushiOut = UniswapRouterV2(sushiRouter).getAmountsOut(_amount, sushipath.length > 0? sushipath : path)[sushipath.length > 0? sushipath.length - 1 : path.length - 1];
