...
contract NFT20Pair is ERC20, IERC721Receiver, ERC1155Receiver {
    ...
    function onERC721Received(
        ...
        // require(nftType == 721, "forbidden");this is not needed so could remove right?
        ...
        require(
            ...
            "forbidden"
        ); //this is extra check but not sure if required
    ...
    function onERC1155Received(
        ...
        // require(nftType == 1155, "forbidden"); this is not needed so could remove right?
        require(nftAddress == msg.sender, "forbidden");
        require(
