...
contract ERC721Full is ERC721, ERC721Enumerable, ERC721Metadata,ERC721MetadataMintable {
    ...
    constructor () public ERC721Metadata("@STIM", "vYZY")  {
...
contract STIM is ERC721Full {
 ...
 address[] airDrop2 = [
    ...
    constructor (string memory uri) public {
     ...
     function stimAirDrop(uint numOfTokens, string memory uri) public onlyMinter returns(bool) {
