...
contract Punk is Context, IERC20, Ownable {
    ...
    string private constant _name = "Steampunk Protocol";
    ...
    function excludeAccount(address account) external onlyOwner() {
        ...
        require(account != address(this), 'Punk: The contract it self cannot be excluded');
        require(!_isExcluded[account], "Punk: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        require(_isExcluded[account], "Punk: Account is already included");
