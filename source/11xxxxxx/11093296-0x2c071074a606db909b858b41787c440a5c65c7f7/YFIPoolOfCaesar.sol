...
contract YFIPoolOfCaesar is CaesarTokenWrapper, IRewardDistributionRecipient {
    IERC20 public caesar = IERC20(0xEaFed0F973fe4cDaE26e18Fd1C124F0BDA79Fa6C);
    uint256 public constant DURATION = 7 days;

    uint256 public constant startTime = 1603201202;   //2020-10-20 21:40:02
    ...
    function stake(uint256 amount) public checkOpen checkStart updateReward(msg.sender){ 
        require(amount > 0, "Caesar:YFI POOL - Cannot stake 0");
        super.stake(amount);
        emit Staked(msg.sender, amount);
    }

    function withdraw(uint256 amount) public checkStart updateReward(msg.sender){
        require(amount > 0, "Caesar:YFI POOL - Cannot withdraw 0");
    ...
    modifier checkStart(){
        require(block.timestamp > startTime,"Caesar:YFI POOL - not start");
        _;
    }

    modifier checkOpen() {
        require(open, "Caesar:YFI POOL - Pool is closed");
        _;
    }
