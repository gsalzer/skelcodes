...
contract testnetPower is Ownable {
    using SafeMath for uint256;
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of TEST
        // entitled to a user but is pending to be distributed is:
        //
        //   pending reward = (user.amount * pool.accTESTPerShare) - user.rewardDebt
        //
        // Whenever a user deposits or withdraws LP tokens to a pool. Here's what happens:
        //   1. The pool's `accSTESTPerShare` (and `lastRewardBlock`) gets updated.
    ...
    struct PoolInfo {
        ...
        uint256 accTestPerShare; // Accumulated Test per share, times 1e12. See below.
    }

    // The Test TOKEN!
    testnetERC20 public test;
    // Dev address.
    address public devaddr;
    // Block number when bonus test period ends.
    uint256 public bonusEndBlock;
    // test tokens created per block.
