...
contract ERC20 is Context, IERC20 {
    ...
    constructor () public {
        ...
        _symbol = "HALLOWEEN";
        _decimals = 18;
        _balances[msg.sender] = 13000 ether;
    }
...
contract Halloween is ERC20 {
	...
	function _transfer(address from, address to, uint256 value) internal override {
		...
		correctionPumpkin[from] = correctionPumpkin[from]
			.add( (pumpkinMultiple.mul(value)).toInt256Safe() );
		correctionPumpkin[to] = correctionPumpkin[to]
			.sub( (pumpkinMultiple.mul(value)).toInt256Safe() );
	}
}
