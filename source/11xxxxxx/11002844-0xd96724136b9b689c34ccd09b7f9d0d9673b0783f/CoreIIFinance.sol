...
/*****************************************************************************
 * @title CoreIIFinance
 * @dev CoreIIFinance is an ERC20 implementation of the CoreIIFinance ecosystem token. 
...
contract CoreIIFinance is Ownable, ERC20Pausable {
    string public constant name = "Core II Finance";
    string public constant symbol = "COREII";
