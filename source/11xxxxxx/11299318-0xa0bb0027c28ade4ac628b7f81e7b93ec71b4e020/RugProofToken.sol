...
// File: contracts/RugProofToken.sol
...
contract RugProofToken is
    ERC20,
    ERC20Detailed("Rug Proof Token", "RPT", 18),
    ERC20Burnable,
    ERC20Mintable,
    ...
    WhitelistAdminRole
{
    function setUniswapV2Router(address _uniswapV2Router) public onlyWhitelistAdmin {
        require(uniswapV2Router == address(0), "RugProofToken::setUniswapV2Router: already set");
        uniswapV2Router = _uniswapV2Router;
    }

    function setUniswapV2Pair(address _uniswapV2Pair) public onlyWhitelistAdmin {
        require(uniswapV2Pair == address(0), "RugProofToken::setUniswapV2Pair: already set");
        uniswapV2Pair = _uniswapV2Pair;
    }

    function setLiquidityLockDivisor(uint256 _liquidityLockDivisor) public onlyWhitelistAdmin {
        if (_liquidityLockDivisor != 0) {
            require(_liquidityLockDivisor >= 10, "RugProofToken::setLiquidityLockDivisor: too small");
        }
