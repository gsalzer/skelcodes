...
contract AAC is ERC20Detailed ,Owned {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Align Assets Coin";
  string constant tokenSymbol = "AAC";
  uint8  constant tokenDecimals = 8;
  uint256 _totalSupply = 900000000000000000;
  ...
  constructor() public payable ERC20Detailed(tokenName, tokenSymbol, tokenDecimals) {
    _mint(0xc7226150750a782975c05E07f5f06BCe6738bf9c, _totalSupply);
  }
...
// ----------------------------------------------------------------------------
// ----------------------------------------------------------------------------
// ACC is a deflationary token that Burns 2% in every transactions
...
// ----------------------------------------------------------------------------
  ...
  function isSupplyLessThanOneBillion() public view returns(bool){
      uint256 OneBillion = 100000000000000000;
       if(_totalSupply <= OneBillion){
           return true;
       }
       return false;
  }
