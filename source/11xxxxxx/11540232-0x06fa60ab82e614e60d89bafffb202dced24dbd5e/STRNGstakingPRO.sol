...
contract STRNGstakingPRO is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // STRNG token contract address
    address public constant tokenAddress = 0x350a6A30C79Df3600C4e0E67DeAb0a64B645e2C2;
    
    // reward rate 1040.00% per year
    uint public constant rewardRate = 104000;
    uint public constant rewardInterval = 365 days;     // 20% per week
    ...
    uint private constant stakingAndDaoTokens = 6000e18;   // 6000 STRNG will be staked by owner
