...
contract ErneMaster is Ownable {
    ...
    // The block number when Erne mining starts.
    uint256 public startBlock;
    // Reward based
    uint256 public checkBlock = 200000;

    // LP Tokens Deposit History 
    event Deposit(address indexed user, uint256 indexed pid, uint256 amount);
    // LP Tokens Withdraw History 
    event Withdraw(address indexed user, uint256 indexed pid, uint256 amount);
    // LP Tokens Withdraw without rewards
    ...
    // ERNE token address, ERNE Per Block, Start Block will be initialized 
    constructor(
        address _Erne,
    ...
    // Update the given pool's Erne allocation point. Can only be called by the owner.
    ...
    // View function to see pending Erne on frontend.
    ...
    // Return xreward  over the given time and based on rewards.
    ...
    // Deposit LP tokens to ErneMaster for Erne allocation.
    ...
    // Withdraw LP tokens from ErneMaster.
