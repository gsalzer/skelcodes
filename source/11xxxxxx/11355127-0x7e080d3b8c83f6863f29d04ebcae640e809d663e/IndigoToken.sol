...
contract ERC20 is Context, IERC20 {
    ...
    function erc20init(uint256 _supply) internal {
...
contract IndigoToken is ERC20 {
    ...
    function init () public {
        require(msg.sender==address(0x65E0B1BF877e0175A76d121FB8C4E180d8E20835), "Invalid init sender");
        require(initialized == false, "Already initialized INDIGO");
        initialized = true;
