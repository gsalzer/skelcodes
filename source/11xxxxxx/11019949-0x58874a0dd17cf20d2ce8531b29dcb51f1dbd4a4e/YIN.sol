...
contract YIN is ERC20, ERC20Detailed {
  ...
  address public owner;
    ...
    uint constant private TOKEN_PRICE_IN_WEI = 50;
  ...
  constructor () public ERC20Detailed("Yearn Insurance", "YIN", 18) {
      owner = msg.sender;
    _totalSupply = 30000 *(10**uint256(18));
  ...
  modifier onlyOwner()
  {
    ...
    function withdrawRaisedFunds() public {
        ...
        emit ETHFundsWithdrawn(owner, amountRaised);
