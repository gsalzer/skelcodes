...
contract AYF is Context, IERC20, Ownable {
    ...
    string private _name = "AYF";
    string private _symbol = "AYF";
    ...
    //10% goes to lp of total collected
    uint256 public _lpRewardFromLiquidity = 90;
