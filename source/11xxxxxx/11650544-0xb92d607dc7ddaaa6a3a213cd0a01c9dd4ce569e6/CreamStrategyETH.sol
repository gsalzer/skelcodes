...
// File: contracts/strategies/CreamStrategyETH.sol
...
contract CreamStrategyETH is CompoundStrategy {
    string public override name = "Strategy-Compound-ETH";
    string public override version = "1.0.5";
