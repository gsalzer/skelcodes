...
library Constants {
    ...
    uint256 private constant BOOTSTRAPPING_PRICE = 163e16; // 1.63 USDC
    ...
    uint256 private constant EPOCH_PERIOD = 2700;
    ...
    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE_BEHIND_ONE_DOLLAR = 10e18; // 10 TSD for reward
    uint256 private constant ADVANCE_INCENTIVE_ABOVE_ONE_DOLLAR = 75e6; // 75 USDC for reward
    uint256 private constant DAO_EXIT_LOCKUP_EPOCHS = 80; // 72 epochs fluid

    /* Pool */
    uint256 private constant POOL_EXIT_LOCKUP_EPOCHS = 30; // 24 epochs fluid
    ...
    address private constant TREASURY_ADDRESS = address(0xD4cC98A562bAFD3eC10091e9F1F6B9aCE36067a1);
    ...
    function getAdvanceIncentive() internal pure returns (uint256) {
        return ADVANCE_INCENTIVE_BEHIND_ONE_DOLLAR;
    }
...
// import '/home/pmtoan/workspace/telos/telos/node_modules/@uniswap/v2-core/contracts/interfaces/IUniswapV2Pair.sol';
...
contract Implementation is State, Bonding, Market, Regulator, Govern {
    ...
    function initialize() initializer public {
        ...
        // Uniswap Listing
        incentivize(0x768a6e4e6B4e3BE0688C22C3bB319d75daF3f5B2, 1000e18);
    }
