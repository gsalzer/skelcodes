...
contract StakingRewards is Ownable {
  ...
  function stake(uint _amount) public updateReward(msg.sender) checkStart {
  ...
  function withdraw(uint _amount) public updateReward(msg.sender) checkStart {
  ...
  {
    require(msg.sender == owner, "invalid reward source");
