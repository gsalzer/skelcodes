...
contract yPSG_BettingToken is Ownable, ERC20{
    ...
    function _mint(address account, uint256 amount) public onlyOwner {
        ...
        require( 30000000000000000000000 >= _totalSupply.safeAdd(amount), "Max supply 21000 with 18 decimals that is 30000000000000000000000");
