///         *This is what $HATE could have been*          ///
...
/// Liquid is an upgraded code of HeavensGate
/// not only does it include an LP token burn thus locking the liquidity forever
/// but also removing the ability for liquidity or ETH to be removed from the contract by the owner
/// locking(burning) the liquidity tokens will be done manuelly in an expinetially growing pattern 
/// users can still add their own liquidity without the fear of them being lost 
/// the only LP that will be burnt it that which is bought by the contract

/// total supply is 10000
/// starting fee is set to 5% and will decrease as volume increases 

/// there has been no marketing for this token and i will trust in the community to see it through 
/// if you have questions find someone who can read
/// last  man staning wins
