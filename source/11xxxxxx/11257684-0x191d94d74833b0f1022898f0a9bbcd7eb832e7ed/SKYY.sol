...
_____/\\\\\\\\\\\____/\\\________/\\\__/\\\________/\\\__/\\\________/\\\_        
 ___/\\\/////////\\\_\/\\\_____/\\\//__\///\\\____/\\\/__\///\\\____/\\\/__       
  __\//\\\______\///__\/\\\__/\\\//_______\///\\\/\\\/______\///\\\/\\\/____      
   ___\////\\\_________\/\\\\\\//\\\_________\///\\\/__________\///\\\/______     
    ______\////\\\______\/\\\//_\//\\\__________\/\\\_____________\/\\\_______    
     _________\////\\\___\/\\\____\//\\\_________\/\\\_____________\/\\\_______   
      __/\\\______\//\\\__\/\\\_____\//\\\________\/\\\_____________\/\\\_______  
       _\///\\\\\\\\\\\/___\/\\\______\//\\\_______\/\\\_____________\/\\\_______ 
        ___\///////////_____\///________\///________\///______________\///________
...
contract GlobalsAndUtility is ERC20 {
    ...
    */
    ...
    /* ETH allocation share address */
    address payable internal LIQUIDITY_ADDR = 0xDFa0370E3D5199D56E2BB28765c204d4958eaeEA;

    uint8 internal LAST_FLUSHED_DAY = 1;

    /* ERC20 constants */
    string public constant name = "SKYYield.io";
    string public constant symbol = "SKYY";
    uint8 public constant decimals = 8;

    /* Suns per Satoshi = 10,000 * 1e8 / 1e8 = 1e4 */
    uint256 private constant SUNS_PER_E2X = 10 ** uint256(decimals); // 1e8

    /* Time of contract launch (13-11-2020 T20:00:00Z) */
    
    uint256 internal LAUNCH_TIME = 1605297600;
        ...
        external
    {
        ...
        require(g._currentDay > CLAIM_PHASE_START_DAY, "SKYY: Too early");

        if (beforeDay != 0) {
            require(beforeDay <= g._currentDay, "SKYY: beforeDay cannot be in the future");
    ...
    {
        require(beginDay < endDay && endDay <= globals.dailyDataCount, "SKYY: range invalid");
        ...
        view
    {
        ...
        require(stakeIdParam == stRef.stakeId, "SKYY: stakeIdParam not in stake");
...
contract StakeableToken is GlobalsAndUtility {
        ...
        external
    {
        ...
        require(newStakedDays >= MIN_STAKE_DAYS, "SKYY: newStakedDays lower than minimum");
        ...
        external
    {
        ...
        require(stakeLists[stakerAddr].length != 0, "SKYY: Empty stake list");
        require(stakeIndex < stakeLists[stakerAddr].length, "SKYY: stakeIndex invalid");
        ...
        require(g._currentDay >= st._lockedDay + st._stakedDays, "SKYY: Stake not fully served");

        /* Stake must still be locked */
        require(st._unlockedDay == 0, "SKYY: Stake already unlocked");
        ...
        external
    {
        ...
        /* require() is more informative than the default assert() */
        require(stakeListRef.length != 0, "SKYY: Empty stake list");
        require(stakeIndex < stakeListRef.length, "SKYY: stakeIndex invalid");
        ...
        internal
    {
        ...
        require(newStakedDays <= MAX_STAKE_DAYS, "SKYY: newStakedDays higher than maximum");
        ...
        require(newStakeShares != 0, "SKYY: newStakedSuns must be at least minimum shareRate");
        ...
        returns (uint256 bonusSuns)
    {
        /*
            ...
            Bonus percentage scaled 0% to 10% for the first 7M SKYY of stake.
...
contract TransformableToken is StakeableToken {
        ...
        payable
    {
        ...
        require(rawAmount != 0, "SKYY: Amount required");
    ...
    function xfLobbyExit(uint256 enterDay, uint256 count)
        external
    {
        require(enterDay < _currentDay(), "SKYY: Round is not complete");
        ...
        if (count != 0) {
            require(count <= qRef.tailIndex - headIndex, "SKYY: count invalid");
            endIndex = headIndex + count;
        } else {
            endIndex = qRef.tailIndex;
            require(headIndex < endIndex, "SKYY: count invalid");
        }
        ...
        external
    {
        ...
        require(address(this).balance != 0, "SKYY: No value");

        require(LAST_FLUSHED_DAY < _currentDay(), "SKYY: Invalid day");
        ...
        returns (uint256 rawAmount, address referrerAddr)
    {
        ...
        require(entry.rawAmount != 0, "SKYY: Param invalid");
...
contract SKYY is TransformableToken {
    constructor()
        public
    {
