...
contract BzxLiquidate is Ownable {
    ILock3rV1 public constant LK3R = ILock3rV1(
        0xe3f3869dDD41C23Eff3630F58E5bFA584C770D67
    );
    IBZx public constant BZX = IBZx(
        address(0xD8Ee69652E4e4838f2531732a46d1f7F584F0b7f)
    );
    // address public constant  PROFIT = 0xD8Ee69652E4e4838f2531732a46d1f7F584F0b7f; 

    modifier upkeep() {
        require(
            LK3R.isLocker(msg.sender),
            "::isLocker: locker is not registered"
        );
        _;
