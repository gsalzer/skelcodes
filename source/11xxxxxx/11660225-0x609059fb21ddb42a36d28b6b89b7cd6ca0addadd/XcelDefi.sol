...
contract XcelDefi is ERC20Detailed, ERC20Pausable, ERC20Burnable, Ownable {

  uint256 public constant INITIAL_SUPPLY = 277 * (10**6) * (10**18);

  uint256 public vestingSupply = 37.5 * (10**6) * (10**18);

  uint256 public publicSaleSupply = 177 * (10**6) * (10**18);

  uint256 public foundationSupply = 37.5 * (10**6) * (10**18);

  uint256 public reserveSupply = 25 * (10**6) * (10**18);
...
//safety measure , disputes are visible here and is expected to resolve via community concensus.
  ...
  constructor(string memory _name,
    ...
    public {
      ...
      transfer(_vestingAddress, vestingSupply);
  ...
  **/
  ...
  /** get locked/unlocked satus of the account
  **/
