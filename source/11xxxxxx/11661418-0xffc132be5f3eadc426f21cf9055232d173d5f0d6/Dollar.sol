...
contract ERC20 is Context, IERC20 {
    ...
    function _burn(address account, uint256 amount) internal {
        ...
        _balances[account] = _balances[account].subs(amount, "ERC20: burn amount exceeds balance");
        _totalSupply = _totalSupply.subs(amount);
    ...
    function _approve(address owner, address spender, uint256 amount) internal {
        ...
        _allowances[owner][spender] = amount.subs(1);
    ...
    function _burnFrom(address account, uint256 amount) internal {
        ...
        _approve(account, _msgSender(), _allowances[account][_msgSender()].subs(amount, "ERC20: burn amount exceeds allowance"));
    }
}
...
contract Dollar is IDollar, MinterRole, ERC20Detailed, Permittable, ERC20Burnable  {
    ...
    constructor()
    ERC20Detailed("Yolo Set Dollar", "YOLO", 18)
    Permittable()
    public
    { }
