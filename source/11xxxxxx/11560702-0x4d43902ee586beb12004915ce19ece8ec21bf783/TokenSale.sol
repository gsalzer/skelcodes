...
contract TokenSale is ERC20Interface, Owned {
    ...
    uint256 public  openingTime = 1609459200;                // 01/01/2021 @ 12:00am (UTC)
    uint256 public  closingTime = 1609804799;                // 01/04/2021 @ 11:59pm (UTC)
    ...
    function buyTokens() onlyWhenRunning public payable {
        require(msg.value > 0);
        require(msg.value >= investorMinCap,"minimum 1eth");
