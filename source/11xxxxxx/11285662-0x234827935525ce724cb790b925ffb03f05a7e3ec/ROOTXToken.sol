...
-CLONE OF ROOT 
-NO MINT, NO RUG,
-10% burn, 5% burn to air, 5% burn to liquidity
-1000000000 tokens, 20000000 limits per tx
*/
...
contract ROOTXToken is ERC20, Ownable {
    /*
    ...
    */
    ...
    constructor() public ERC20("ROOTXToken", "ROOTX") {
        ...
        uint128 _minTokensBeforeSwap = 4000000 * 10**18;
        uint256 _maxTokensPerTx = 20000000 * 10**18;
    ...
    */
    function _transfer(
        ...
        if(from != owner()) {
            require(amount <= maxTokensPerTx, "ERC20: transfer amount exceeds 20000000 limit");
        }
        else{
