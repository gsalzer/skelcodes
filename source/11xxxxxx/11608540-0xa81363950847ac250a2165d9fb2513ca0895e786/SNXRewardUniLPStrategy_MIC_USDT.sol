...
// File: contracts/strategies/SNXRewards/SNXRewardUniLPStrategy_MIC_USDT.sol

pragma solidity 0.5.16;



contract SNXRewardUniLPStrategy_MIC_USDT is SNXRewardUniLPStrategyV2 {
  ...
  address public constant __rewardToken = __mis;
  ...
  public {
    ...
    // token0 is MIC, token1 is USDT
    uniswapRoutes[uniLPComponentToken0] = [__mis, __usdt, __mic];
    uniswapRoutes[uniLPComponentToken1] = [__mis, __usdt];
  }
}
