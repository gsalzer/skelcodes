...
contract DiamondofEthereum is StandardToken {

  string public constant name = "Diamond of Ethereum";
  string public constant symbol = "EDM";
  uint8 public constant decimals = 18;


  uint256 public constant INITIAL_SUPPLY = 91431 * (10 ** uint256(decimals));
