...
library Constants {
    ...
    uint256 private constant _presaleIndividualCap = 5 ether;
    uint256 private constant _presaleCap = 2 * 10**5 * 10**9;
    uint256 private constant _maxPresaleGas = 1000000000000;

    uint256 private constant _epochLength = 6 hours;
    ...
    address payable private constant _deployerAddress = 0xE8059890d5c6a86D844eF6A76281C41c13509A14;
