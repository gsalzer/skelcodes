...
contract MvsToken is ERC20("GeneToken", "GENE"), Ownable {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "MVS::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "MVS::delegateBySig: invalid nonce");
        require(now <= expiry, "MVS::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "MVS::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying MVSs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "MVS::_writeCheckpoint: block number exceeds 32 bits");
...
contract MasterChef is Ownable {
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 mvsReward = multiplier
            ...
            .mul(pool.allocPoint)
            .div(totalAllocPoint);
        mvs.mint(devaddr, mvsReward.mul(15).div(100)); //15%
