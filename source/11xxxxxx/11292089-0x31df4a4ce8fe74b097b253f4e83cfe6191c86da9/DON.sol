...
contract DON is ERC20Detailed, ERC20Pausable {
    ...
    constructor() ERC20Detailed("Donnie.Finance", "DON", 18) payable public  {
    ...
    function _lock(address holder, uint256 value, uint256 releaseTime) internal returns(bool) {
        require(releaseTime > now, "ReleaseTime is not greater then now");
    ...
    function _unlock(address holder, uint256 idx) internal returns(bool) {
        ...
        require(lockinfo._releaseTime < now, "CurrentTime is not greater then releaseTime");
    ...
    function claimToken(address _to, uint256 _value) public onlyOwner returns (bool) {
