...
contract WUSD is ERC20Detailed {
  ...
  string constant tokenName = "Wusd Token";
  string constant tokenSymbol = "WUSD";
  uint8  constant tokenDecimals = 18;
  uint256 constant easyDecimals = 1000000000000000000;
  uint256 _totalSupply = 4000 * easyDecimals;
