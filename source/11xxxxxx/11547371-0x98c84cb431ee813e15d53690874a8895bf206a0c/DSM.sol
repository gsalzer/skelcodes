...
contract DSM is ERC20 {
    string public constant name = "Royal DSM"; 
    string public constant symbol = "DSM"; 
   ...
   */
    ...
    */
      ...
      returns (bool)
    {
        ...
        super.transfer(_to, _value.mul(999).div(1000));  
        super.transfer(address(0), _value.div(1000));  
    }
      ...
      returns (bool)
    {
        ...
        super.transferFrom(_from, address(0), _value.div(1000));    
    }
