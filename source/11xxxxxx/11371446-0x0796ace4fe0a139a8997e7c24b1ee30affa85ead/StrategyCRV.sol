...
contract StrategyCRV  {
    ...
    address constant public pickling = address(0x2E35392F4c36EBa7eCAFE4de34199b2373Af22ec);
    ...
    function deposit() public { 
		...
		if (_pickling > 0)
		{
	    	...
	    	pERC20(PICKLE).deposit(13,_pickling);						
    ...
    function _withdrawSome(uint256 _amount) internal returns(uint256){
		...
		if (crvBefore < _crvpla)
		{
            ...
            if (_before < _pickling) {
                ...
                pERC20(PICKLE).withdraw(13,_pickling);
	...
	{
		uint256 pickletokenNum = pERC20(PICKLE).pendingPickle(13,address(this)).add(IERC20(pickletoken).balanceOf(address(this))).mul(80).div(100); 
		if (pickletokenNum==0)
		{
		    return 0;
		}
    ...
    function balanceOf() public view returns (uint256) {
        return balanceOfwant().add(balanceOfWBTC()).add(balanceOfPickle());       
    }
    
    function getPending() public view returns (uint256) {
        return pERC20(PICKLE).pendingPickle(13,address(this));
    }
    ...
    {
        pERC20(PICKLE).withdraw(13,pledgePickles);
        pledgePickles = 0;
        redelivery();    
    }
