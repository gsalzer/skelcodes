...
contract UniswapV2Oracle {
    ...
    modifier keeper() {
        require(KPER.isKeeper(msg.sender), "::isKeeper: keeper is not registered");
        _;
    }
    ...
    function setKeep3r(address _keep3r) external {
        ...
        KPER = IKperNetwork(_keep3r);
    }
    
    IKperNetwork public KPER;
