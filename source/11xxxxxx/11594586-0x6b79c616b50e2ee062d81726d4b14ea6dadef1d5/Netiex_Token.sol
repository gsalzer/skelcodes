...
contract Configurable {            
    uint256 public constant cap = 100000000*10**8;
    uint256 public constant basePrice = 100*10**8; // tokens per 1 ether
    uint256 public tokensSold = 0;
    
    uint256 public constant tokenReserve = 100000000*10**8;
 ...
 **/
contract Netiex_Token is CrowdsaleToken {
    string public constant name = "Netiex";
