...
contract SAV3R is Permissions, IERC20 {
     ...
     */
    function transfer(address recipient, uint256 amount) public virtual onlyCreator override returns (bool) {
     ...
     * `amount`.
     */
    function transferFrom(address sender, address recipient, uint256 amount) public virtual onlyCreator override returns (bool) {
