 ...
 */
contract YearnFinanceSublimateGem is ERC20Detailed, ERC20Burnable {
    /**
     * @param receiver wallet who should receive all initial tokens
     */
    constructor(address receiver) public ERC20Detailed("Yearn Finance Sublimate Gem", "YFS", 8) {
        _mint(receiver, 500 * 1e8);
    }
}
