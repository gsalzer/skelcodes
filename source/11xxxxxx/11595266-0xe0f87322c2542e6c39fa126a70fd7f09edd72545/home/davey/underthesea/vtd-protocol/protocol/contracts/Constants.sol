...
library Constants {
    ...
    /* Bootstrapping */
    uint256 private constant BOOTSTRAPPING_PERIOD = 36; // 60 epochs TODO
    uint256 private constant BOOTSTRAPPING_PERIOD_PHASE1 = 11; // 12 epochs to speed up deployment TODO
    ...
    //TODO 0xBD2F0Cd039E0BFcf88901C98c0bFAc5ab27566e3
    address private constant USDC = address(0xBD2F0Cd039E0BFcf88901C98c0bFAc5ab27566e3); 
    uint256 private constant ORACLE_RESERVE_MINIMUM = 1e9; // 1,000 pegged token, 1e9 TODO
    ...
    uint256 private constant EPOCH_BASE = 7200; //two hours TODO
    uint256 private constant EPOCH_GROWTH_CONSTANT = 12000; //3.3 hrs
    uint256 private constant P1_EPOCH_BASE = 300; // TODO
    uint256 private constant P1_EPOCH_GROWTH_CONSTANT = 2000; // TODO
    uint256 private constant ADVANCE_LOTTERY_TIME = 120; // 2 minutes

    /* Governance */
    uint256 private constant GOVERNANCE_PERIOD = 12; // 1 dayish governance period TODO
    ...
    uint256 private constant DAO_EXIT_LOCKUP_EPOCHS = 18; // 18 epoch fluid TODO

    /* Pool */
    uint256 private constant POOL_EXIT_LOCKUP_EPOCHS = 9; // 9 epoch fluid TODO
