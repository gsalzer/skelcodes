...
contract EarthquakeFinance is ERC20 {
    using SafeMath for uint256;
    ...
    /// @notice uniswap pair for ETHQ/ETH
    address uniswapPair;

    /// @notice Whether or not this token is first in uniswap ETHQ<>ETH pair
    bool isThisToken0;
