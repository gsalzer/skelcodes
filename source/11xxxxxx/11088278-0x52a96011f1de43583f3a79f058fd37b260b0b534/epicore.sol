...
interface IFeeApprover {
    ...
    function setepicoreTokenAddress(address _epicoreTokenAddress) external;
...
contract NBUNIERC20 is Context, INBUNIERC20, Ownable {
    ...
    uint256 public constant initialSupply = 1000e18;
    ...
    string public liquidityGenerationParticipationAgreement = "I agree that the developers and affiliated parties of the epicore team are not responsible for your funds";
    ...
    function addLiquidityToUniswapepicorexWETHPair() public {
    ...
    function _transfer(
        ...
        if(transferToFeeDistributorAmount > 0 && feeDistributor != address(0)){
            ...
            if(feeDistributor != address(0)){
                IepicoreVault(feeDistributor).addPendingRewards(transferToFeeDistributorAmount);
            }
        }
    }
...
// epicoreToken with Governance.
contract epicore is NBUNIERC20 {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "epicore::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "epicore::delegateBySig: invalid nonce");
        require(now <= expiry, "epicore::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "epicore::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying epicore tokens (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "epicore::_writeCheckpoint: block number exceeds 32 bits");
