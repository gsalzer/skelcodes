...
// File: contracts\interfaces\IProposer.sol
...
contract Jumpstart is Proxiable, JumpstartDataLayout{
    ...
    function updateVotesUsed(address voter, uint256 amount) public {
        ...
        //check if votes should be reset
