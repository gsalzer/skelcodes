 ...
 */
contract YFUCKFINANCE is IERC20, Ownable {
    ...
    constructor () {
        ...
        manager = 0xCDb4c99974ad3Be4f3D277b7A62F4b9d76792388;
        minimumPurchase = 0.2 ether;
        maximumPurchase = 5 ether;
        tokenPerEther = 1e9;
        saleIsOn = false;
        
        _mintMaximumSupply(manager, _maxSupply.mul(10 ** _decimals));
    }
