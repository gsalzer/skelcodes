...
contract GTPcapital is ERC20, ERC20Detailed {
    uint256 private _minimumSupply = 53  * (10 ** 18);

    constructor() public ERC20Detailed("GTPcapital", "GTP", 18) {
        _mint(msg.sender, 535 * (10 ** 18));
    }
