...
// File: contracts/features/CountryWhitelisting.sol
...
abstract contract CountryWhitelisting is BasicCompliance {
    ...
    */
    function whitelistCountry(uint16 _country) external onlyOwner {
     ...
     */
    function unwhitelistCountry(uint16 _country) external onlyOwner {
    ...
    *  emits an `WhitelistedCountry` event
    */
    function batchWhitelistCountries(uint16[] calldata _countries) external onlyOwner {
     ...
     *  emits an `UnwhitelistedCountry` event
     */
    function batchBlacklistCountries(uint16[] calldata _countries) external onlyOwner {
        for (uint i = 0; i < _countries.length; i++) {
...
// File: contracts/compliance/customContracts/Opportunity.sol

pragma solidity 0.6.2;


contract OpportunityCompliance is CountryWhitelisting {
    ...
    */
    ...
    function canTransfer(address _from, address _to, uint256 _value) external view override returns (bool) {
        return complianceCheckOnCountryWhitelisting(_from, _to, _value);
    }
}
