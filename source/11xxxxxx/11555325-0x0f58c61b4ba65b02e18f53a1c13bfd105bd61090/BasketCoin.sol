...
contract BasketCoin {
	...
	uint256 constant private INITIAL_SUPPLY = 21e24; // 21M
	uint256 constant private BURN_RATE = 2; // 2% per tx
	uint256 constant private SUPPLY_FLOOR = 10; // 10% of 21M = 2.1M
	uint256 constant private MIN_FREEZE_AMOUNT = 1e22; // 10000

	string constant public name = "BasketCoin";
	string constant public symbol = "BSKT";
