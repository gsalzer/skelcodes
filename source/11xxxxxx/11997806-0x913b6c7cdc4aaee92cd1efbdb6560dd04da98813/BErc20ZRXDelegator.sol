...
/**
 * @title Bird's BErc20ZRXDelegator Contract
 * @notice BTokens which wrap an EIP-20 underlying and delegate to an implementation
 */
contract BErc20ZRXDelegator is BTokenInterface, BErc20Interface, BDelegatorInterface {
    /**
     ...
     */
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == admin, "BErc20ZRXDelegator::_setImplementation: Caller must be admin");
   ...
   /**
    ...
    function () external payable {
        require(msg.value == 0,"BErc20ZRXDelegator:fallback: cannot send value to fallback");
