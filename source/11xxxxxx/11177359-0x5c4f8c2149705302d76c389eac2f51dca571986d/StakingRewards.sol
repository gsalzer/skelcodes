...
contract RewardsDistributionRecipient {
    ...
    function changeRate(uint256 reward) external;
...
contract StakingRewards is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard {
    ...
    function changeRate(uint256 reward) external onlyRewardsDistribution updateReward(address(0)) {
    ...
    // Added to support recovering LP Rewards from other systems such as BAL to be distributed to holders and recover lost funds
    function recoverERC20(address tokenAddress, uint256 tokenAmount) external  {
        require(msg.sender == owner, "Yu are not the owner");
