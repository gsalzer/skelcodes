 ...
 */
contract BitWellNFT is  Context, Ownable, AccessControl, ERC1155Burnable, ERC1155Pausable {
     ...
     */
    constructor(string memory _uri, string memory _symbol, string memory _name) public ERC1155(_uri) {
        name = _name;
        symbol = _symbol;
