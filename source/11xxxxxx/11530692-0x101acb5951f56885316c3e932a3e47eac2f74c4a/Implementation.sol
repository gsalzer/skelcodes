...
library Constants {
   /* Chain */
    ...
    /* Bootstrapping */
    uint256 private constant BOOTSTRAPPING_PERIOD = 126; // 126 epochs
    uint256 private constant BOOTSTRAPPING_PRICE = 132e16; // 1.32 USDC
    ...
    /* Bonding */
    uint256 private constant INITIAL_STAKE_MULTIPLE = 1e6; // 100 ZSD -> 100M ZSDS
    ...
    uint256 private constant EPOCH_START = 1609005600;
    uint256 private constant EPOCH_PERIOD = 14400;

    /* Governance */
    uint256 private constant GOVERNANCE_PERIOD = 18;
    uint256 private constant GOVERNANCE_QUORUM = 33e16; // 33%
    uint256 private constant GOVERNANCE_SUPER_MAJORITY = 66e16; // 66%
    uint256 private constant GOVERNANCE_EMERGENCY_DELAY = 6; // 6 epochs

    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 75e18; // 75 ZSD
    uint256 private constant DAO_EXIT_LOCKUP_EPOCHS = 24; // 24 epochs fluid

    /* Pool */
    uint256 private constant POOL_EXIT_LOCKUP_EPOCHS = 9; // 9 epochs fluid
    ...
    /* Regulator */
    uint256 private constant SUPPLY_CHANGE_DIVISOR = 9e18; // 9%
    uint256 private constant SUPPLY_CHANGE_LIMIT = 6e16; // 6%
...
// import '/Users/khuyen/Documents/ProjectSecret/zsd-mainet/node_modules/@uniswap/v2-core/contracts/interfaces/IUniswapV2Pair.sol';
...
contract Implementation is State, Bonding, Market, Regulator, Govern {
    ...
    function initialize() initializer public {
        //250 Zero Dao
        mintToAccount(0xa6c5c85e1194C0Da3552c6fd8AefA4294209A280 , 250e18);
        //500 Zero Liquidity
        mintToAccount(0xeeb8A28123790444588F21958822A7286a28a5F3, 500e18);
    }
