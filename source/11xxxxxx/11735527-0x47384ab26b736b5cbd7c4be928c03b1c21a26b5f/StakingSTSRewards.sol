...
contract StakingSTSRewards is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard, Pausable {
    ...
    function setRewardRate(uint256 _duration) public onlyOwner{
        rewardRate = stakingToken.balanceOf(address(this)).div(_duration);
    }
