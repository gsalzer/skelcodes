// File: browser/github/JonahGlasgow/liquidity-staker/contracts/RewardsDistributionRecipient.sol
...
// File: browser/github/JonahGlasgow/liquidity-staker/contracts/interfaces/IStakingRewards.sol
...
// File: browser/github/JonahGlasgow/openzeppelin-contracts/contracts/utils/ReentrancyGuard.sol
...
// File: browser/github/JonahGlasgow/openzeppelin-contracts/contracts/utils/Address.sol
...
// File: browser/github/JonahGlasgow/openzeppelin-contracts/contracts/token/ERC20/SafeERC20.sol
...
// File: browser/github/JonahGlasgow/openzeppelin-contracts/contracts/token/ERC20/IERC20.sol
...
// File: browser/github/JonahGlasgow/openzeppelin-contracts/contracts/token/ERC20/ERC20Detailed.sol
...
// File: browser/github/JonahGlasgow/openzeppelin-contracts/contracts/math/SafeMath.sol
...
// File: browser/github/JonahGlasgow/openzeppelin-contracts/contracts/math/Math.sol
...
// File: browser/github/JonahGlasgow/openzeppelin-contracts/contracts/ownership/Ownable.sol
...
// File: browser/github/JonahGlasgow/liquidity-staker/contracts/StakingRewards.sol
...
contract StakingRewards is Ownable,  IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard {
   ...
   // for vetting the staking pool and or unknown project.
    ...
    function getReward() public nonReentrant updateReward(msg.sender) {
        ...
        if (block.timestamp > depositTime[msg.sender] + minStakingTime) {
            depositTime[msg.sender] = block.timestamp;
...
// File: browser/github/JonahGlasgow/liquidity-staker/contracts/StakingRewardsFactory.sol
...
contract StakingRewardsFactory is Ownable, ReentrancyGuard{
    ...
    if (OwnerAddress == msg.sender)    
     ...
     // Withdraw extra tokens from staking pool after rebase 
