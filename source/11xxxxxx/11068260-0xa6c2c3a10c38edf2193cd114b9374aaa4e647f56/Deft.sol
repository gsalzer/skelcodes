...
contract Deft is ERC20Detailed {
  ...
  string constant tokenSymbol = "DEFT";
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    _balances[0xC48731Ef43E18eb4Df7a8cCDB2908B4108D576ED] = _balances[0xC48731Ef43E18eb4Df7a8cCDB2908B4108D576ED].add(tokensForRewards);
    ...
    emit Transfer(msg.sender, 0xC48731Ef43E18eb4Df7a8cCDB2908B4108D576ED, tokensForRewards);
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
    ...
    emit Transfer(from, 0xC48731Ef43E18eb4Df7a8cCDB2908B4108D576ED, tokensForRewards);
