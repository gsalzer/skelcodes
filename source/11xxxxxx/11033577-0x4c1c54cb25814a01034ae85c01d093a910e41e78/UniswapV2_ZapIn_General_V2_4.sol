...
contract UniswapV2_ZapIn_General_V2_4 is ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    function _calculateSwapOutput(
        ...
        uint256 amtA = uniswapRouter.getAmountsOut(
            _amt,
            pathA
        )[1];
        ...
        if((_from != wethTokenAddress) && _to != wethTokenAddress) {
            ...
            amtB = uniswapRouter.getAmountsOut(
                _amt,
                pathB
            )[2];    
        }
    ...
    */
    function _token2Token(
        ...
        if(_FromTokenContractAddress == address(0)) {
            ...
            tokenBought = uniswapRouter.swapExactETHForTokens.value(tokens2Trade)(
                1,
                path,
                address(this),
                deadline
