...
/*  
    Ethverse Cities : https://ethverse.com
 ...
 * @dev see https://eips.ethereum.org/EIPS/eip-721
 */
contract EthverseCity is Context, Ownable, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    */
    ...
    mapping (uint256 => CityMeta) internal city;
    mapping (string => uint256) internal cityNames;
    ...
    function createCity(string calldata _cityName, string calldata _ip, address _governor, string calldata _uri) external onlyOwner returns(uint256 _id) {
        ...
        if(createCityFee > 0){
            IETHVBasic(ethv).transferFrom(msg.sender, address(this), createCityFee);
    ...
    function updateCreateCityFee(uint256 _fee) external onlyOwner {
        createCityFee = _fee;
    }
    
    
    function updateETHV(address _address) external onlyOwner {
        ethv = _address;
    }
}
