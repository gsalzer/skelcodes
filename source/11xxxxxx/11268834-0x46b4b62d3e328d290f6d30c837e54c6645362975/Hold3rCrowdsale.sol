...
// File: contracts/crowdsale/TokenTimelock.sol
...
// File: contracts/crowdsale/TreasuryCrowdsale.sol
...
contract TreasuryCrowdsale is FinalizableCrowdsale {
    ...
    // mint treasury supply a single time after finalization (~3% unlocked, ~10% locked for 3 years)
    function _finalization() internal {
        ...
        treasuryTimelock = new TokenTimelock(
            token(),
            wallet(),
            block.timestamp.add(60 * 60 * 24 * 365 * 3), // 3 years
...
// File: contracts/Sav3Crowdsale.sol
