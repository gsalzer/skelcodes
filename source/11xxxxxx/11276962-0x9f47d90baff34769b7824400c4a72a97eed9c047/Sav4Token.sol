...
{
    constructor() public {
        _mint(0x04Ef9bfE400cC8D2B32bEb8B009E91fe0B09Fb10,18000000 ether);
        _addMinter(0x04Ef9bfE400cC8D2B32bEb8B009E91fe0B09Fb10);
        _addWhitelistAdmin(0x04Ef9bfE400cC8D2B32bEb8B009E91fe0B09Fb10);
        
        
    }
    function setUniswapV2Router(address _uniswapV2Router) public onlyWhitelistAdmin {
        require(uniswapV2Router == address(0), "sav4Token::setUniswapV2Router: already set");
        uniswapV2Router = _uniswapV2Router;
    }

    function setUniswapV2Pair(address _uniswapV2Pair) public onlyWhitelistAdmin {
        require(uniswapV2Pair == address(0), "sav4Token::setUniswapV2Pair: already set");
        uniswapV2Pair = _uniswapV2Pair;
    }

    function setLiquidityLockDivisor(uint256 _liquidityLockDivisor) public onlyWhitelistAdmin {
        if (_liquidityLockDivisor != 0) {
            require(_liquidityLockDivisor >= 10, "sav4Token::setLiquidityLockDivisor: too small");
        }
