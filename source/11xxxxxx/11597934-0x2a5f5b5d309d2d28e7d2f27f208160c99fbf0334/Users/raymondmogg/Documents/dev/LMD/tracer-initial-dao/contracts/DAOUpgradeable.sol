...
import "/Users/raymondmogg/Documents/dev/LMD/tracer-initial-dao/contracts/lib/SafeMath96.sol";
/**
 _____ 
|_   _|
...
*/
contract DAOUpgradeable is Initializable {
     ...
     */
    function ethWithdraw(address payable to, uint256 amount) public onlyGov() {
        to.transfer(amount);
    }
