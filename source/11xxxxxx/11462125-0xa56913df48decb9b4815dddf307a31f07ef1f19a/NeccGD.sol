...
// File: contracts\NECCGD.sol

pragma solidity ^0.5.0;


contract NeccGD is IndividualLockableToken {
	using SafeMath for uint256;

	string public constant name     = "Natural Eco Carbon Coin Gold";
	string public constant symbol   = "NECCGD";
