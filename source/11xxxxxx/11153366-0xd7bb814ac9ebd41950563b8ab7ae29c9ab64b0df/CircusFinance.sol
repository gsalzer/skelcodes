...
// File: contracts/CircusFinance.sol

// Circus Finance (CRC) with Governance Alpha
contract CircusFinance is ERC20 {
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying CRCs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "CRC::_writeCheckpoint: block number exceeds 32 bits");
