...
contract RRIA is StandardToken {

  string public constant name = "RRIA";
  string public constant symbol = "RRIA";
  uint8 public constant decimals = 18;


  uint256 public constant INITIAL_SUPPLY = 92416 * (10 ** uint256(decimals));
