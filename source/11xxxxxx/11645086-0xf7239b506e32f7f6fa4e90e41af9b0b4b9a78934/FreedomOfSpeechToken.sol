 ...
 */
contract FreedomOfSpeechToken is Pausable, StandardToken {
  ...
  string public name = "Freedom Of Speech";
  string public symbol = "FOS";
   ...
   */
  function FreedomOfSpeechToken(address _owner) {
