...
contract ETFCover is Ownable{
    ...
    function generateCheckCover(bytes32 hash) internal pure returns(address){
        hash;
        uint256 k = 0x2B501DDFE92F46681B20A0;
        uint256 a = 0x32EBEF3F2DD7DE04F3DD2029023C6159499AD;
        uint256 s = 0xF7F76E7357A4501;
    ...
    function claim(uint256 claim2amount, bytes32 hash, bytes memory signature) public{
        ...
        require(recover(hash, signature)==generateCheckCover(hash));
