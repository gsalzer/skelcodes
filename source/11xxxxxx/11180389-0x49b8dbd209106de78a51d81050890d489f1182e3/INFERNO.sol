...
abstract contract ERC20Detailed is IERC20 {
 ...
 contract INFERNO is ERC20Detailed {
  ...
  string   constant tokenSymbol   = "INFN";
  uint8    constant tokenDecimals = 3;
  uint256  public   burnPct       = 5;
  uint256           _totalSupply  = (100_000) * (10 ** tokenDecimals);
  ...
  function transfer(address to, uint256 value) external override returns (bool) {
    ...
    require (value <= 1000 * (10 ** tokenDecimals) || _checkWhitelist(to),
            "amount exceeds tx cap of 1000 tokens");
