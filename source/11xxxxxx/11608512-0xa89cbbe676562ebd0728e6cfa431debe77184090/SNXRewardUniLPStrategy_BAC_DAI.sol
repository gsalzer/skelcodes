...
// File: contracts/strategies/SNXRewards/SNXRewardInterface.sol
...
// File: contracts/strategies/SNXRewards/SNXRewardUniLPStrategyV2.sol
...
contract SNXRewardUniLPStrategyV2 is IStrategy, Controllable, RewardTokenProfitNotifier {
  ...
  constructor(
    ...
    address _rewardPool,
    address _rewardToken,
    address _routerV2 // allows for liquidating on Sushiswap
  )
...
// File: contracts/strategies/SNXRewards/SNXRewardUniLPStrategy_BAC_DAI.sol

pragma solidity 0.5.16;



contract SNXRewardUniLPStrategy_BAC_DAI is SNXRewardUniLPStrategyV2 {
  ...
  address public constant __underlying = address(0xd4405F0704621DBe9d4dEA60E128E0C3b26bddbD);
  address public constant __rewardPool = address(0x067d4D3CE63450E74F880F86b5b52ea3edF9Db0f);
  address public constant __rewardToken = __bas;
  ...
  public {
    require(IVault(_vault).underlying() == __underlying, "Underlying mismatch");
    // token0 is BAC, token1 is DAI
    uniswapRoutes[uniLPComponentToken0] = [__bas, __dai, __bac];
    uniswapRoutes[uniLPComponentToken1] = [__bas, __dai];
  }
}
