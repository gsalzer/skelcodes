...
contract StrategyCurvea3CRVVoterProxy {
    ...
    address public constant want = address(0xFd2a8fA60Abd58Efe3EeE34dd494cD491dC14900);
    address public constant crv = address(0xD533a949740bb3306d119CC777fa900bA034cd52);

    address public constant curve = address(0xDeBF20617708857ebe4F679508E7b7863a8A8EeE);
    address public constant gauge = address(0xd662908ADA2Ea1916B3318327A97eB18aD588b5d);
    ...
    function harvest() public {
        ...
        if (_dai > 0) {
            ...
            ICurveFi(curve).add_liquidity([_dai, 0, 0], 0, true);
        }
        uint256 _want = IERC20(want).balanceOf(address(this));
        if (_want > 0) {
