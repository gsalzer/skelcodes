...
contract Fesstable is ERC20 {
    ...
    constructor(address _owner, address payable _feesWallet, string memory _name, string memory _symbol, address _chainAddress, uint256 _price) public Owned(_owner) {
    ...
    function swapTokens(uint256 value) public whenNotPaused payable returns (bool) {
       ...
       uint256 worthOfUSd = value.mul(priceOftoken).div(100);
       ...
       feesWallet.transfer(msg.value);
       require(ERC20(token).transferFrom(msg.sender,address(this),value), "transferFrom failed");
       return true;
    }    
