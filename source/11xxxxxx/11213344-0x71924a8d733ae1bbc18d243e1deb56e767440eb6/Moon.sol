 ...
 * For a generic mechanism see {MOON}.
 *
 ...
 */
contract Moon is Context, AccessControl, ERC20Burnable, ERC20Pausable, ERC20Capped {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "MOON: must have minter role to mint");
        _mint(to, amount);
    }
    ...
    function setCap(uint256 limit) public virtual {
        require(hasRole(CAPPER_ROLE, _msgSender()), "MOON: must have capper role to set cap");
        _setCap(limit);
    }
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "MOON: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "MOON: must have pauser role to unpause");
        _unpause();
    }
