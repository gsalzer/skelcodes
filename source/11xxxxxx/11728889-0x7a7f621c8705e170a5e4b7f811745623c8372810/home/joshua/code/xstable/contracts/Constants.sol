...
library Constants {
    ...
    uint256 private constant _presaleIndividualCap = 300 ether;
    uint256 private constant _presaleCap = 4 * 10**5 * 10**9;
    uint256 private constant _maxPresaleGas = 1000000000000;

    uint256 private constant _epochLength = 3 hours;
    ...
    address payable private constant _deployerAddress = 0xe65853C996AaE8E7af889A724f4896b8367948b2;
    address private constant _treasuryAddress = 0xA799f39EE3d2786Ee37E27A5903E98AD5A2AAa89;

    string private constant _name = "TXSTABLE.FINANCE";
    string private constant _symbol = "TXS";
