...
contract EighteenPlus is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "18+ Token";
    string private _symbol = "18+";
    ...
    uint256 internal _tokenTotal = 1_000e18;
    ...
    uint256 public rebalanceInterval = 18 minutes;
