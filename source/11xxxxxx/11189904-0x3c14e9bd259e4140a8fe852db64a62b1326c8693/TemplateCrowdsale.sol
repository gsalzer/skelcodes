...
contract Consts {
    ...
    string public constant TOKEN_NAME = "Evalanche";
    string public constant TOKEN_SYMBOL = "EVA";
    bool public constant PAUSED = true;
    address public constant TARGET_USER = 0xB2E379dEd4c0902bF09a318DC1E6994B30D1D661;
    
    uint public constant START_TIME = 1604509200;
...
contract BonusableCrowdsale is Consts, Crowdsale {
    ...
    function getBonusRate(uint256 _weiAmount) internal view returns (uint256) {
        ...
        // apply amount
        uint[2] memory weiAmountBounds = [uint(10000000000000000000),uint(2000000000000000000)];
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(400 * TOKEN_DECIMAL_MULTIPLIER, 0x4dd003Fc37143a2A848f02e5dd170b59f724D4Ca, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1605373200)
    ...
    function init() public onlyOwner {
        ...
        address[4] memory addresses = [address(0x6d9204fde0cd746923b855a4e83d7fc7896f971e),address(0xc29ac5e03f57857f7d9ed0c378827211503c6c12),address(0xad2bba86c64829c58357fdd20aaac15eb0af732f),address(0x14336b55ab3f3fa6aea157f5d176f04b98c81a94)];
        uint[4] memory amounts = [uint(525000000000000000000000),uint(225000000000000000000000),uint(75000000000000000000000),uint(75000000000000000000000)];
        uint64[4] memory freezes = [uint64(0),uint64(0),uint64(0),uint64(1620165601)];
