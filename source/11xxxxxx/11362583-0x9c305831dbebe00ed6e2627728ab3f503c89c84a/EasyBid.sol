...
// File: contracts\interfaces\INyan.sol
...
contract EasyBid is EasyBidDataLayout, Proxiable {
    ...
    function getETHAllowance(address user) public view returns(uint256) {
        ...
        require(blockStaked.sub(block.number) >= 100, "Staked too recently");
    ...
    function createBid(
        ...
        bidder[msg.sender].ethUsed = bidder[msg.sender].ethUsed.add(ethUsed);
