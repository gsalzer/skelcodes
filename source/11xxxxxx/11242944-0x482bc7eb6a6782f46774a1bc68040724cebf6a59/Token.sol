...
contract Token is Initializable {
     ...
     */
    function initialize(string memory name_, string memory symbol_, uint initialSupply_, address account, address minter_, uint mintingAllowedAfter_, uint8 mintCap_, uint32 minimumTimeBetweenMints_) public initializer {
