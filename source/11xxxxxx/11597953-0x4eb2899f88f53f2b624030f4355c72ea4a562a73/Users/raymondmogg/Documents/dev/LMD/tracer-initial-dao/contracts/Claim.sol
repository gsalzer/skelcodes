...
contract Claim {
    ...
    // Initial Vesting contract
    IVesting public _vesting;
    // Users who have already 'claimed' part of the DAO
    ...
    /**
    * @notice Join the Tracer DAO. By executing this function, you confirm you agree to the
    *         attached participation agreement.
    * @dev Sends 1 token to each claimer. Sends 99999 tokens to the vesting contract
    *      for the claimer to receive over 3 years, with a 6 month cliff.
    */
    function claim() public {
        require(!claimed[msg.sender], "No double claiming");
        //0.01% of 1 billion = 100000
        //1 token sent immedietly
        //99999 vesting over 3 years
        uint256 singleToken = 1000000000000000000;
        uint256 vestingTokens = 99999000000000000000000;
        ...
        _vesting.setVesting(msg.sender, vestingTokens, true);
