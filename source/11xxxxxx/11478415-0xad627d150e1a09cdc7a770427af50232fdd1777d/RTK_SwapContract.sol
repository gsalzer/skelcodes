...
/*
* Code and Design by Harshil Jain
* A.K.A. Hentai Ousama
* Telegram : @OreGaZembuToushiiSuru
* Email : kutabare.eerito@gmail.com
*/
...
contract RTK_SwapContract {
    ...
    /*
    * _Token_RTKL[0] = RTKL1 is actually original RTK
    * _Token_RTKL[1...4] are RTKL2...RTKL5
    * _Token_Bullet is addy of bullet contract
    */
    ...
    // Function to get amount of minimum required AMMO in the contract
    ...
    // Function for owner to pull out EXCESS AMMO. A certain minimum amount AMMO has to stay within the contract
