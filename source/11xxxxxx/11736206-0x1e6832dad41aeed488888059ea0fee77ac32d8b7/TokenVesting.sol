...
contract TokenVesting {
    ...
    address public _STS_contract_address;
    ERC20 STS;
    ...
    function setSTSAddress(address STS_address) public {
        require(msg.sender == _owner, "must be set by the owner");
        _STS_contract_address = STS_address;
        STS = ERC20(STS_address);
    }
    ...
    function release() public {
        ...
        STS.transfer(_beneficiary, unreleased);
    ...
    function revoke() public {
        ...
        uint256 balance = STS.balanceOf(address(this));
    ...
    function recoverERC20(address tokenAddress, uint256 tokenAmount) external {
        ...
        require(tokenAddress != _STS_contract_address, "Cannot withdraw the STS through this function");
    ...
    function _vestedAmount() private view returns (uint256) {
        uint256 currentBalance = STS.balanceOf(address(this));
