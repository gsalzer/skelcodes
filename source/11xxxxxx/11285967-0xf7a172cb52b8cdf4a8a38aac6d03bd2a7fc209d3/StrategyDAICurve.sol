...
contract StrategyDAICurve {
    ...
    */
    ...
    address constant public y = address(0xa3Aa4a71dBb17EBF2108A75b0BB7eFd9955463EF);//yDai itoken
    address constant public ycrv = address(0xdF5e0e81Dff6FAF3A7e52BA697820c5e32D806A8);
    address constant public yycrv = address(0x444b9167A7cA884725AF4c09961c6B4A62A59eB9);//vault_yCrv
    address constant public curve = address(0x45F783CCE6B7FF23B2ab2D70e416cdb7D6055f51);
    
    address constant public dai = address(0x6B175474E89094C44Da98b954EedeAC495271d0F);
    address constant public ydai = address(0xa3Aa4a71dBb17EBF2108A75b0BB7eFd9955463EF);

    address constant public usdc = address(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);
    address constant public yusdc = address(0x82Ac4e3A35dd64dD3574bF5BD5029fd90ABc2A86);

    address constant public usdt = address(0xdAC17F958D2ee523a2206206994597C13D831ec7);
    address constant public yusdt = address(0x6C77dF12c39CAE90C4c46E5C19177679b7235CFa);

    address constant public tusd = address(0x0000000000085d4780B73119b644AE5ecd22b376);
    address constant public ytusd = address(0xe96F3621F5eF085f79Bd0Cc87b6e43378cFA6a60);
