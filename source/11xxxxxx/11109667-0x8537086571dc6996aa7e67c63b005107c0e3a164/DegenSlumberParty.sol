...
contract DegenSlumberParty {
    string public constant name = "Degen Slumber Party";
    string public constant symbol = "DSPY";
   ...
   constructor() public {
        ...
        DegenSlumberPartyContract = msg.sender;
    ...
    address public DegenSlumberPartyContract;
}
