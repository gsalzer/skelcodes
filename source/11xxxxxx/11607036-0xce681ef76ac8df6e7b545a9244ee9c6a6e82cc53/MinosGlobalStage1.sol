...
/**
 * @title MinosGlobalStage1
 * @dev Contract for token Minos Global Stage 1
 **/
contract MinosGlobalStage1 is ERC20, Ownable {

  string public constant name = "Minos Global Stage 1";
  string public constant symbol = "MNSG1";
  uint8 public constant decimals = 18;

  // Contract hash is the SHA-256 hash for the document of the security contract
  string public contractHash = "D5123652BC02E0C318561DC219DA0CA26F776CC7152D976577FE914DA6D0CF11";
  ...
  event ContractHashUpdated(
    string indexed previousContractHash,
    string indexed newContractHash
  );

  // Initial supply is the balance assigned to the owner
  uint256 private constant _initialSupply = 150000 * (10 ** uint256(decimals));
  ...
  {
    require(msg.sender != address(0), "Minos Global Stage 1: Create contract from the zero address");
  }
  ...
  function withdrawEther() external onlyOwner {
    ...
    require(totalBalance > 0, "Minos Global Stage 1: No ether available to be withdrawn");
