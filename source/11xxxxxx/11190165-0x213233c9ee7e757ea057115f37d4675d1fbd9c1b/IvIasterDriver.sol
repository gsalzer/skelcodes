...
/**
 *
 * CONNECTING MANY ROADS
 * 
 * The 401 is a highway in eastern Ontario, Canada. It is long with lots of roads connecting to it.
 *The intention of this project is to connect many roads as possible to the 401 e.g. Ethereum, rBTC, USDT, CUSD to name a few. 
 *With many roads leading to the 401.  To make a freeway that AMM's can drive on a daily basis. 
 *Gain from there gains and gain from there loses. The object of the project is pretty straight forward, "STAND FIRM."
 *I have made an investment of about 1 ETHER into the project (from the time of writing this.)
 *The code below is forked from Pickle to help with distribution of the rewards.
 *
...
contract Token is ERC20("FOUROONE", "401"), Ownable {
...
contract IvIasterDriver is Ownable {
    using SafeMath for uint256;
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 tokenReward = multiplier
            ...
            .mul(pool.allocPoint)
            .div(totalAllocPoint);
        token.mint(devaddr, tokenReward.div(devFundDivRate));
    ...
    // **** Additional functions separate from the original IvIasterDriver contract ****
