...
contract FeeApprover is OwnableUpgradeSafe {
    ...
    function calculateAmountsAfterFee(        
        ...
        ) public  returns (uint256 transferToAmount, uint256 transferToFeeDistributorAmount) 
        {
            ...
            if(sender == coreVaultAddress  || sender == tokenUniswapPair || isWhiteListed[sender]) { // Dont have a fee when corevault is sending, or infinite loop                       // And when pair is sending ( buys are happening, no tax on it)
