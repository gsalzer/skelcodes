...
contract dVault is ERC20, ERC20Detailed {
    ...
    constructor (uint _earnLowerlimit,address _playerBook,address _feeAddress) public ERC20Detailed(
        "dms:vault:ETH","dETH",18
    ) {
    ...
    function depositETH(string memory inviter) public payable onlyRestrictContractCall {
