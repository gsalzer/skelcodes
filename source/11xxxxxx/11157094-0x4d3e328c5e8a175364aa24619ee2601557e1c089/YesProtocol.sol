...
//symbol        : YES
//decimals      : 8
//Total Supply  : 10,000 YES
//website       : https://www.yesprotocol.com/
...
contract YesProtocol is ERC20 {
    ...
    string public constant name = "Yes Protocol"; //* Token Name *//
    string public constant symbol = "YES"; //* Yes Protocol Symbol *//
    uint public constant decimals = 8; //* Number of Decimals *//
    uint256 public totalSupply = 1000000000000; //* total supply of Yes Protocol *//
    uint256 public totalDistributed =  1;  //* Initial Yes Protocol that will give to contract creator *//
    uint256 public constant MIN = 1 ether / 100;  //* Minimum Contribution for Yes Protocol //
    uint256 public tokensPerEth = 4000000000; //* Yes Protocol Amount per Ethereum *//
    ...
    //allow the contract owner to withdraw any token that are not belongs to Yes Protocol Community
    ...
    //Burning specific amount of Yes Protocol
    function burnYesProtocol(uint256 _value) onlyOwner public {
