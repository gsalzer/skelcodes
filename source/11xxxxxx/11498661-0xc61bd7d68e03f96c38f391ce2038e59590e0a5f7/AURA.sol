...
contract AURA is Context, IERC20, Ownable {
    ...
    string private _name = "Aura Plus";
    string private _symbol = "AUPLUS";
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(
            ...
            "AURAPLUS: Uniswap router cannot be excluded."
        );
        require(account != address(this), 'AUPLUS: The contract it self cannot be excluded');
        require(!_isExcluded[account], "AUPLUS: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        require(_isExcluded[account], "AUPLUS: Account is already included");
