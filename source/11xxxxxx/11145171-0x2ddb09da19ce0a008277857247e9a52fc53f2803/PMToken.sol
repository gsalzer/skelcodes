 ...
 */
contract PMToken is ERC20, ERC20Detailed, Ownable {
    ...
    constructor(address initialOwner, address recipient) public ERC20Detailed("Profit Moon Token", "PMT", 18) Ownable(initialOwner) {
        // creating of inital supply
        uint256 INITIAL_SUPPLY = 1000000e18;
