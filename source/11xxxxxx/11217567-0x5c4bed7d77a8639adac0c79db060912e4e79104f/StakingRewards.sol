...
contract StakingRewards is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard, Pausable {
    ...
    uint256 public locktime = 2 minutes;//3 weeks;
    
    uint256 public rewardRate = 0;
    uint256 public rewardsDuration = 30;//3 weeks;
    ...
    function stake(uint256 amount) external nonReentrant notPaused updateReward(msg.sender) {
        ...
        lockingPeriod[msg.sender]= block.timestamp.add(locktime);
    ...
    function withdraw(uint256 amount) public nonReentrant updateReward(msg.sender) {
        ...
        require(block.timestamp >= lockingPeriod[msg.sender], "Transaction hasn't surpassed time lock.");
