...
contract SDController is TokenController, Ownable {

    SD public tokenContract;   // The new token for this Campaign
    ...
    constructor(
        ...
        tokenContract = SD(_tokenAddress);         // The Deployed Token Contract
    }
