...
// VIDYG Token with Governance.
contract VIDYG is ERC20("vidygold.finance", "VIDYG"), Ownable {
    uint256 private _cap = 30000e18;
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "VIDYG::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "VIDYG::delegateBySig: invalid nonce");
        require(now <= expiry, "VIDYG::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "VIDYG::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "VIDYG::_writeCheckpoint: block number exceeds 32 bits");
