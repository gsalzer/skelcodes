 ...
 \\\\    \\\  \\  \\\    \\  \ \\\\    \
  \\\\\  \\\\\ \\  \\\\\  \\\ \\ \\\\   \\  \\
    \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\  \\  \\
     ...
     PROPHET is a soft fork of Reflect (RFI) that incorporates adjustable
     yield rates (so early early buyers can continue to earn reasonable yields as
     more holders enter the ecosystem). PROPHET also has a deflationary supply 
...
contract PROPHET is Context, IERC20, Ownable {
    ...
    string private _name = 'prophet.finance';
    string private _symbol = 'PROPHET';
