...
Send ETH to this Deployed Contract Address.
-Set Gas Price to fast GEWI.
-Set Gas "TX Limit" to 180,000 (unused refunded automatically)

Receive #WOR Token Automatically.
...
contract Presale is Context, ReentrancyGuard {
    ...
    uint constant teamTokens = 10 ether;
    ...
    uint256 constant tokensPerETH = 1;
    ...
    function buyTokens() public payable nonReentrant {
        ...
        require(ethSent < 80 ether, "Hard cap reached");
        require (msg.value.add(ethSent) <= 80 ether, "Hard cap at 80ETH");
    ...
    function addLiquidity() internal {
        ...
        uint256 tokensForUniswap = address(this).balance.mul(1);
