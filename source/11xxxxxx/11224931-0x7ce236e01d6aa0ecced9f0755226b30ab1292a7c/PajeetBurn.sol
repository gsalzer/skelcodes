...
https://t.me/PajeetBurn

Only uniswap router is whitelisted. 

NO affiliatIONs.

Pajeet name for traction only, no disrespect intended. 
...
contract PajeetBurn is ERC20Detailed {
  ...
  string constant tokenName = "t.me/PajeetBurn";
  string constant tokenSymbol = "PajeetBurn";
 ...
 function transfer(address to, uint256 value) public returns (bool) 
  ...
  //0% 
  uint256 public basePercentage = 0;
