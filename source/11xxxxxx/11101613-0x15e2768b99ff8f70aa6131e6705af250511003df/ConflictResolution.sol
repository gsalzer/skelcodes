...
interface ConflictResolutionInterface {
    ...
    function conflictEndFine() external view returns(int);
...
contract ConflictResolution is ConflictResolutionInterface, Games, Ownable {
    ...
    uint public SERVER_TIMEOUT = 6 hours;
    uint public USER_TIMEOUT = 6 hours;

    uint public MIN_BET_VALUE = 1e13; /// min 0.00001 ether bet
    uint public MIN_BANKROLL = 40e18; // 40e18

    int public NOT_ENDED_FINE = 1e15; /// 0.001 ether

    int public CONFLICT_END_FINE = 1e15; /// 0.001 ether
     ...
     */
    function conflictEndFine() public view returns(int) {
    ...
    /**
     * @dev Set Server Tiemout
     * @param _serverTimeOut new server time
     */
    function setServerTimeOut(uint _serverTimeOut) public onlyOwner {
        SERVER_TIMEOUT = _serverTimeOut;
    }

    /**
     * @dev Set User Timeout
     * @param _userTimeOut new user time.
     */
     function setUserTimeOut(uint _userTimeOut) public onlyOwner {
         USER_TIMEOUT = _userTimeOut;
     }
    
    /**
     * @dev Set Min Bet Value
     * @param _minBetValue new min bet value.
     */
     function setMinBetValue(uint _minBetValue) public onlyOwner {
         MIN_BET_VALUE = _minBetValue;
     }

    /**
     * @dev Set Not Ended Fine
     * @param _notEndedFine new not ended fine.
     */
     function setNotEndedFine(int _notEndedFine) public onlyOwner {
         NOT_ENDED_FINE = _notEndedFine;
     }

    /**
     * @dev Set Conflict End Fine
     * @param _conflictEndFine new conflict end fine.
     */
    function setConflictEndFine(int _conflictEndFine) public onlyOwner {
        CONFLICT_END_FINE = _conflictEndFine;
    }
}
