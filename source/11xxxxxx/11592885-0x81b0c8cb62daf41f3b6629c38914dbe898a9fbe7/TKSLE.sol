...
contract ERC1155Tradable is ERC1155, ERC1155MintBurn, ERC1155Metadata, Ownable {
  ...
  mapping (uint256 => string) public ipfshashById;
  // Contract name
  string public name;
  // Contract symbol
 ...
 */
contract TKSLE is ERC1155Tradable {
  ...
  ERC1155Tradable(
    ...
    // _setBaseMetadataURI("https://raw.githubusercontent.com/TokenFighter/tk-metadata/master/tksle/");
