...
**NOTE** Sorry for #SAD's failure at the start, I hope #SAD2 will doing everything fine, I may be stupid on #SAD, but I'm not a scam, I lose about 0.5 ETH on deploy and testing functions when #SAD have a problem. I make this #SAD2, but #SAD works fine now too.

**NOTE** Hello World! I'm SADMAN, THIS TOKEN GOT INSPIRE FROM DEV OF #LIQBURN. 
Future tokens made by SADMAN will only create from the same address which creates #SAD2. 
SADMAN will never have any public social identity. 
...
3: When 1-2 satisfies, please PIN all 4 people's address as the group info, SADMAN will transfer the reward soon.
3: SADMAN always anonymous, will keep in dark place watching. And of course, I will join the group, 
...
**NOTE** Token liquidity adding time: 01:00 November 20, 2020  
**NOTE** Token liquidity locking time: 01:02 November 20, 2020
**NOTE** Token trading enable time:   01:03 November 20, 2020  
...
contract SAD2Token is ERC20, Ownable {
    /*
    ...
    */
    ...
    constructor() public ERC20("SAD2Token", "SAD2") {
