...
contract BadgerRewardsManager is AccessControlUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable, Executor {
    event Call(address to, uint256 value, bytes data);
 
    bytes32 public constant DISTRIBUTOR_ROLE = keccak256("DISTRIBUTOR_ROLE");

    function initialize(address admin, address initialDistributor) public initializer {
