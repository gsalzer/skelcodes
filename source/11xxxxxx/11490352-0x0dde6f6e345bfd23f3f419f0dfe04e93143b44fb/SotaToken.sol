...
contract SotaToken is ERC20, ERC20Capped, ERC20Burnable, Ownable {
    ...
    constructor (
        ...
        _mint(0x077EdcC92337eD87C5D8f975F955A25465a5D950, cap);
        whiteListTransfer[0x077EdcC92337eD87C5D8f975F955A25465a5D950] = true;
    }
    ...
    function adminSetTime(uint _newTimeTransfer) onlyOwner public returns (bool) {
        require(_newTimeTransfer < allowTransferOn, "Invalid-time-or-allowed");
        allowTransferOn = _newTimeTransfer;
        return true;
    }
    function transfer(address to, uint amount) public override(ERC20) returns (bool) {
        require(whiteListTransfer[msg.sender] || block.timestamp > allowTransferOn,"Can-not-transfer");
