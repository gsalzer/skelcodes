...
// This strategy uses optimizations to reduce gas fees such as trading only every 24 hours (modifiable)
...
contract StabilizeStrategyBTCArbV2 is Ownable {
    using SafeMath for uint256;
    ...
    uint256 public secondsBeforeTrade = 86400; // 24 hours wait before trade triggered
    ...
    function finishChangeMinTradeSplit() external onlyGovernance timelockConditionsMet(10) {
