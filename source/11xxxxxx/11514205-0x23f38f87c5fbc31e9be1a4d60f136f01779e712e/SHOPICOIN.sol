...
contract SHOPICOIN is SafeMath {
    string public constant name                         = "SHOPI COIN";                     // Name of the token
    string public constant symbol                       = "SPC";                            // Symbol of token
    uint256 public constant decimals                    = 18;                               // Decimal of token
    uint256 public _totalsupply                         = 1000000000 * 10 ** decimals;      // Total supply
    uint256 public _circulatingSupply                   = 600000000 * 10 ** decimals;       // Circulating supply
    uint256 public _initialTransfer                     = 400000000 * 10 ** decimals;       // Initiral tokens
    address public owner                                = msg.sender;                       // Owner of smart contract
    uint256 public _price_token                         = 5000;                             // 1 Ether = 5000 tokens in ICO
    uint256 no_of_tokens;
    address public admin                                = 0x483a73C0c049f72D71819F358ddAC65338e6C605;   
    ...
    function () public payable {
        require(now <= (_ICOstarttime + 90 days) && _ICOstarttime != 0); // 90 days
    ...
    {
        _ICOstarttime = now + 90 days; // 90 days
    }
