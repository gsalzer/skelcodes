...
contract ABToken is Pausable, StandardToken, BlackList {

    string public constant name = "AB Token";
    string public constant symbol = "AB";
    uint public constant decimals = 18;
    address public upgradedAddress;
    bool public deprecated = false;
    uint public constant _initialSupply = 18 * 10000 * 1000 * (10 ** uint256(decimals));
    uint public _totalSupply = _initialSupply;

    /**
    * @dev Constructor that gives owner all of existing tokens.
    */
    constructor() ABToken() public {
