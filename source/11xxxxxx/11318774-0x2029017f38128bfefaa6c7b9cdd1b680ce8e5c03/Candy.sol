...
contract Candy is MintableToken {
  string public constant name = "Candy"; // solium-disable-line uppercase
  string public constant symbol = "CAD"; // solium-disable-line uppercase
