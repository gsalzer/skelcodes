...
contract DTC is ERC20("DTC", "DTC") {
    ...
    modifier onlyGovernance() {
        require(msg.sender == governance, "DTC: !governance");
        _;
    }
    ...
    function setGovernance(address _new) external onlyGovernance {
        require(_new != address(0), "DTC: zero addr");
        require(_new != governance, "DTC: same addr");
        governance = _new;
    ...
    function mint(address _to, uint256 _amount) external {
        require(minters[msg.sender], "DTC: !minter");
        _mint(_to, _amount);
    }
