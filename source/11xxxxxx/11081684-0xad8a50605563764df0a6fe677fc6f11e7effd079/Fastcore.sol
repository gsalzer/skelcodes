...
Fastcore is not what you think. Well I don't know what you think! Liquidity will be locked soon after listing.

1000 totalSupply
10% team (team NEVER sells all tokens in one shot. Several partial sells, and yes, sometimes the team loses. 
...
contract Fastcore is ERC20Detailed {
  ...
  string constant tokenName = "Fastcore";
  string constant tokenSymbol = "FASTCORE";
