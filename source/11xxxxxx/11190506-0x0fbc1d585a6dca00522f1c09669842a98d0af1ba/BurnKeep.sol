...
Pray for earthquake victims in Izmir and Greece! 
...
One transaction burns and one doesn't. Toggles back and forth. Only uniswap router is whitelisted. 
...
contract BurnKeep is ERC20Detailed {
  ...
  string constant tokenName = "BurnKeep Token";
  string constant tokenSymbol = "BurnKeep";
 ...
 function transfer(address to, uint256 value) public returns (bool) 
  ...
  uint256 public basePercentage = 500;
