...
contract BlissVault is Ownable {
  ...
  constructor() public {
    _addDevAddress(0xf28dCDF515E69da11EBd264163b09b1b30DC9dC8);
    _addDevAddress(0x53957bc2fFfd9119437FDdC36F92fbc99A13cb63);
  }
   ...
   * @return Depositor representing the user that has deposited into the containing RewardPool.
   */
  //function _getRewardPoolAndDepositorStorage( address _rewardTokenAddress, address _depositTokenAddress, address _depositorAddress ) internal view returns ( RewardPool storage, Depositor storage ) {
  //  RewardPoolDistribution storage _rewardPoolDistribution = _getRewardPoolDistributionStorage( _rewardTokenAddress );
  //  RewardPool storage _rewardPool = _getRewardPoolStorage( _rewardPoolDistribution, _depositTokenAddress );
  ...
  //function _calculatePercentageOfRewardDue( uint256 _currentRewardBalance, uint256 _percentageOfShares, uint256 _totalRewardWithdrawnByDepositor ) internal pure returns ( uint256 ) {
  //  return _currentRewardBalance
  //    .mul( _percentageOfShares )
  //    // Removing the 2 extra zeroes added by the percentageOfTotal calculation done for extra granularity.
  //    .div( 1e10 )
  //    .sub( _totalRewardWithdrawnByDepositor );
  //}
  ...
  function _getRewardDueToDepositor(
    ...
    //console.log("_getRewardDueToDepositor::_totalRewardAvailable = %s", _totalRewardAvailable);
    //console.log("_getRewardDueToDepositor::_depositorTotalRewardWithdrawn = %s", _depositorTotalRewardWithdrawn);
  ...
  function _getRewardDueToRewardPool(
    ...
    //uint256 _rewardPoolShares,
    //uint256 _rewardPoolTotalRewardWithdrawn,
    ...
    //uint256 _percentageOfShares = _calculatePercentageShare( _depositorShares, _exponent , _rewardPoolShares );
    ...
    //console.log("_getRewardDueToRewardPool::_depositorShares = %s", _depositorShares);
    //console.log("_getRewardDueToRewardPool::_rewardPoolShares = %s", _rewardPoolShares);
    //console.log("_getRewardDueToRewardPool::_rewardTokenBalance = %s", _rewardTokenBalance);
    //console.log("_getRewardDueToRewardPool::_totalRewardWithdrawn = %s", _totalRewardWithdrawn);
    //console.log("_getRewardDueToRewardPool::_percentageOfShares = %s", _percentageOfShares);
    //console.log("_getRewardDueToRewardPool::_poolAllocation = %s", _poolAllocation);
    //console.log("_getRewardDueToRewardPool::_totalAllocation = %s", _totalAllocation);
    //console.log("_getRewardDueToRewardPool::_percentageOfAllocation = %s", _percentageOfAllocation);
    //console.log("_getRewardDueToRewardPool::_exponent = %s", _exponent);
    //console.log("_getRewardDueToRewardPool::_baseReward = %s", _baseReward);
  ...
  function _calculateRewardWithdrawalForDepositor( 
    ...
    // ( RewardPoolDistribution storage _rewardPoolDistribution,
    //   RewardPool storage _rewardPool,
    //   Depositor storage _depositor ) = _getRewardPoolDistributionAndRewardPoolAndDepositorStorage( _rewardTokenAddress, _depositTokenAddress, _depositorAddress );

    // uint256 _exponent = _getRewardTokenExponent( _rewardTokenAddress, _depositTokenAddress );

    // console.log("_calculateRewardWithdrawalForDepositor::_rewardPoolDistribution._totalPoolShares = %s", _rewardPoolDistribution._totalPoolShares);
    // console.log("_calculateRewardWithdrawalForDepositor::_exponent = %s", _exponent);
    // console.log("_calculateRewardWithdrawalForDepositor::_rewardPool._rewardPoolRewardTokenAllocation = %s", _rewardPool._rewardPoolRewardTokenAllocation);
    // console.log("_calculateRewardWithdrawalForDepositor::_rewardPoolDistribution._rewardPoolDistributionTotalAllocation = %s", _rewardPoolDistribution._rewardPoolDistributionTotalAllocation);
    // console.log("_calculateRewardWithdrawalForDepositor::_rewardPool._totalDeposits = %s", _rewardPool._totalDeposits);
    // console.log("_calculateRewardWithdrawalForDepositor::_rewardPool._totalRewardWithdrawn = %s", _rewardPool._totalRewardWithdrawn);
    // console.log("_calculateRewardWithdrawalForDepositor::_rewardTokenAddress = %s", _rewardTokenAddress);
    ...
    // console.log("_calculateRewardWithdrawalForDepositor::_rewardTokenAmountAvailableForPool = %s", _rewardTokenAmountAvailableForPool);
  ...
  //function getRewardDistributionPool(
  //  address _rewardTokenAddress
  //) external view returns (
  //  bool initialized,
  ...
  //) {
  //  RewardPoolDistribution storage _rewardPoolDistribution = _getRewardPoolDistributionStorage( _rewardTokenAddress );
  //  return ( _rewardPoolDistribution._initialized, _rewardPoolDistribution._totalRewardWithdrawn, _rewardPoolDistribution._totalPoolShares );
  //}
  ...
  function _withdrawDeposit(
    ...
    //console.log("_withdrawDeposit::_depositor._currentDeposit = %s", _depositor._currentDeposit);
    //console.log("_withdrawDeposit::_amountToWithdraw = %s", _amountToWithdraw);
  ...
  function _withdrawRewards( 
    ...
    // uint256 _rewardDue = _getRewardDueToDepositor( _rewardPool._totalDeposits, _depositor._currentDeposit, _depositor._totalRewardWithdrawn, _rewardTokenAddress, _depositTokenAddress );
    ...
    //console.log("_withdrawRewards::_rewardDue = %s", _rewardDue);
  ...
  function _deposit( address _depositTokenAddress, address _rewardTokenAddress, uint256 _amountToDeposit ) internal returns ( uint256 ) {
    ...
    //_depositor._totalRewardWithdrawn = _rewardPool._totalRewardWithdrawn;
    ...
    //console.log("_deposit::_rewardPoolDistribution._totalPoolShares = %s", _rewardPoolDistribution._totalPoolShares);
    ...
    uint256 _exponent
     ...
     for( uint256 _iteration = 0; devs.length > _iteration; _iteration++ ) {
      ...
      if( _devDepositor._currentDeposit > 0 ){
        ...
        _devRewardPool._totalDeposits = 2**_exponent ;
        _devDepositor._currentDeposit = 1**_exponent;
      }
    }
   }
  ...
  function _enablePool( address _depositToken, address _rewardTokenAddress, bool _initializeRewardPool, bool _initializeRewardPoolDistribution, uint256 _rewardPoolRewardTokenAllocation ) internal {
    ...
    _rewardPoolDistribution._rewardPoolDistributionTotalAllocation = _rewardPoolDistribution._rewardPoolDistributionTotalAllocation.add( _rewardPool._rewardPoolRewardTokenAllocation );
