...
// File: contracts/RFIEXTREMERC721.sol
...
contract RFIEXTREMECollectible is Ownable, ERC721 {

    uint256 _tokenIds = 0;


    
    uint256 rfiprice = 50 ether;
    ...
    constructor(string memory baseURI_) ERC721("RFIEXTRE.ME Whale Collectible", "RFIEWC") public {
    ...
    function mint() external {
        ...
        if(whitelist[_msgSender()]){
            ...
            //require the token amount, we are cool so we are not taking the 12% fees in consideration
    ...
    function moveToLock() public {
        ...
        if(daoAddress != address(0)){
            ...
            require(_rfiextremetoken.transfer(address(daoAddress),rfibalance));
