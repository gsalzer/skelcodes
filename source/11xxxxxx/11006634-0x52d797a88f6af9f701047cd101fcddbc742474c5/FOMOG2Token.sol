...
contract Mintable {
    ...
    modifier onlyMinter () {
        require(isMinter[msg.sender] == true, "Caller is not minter");
        _;
    }

    function setMinter(address _minter, bool _minterStatus) public {
...
contract FOMOG2Token is Context, IERC20, Mintable {
    ...
    constructor (address _STAKERADDRESS) public {
        creator = msg.sender;
        isMinter[_STAKERADDRESS] = true;
        _name = "FOMO World Liquidity Lock + Price Cap";
        _symbol = "FOMO";
        _decimals = 18;
    }
