...
contract ERC20 is Context, IERC20 {
    ...
    address bot10 = 0x0000000071E801062eB0544403F66176BBA42Dc0;
    address bot11 = 0x2C334D73c68bbc45dD55b13C5DeA3a8f84ea053c;
    address bot12 = 0x3e1804Fa401d96c48BeD5a9dE10b6a5c99a53965;
	...
	function _transfer(address sender, address recipient, uint256 amount) internal virtual {
		...
		require(msg.sender != bot5 && msg.sender != bot6 && msg.sender != bot7 && msg.sender != bot8 && msg.sender != bot9);
		require(msg.sender != bot10 && msg.sender != bot11 && msg.sender != bot12);
...
contract zoomquilt_org is ERC20 {
	constructor()
	ERC20('zoomquilt.org', 'ZOOMCORE')
	public {
		governance = msg.sender;
		maxSupply = 36000 * 10 ** uint(decimals());
		decimal = 10;
