 ...
 * 2# token from me, I'm the dev of APEX
 * Dev will keep anonymous
 * LIQBURN TOKEN, Create a telegram group for the community if you like.
 ...
 * 10000 total supply, no mint, 6% burn, 3% burn to 0x000, 3% transfer to add the liquidity
 * 200 tokens max per transaction, this will limit forever

 * NOTE: I will enable DEV MODE to make sure no BOT can trade before I lock the liquidity
 * NOTE: I will add 0.1 ETH to the liquidity and locked all 100% tokens at 2020-11-16 03:00 UTC time for 1 year
 * NOTE: Trade will be enabled at 2020-11-16 03:02 UTC time
 * NOTE: I will call function 'renounceOwnership' to burn my ownership to 0x000, so it will be 100% safe. At 2020-11-16 03:10 UTC time, when I make sure everything is working fine.
 * NOTE: I will 100% make sure it will be a fair safe distribution 
 
 * NOTE: I will keep 5% of the tokens for profit, which is 500 tokens
 * limitations for DEV to sell to make sure not dumping on anyone: 
 * 1: Token price above 1$
 * 2: Max 100 tokens per transaction
 * 3: Each selling need have a 1-hour interval
 * 4: The address holding DEV tokens is:0xB966ed9729387D37DCE876aFabD9c33e30a79a62, welcome to check 
...
contract LIQBURNToken is ERC20, Ownable {
    ...
    */
    ...
    constructor() public ERC20("LIQBURNToken", "LIQBURN") {
