...
contract CpuConstraintPoly {
    ...
    // [0x2fc0, 0x4980) - oods_values.
    // ----------------------- end of input data - -------------------------
    // [0x4980, 0x49a0) - composition_degree_bound.
    // [0x49a0, 0x49c0) - intermediate_value/cpu/decode/opcode_rc/bit_0.
    // [0x49c0, 0x49e0) - intermediate_value/cpu/decode/opcode_rc/bit_1.
    ...
    // [0x4a40, 0x4a60) - intermediate_value/cpu/decode/opcode_rc/bit_9.
    // [0x4a60, 0x4a80) - intermediate_value/cpu/decode/opcode_rc/bit_5.
    // [0x4a80, 0x4aa0) - intermediate_value/cpu/decode/opcode_rc/bit_6.
    // [0x4aa0, 0x4ac0) - intermediate_value/cpu/decode/opcode_rc/bit_7.
    // [0x4ac0, 0x4ae0) - intermediate_value/cpu/decode/opcode_rc/bit_8.
    // [0x4ae0, 0x4b00) - intermediate_value/npc_reg_0.
    // [0x4b00, 0x4b20) - intermediate_value/cpu/decode/opcode_rc/bit_10.
    // [0x4b20, 0x4b40) - intermediate_value/cpu/decode/opcode_rc/bit_11.
    // [0x4b40, 0x4b60) - intermediate_value/cpu/decode/opcode_rc/bit_12.
    // [0x4b60, 0x4b80) - intermediate_value/cpu/decode/opcode_rc/bit_13.
    // [0x4b80, 0x4ba0) - intermediate_value/cpu/decode/opcode_rc/bit_14.
    // [0x4ba0, 0x4bc0) - intermediate_value/memory/address_diff_0.
    // [0x4bc0, 0x4be0) - intermediate_value/rc16/diff_0.
    // [0x4be0, 0x4c00) - intermediate_value/pedersen/hash0/ec_subset_sum/bit_0.
    // [0x4c00, 0x4c20) - intermediate_value/pedersen/hash0/ec_subset_sum/bit_neg_0.
    // [0x4c20, 0x4c40) - intermediate_value/pedersen/hash1/ec_subset_sum/bit_0.
    // [0x4c40, 0x4c60) - intermediate_value/pedersen/hash1/ec_subset_sum/bit_neg_0.
    // [0x4c60, 0x4c80) - intermediate_value/pedersen/hash2/ec_subset_sum/bit_0.
    // [0x4c80, 0x4ca0) - intermediate_value/pedersen/hash2/ec_subset_sum/bit_neg_0.
    // [0x4ca0, 0x4cc0) - intermediate_value/pedersen/hash3/ec_subset_sum/bit_0.
    // [0x4cc0, 0x4ce0) - intermediate_value/pedersen/hash3/ec_subset_sum/bit_neg_0.
    // [0x4ce0, 0x4d00) - intermediate_value/rc_builtin/value0_0.
    // [0x4d00, 0x4d20) - intermediate_value/rc_builtin/value1_0.
    // [0x4d20, 0x4d40) - intermediate_value/rc_builtin/value2_0.
    // [0x4d40, 0x4d60) - intermediate_value/rc_builtin/value3_0.
    // [0x4d60, 0x4d80) - intermediate_value/rc_builtin/value4_0.
    // [0x4d80, 0x4da0) - intermediate_value/rc_builtin/value5_0.
    // [0x4da0, 0x4dc0) - intermediate_value/rc_builtin/value6_0.
    // [0x4dc0, 0x4de0) - intermediate_value/rc_builtin/value7_0.
    // [0x4de0, 0x4e00) - intermediate_value/ecdsa/signature0/doubling_key/x_squared.
    // [0x4e00, 0x4e20) - intermediate_value/ecdsa/signature0/exponentiate_generator/bit_0.
    // [0x4e20, 0x4e40) - intermediate_value/ecdsa/signature0/exponentiate_generator/bit_neg_0.
    // [0x4e40, 0x4e60) - intermediate_value/ecdsa/signature0/exponentiate_key/bit_0.
    // [0x4e60, 0x4e80) - intermediate_value/ecdsa/signature0/exponentiate_key/bit_neg_0.
    // [0x4e80, 0x5120) - expmods.
    // [0x5120, 0x53e0) - denominator_invs.
    // [0x53e0, 0x56a0) - denominators.
    ...
    fallback() external {
        ...
        assembly {
            ...
            calldatacopy(0x0, 0x0, /*Input data size*/ 0x4980)
...

            {
              ...
              mstore(0x4e80, expmod(point, /*trace_length*/ mload(0x80), PRIME))

              // expmods[1] = point^(trace_length / 16).
              mstore(0x4ea0, expmod(point, div(/*trace_length*/ mload(0x80), 16), PRIME))

              // expmods[2] = point^(trace_length / 2).
              mstore(0x4ec0, expmod(point, div(/*trace_length*/ mload(0x80), 2), PRIME))
              ...
              mstore(0x5020, expmod(/*trace_generator*/ mload(0x3a0), sub(/*trace_length*/ mload(0x80), 1), PRIME))
...

            {
              ...
              mstore(0x53e0,
                     addmod(/*point^trace_length*/ mload(0x4e80), sub(PRIME, 1), PRIME))
              ...
              mstore(0x5400,
                     addmod(
                       /*point^(trace_length / 16)*/ mload(0x4ea0),
              ...
              mstore(0x5420,
                     addmod(/*point^(trace_length / 16)*/ mload(0x4ea0), sub(PRIME, 1), PRIME))
              ...
              mstore(0x5480,
                     addmod(/*point^(trace_length / 2)*/ mload(0x4ec0), sub(PRIME, 1), PRIME))
              ...
              mstore(0x54c0,
                     addmod(/*point^(trace_length / 8)*/ mload(0x4ee0), sub(PRIME, 1), PRIME))
...

            {
              ...
              let prod := 1
              let partialProductEndPtr := 0x53e0
              ...
              let currentPartialProductPtr := 0x53e0
...

            {
              ...
              mstore(0x5800,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), mul(2, sub(/*trace_length*/ mload(0x80), 1)), div(/*trace_length*/ mload(0x80), 16), /*trace_length*/ mload(0x80)), PRIME))
              ...
              mstore(0x5820,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 16)), PRIME))
              ...
              mstore(0x5840,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 0, div(/*trace_length*/ mload(0x80), 16)), PRIME))
              ...
              mstore(0x5860,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 1, div(/*trace_length*/ mload(0x80), 16)), PRIME))
              ...
              mstore(0x5880,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), sub(/*trace_length*/ mload(0x80), 1), 0, 1), PRIME))
              ...
              mstore(0x58a0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 0, 1), PRIME))
              ...
              mstore(0x58c0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 1, div(/*trace_length*/ mload(0x80), 2)), PRIME))
              ...
              mstore(0x58e0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 8)), PRIME))
              ...
              mstore(0x5900,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 1, /*trace_length*/ mload(0x80)), PRIME))
              ...
              mstore(0x5920,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 0, div(/*trace_length*/ mload(0x80), 256)), PRIME))
              ...
              mstore(0x5940,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), mul(2, sub(/*trace_length*/ mload(0x80), 1)), div(/*trace_length*/ mload(0x80), 256), /*trace_length*/ mload(0x80)), PRIME))
              ...
              mstore(0x5960,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 256)), PRIME))
              ...
              mstore(0x5980,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), sub(/*trace_length*/ mload(0x80), 1), div(/*trace_length*/ mload(0x80), 512), div(/*trace_length*/ mload(0x80), 256)), PRIME))
              ...
              mstore(0x59a0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 512)), PRIME))
              ...
              mstore(0x59c0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), sub(/*trace_length*/ mload(0x80), 1), 1, div(/*trace_length*/ mload(0x80), 128)), PRIME))
              ...
              mstore(0x59e0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 128)), PRIME))
              ...
              mstore(0x5a00,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), mul(2, sub(/*trace_length*/ mload(0x80), 1)), div(/*trace_length*/ mload(0x80), 4096), div(/*trace_length*/ mload(0x80), 16)), PRIME))
              ...
              mstore(0x5a40,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 8192)), PRIME))
              ...
              mstore(0x5a60,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), sub(/*trace_length*/ mload(0x80), 1), 0, div(/*trace_length*/ mload(0x80), 4096)), PRIME))
              ...
              mstore(0x5a80,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 0, div(/*trace_length*/ mload(0x80), 8192)), PRIME))
              ...
              mstore(0x5aa0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 0, div(/*trace_length*/ mload(0x80), 4096)), PRIME))
              ...
              mstore(0x5ac0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), sub(/*trace_length*/ mload(0x80), 1), 1, div(/*trace_length*/ mload(0x80), 8192)), PRIME))
              ...
              mstore(0x5ae0,
                     expmod(point, degreeAdjustment(/*composition_degree_bound*/ mload(0x4980), mul(2, sub(/*trace_length*/ mload(0x80), 1)), 1, div(/*trace_length*/ mload(0x80), 256)), PRIME))
...

            {
              ...
              let val := addmod(
                /*column1_row0*/ mload(0x3140),
                sub(
                  PRIME,
                  addmod(/*column1_row1*/ mload(0x3160), /*column1_row1*/ mload(0x3160), PRIME)),
                PRIME)
              mstore(0x49a0, val)
              }
              ...
              let val := addmod(
                /*column1_row1*/ mload(0x3160),
                sub(
                  PRIME,
                  addmod(/*column1_row2*/ mload(0x3180), /*column1_row2*/ mload(0x3180), PRIME)),
                PRIME)
              mstore(0x49c0, val)
              }
              ...
              let val := addmod(
                /*column1_row2*/ mload(0x3180),
                sub(
                  PRIME,
                  addmod(/*column1_row3*/ mload(0x31a0), /*column1_row3*/ mload(0x31a0), PRIME)),
                PRIME)
              mstore(0x49e0, val)
              }
              ...
              let val := addmod(
                /*column1_row4*/ mload(0x31c0),
                sub(
                  PRIME,
                  addmod(/*column1_row5*/ mload(0x31e0), /*column1_row5*/ mload(0x31e0), PRIME)),
                PRIME)
              mstore(0x4a00, val)
              }
              ...
              let val := addmod(
                /*column1_row3*/ mload(0x31a0),
                sub(
                  PRIME,
                  addmod(/*column1_row4*/ mload(0x31c0), /*column1_row4*/ mload(0x31c0), PRIME)),
                PRIME)
              mstore(0x4a20, val)
              }
              ...
              let val := addmod(
                /*column1_row9*/ mload(0x3260),
                sub(
                  PRIME,
                  addmod(/*column1_row10*/ mload(0x3280), /*column1_row10*/ mload(0x3280), PRIME)),
                PRIME)
              mstore(0x4a40, val)
              }
              ...
              let val := addmod(
                /*column1_row5*/ mload(0x31e0),
                sub(
                  PRIME,
                  addmod(/*column1_row6*/ mload(0x3200), /*column1_row6*/ mload(0x3200), PRIME)),
                PRIME)
              mstore(0x4a60, val)
              }
              ...
              let val := addmod(
                /*column1_row6*/ mload(0x3200),
                sub(
                  PRIME,
                  addmod(/*column1_row7*/ mload(0x3220), /*column1_row7*/ mload(0x3220), PRIME)),
                PRIME)
              mstore(0x4a80, val)
              }
              ...
              let val := addmod(
                /*column1_row7*/ mload(0x3220),
                sub(
                  PRIME,
                  addmod(/*column1_row8*/ mload(0x3240), /*column1_row8*/ mload(0x3240), PRIME)),
                PRIME)
              mstore(0x4aa0, val)
              }
              ...
              let val := addmod(
                /*column1_row8*/ mload(0x3240),
                sub(
                  PRIME,
                  addmod(/*column1_row9*/ mload(0x3260), /*column1_row9*/ mload(0x3260), PRIME)),
                PRIME)
              mstore(0x4ac0, val)
              }
              ...
              let val := addmod(
                /*column1_row10*/ mload(0x3280),
                sub(
                  PRIME,
                  addmod(/*column1_row11*/ mload(0x32a0), /*column1_row11*/ mload(0x32a0), PRIME)),
                PRIME)
              mstore(0x4b00, val)
              }
              ...
              let val := addmod(
                /*column1_row11*/ mload(0x32a0),
                sub(
                  PRIME,
                  addmod(/*column1_row12*/ mload(0x32c0), /*column1_row12*/ mload(0x32c0), PRIME)),
                PRIME)
              mstore(0x4b20, val)
              }
              ...
              let val := addmod(
                /*column1_row12*/ mload(0x32c0),
                sub(
                  PRIME,
                  addmod(/*column1_row13*/ mload(0x32e0), /*column1_row13*/ mload(0x32e0), PRIME)),
                PRIME)
              mstore(0x4b40, val)
              }
              ...
              let val := addmod(
                /*column1_row13*/ mload(0x32e0),
                sub(
                  PRIME,
                  addmod(/*column1_row14*/ mload(0x3300), /*column1_row14*/ mload(0x3300), PRIME)),
                PRIME)
              mstore(0x4b60, val)
              }
              ...
              let val := addmod(
                /*column1_row14*/ mload(0x3300),
                sub(
                  PRIME,
                  addmod(/*column1_row15*/ mload(0x3320), /*column1_row15*/ mload(0x3320), PRIME)),
                PRIME)
              mstore(0x4b80, val)
              }
              ...
              let val := addmod(/*column20_row2*/ mload(0x42c0), sub(PRIME, /*column20_row0*/ mload(0x4280)), PRIME)
              mstore(0x4ba0, val)
              }
              ...
              let val := addmod(/*column2_row1*/ mload(0x3360), sub(PRIME, /*column2_row0*/ mload(0x3340)), PRIME)
              mstore(0x4bc0, val)
              }
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  addmod(/*column6_row1*/ mload(0x3500), /*column6_row1*/ mload(0x3500), PRIME)),
                PRIME)
              mstore(0x4be0, val)
              }
              ...
              let val := addmod(
                1,
                sub(PRIME, /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_0*/ mload(0x4be0)),
                PRIME)
              mstore(0x4c00, val)
              }
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  addmod(/*column10_row1*/ mload(0x3780), /*column10_row1*/ mload(0x3780), PRIME)),
                PRIME)
              mstore(0x4c20, val)
              }
              ...
              let val := addmod(
                1,
                sub(PRIME, /*intermediate_value/pedersen/hash1/ec_subset_sum/bit_0*/ mload(0x4c20)),
                PRIME)
              mstore(0x4c40, val)
              }
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  addmod(/*column14_row1*/ mload(0x3a00), /*column14_row1*/ mload(0x3a00), PRIME)),
                PRIME)
              mstore(0x4c60, val)
              }
              ...
              let val := addmod(
                1,
                sub(PRIME, /*intermediate_value/pedersen/hash2/ec_subset_sum/bit_0*/ mload(0x4c60)),
                PRIME)
              mstore(0x4c80, val)
              }
              ...
              let val := addmod(
                /*column18_row0*/ mload(0x3c60),
                sub(
                  PRIME,
                  addmod(/*column18_row1*/ mload(0x3c80), /*column18_row1*/ mload(0x3c80), PRIME)),
                PRIME)
              mstore(0x4ca0, val)
              }
              ...
              let val := addmod(
                1,
                sub(PRIME, /*intermediate_value/pedersen/hash3/ec_subset_sum/bit_0*/ mload(0x4ca0)),
                PRIME)
              mstore(0x4cc0, val)
              }
              ...
              let val := /*column0_row12*/ mload(0x3040)
              mstore(0x4ce0, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value0_0*/ mload(0x4ce0),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
                /*column0_row28*/ mload(0x3060),
                PRIME)
              mstore(0x4d00, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value1_0*/ mload(0x4d00),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
                /*column0_row44*/ mload(0x3080),
                PRIME)
              mstore(0x4d20, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value2_0*/ mload(0x4d20),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
                /*column0_row60*/ mload(0x30a0),
                PRIME)
              mstore(0x4d40, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value3_0*/ mload(0x4d40),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
                /*column0_row76*/ mload(0x30c0),
                PRIME)
              mstore(0x4d60, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value4_0*/ mload(0x4d60),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
                /*column0_row92*/ mload(0x30e0),
                PRIME)
              mstore(0x4d80, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value5_0*/ mload(0x4d80),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
                /*column0_row108*/ mload(0x3100),
                PRIME)
              mstore(0x4da0, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc_builtin/value6_0*/ mload(0x4da0),
                  /*offset_size*/ mload(0xa0),
                  PRIME),
                /*column0_row124*/ mload(0x3120),
                PRIME)
              mstore(0x4dc0, val)
              }
              ...
              let val := mulmod(/*column21_row6*/ mload(0x43c0), /*column21_row6*/ mload(0x43c0), PRIME)
              mstore(0x4de0, val)
              }
              ...
              let val := addmod(
                /*column21_row31*/ mload(0x4600),
                sub(
                  PRIME,
                  addmod(/*column21_row63*/ mload(0x4660), /*column21_row63*/ mload(0x4660), PRIME)),
                PRIME)
              mstore(0x4e00, val)
              }
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_0*/ mload(0x4e00)),
                PRIME)
              mstore(0x4e20, val)
              }
              ...
              let val := addmod(
                /*column21_row3*/ mload(0x4360),
                sub(
                  PRIME,
                  addmod(/*column21_row19*/ mload(0x4520), /*column21_row19*/ mload(0x4520), PRIME)),
                PRIME)
              mstore(0x4e40, val)
              }
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_0*/ mload(0x4e40)),
                PRIME)
              mstore(0x4e60, val)
              }
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/cpu/decode/opcode_rc/bit_0*/ mload(0x49a0),
                  /*intermediate_value/cpu/decode/opcode_rc/bit_0*/ mload(0x49a0),
                  PRIME),
                sub(PRIME, /*intermediate_value/cpu/decode/opcode_rc/bit_0*/ mload(0x49a0)),
                PRIME)
              ...
              let val := /*column1_row0*/ mload(0x3140)
                  ...
                  addmod(
                    mulmod(
                      addmod(
                        mulmod(
                          addmod(
                            mulmod(/*column1_row0*/ mload(0x3140), /*offset_size*/ mload(0xa0), PRIME),
                            /*column0_row4*/ mload(0x3000),
                            PRIME),
                          /*offset_size*/ mload(0xa0),
                          PRIME),
                        /*column0_row8*/ mload(0x3020),
                        PRIME),
                      /*offset_size*/ mload(0xa0),
                      PRIME),
              ...
              let val := addmod(
                addmod(/*column19_row8*/ mload(0x3e80), /*half_offset_size*/ mload(0xc0), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(
              ...
              let val := addmod(
                addmod(/*column19_row4*/ mload(0x3e00), /*half_offset_size*/ mload(0xc0), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(
                      mulmod(
                        /*intermediate_value/cpu/decode/opcode_rc/bit_1*/ mload(0x49c0),
                        /*column21_row8*/ mload(0x4400),
                        PRIME),
                      mulmod(
                        addmod(
                          1,
                          sub(PRIME, /*intermediate_value/cpu/decode/opcode_rc/bit_1*/ mload(0x49c0)),
                          PRIME),
                        /*column21_row0*/ mload(0x4300),
                        PRIME),
                      PRIME),
              ...
              let val := addmod(
                addmod(/*column19_row12*/ mload(0x3ec0), /*half_offset_size*/ mload(0xc0), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(
              ...
              let val := addmod(
                /*column21_row4*/ mload(0x4380),
                sub(
                  PRIME,
                  mulmod(/*column19_row5*/ mload(0x3e20), /*column19_row13*/ mload(0x3ee0), PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(
                  addmod(
                    1,
                    sub(PRIME, /*intermediate_value/cpu/decode/opcode_rc/bit_9*/ mload(0x4a40)),
                    PRIME),
                  /*column21_row12*/ mload(0x4480),
                  PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(
                      mulmod(
                        ...
                        addmod(/*column19_row5*/ mload(0x3e20), /*column19_row13*/ mload(0x3ee0), PRIME),
                        PRIME),
                      mulmod(
                        ...
                        sub(
                          ...
                          addmod(
                            addmod(
                              ...
                              /*intermediate_value/cpu/decode/opcode_rc/bit_6*/ mload(0x4a80),
                              PRIME),
                            /*intermediate_value/cpu/decode/opcode_rc/bit_9*/ mload(0x4a40),
                            PRIME)),
                        PRIME),
                      /*column19_row13*/ mload(0x3ee0),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column21_row2*/ mload(0x4340),
                sub(
                  PRIME,
                  mulmod(
                    /*intermediate_value/cpu/decode/opcode_rc/bit_9*/ mload(0x4a40),
                    /*column19_row9*/ mload(0x3ea0),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column21_row10*/ mload(0x4440),
                sub(
                  PRIME,
                  mulmod(/*column21_row2*/ mload(0x4340), /*column21_row12*/ mload(0x4480), PRIME)),
                PRIME)
                ...
                addmod(
                  ...
                  mulmod(
                    ...
                    addmod(
                      ...
                      sub(
                        PRIME,
                        addmod(/*column19_row0*/ mload(0x3d80), /*column19_row13*/ mload(0x3ee0), PRIME)),
                      PRIME),
                    PRIME),
                  PRIME),
                sub(
                  ...
                  addmod(
                      ...
                      mulmod(
                        addmod(
                          ...
                          sub(
                            ...
                            addmod(
                              addmod(
                                /*intermediate_value/cpu/decode/opcode_rc/bit_7*/ mload(0x4aa0),
                                /*intermediate_value/cpu/decode/opcode_rc/bit_8*/ mload(0x4ac0),
                                PRIME),
                              /*intermediate_value/cpu/decode/opcode_rc/bit_9*/ mload(0x4a40),
                              PRIME)),
                          PRIME),
                        /*intermediate_value/npc_reg_0*/ mload(0x4ae0),
                        PRIME),
                      mulmod(
                        /*intermediate_value/cpu/decode/opcode_rc/bit_7*/ mload(0x4aa0),
                        /*column21_row12*/ mload(0x4480),
                    ...
                    mulmod(
                      /*intermediate_value/cpu/decode/opcode_rc/bit_8*/ mload(0x4ac0),
                      addmod(/*column19_row0*/ mload(0x3d80), /*column21_row12*/ mload(0x4480), PRIME),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                ...
                addmod(
                  /*column19_row16*/ mload(0x3f00),
                  sub(PRIME, /*intermediate_value/npc_reg_0*/ mload(0x4ae0)),
                  PRIME),
                PRIME)
                  ...
                  addmod(
                    addmod(
                      addmod(
                        /*column21_row0*/ mload(0x4300),
                        mulmod(
                          /*intermediate_value/cpu/decode/opcode_rc/bit_10*/ mload(0x4b00),
                          /*column21_row12*/ mload(0x4480),
                          PRIME),
                        PRIME),
                      /*intermediate_value/cpu/decode/opcode_rc/bit_11*/ mload(0x4b20),
                      PRIME),
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  addmod(
                    ...
                    mulmod(
                      /*intermediate_value/cpu/decode/opcode_rc/bit_12*/ mload(0x4b40),
                      addmod(/*column21_row0*/ mload(0x4300), 2, PRIME),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_rc/bit_12*/ mload(0x4b40),
                addmod(/*column19_row9*/ mload(0x3ea0), sub(PRIME, /*column21_row8*/ mload(0x4400)), PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/cpu/decode/opcode_rc/bit_14*/ mload(0x4b80),
                addmod(
                  /*column19_row9*/ mload(0x3ea0),
                  sub(PRIME, /*column21_row12*/ mload(0x4480)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(/*column21_row0*/ mload(0x4300), sub(PRIME, /*initial_ap*/ mload(0xe0)), PRIME)
              ...
              let val := addmod(/*column21_row8*/ mload(0x4400), sub(PRIME, /*initial_ap*/ mload(0xe0)), PRIME)
              ...
              let val := addmod(/*column19_row0*/ mload(0x3d80), sub(PRIME, /*initial_pc*/ mload(0x100)), PRIME)
              ...
              let val := addmod(/*column21_row0*/ mload(0x4300), sub(PRIME, /*final_ap*/ mload(0x120)), PRIME)
              ...
              let val := addmod(/*column19_row0*/ mload(0x3d80), sub(PRIME, /*final_pc*/ mload(0x140)), PRIME)
                    ...
                    mulmod(
                      addmod(
                        ...
                        sub(
                          PRIME,
                          addmod(
                            /*column20_row0*/ mload(0x4280),
                            mulmod(
                              /*memory/multi_column_perm/hash_interaction_elm0*/ mload(0x180),
                              /*column20_row1*/ mload(0x42a0),
                              PRIME),
                            PRIME)),
                        PRIME),
                      /*column24_inter1_row0*/ mload(0x4940),
                      PRIME),
                    /*column19_row0*/ mload(0x3d80),
                    PRIME),
                  mulmod(
                ...
                mulmod(
                  addmod(
                    ...
                    sub(
                      PRIME,
                      addmod(
                        /*column20_row2*/ mload(0x42c0),
                        mulmod(
                          /*memory/multi_column_perm/hash_interaction_elm0*/ mload(0x180),
                          /*column20_row3*/ mload(0x42e0),
                          PRIME),
                        PRIME)),
                    PRIME),
                  /*column24_inter1_row2*/ mload(0x4960),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    addmod(
                      ...
                      sub(
                        PRIME,
                        addmod(
                          /*column19_row2*/ mload(0x3dc0),
                          mulmod(
                            /*memory/multi_column_perm/hash_interaction_elm0*/ mload(0x180),
                            /*column19_row3*/ mload(0x3de0),
                            PRIME),
                          PRIME)),
                      PRIME),
                    /*column24_inter1_row0*/ mload(0x4940),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/memory/address_diff_0*/ mload(0x4ba0),
                  /*intermediate_value/memory/address_diff_0*/ mload(0x4ba0),
                  PRIME),
                sub(PRIME, /*intermediate_value/memory/address_diff_0*/ mload(0x4ba0)),
                PRIME)
              ...
              let val := mulmod(
                addmod(/*intermediate_value/memory/address_diff_0*/ mload(0x4ba0), sub(PRIME, 1), PRIME),
                addmod(/*column20_row1*/ mload(0x42a0), sub(PRIME, /*column20_row3*/ mload(0x42e0)), PRIME),
                PRIME)
              ...
              let val := addmod(/*column20_row0*/ mload(0x4280), sub(PRIME, 1), PRIME)
              ...
              let val := /*column19_row2*/ mload(0x3dc0)
              ...
              let val := /*column19_row3*/ mload(0x3de0)
                ...
                addmod(
                  mulmod(
                    addmod(
                      ...
                      sub(PRIME, /*column2_row0*/ mload(0x3340)),
                      PRIME),
                    /*column23_inter1_row0*/ mload(0x4900),
                    PRIME),
                  /*column0_row0*/ mload(0x2fc0),
                  PRIME),
              ...
              let val := addmod(
                mulmod(
                  addmod(
                    /*rc16/perm/interaction_elm*/ mload(0x1c0),
                    sub(PRIME, /*column2_row1*/ mload(0x3360)),
                    PRIME),
                  /*column23_inter1_row1*/ mload(0x4920),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    addmod(
                      /*rc16/perm/interaction_elm*/ mload(0x1c0),
                      sub(PRIME, /*column0_row1*/ mload(0x2fe0)),
                      PRIME),
                    /*column23_inter1_row0*/ mload(0x4900),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/rc16/diff_0*/ mload(0x4bc0),
                  /*intermediate_value/rc16/diff_0*/ mload(0x4bc0),
                  PRIME),
                sub(PRIME, /*intermediate_value/rc16/diff_0*/ mload(0x4bc0)),
                PRIME)
              ...
              let val := addmod(/*column2_row0*/ mload(0x3340), sub(PRIME, /*rc_min*/ mload(0x200)), PRIME)
              ...
              let val := addmod(/*column2_row0*/ mload(0x3340), sub(PRIME, /*rc_max*/ mload(0x220)), PRIME)
              ...
              let val := mulmod(
                /*column13_row255*/ mload(0x39c0),
                addmod(
                  /*column6_row1*/ mload(0x3500),
                  sub(
                    PRIME,
                    mulmod(
                      3138550867693340381917894711603833208051177722232017256448,
                      /*column6_row192*/ mload(0x3520),
                      PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column17_row255*/ mload(0x3c40),
                    addmod(
                      /*column6_row192*/ mload(0x3520),
                      sub(
                        PRIME,
                        addmod(/*column6_row193*/ mload(0x3540), /*column6_row193*/ mload(0x3540), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*column17_row255*/ mload(0x3c40),
                addmod(
                  /*column6_row193*/ mload(0x3540),
                  sub(PRIME, mulmod(8, /*column6_row196*/ mload(0x3560), PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  mulmod(
                    addmod(
                      /*column6_row251*/ mload(0x35a0),
                      sub(
                        PRIME,
                        addmod(/*column6_row252*/ mload(0x35c0), /*column6_row252*/ mload(0x35c0), PRIME)),
                      PRIME),
                    addmod(
                      /*column6_row196*/ mload(0x3560),
                      sub(
                        PRIME,
                        addmod(/*column6_row197*/ mload(0x3580), /*column6_row197*/ mload(0x3580), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                addmod(
                  ...
                  PRIME),
                addmod(
                  /*column6_row197*/ mload(0x3580),
                  sub(PRIME, mulmod(18014398509481984, /*column6_row251*/ mload(0x35a0), PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_0*/ mload(0x4be0),
                addmod(
                  /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_0*/ mload(0x4be0),
                  sub(PRIME, 1),
                  PRIME),
              ...
              let val := /*column6_row0*/ mload(0x34e0)
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column5_row0*/ mload(0x34a0),
                    addmod(
                      /*column3_row0*/ mload(0x3380),
              ...
              let val := addmod(
                mulmod(/*column5_row0*/ mload(0x34a0), /*column5_row0*/ mload(0x34a0), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_0*/ mload(0x4be0),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_0*/ mload(0x4be0),
                  addmod(/*column4_row0*/ mload(0x3420), /*column4_row1*/ mload(0x3440), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column5_row0*/ mload(0x34a0),
                    addmod(/*column3_row0*/ mload(0x3380), sub(PRIME, /*column3_row1*/ mload(0x33a0)), PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_neg_0*/ mload(0x4c00),
                addmod(/*column3_row1*/ mload(0x33a0), sub(PRIME, /*column3_row0*/ mload(0x3380)), PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash0/ec_subset_sum/bit_neg_0*/ mload(0x4c00),
                addmod(/*column4_row1*/ mload(0x3440), sub(PRIME, /*column4_row0*/ mload(0x3420)), PRIME),
                PRIME)
              ...
              let val := addmod(
                /*column3_row256*/ mload(0x33e0),
                sub(PRIME, /*column3_row255*/ mload(0x33c0)),
                PRIME)
              ...
              let val := addmod(
                /*column4_row256*/ mload(0x3480),
                sub(PRIME, /*column4_row255*/ mload(0x3460)),
                PRIME)
              ...
              let val := mulmod(
                /*column5_row255*/ mload(0x34c0),
                addmod(
                  /*column10_row1*/ mload(0x3780),
                  sub(
                    PRIME,
                    mulmod(
                      3138550867693340381917894711603833208051177722232017256448,
                      /*column10_row192*/ mload(0x37a0),
                      PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column9_row255*/ mload(0x3740),
                    addmod(
                      /*column10_row192*/ mload(0x37a0),
                      sub(
                        PRIME,
                        addmod(/*column10_row193*/ mload(0x37c0), /*column10_row193*/ mload(0x37c0), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*column9_row255*/ mload(0x3740),
                addmod(
                  /*column10_row193*/ mload(0x37c0),
                  sub(PRIME, mulmod(8, /*column10_row196*/ mload(0x37e0), PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  mulmod(
                    addmod(
                      /*column10_row251*/ mload(0x3820),
                      sub(
                        PRIME,
                        addmod(/*column10_row252*/ mload(0x3840), /*column10_row252*/ mload(0x3840), PRIME)),
                      PRIME),
                    addmod(
                      /*column10_row196*/ mload(0x37e0),
                      sub(
                        PRIME,
                        addmod(/*column10_row197*/ mload(0x3800), /*column10_row197*/ mload(0x3800), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                addmod(
                  ...
                  PRIME),
                addmod(
                  /*column10_row197*/ mload(0x3800),
                  sub(PRIME, mulmod(18014398509481984, /*column10_row251*/ mload(0x3820), PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash1/ec_subset_sum/bit_0*/ mload(0x4c20),
                addmod(
                  /*intermediate_value/pedersen/hash1/ec_subset_sum/bit_0*/ mload(0x4c20),
                  sub(PRIME, 1),
                  PRIME),
              ...
              let val := /*column10_row0*/ mload(0x3760)
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column9_row0*/ mload(0x3720),
                    addmod(
                      /*column7_row0*/ mload(0x3600),
                      sub(PRIME, /*periodic_column/pedersen/points/x*/ mload(0x0)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column9_row0*/ mload(0x3720), /*column9_row0*/ mload(0x3720), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*intermediate_value/pedersen/hash1/ec_subset_sum/bit_0*/ mload(0x4c20),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/pedersen/hash1/ec_subset_sum/bit_0*/ mload(0x4c20),
                  addmod(/*column8_row0*/ mload(0x36a0), /*column8_row1*/ mload(0x36c0), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column9_row0*/ mload(0x3720),
                    addmod(/*column7_row0*/ mload(0x3600), sub(PRIME, /*column7_row1*/ mload(0x3620)), PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash1/ec_subset_sum/bit_neg_0*/ mload(0x4c40),
                addmod(/*column7_row1*/ mload(0x3620), sub(PRIME, /*column7_row0*/ mload(0x3600)), PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash1/ec_subset_sum/bit_neg_0*/ mload(0x4c40),
                addmod(/*column8_row1*/ mload(0x36c0), sub(PRIME, /*column8_row0*/ mload(0x36a0)), PRIME),
                PRIME)
              ...
              let val := addmod(
                /*column7_row256*/ mload(0x3660),
                sub(PRIME, /*column7_row255*/ mload(0x3640)),
                PRIME)
              ...
              let val := addmod(
                /*column8_row256*/ mload(0x3700),
                sub(PRIME, /*column8_row255*/ mload(0x36e0)),
                PRIME)
              ...
              let val := mulmod(
                /*column22_row144*/ mload(0x48a0),
                addmod(
                  /*column14_row1*/ mload(0x3a00),
                  sub(
                    PRIME,
                    mulmod(
                      3138550867693340381917894711603833208051177722232017256448,
                      /*column14_row192*/ mload(0x3a20),
                      PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column22_row16*/ mload(0x4860),
                    addmod(
                      /*column14_row192*/ mload(0x3a20),
                      sub(
                        PRIME,
                        addmod(/*column14_row193*/ mload(0x3a40), /*column14_row193*/ mload(0x3a40), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*column22_row16*/ mload(0x4860),
                addmod(
                  /*column14_row193*/ mload(0x3a40),
                  sub(PRIME, mulmod(8, /*column14_row196*/ mload(0x3a60), PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  mulmod(
                    addmod(
                      /*column14_row251*/ mload(0x3aa0),
                      sub(
                        PRIME,
                        addmod(/*column14_row252*/ mload(0x3ac0), /*column14_row252*/ mload(0x3ac0), PRIME)),
                      PRIME),
                    addmod(
                      /*column14_row196*/ mload(0x3a60),
                      sub(
                        PRIME,
                        addmod(/*column14_row197*/ mload(0x3a80), /*column14_row197*/ mload(0x3a80), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                addmod(
                  ...
                  PRIME),
                addmod(
                  /*column14_row197*/ mload(0x3a80),
                  sub(PRIME, mulmod(18014398509481984, /*column14_row251*/ mload(0x3aa0), PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash2/ec_subset_sum/bit_0*/ mload(0x4c60),
                addmod(
                  /*intermediate_value/pedersen/hash2/ec_subset_sum/bit_0*/ mload(0x4c60),
                  sub(PRIME, 1),
                  PRIME),
              ...
              let val := /*column14_row0*/ mload(0x39e0)
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column13_row0*/ mload(0x39a0),
                    addmod(
                      /*column11_row0*/ mload(0x3880),
                      sub(PRIME, /*periodic_column/pedersen/points/x*/ mload(0x0)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column13_row0*/ mload(0x39a0), /*column13_row0*/ mload(0x39a0), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*intermediate_value/pedersen/hash2/ec_subset_sum/bit_0*/ mload(0x4c60),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/pedersen/hash2/ec_subset_sum/bit_0*/ mload(0x4c60),
                  addmod(/*column12_row0*/ mload(0x3920), /*column12_row1*/ mload(0x3940), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column13_row0*/ mload(0x39a0),
                    addmod(/*column11_row0*/ mload(0x3880), sub(PRIME, /*column11_row1*/ mload(0x38a0)), PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash2/ec_subset_sum/bit_neg_0*/ mload(0x4c80),
                addmod(/*column11_row1*/ mload(0x38a0), sub(PRIME, /*column11_row0*/ mload(0x3880)), PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash2/ec_subset_sum/bit_neg_0*/ mload(0x4c80),
                addmod(/*column12_row1*/ mload(0x3940), sub(PRIME, /*column12_row0*/ mload(0x3920)), PRIME),
                PRIME)
              ...
              let val := addmod(
                /*column11_row256*/ mload(0x38e0),
                sub(PRIME, /*column11_row255*/ mload(0x38c0)),
                PRIME)
              ...
              let val := addmod(
                /*column12_row256*/ mload(0x3980),
                sub(PRIME, /*column12_row255*/ mload(0x3960)),
                PRIME)
              ...
              let val := mulmod(
                /*column22_row208*/ mload(0x48c0),
                addmod(
                  /*column18_row1*/ mload(0x3c80),
                  sub(
                    PRIME,
                    mulmod(
                      3138550867693340381917894711603833208051177722232017256448,
                      /*column18_row192*/ mload(0x3ca0),
                      PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column22_row80*/ mload(0x4880),
                    addmod(
                      /*column18_row192*/ mload(0x3ca0),
                      sub(
                        PRIME,
                        addmod(/*column18_row193*/ mload(0x3cc0), /*column18_row193*/ mload(0x3cc0), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*column22_row80*/ mload(0x4880),
                addmod(
                  /*column18_row193*/ mload(0x3cc0),
                  sub(PRIME, mulmod(8, /*column18_row196*/ mload(0x3ce0), PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  mulmod(
                    addmod(
                      /*column18_row251*/ mload(0x3d20),
                      sub(
                        PRIME,
                        addmod(/*column18_row252*/ mload(0x3d40), /*column18_row252*/ mload(0x3d40), PRIME)),
                      PRIME),
                    addmod(
                      /*column18_row196*/ mload(0x3ce0),
                      sub(
                        PRIME,
                        addmod(/*column18_row197*/ mload(0x3d00), /*column18_row197*/ mload(0x3d00), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                addmod(
                  ...
                  PRIME),
                addmod(
                  /*column18_row197*/ mload(0x3d00),
                  sub(PRIME, mulmod(18014398509481984, /*column18_row251*/ mload(0x3d20), PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash3/ec_subset_sum/bit_0*/ mload(0x4ca0),
                addmod(
                  /*intermediate_value/pedersen/hash3/ec_subset_sum/bit_0*/ mload(0x4ca0),
                  sub(PRIME, 1),
                  PRIME),
              ...
              let val := /*column18_row0*/ mload(0x3c60)
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column17_row0*/ mload(0x3c20),
                    addmod(
                      /*column15_row0*/ mload(0x3b00),
                      sub(PRIME, /*periodic_column/pedersen/points/x*/ mload(0x0)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column17_row0*/ mload(0x3c20), /*column17_row0*/ mload(0x3c20), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*intermediate_value/pedersen/hash3/ec_subset_sum/bit_0*/ mload(0x4ca0),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/pedersen/hash3/ec_subset_sum/bit_0*/ mload(0x4ca0),
                  addmod(/*column16_row0*/ mload(0x3ba0), /*column16_row1*/ mload(0x3bc0), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column17_row0*/ mload(0x3c20),
                    addmod(/*column15_row0*/ mload(0x3b00), sub(PRIME, /*column15_row1*/ mload(0x3b20)), PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash3/ec_subset_sum/bit_neg_0*/ mload(0x4cc0),
                addmod(/*column15_row1*/ mload(0x3b20), sub(PRIME, /*column15_row0*/ mload(0x3b00)), PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/pedersen/hash3/ec_subset_sum/bit_neg_0*/ mload(0x4cc0),
                addmod(/*column16_row1*/ mload(0x3bc0), sub(PRIME, /*column16_row0*/ mload(0x3ba0)), PRIME),
                PRIME)
              ...
              let val := addmod(
                /*column15_row256*/ mload(0x3b60),
                sub(PRIME, /*column15_row255*/ mload(0x3b40)),
                PRIME)
              ...
              let val := addmod(
                /*column16_row256*/ mload(0x3c00),
                sub(PRIME, /*column16_row255*/ mload(0x3be0)),
                PRIME)
              ...
              let val := addmod(/*column19_row7*/ mload(0x3e60), sub(PRIME, /*column6_row0*/ mload(0x34e0)), PRIME)
              ...
              let val := addmod(
                /*column19_row135*/ mload(0x4080),
                sub(PRIME, /*column10_row0*/ mload(0x3760)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row263*/ mload(0x4140),
                sub(PRIME, /*column14_row0*/ mload(0x39e0)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row391*/ mload(0x41a0),
                sub(PRIME, /*column18_row0*/ mload(0x3c60)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row134*/ mload(0x4060),
                sub(PRIME, addmod(/*column19_row38*/ mload(0x3f60), 1, PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row71*/ mload(0x3fc0),
                sub(PRIME, /*column6_row256*/ mload(0x35e0)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row199*/ mload(0x4100),
                sub(PRIME, /*column10_row256*/ mload(0x3860)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row327*/ mload(0x4180),
                sub(PRIME, /*column14_row256*/ mload(0x3ae0)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row455*/ mload(0x4200),
                sub(PRIME, /*column18_row256*/ mload(0x3d60)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row70*/ mload(0x3fa0),
                sub(PRIME, addmod(/*column19_row6*/ mload(0x3e40), 1, PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row39*/ mload(0x3f80),
                sub(PRIME, /*column3_row511*/ mload(0x3400)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row167*/ mload(0x40e0),
                sub(PRIME, /*column7_row511*/ mload(0x3680)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row295*/ mload(0x4160),
                sub(PRIME, /*column11_row511*/ mload(0x3900)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row423*/ mload(0x41e0),
                sub(PRIME, /*column15_row511*/ mload(0x3b80)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row38*/ mload(0x3f60),
                sub(PRIME, addmod(/*column19_row70*/ mload(0x3fa0), 1, PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*intermediate_value/rc_builtin/value7_0*/ mload(0x4dc0),
                sub(PRIME, /*column19_row103*/ mload(0x4040)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row230*/ mload(0x4120),
                sub(PRIME, addmod(/*column19_row102*/ mload(0x4020), 1, PRIME)),
                PRIME)
              ...
              let val := addmod(
                addmod(
                  addmod(
                    addmod(
                      /*intermediate_value/ecdsa/signature0/doubling_key/x_squared*/ mload(0x4de0),
                      /*intermediate_value/ecdsa/signature0/doubling_key/x_squared*/ mload(0x4de0),
                      PRIME),
                    /*intermediate_value/ecdsa/signature0/doubling_key/x_squared*/ mload(0x4de0),
                    PRIME),
                ...
                sub(
                  PRIME,
                  mulmod(
                    addmod(/*column21_row14*/ mload(0x44c0), /*column21_row14*/ mload(0x44c0), PRIME),
                    /*column21_row1*/ mload(0x4320),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column21_row1*/ mload(0x4320), /*column21_row1*/ mload(0x4320), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(/*column21_row6*/ mload(0x43c0), /*column21_row6*/ mload(0x43c0), PRIME),
                    /*column21_row22*/ mload(0x4560),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                addmod(/*column21_row14*/ mload(0x44c0), /*column21_row30*/ mload(0x45e0), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column21_row1*/ mload(0x4320),
                    addmod(
                      /*column21_row6*/ mload(0x43c0),
                      sub(PRIME, /*column21_row22*/ mload(0x4560)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := /*column21_row31*/ mload(0x4600)
              ...
              let val := addmod(
                ...
                sub(
                  PRIME,
                  mulmod(
                    /*column21_row15*/ mload(0x44e0),
                    addmod(
                      /*column21_row7*/ mload(0x43e0),
              ...
              let val := addmod(
                mulmod(/*column21_row15*/ mload(0x44e0), /*column21_row15*/ mload(0x44e0), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_0*/ mload(0x4e00),
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_0*/ mload(0x4e00),
                  addmod(/*column21_row23*/ mload(0x4580), /*column21_row55*/ mload(0x4640), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    ...
                    addmod(
                      /*column21_row7*/ mload(0x43e0),
                      sub(PRIME, /*column21_row39*/ mload(0x4620)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_neg_0*/ mload(0x4e20),
                addmod(
                  /*column21_row39*/ mload(0x4620),
                  sub(PRIME, /*column21_row7*/ mload(0x43e0)),
                  PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_neg_0*/ mload(0x4e20),
                addmod(
                  /*column21_row55*/ mload(0x4640),
                  sub(PRIME, /*column21_row23*/ mload(0x4580)),
                  PRIME),
                PRIME)
              ...
              let val := /*column21_row3*/ mload(0x4360)
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_0*/ mload(0x4e40),
                  addmod(
                    /*column21_row5*/ mload(0x43a0),
                    sub(PRIME, /*column21_row14*/ mload(0x44c0)),
                    PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column21_row13*/ mload(0x44a0),
                    addmod(/*column21_row9*/ mload(0x4420), sub(PRIME, /*column21_row6*/ mload(0x43c0)), PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column21_row13*/ mload(0x44a0), /*column21_row13*/ mload(0x44a0), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_0*/ mload(0x4e40),
                    addmod(
                      addmod(/*column21_row9*/ mload(0x4420), /*column21_row6*/ mload(0x43c0), PRIME),
                      /*column21_row25*/ mload(0x45c0),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(
                  /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_0*/ mload(0x4e40),
                  addmod(/*column21_row5*/ mload(0x43a0), /*column21_row21*/ mload(0x4540), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column21_row13*/ mload(0x44a0),
                    addmod(
                      /*column21_row9*/ mload(0x4420),
                      sub(PRIME, /*column21_row25*/ mload(0x45c0)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_neg_0*/ mload(0x4e60),
                addmod(
                  /*column21_row25*/ mload(0x45c0),
                  sub(PRIME, /*column21_row9*/ mload(0x4420)),
                  PRIME),
                PRIME)
              ...
              let val := mulmod(
                /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_neg_0*/ mload(0x4e60),
                addmod(
                  /*column21_row21*/ mload(0x4540),
                  sub(PRIME, /*column21_row5*/ mload(0x43a0)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                /*column21_row8183*/ mload(0x47e0),
                sub(
                  PRIME,
                  addmod(
                    /*column21_row4085*/ mload(0x46a0),
                    mulmod(
                      /*column22_row8160*/ mload(0x48e0),
                      addmod(
                        /*column21_row8167*/ mload(0x4760),
                        sub(PRIME, /*column21_row4089*/ mload(0x46c0)),
                        PRIME),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column22_row8160*/ mload(0x48e0), /*column22_row8160*/ mload(0x48e0), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(/*column21_row8167*/ mload(0x4760), /*column21_row4089*/ mload(0x46c0), PRIME),
                    /*column21_row4102*/ mload(0x4720),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                addmod(/*column21_row8183*/ mload(0x47e0), /*column21_row4110*/ mload(0x4740), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column22_row8160*/ mload(0x48e0),
                    addmod(
                      /*column21_row8167*/ mload(0x4760),
                      sub(PRIME, /*column21_row4102*/ mload(0x4720)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                addmod(
                  /*column21_row8181*/ mload(0x47c0),
                  /*ecdsa/sig_config.shift_point.y*/ mload(0x300),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column21_row4093*/ mload(0x4700),
                    addmod(
                      /*column21_row8185*/ mload(0x4800),
                      sub(PRIME, /*ecdsa/sig_config.shift_point.x*/ mload(0x2e0)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column21_row4093*/ mload(0x4700), /*column21_row4093*/ mload(0x4700), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(
              ...
              let val := addmod(
                mulmod(/*column21_row31*/ mload(0x4600), /*column21_row4081*/ mload(0x4680), PRIME),
                sub(PRIME, 1),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column21_row3*/ mload(0x4360), /*column21_row4091*/ mload(0x46e0), PRIME),
                sub(PRIME, 1),
                PRIME)
              ...
              let val := addmod(
                /*column21_row8177*/ mload(0x47a0),
                sub(
                  PRIME,
                  mulmod(/*column21_row6*/ mload(0x43c0), /*column21_row6*/ mload(0x43c0), PRIME)),
                PRIME)
              ...
              let val := addmod(
                mulmod(/*column21_row14*/ mload(0x44c0), /*column21_row14*/ mload(0x44c0), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(
                      mulmod(/*column21_row6*/ mload(0x43c0), /*column21_row8177*/ mload(0x47a0), PRIME),
                      mulmod(/*ecdsa/sig_config.alpha*/ mload(0x2c0), /*column21_row6*/ mload(0x43c0), PRIME),
                      PRIME),
              ...
              let val := addmod(
                /*column19_row4118*/ mload(0x4220),
                sub(PRIME, addmod(/*column19_row22*/ mload(0x3f20), 1, PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row8214*/ mload(0x4260),
                sub(PRIME, addmod(/*column19_row4118*/ mload(0x4220), 1, PRIME)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row4119*/ mload(0x4240),
                sub(PRIME, /*column21_row31*/ mload(0x4600)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row23*/ mload(0x3f40),
                sub(PRIME, /*column21_row6*/ mload(0x43c0)),
                PRIME)
              ...
              let val := addmod(
                /*column19_row86*/ mload(0x3fe0),
                sub(PRIME, addmod(/*column19_row150*/ mload(0x40a0), 1, PRIME)),
                PRIME)
              ...
              let val := mulmod(
                addmod(
                  /*column19_row406*/ mload(0x41c0),
                  sub(PRIME, /*column19_row150*/ mload(0x40a0)),
                  PRIME),
                addmod(
                  /*column19_row406*/ mload(0x41c0),
                  sub(PRIME, addmod(/*column19_row150*/ mload(0x40a0), 2, PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := mulmod(
                addmod(
                  ...
                  PRIME),
                addmod(
                  /*column19_row151*/ mload(0x40c0),
                  sub(PRIME, /*column19_row0*/ mload(0x3d80)),
                  PRIME),
                PRIME)
              ...
              let val := mulmod(
                addmod(
                  ...
                  PRIME),
                addmod(
                  /*column19_row87*/ mload(0x4000),
                  sub(PRIME, /*column21_row8*/ mload(0x4400)),
                  PRIME),
                PRIME)
