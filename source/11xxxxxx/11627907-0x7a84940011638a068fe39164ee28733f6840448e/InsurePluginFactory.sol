...
/**
 *
 * This was a concept plugin for insuring BOND farm with ETH via Stash. Unfortunately plugin had no fallback to receive eth so plugin will need a redeploy.
