...
contract ZRBV2 is Context, IERC20, AccessControl {
    bytes32 public constant UNISWP_ROLE = keccak256("UNISWP_ROLE");
    ...
    constructor () public {
        ...
        _symbol = "ZRBV2";
        _decimals = 18; 
        initialSupply = 200000000000000000000; // add 18 zero's = dit is 200 tokens
        _balances[msg.sender] = initialSupply;  // assigns it to contract creator 
        
        emit Transfer(address(0), msg.sender, initialSupply); //transfers it to contract creator
        
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender); // contract creator default admin
        _setupRole(STAKER_ROLE, msg.sender); // contract creator default staker 
