...
// ASTToken with Governance.
contract ASTToken is ERC20("AlphaSwapToken", "AST"), Ownable {
    ...
    returns (uint256)
    {
        require(blockNumber < block.number, "AST::getPriorVotes: not yet determined");
    ...
    internal
    {
        uint32 blockNumber = safe32(block.number, "AST::_writeCheckpoint: block number exceeds 32 bits");
