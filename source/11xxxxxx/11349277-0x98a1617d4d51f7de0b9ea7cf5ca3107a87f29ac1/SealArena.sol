...
contract SealArena is Ownable {
    ...
    function withdrawFeeRate() public view returns (uint256 feeRate) {
        if(now < close) {
            feeRate = close.sub(now).mul(1e18).div(close.sub(open));
            feeRate = feeRate.mul(feeRate).div(1e18);
        }
    }

    constructor( uint256 _bonus, uint256 _sealQuantity, uint256 _maxPlayer, uint256 _open, uint256 _close) public {
        bonus = _bonus;
        sealQuantity = _sealQuantity;
        maxPlayer = _maxPlayer;
        open = _open;
        close = _close;
        pairAddressOfToken[0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984] = 0xf54B26A9ec6251afC5c7a45e63b775b6a07FF7AD;
        pairAddressOfToken[0xC011a73ee8576Fb46F5E1c5751cA3B9Fe0af2a6F] = 0x2ABf1CF836B321B8e77Ba1C937b6de2536c4e87e;
        pairAddressOfToken[0x0bc529c00C6401aEF6D220BE8C6Ea1667F6Ad93e] = 0x4ffcE2b2a325F60219701A57EC5ED379749c4c90;
        pairAddressOfToken[0x0E29e5AbbB5FD88e28b2d355774e73BD47dE3bcd] = 0xae590578cc96389FA477d5cC0e461a5BeceddF9e;
        pairAddressOfToken[0x429881672B9AE42b8EbA0E26cD9C73711b891Ca5] = 0x82b1506Cc8c184b256cdE4430ae68C2e49a8673C;
        pairAddressOfToken[0xa3BeD4E1c75D00fa6f4E5E6922DB7261B5E9AcD2] = 0x256e337f25A21882102D52F7A6515c85bcCa36F4;
        pairAddressOfToken[0xdAC17F958D2ee523a2206206994597C13D831ec7] = 0xaA9612d06800CC7DB862592e222df31601963acb;
        pairAddressOfToken[0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599] = 0x94FAa1740d31eE3Dce3EFB166020C29334f1Fa9d;
        pairAddressOfToken[0x514910771AF9Ca656af840dff83E8264EcF986CA] = 0xc22008ce0ffFd95D81d467E0879EF068019EfFbb;
        pairAddressOfToken[0x1cEB5cB57C4D4E2b2433641b95Dd330A33185A44] = 0x1Bea99238faC1dB097995fb58974E1A5970C9B63;
        pairAddressOfToken[0x7Fc66500c84A76Ad7e9c93437bFc5Ac33E2DDaE9] = 0xc4daCed3A48c4C58a9871D6023FB4f3B14c09D8a;
        pairAddressOfToken[0xc00e94Cb662C3520282E6f5717214004A7f26888] = 0x956DA493eAf640418E96483AC21926904EECD7d4;
        pairAddressOfToken[0x6B175474E89094C44Da98b954EedeAC495271d0F] = 0x0fCD8a2b4CF65f59eC16aAe52E4D56661767b1F0;
    ...
    function balanceOfUnderlying(address account) public view returns (uint256) {
        return totalValue().mul(balanceOf(account)).div(totalSupply());
    }

    function totalValue() public view returns(uint256) {
        return seal.balanceOf(address(this));
    }
    ...
    function withdraw(address to, uint256 share) external returns (uint256 amount) {
        ...
        require(seal.transfer(to, amount));
    ...
    function rescueToken(ERC20 _token, uint256 _amount) onlyOwner public {
        require(_token != ERC20(address(seal)));
