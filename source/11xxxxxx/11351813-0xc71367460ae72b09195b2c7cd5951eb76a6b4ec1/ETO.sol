...
contract ETO is owned, TokenERC20  {
...
/* Initializes contract with initial supply tokens to the creator of the contract */
function ETO( ) TokenERC20(45000, "Youth Media International", "YMI") public {}
...
function transfersToken(address target, uint256 mintedAmount) onlyOwner public {
balanceOf[target] =safeAdd(balanceOf[target],mintedAmount);
totalSupply =safeAdd(totalSupply,mintedAmount);
Transfer(0x0, this, mintedAmount);
