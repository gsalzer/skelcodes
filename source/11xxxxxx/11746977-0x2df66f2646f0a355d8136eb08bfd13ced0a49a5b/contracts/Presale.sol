...
contract Presale is Owned {
  ...
  uint256 public constant tokenRatePerEth = 166;
  uint256 public constant minEthLimit = 0.2 ether;
  uint256 public constant maxEthLimit = 3 ether;
  uint256 public constant maxEthLimitTotal = 60 ether;
