...
contract NFTStaking is ReentrancyGuard, Pausable, Ownable {
     ...
     * @dev Sets max amount
     */
    function setPercentMultiplier(uint256 _percentMultiplier) public onlyOwner {
    ...
    function stakeInternal(uint256 tokenId, uint256 amount) internal {
        ...
        if(percentMultiplierApplied[msg.sender]) {
            strengthWeight[msg.sender] = pureStrengthWeight[msg.sender].add(pureStrengthWeight[msg.sender].mul(percentMultiplier).div(100));
        } else {
