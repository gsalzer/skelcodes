...
// File: contracts/strategies/StabilizeStrategyStablecoinArbV2.sol

pragma solidity ^0.6.6;

// This is iteration 2 of the strategy
...
// Half the profit earned from the sell will be used to buy WETH and split it among the treasury, stakers and executor
...
// Anyone can be an executors and profit 10% on a trade

// This strategy includes efficiencies to help decrease gas costs and incentivize trading by provider % of profit to trade executor
...
contract StabilizeStrategyStablecoinArbV2 is Ownable {
    using SafeMath for uint256;
    ...
    uint256 public secondsBeforeTrade = 86400; // Default 24 hours wait before trade triggered automatically
    ...
    uint256 public minTradeSplit = 1000; // If the balance of a stablecoin is less than or equal to this, it trades the entire balance
    ...
    function expectedProfit(bool _restrictSwaps) external view returns (uint256) {
    ...
    function executorSwapTokens(address _executor, uint256 _minSecSinceLastTrade) external {
        ...
        checkAndSwapTokens(true, _executor);
    }
    
    // Governance functions
    function governanceSwapTokens(bool _restrict) external onlyGovernance {
        // This is function that force trade tokens at anytime. It can only be called by governance
        checkAndSwapTokens(_restrict, _msgSender());
    }
    ...
    // --------------------
    function startChangeTradeWaitTime(uint256 _seconds) external onlyGovernance {
        _timelockStart = now;
        _timelockType = 11;
        _timelock_data_1 = _seconds;
    }
    
    function finishChangeTradeWaitTime() external onlyGovernance timelockConditionsMet(11) {
    ...
    function finishChangePercentTradeTrigger() external onlyGovernance timelockConditionsMet(12) {
    ...
    function finishChangeMinTradeSplit() external onlyGovernance timelockConditionsMet(13) {
