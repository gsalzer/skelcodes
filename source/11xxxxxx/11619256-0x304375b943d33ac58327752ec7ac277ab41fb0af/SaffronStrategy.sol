...
contract SaffronStrategy is ISaffronStrategy {
  ...
  uint256[] public pool_SFI_rewards = [200/2*1 ether, 410/2*1 ether, 210/2*1 ether, 100/2*1 ether, 210/2*1 ether, 10/2*1 ether, 50/2*1 ether, 410/2*1 ether, 50/2*1 ether, 200/2*1 ether, 25*1 ether/2];
  ...
  function wind_down_epoch(uint256 epoch) external {
    require(epoch == 5, "v1.5: only epoch 5");
