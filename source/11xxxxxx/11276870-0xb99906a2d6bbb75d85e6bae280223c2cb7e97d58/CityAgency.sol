...
contract CityAgency is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 farmStartBlockNum;  // StartBlockNum for Farming of each pool
        uint256 bonus1EndBlockNum;  // bonus1EndBlockNum = farmStartBlockNum + 60480; 60480 = 6 * 60mins * 24hours * 7days
        uint256 bonus2EndBlockNum;  // bonus2EndBlockNum = farmStartBlockNum + 120960; 120960 = 6 * 60mins * 24hours * 14days
    }
    ...
    // Block number when Halving ends.
    uint256 public halvingEndBlock1;
    uint256 public halvingEndBlock2;
    // BonusMultiplier within 2 weeks.
    uint256 public constant BONUS_MULTIPLIER_1WEEK = 4; // first week bonus (farmStartBlockNum ~ bonus1EndBlockNum)
    uint256 public constant BONUS_MULTIPLIER_2WEEK = 2; // second week bonus (bonus1EndBlockNum ~ bonus2EndBlockNum)
    // Halving Blocknum
    ...
    // The block number when CITY mining ends.
    ...
    constructor(
        ...
        halvingEndBlock1 = startBlock.add(3153600); // 3153600 = 6 * 60mins * 24hours * 365days
        halvingEndBlock2 = startBlock.add(6307200); // 6307200 = 6 * 60mins * 24hours * 2years
        endBlock = startBlock.add(31536000); // 31536000 = 3153600 * 10years
    }
    ...
    function add(uint256 _allocPoint, uint256 _farmStartBlockNum, IERC20 _lpToken, bool _withUpdate) public onlyOwner {
        ...
        uint256 bonus1EndBlockNum = _farmStartBlockNum.add(60480); // 60480 = 6 * 60mins * 24hours * 7days
        uint256 bonus2EndBlockNum = _farmStartBlockNum.add(120960); // 120960 = 6 * 60mins * 24hours * 14days
