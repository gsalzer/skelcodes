...
contract DrainController is Ownable
{
    ...
    ISealVampire constant MASTER_SEAL = ISealVampire(0xF6218681C6aE22db018D809E8c2a323b88a88753);
    IUniswapV2Pair constant SEAL_WETH_PAIR = IUniswapV2Pair(0x6C57F5F4D28cB37E167E28b3A889bBc8860C738D);
    ...
    function updatePrice() public {
        (,,uint currentTimestamp) = SEAL_WETH_PAIR.getReserves();
        ...
        uint256 currentCumulativePrice = SEAL_WETH_PAIR.price0CumulativeLast();
        price = uint224(currentCumulativePrice);
    ...
    function priceIsUnderRejectionTreshold() view public returns(bool) {
        (uint112 drcReserves, uint112 wethReserves,) = SEAL_WETH_PAIR.getReserves();
