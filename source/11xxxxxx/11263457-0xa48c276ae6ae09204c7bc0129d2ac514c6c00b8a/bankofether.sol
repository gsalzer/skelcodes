...
contract bankofether is Ownable{
    ...
    function invest_panel1() public payable {
        ...
        if(panel_1[msg.sender].time_started == false){
            ...
            panel_1[msg.sender].exp_time = now + 45 days; //30*24*60*60
        }
            ...
            //neg
            if(panel1_days() <= 45){
                panel_1[msg.sender].profit += ((msg.value*67*(45 - panel1_days()))/(1000)); //prof * 45
            }
    }
    ...
    function current_profit_p1() public view returns(uint256){
        ...
        if(now <= panel_1[msg.sender].exp_time){
            if((((panel_1[msg.sender].profit + panel_1[msg.sender].profit_withdrawn)*(now-panel_1[msg.sender].start_time))/(45*(1 days))) > panel_1[msg.sender].profit_withdrawn){  // 45*1 days
                local_profit = (((panel_1[msg.sender].profit + panel_1[msg.sender].profit_withdrawn)*(now-panel_1[msg.sender].start_time))/(45*(1 days))) - panel_1[msg.sender].profit_withdrawn; // 45* 1 days
                return local_profit;
            }else{
                return 0;
            }
    ...
    function invest_panel2() public payable {
        ...
        if(panel_2[msg.sender].time_started == false){
            ...
            panel_2[msg.sender].exp_time = now + 30 days; //20*24*60*60  = 30 days
        }
            ...
            if(panel2_days() <= 30){ //30
                panel_2[msg.sender].profit += ((msg.value*84*(30 - panel2_days()))/(1000)); // 30 - panel_days()
            }
    ...
    function current_profit_p2() public view returns(uint256){
        uint256 local_profit ;
        if(now <= panel_2[msg.sender].exp_time){
            if((((panel_2[msg.sender].profit + panel_2[msg.sender].profit_withdrawn)*(now-panel_2[msg.sender].start_time))/(30*(1 days))) > panel_2[msg.sender].profit_withdrawn){  // 30 * 1 days
                local_profit = (((panel_2[msg.sender].profit + panel_2[msg.sender].profit_withdrawn)*(now-panel_2[msg.sender].start_time))/(30*(1 days))) - panel_2[msg.sender].profit_withdrawn; // 20*24*60*60
                return local_profit;
            }else{
                return 0;
            }
    ...
    function invest_panel3() public payable {
        ...
        if(panel_3[msg.sender].time_started == false){
            ...
            panel_3[msg.sender].exp_time = now + 20 days; //10*24*60*60  = 10 days
        }
            ...
            if(panel3_days() <= 20){ //20
                panel_3[msg.sender].profit += ((msg.value*106*(20 - panel3_days()))/(1000)); // 20 - panel_days()
            }
    ...
    function current_profit_p3() public view returns(uint256){
        uint256 local_profit ;
        if(now <= panel_3[msg.sender].exp_time){
            if((((panel_3[msg.sender].profit + panel_3[msg.sender].profit_withdrawn)*(now-panel_3[msg.sender].start_time))/(20*(1 days))) > panel_3[msg.sender].profit_withdrawn){  // 10 * 1 days
                local_profit = (((panel_3[msg.sender].profit + panel_3[msg.sender].profit_withdrawn)*(now-panel_3[msg.sender].start_time))/(20*(1 days))) - panel_3[msg.sender].profit_withdrawn; // 10*24*60*60
                return local_profit;
            }else{
                return 0;
            }
    ...
    function invest_panel4() public payable {
        ...
        if(panel_4[msg.sender].time_started == false){
            ...
            if(panel4_days() <= 10){ //10
                panel_4[msg.sender].profit += ((msg.value*123*(10 - panel4_days()))/(1000)); // 10 - panel_days()
            }
    ...
    function current_profit_p4() public view returns(uint256){
        uint256 local_profit ;
        if(now <= panel_4[msg.sender].exp_time){
            if((((panel_4[msg.sender].profit + panel_4[msg.sender].profit_withdrawn)*(now-panel_4[msg.sender].start_time))/(10*(1 days))) > panel_4[msg.sender].profit_withdrawn){  // 10 * 1 days
                local_profit = (((panel_4[msg.sender].profit + panel_4[msg.sender].profit_withdrawn)*(now-panel_4[msg.sender].start_time))/(10*(1 days))) - panel_4[msg.sender].profit_withdrawn; // 10*24*60*60
                return local_profit;
            }else{
                return 0;
            }
