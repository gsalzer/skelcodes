...
contract Consts {
    ...
    string public constant TOKEN_NAME = "ETIOPIA";
    string public constant TOKEN_SYMBOL = "IOP";
    bool public constant PAUSED = true;
    address public constant TARGET_USER = 0x0d3cDbAA4d7430737159002dA414909a2521A54C;
    
    uint public constant START_TIME = 1603757668;
...
contract BonusableCrowdsale is Consts, Crowdsale {
    ...
    function getBonusRate(uint256 _weiAmount) internal view returns (uint256) {
        ...
        uint[3] memory weiRaisedEndsBounds = [uint(232375000000000000000000),uint(232375000000000000000000),uint(232375000000000000000000)];
        uint64[3] memory timeStartsBounds = [uint64(1603757668),uint64(1606781640),uint64(1609460040)];
        uint64[3] memory timeEndsBounds = [uint64(1606781640),uint64(1609460040),uint64(1615162435)];
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(40000 * TOKEN_DECIMAL_MULTIPLIER, 0x425d5aA6E6447F57018C786EFDA7895272a3068B, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1615162440)
        CappedCrowdsale(232375000000000000000000)
    ...
    function init() public onlyOwner {
        ...
        address[5] memory addresses = [address(0x5f88dd14d1991716607e8ffc87294fc47736dbc2),address(0x931ef2fd0176da45951923aabc491a5c85f77d48),address(0xeb8fcbf6464ca3fc3a1861bb6a39a714c9b7d8a1),address(0xcf90027c64a359ac0ae91cf605d3a80f6a848b51),address(0x97f25faa41a99c388f8d55afc2f600dd7ca26a4f)];
        uint[5] memory amounts = [uint(5000000000000000000000000),uint(200000000000000000000000000),uint(100000000000000000000000000),uint(300000000000000000000000000),uint(100000000000000000000000000)];
        uint64[5] memory freezes = [uint64(1615162501),uint64(0),uint64(1615162501),uint64(1615162501),uint64(1615162501)];
        ...
        internal
    {
        ...
        require(msg.value <= 250000000000000000000);
