...
library Constants {
    ...
    /* Bonding */
    uint256 private constant INITIAL_STAKE_MULTIPLE = 1e6; // 100 SDP -> 100M SDPS
    ...
    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 40e18; // 40 SDP
...
contract Getters is State {
    ...
    function name() public view returns (string memory) {
        return "Scalable Dollar Protocol Stake";
    }
...
contract Implementation is State, Bonding, Market, Regulator, Govern {
    ...
    function initialize() public initializer {
        ...
        // 1 time marketing/audit reserve
        mintToAccount(0x823C37C82ff936459a0a7D3E3488989456BA5D46, 100000e18);
    }
