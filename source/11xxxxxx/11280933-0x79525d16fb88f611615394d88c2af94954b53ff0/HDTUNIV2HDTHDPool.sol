...
contract HDTokenWrapper {
    ...
    //UNI-V2(HDT-HD)
    IERC20 public stakeToken = IERC20(0x8fF453aED0C934387D1b8AAF51a1CAf0d9430ce2); 
...
/**
 * HDT-UNI-V2(HDT-HD) Pool
 */
contract HDTUNIV2HDTHDPool is HDTokenWrapper, IRewardDistributionRecipient {
    ...
    function stake(uint256 amount) public checkOpen checkStart updateReward(msg.sender){ 
        require(amount > 0, "HDT-UNI-V2(HDT-HD)-POOL: Cannot stake 0");
        super.stake(amount);
        emit Staked(msg.sender, amount);
    }

    function withdraw(uint256 amount) public checkStart updateReward(msg.sender){
        require(amount > 0, "HDT-UNI-V2(HDT-HD)-POOL: Cannot withdraw 0");
    ...
    modifier checkStart(){
        require(block.timestamp > startTime,"HDT-UNI-V2(HDT-HD)-POOL: Not start");
        _;
    }

    modifier checkOpen() {
        require(open, "HDT-UNI-V2(HDT-HD)-POOL: Pool is closed");
        _;
    }
