...
/**
 * TRY farming LP Pool.  Deposit LP earn TRY.
 * Unlocked farming contract, remove your LP and TRY rewards at anytime.
*/

pragma solidity ^0.7.6;


// https://gist.github.com/shaaappy/0d211bc270253cfdfcd9ad498e3491fb
...
contract TRYFarm is IRewardDistributionRecipient, ReentrancyGuard {
    ...
    function recoverLostTokensExceptOurTokens(IERC20 _token, uint256 amount) external onlyOwner {
        // Ensure requested tokens aren't users LP or TRY tokens
        require(_token != lpToken, "Cannot recover LP tokens");
        require(_token != rewardToken, "Cannot recover reward tokens");
