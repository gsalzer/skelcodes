...
contract Fessstable is ERC20 {
    ...
    constructor(address _owner, address payable _feesWallet, string memory _name, string memory _symbol, address _fesschainAddress, uint256 _priceFess) public Owned(_owner) {
