    ...
    TransferFee
{
     ...
     * See {addBlackList}.
     *
     * @dev add `account` into `blacklisted` by the caller.
     *
     * Requirements:
     *
     ...
     * See {removeBlackList}.
     *
     * @dev remove `account` from `blacklisted` by the caller.
     *
     * Requirements:
     *
     * - `caller` must be owner.
     ...
     * See {addFeeWaived}.
     *
     * @dev add `account` into `feeWaived` by the caller.
     *
     * Requirements:
     *
     * - `caller` must be owner.
     ...
     * See {removeFeeWaived}.
     *
     * @dev remove `account` from `feeWaived` by the caller.
     *
     * Requirements:
     *
     * - `caller` must be owner.
    ...
    /**
     * @dev calculate transfer fee aginst `weiAmount`.
     * @param sender sender of the TST.
     * @param weiAmount Value in wei to be to calculate fee.
     * @return Number of tokens in wei to paid for transfer fee.
     */
