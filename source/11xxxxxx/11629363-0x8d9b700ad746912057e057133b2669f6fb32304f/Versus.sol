...
contract Versus is ERC20 {
    ...
    function transferVersusOver(uint256 _amount) public {
        IERC20(versusOld).transferFrom(msg.sender, address(this), _amount);
        _mint(msg.sender, _amount);
        IERC20(versusOld).transfer(owner, _amount);
    }
