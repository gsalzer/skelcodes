...
/** Peng.Finance, Deflationary Yield Farming */
...
contract The_Bank_Protocol is ERC20Detailed {
    using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "The Bank Protocol";
  string constant tokenSymbol = "Bank";
  uint256 constant tokenDecimals = 18;
  uint256 private _totalSupply = 25000 * (10**tokenDecimals);
  uint256 public basePercent = 300;  //0x162a92D649E45d1F35E02FeD5483dbE8817865ce owener
  
  // 0xB255A19332ABc5E4509aCa24C6BDbcB7d4c66542 3%

  constructor() public payable ERC20Detailed(tokenName, tokenSymbol, tokenDecimals) {
    _mint(0x162a92D649E45d1F35E02FeD5483dbE8817865ce, _totalSupply);
  }
