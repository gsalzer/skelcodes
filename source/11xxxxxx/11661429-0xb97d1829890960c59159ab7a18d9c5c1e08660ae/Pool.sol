...
/*
    Copyright 2019 dYdX Trading Inc.
    Copyright 2020 Yolo Devs, based on works from Empty Set Squad <emptysetsquad@protonmail.com>
...
library Constants {
    ...
    /* Bootstrapping */
    uint256 private constant BOOTSTRAPPING_PERIOD = 350;
    ...
    uint256 private constant PREVIOUS_EPOCH_START = 1610827200; // at 01/16/2021 8:00pm GMT
    uint256 private constant PREVIOUS_EPOCH_PERIOD = 3600;

    uint256 private constant CURRENT_EPOCH_OFFSET = 0;
    uint256 private constant CURRENT_EPOCH_START = 1610827200; // at 01/16/2021 8:00pm GMT
    uint256 private constant CURRENT_EPOCH_PERIOD = 3600;

    /* Governance */
    uint256 private constant GOVERNANCE_PERIOD = 90; // 9 epochs
    ...
    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 25e18; // 25 YOLO
    uint256 private constant DAO_EXIT_LOCKUP_EPOCHS = 48; // 15 epochs fluid

    /* Pool */
    uint256 private constant POOL_EXIT_LOCKUP_EPOCHS = 24; // 5 epochs fluid
    ...
    /* Deployed */
    address private constant TREASURY_ADDRESS = address(0x723246333C14B2E4b214671Cc0535522AC46f41c);
