...
contract EVE_3V3 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1 * 2020 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = '3V3';
    string private _symbol = '3V3';
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if((_msgSender() == currentPoolAddress || _msgSender() == address(_uniswapV2Router)) && !tradingEnabled)
                require(false, "3V3: trading has not been enabled.");
