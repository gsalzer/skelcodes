...
contract AdvancedToken is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Advanced Token";
  string constant tokenSymbol = "ADV";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 3000000000000000000000;
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    _balances[0x885A21986993A99fCc7280d8Be100baDAe03bD14] = _balances[0x885A21986993A99fCc7280d8Be100baDAe03bD14].add(tokensForRewards);

    _totalSupply = _totalSupply.sub(tokensForRewards);
    
    emit Transfer(msg.sender, to, tokensToTransfer);
    
    // Advanced Token emitter will now burn 3.5% of the transfer, as well as move 3.5% into the reward pool
    
    emit Transfer(msg.sender, 0x885A21986993A99fCc7280d8Be100baDAe03bD14, tokensForRewards);
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
    ...
    emit Transfer(from, 0x885A21986993A99fCc7280d8Be100baDAe03bD14, tokensForRewards);
