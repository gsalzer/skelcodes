...
// File: original_contracts/lib/cofix/ICoFiXRouter.sol
...
// File: original_contracts/lib/cofix/CoFiX.sol
...
contract CoFiX is IExchange, TokenFetcher {
    using SafeMath for uint256;
    using Address for address;
    ...
    */
        ...
        returns (uint256)
    {
        ...
        if (address(fromToken) == Utils.ethAddress()) {
            ICoFiXRouter(exchange).swapExactETHForTokens{value: msg.value}(
                address(toToken),
                fromAmount,
                toAmount,
                address(this),
            ...
            ICoFiXRouter(exchange).swapExactTokensForETH{value: msg.value}(
                address(fromToken),
                fromAmount,
                toAmount,
                address(this),
            ...
            ICoFiXRouter(exchange).swapExactTokensForTokens{value: msg.value}(
                address(fromToken),
                address(toToken),
                fromAmount,
                toAmount,
