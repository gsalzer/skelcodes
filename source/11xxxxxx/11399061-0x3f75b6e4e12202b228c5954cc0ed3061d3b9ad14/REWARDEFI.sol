...
// ----------------------------------------------------------------------------------------------
// WFI token by Rewardefi.finance Limited.
// An ERC20 standard
//
// author: HOO dev
// Contact: support@rewardefi.finance
contract ERC20 {
...
contract REWARDEFI is StandardToken, OnlyOwner{
	uint256 public constant decimals = 18;
    string public constant name = "REWARDEFI";
    string public constant symbol = "WFI";
    string public constant version = "1.0";
    uint256 public constant totalSupply =40000*10**18;
