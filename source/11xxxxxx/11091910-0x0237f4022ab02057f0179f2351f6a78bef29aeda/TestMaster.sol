...
contract TestToken is ERC20Capped , Ownable {
    ...
    ERC20Capped(5018000*10**18) //12 hrs=3600 blocks, token = 3600*5=18000
...
contract TestMaster is Ownable {
    using SafeMath for uint256;
    ...
    struct PoolInfo {
        ...
        uint256 accTestPerShare; // Accumulated SAKEs per share, times 1e12. See below.
    }
    ...
    uint256 public constant BETATEST_BLOCKNUM = 900;//3hrs
    // Bonus block num,about 13 days.
    uint256 public constant BONUS_BLOCKNUM = 9000;//30hrs
    // mint end block num,about 30 days.
    uint256 public constant MINTEND_BLOCKNUM = 21000; //3+30+10
    ...
    function add(uint256 _allocPoint, IERC20 _lpToken, bool _withUpdate) public onlyOwner {
        ...
        require(lpTokenPID[address(_lpToken)] == 0, "TestMaster:duplicate add.");
    ...
    function handoverTestMintage(address newOwner) public onlyOwner {
        test.transferOwnership(newOwner);
    }
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 testReward = multiplier.mul(testPerBlock).mul(pool.allocPoint).div(totalAllocPoint);
        test.mint(devaddr, testReward.div(10));
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        if (pending > 0) safeTestTransfer(msg.sender, pending);
