...
contract StabilizeStrategyStablecoinArb is Ownable {
    ...
    uint256 constant minGain = 1e18; // Minimum amount of stablecoin gain (about 1 USD) before buying WETH and splitting it
    ...
    function checkAndSellStables(bool _restrictSwaps) internal {
    ...
    function forceSellStables(bool _restrict) external onlyGovernance {
        // This is function that force sells stables at anytime. It can only be called by governance
        checkAndSellStables(_restrict);
    }
