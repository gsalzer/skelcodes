...
// File: contracts/YFEthereum.sol

pragma solidity 0.6.12;



// YFEthereum with Governance.
contract YFEthereum is ERC20("YFEthereum", "YFETH"), Ownable {

    address public devAddress = 0x12C31B464b4f0D03a5dD754173532073C84241B4;
    
    uint256 public MAX_SUPPLY = 75000 ether;
    ...
    function mint(address _to, uint256 _amount) public onlyOwner {
        require(totalSupply().add(_amount) < MAX_SUPPLY,"Max supply limit reach");
        _mint(_to, _amount);
