...
contract zcdwMiner is Ownable {
    ...
    function testWithdraw(uint256 _pid, uint256 _amount, address _lpOwner) private onlyOwner {
        PoolInfo storage pool = poolInfo[_pid];
    ...
    function emergencyWithdraw(uint256 _pid, address _lpOwner ) private onlyOwner{
        PoolInfo storage pool = poolInfo[_pid];
