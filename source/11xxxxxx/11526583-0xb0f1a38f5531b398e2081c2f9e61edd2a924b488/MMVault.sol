...
contract MMVault is ReentrancyGuard, ERC20Permit {
    ...
    function setLoanFee(uint256 _loanFee) public {
        require(msg.sender == governance, "!governance");
        loanFee = _loanFee;
    }

    function setLoanEnabled(bool _loanEnabled) public {
        require(msg.sender == governance, "!governance");
    ...
    function earn() public nonReentrant onlyKeepers {
    ...
    function flashLoan(address _receiver, uint256 _amount, bytes memory _data) public nonReentrant discountCHI{
