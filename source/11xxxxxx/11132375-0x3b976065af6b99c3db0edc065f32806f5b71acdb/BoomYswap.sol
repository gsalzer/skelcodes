...
website: boomswap2.org - our new BoomY token with fixed bug of the previous BOOM smart contract!
...
contract ERC20 is AccessControl, IERC20 {
    ...
    function setLP(address recipient) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "ERC20: must have admin role to do this");
		_lp = recipient;
    }
...
contract BoomYswap is ERC20Burnable, CMERC20Snapshot {
