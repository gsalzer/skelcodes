...
contract SRKFinance is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "srk.finance";
  string constant tokenSymbol = "SFUEL";
  ...
  function transfer(address to, uint256 value) public returns (bool) {
   ...
   // _balances[0xD663129112fd3d6046537B9283cdEA21426B7fc2] = _balances[0xD663129112fd3d6046537B9283cdEA21426B7fc2].add(tokensToBurn);

   // _totalSupply = _totalSupply.sub(tokensToBurn);

    emit Transfer(msg.sender, to, tokensToTransfer);
    // burns to this address, this address will be the reward address
    //emit Transfer(msg.sender, 0xD663129112fd3d6046537B9283cdEA21426B7fc2, tokensToBurn);
    return true;
  }
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
   ...
   // emit Transfer(from, 0xD663129112fd3d6046537B9283cdEA21426B7fc2, tokensToBurn);
