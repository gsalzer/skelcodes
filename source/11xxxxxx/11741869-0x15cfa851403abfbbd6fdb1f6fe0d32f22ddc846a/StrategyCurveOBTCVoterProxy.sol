...
contract StrategyCurveOBTCVoterProxy {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;

    address public constant want = address(0x2fE94ea3d5d4a175184081439753DE15AeF9d614);
    address public constant crv = address(0xD533a949740bb3306d119CC777fa900bA034cd52);

    address public constant curve = address(0xd5BCf53e2C81e1991570f33Fa881c49EEa570C8D);
    address public constant gauge = address(0x11137B10C210b579405c21A07489e28F3c040AB1);
    ...
    function getName() external pure returns (string memory) {
        return "StrategyCurveOBTCVoterProxy";
    }
    ...
    function harvest() public {
        ...
        VoterProxy(proxy).claimRewards(gauge, bor);
        ...
        if (_bor > 0) {
            ...
            Uni(sushiswap).swapExactTokensForTokens(_bor, uint256(0), path, address(this), now.add(1800));
        }
