...
contract StakingLP is ReentrancyGuard, Exponential {
    ...
    /**
     * @notice Address of Uniswap LP Token
     */
    ...
    function accrueBonus() public {
        ...
        EIP20Interface bonusToken = EIP20Interface(dflAddress);
    ...
    function distributeBonus(address account) internal {
        ...
        doTransferOut(dflAddress, account, accountDelta);
    ...
    function withdraw(uint amount) external nonReentrant {
        ...
        doTransferOut(lpAddress, account, amount);
