...
// Migrate your existing UNI-V2 tokens to P-LP ones
contract PlasmaRebalancer {
    /// @notice The name of this contract
    string public constant name = "Rebalancer UNI-V2 to P-LP";
    ...
    function pairForOldRouter(address tokenA, address tokenB) internal view returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f' // init code hash Uniswap
            ))));
    }
