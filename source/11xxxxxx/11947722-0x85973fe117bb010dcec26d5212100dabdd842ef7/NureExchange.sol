...
interface INureCaller is ISafeERC20Extension {
...
contract NureExchange is Ownable, Pausable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    using NureERC20 for IERC20;
    ...
    function swap(
        ...
        INureCaller.CallDescription[] calldata calls
    )
        external
        payable
        whenNotPaused
