...
// File: contracts/VENIToken.sol

// VENIToken with Governance.
contract VENIToken is ERC20("VENI", "VENI"), Ownable {
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (VENIAdmin).
     ...
     * @param singaddress signature address
     */
