...
// File: contracts/FSToken/FsProxyAdmin.sol

pragma solidity ^0.5.17;


// The admin of the FsProxy.
// Owning the contract effectively allows one to upgrade the code of FsToken.
contract FsProxyAdmin is ProxyAdmin {
