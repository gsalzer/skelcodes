...
// File: contracts/Corlibri_Nectar.sol
...
contract wUNIV2 is ERC20 {
    ...
    address public Corlibri;
    address public UNIv2;


    modifier onlyCorlibri() {
        require(msg.sender == Corlibri, "Only Corlibri can send wrapped tokens");
        _;
    }
//=========================================================================================================================================
    constructor(address _Corlibri) ERC20("Wrapped Corlibri LP","NECTAR") public {
        Corlibri = _Corlibri;
        UNIv2 = ICorlibri(Corlibri).viewUNIv2();
        require(Corlibri != address(0) && UNIv2 != address(0));
    }
...
//=========================================================================================================================================
    ...
    function wTransfer(address recipient, uint256 amount) external onlyCorlibri{
    ...
    function wrapUNIv2(uint256 amount) public {
        ...
        _wrapUNIv2(msg.sender, Corlibri, amount);
    }
    
    function setPublicWrappingRatio(uint256 _ratioBase100) external onlyCorlibri {
