...
// Groot with Governance.
contract GrootToken is ERC20("GROOT", "GROOT"), Ownable {
    uint256 private _cap = 25000000000000000000000;
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "GROOT::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "GROOT::delegateBySig: invalid nonce");
        require(now <= expiry, "GROOT::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "GROOT::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "GROOT::_writeCheckpoint: block number exceeds 32 bits");
