...
contract TinlakeRoot is Auth {
    ...
    function deploy() public {
        ...
        address poolAdmin1 = 0xe23d39C932D1cfB8956d0291f4F06E61Bb31729E;
        address poolAdmin2 = 0x71d9f8CFdcCEF71B59DD81AB387e523E2834F2b8;
        address poolAdmin3 = 0x97b2d32FE673af5bb322409afb6253DFD02C0567;
        address poolAdmin4 = 0xa7Aa917b502d86CD5A23FFbD9Ee32E013015e069;
        address poolAdmin5 = 0xfEADaD6b75e6C899132587b7Cb3FEd60c8554821;
                                                   
        address oracle = 0x0A735602a357802f553113F5831FE2fbf2F0E2e0;

        AuthLike_3(lenderDeployer.assessorAdmin()).rely(poolAdmin1);
        AuthLike_3(lenderDeployer.assessorAdmin()).rely(poolAdmin2);
        AuthLike_3(lenderDeployer.assessorAdmin()).rely(poolAdmin3);
        AuthLike_3(lenderDeployer.assessorAdmin()).rely(poolAdmin4);
        AuthLike_3(lenderDeployer.assessorAdmin()).rely(poolAdmin5);

        AuthLike_3(lenderDeployer.juniorMemberlist()).rely(poolAdmin2);
        AuthLike_3(lenderDeployer.juniorMemberlist()).rely(poolAdmin3);
        AuthLike_3(lenderDeployer.juniorMemberlist()).rely(poolAdmin4);
        AuthLike_3(lenderDeployer.juniorMemberlist()).rely(poolAdmin5);

        AuthLike_3(lenderDeployer.seniorMemberlist()).rely(poolAdmin2);
        AuthLike_3(lenderDeployer.seniorMemberlist()).rely(poolAdmin3);
        AuthLike_3(lenderDeployer.seniorMemberlist()).rely(poolAdmin4);
        AuthLike_3(lenderDeployer.seniorMemberlist()).rely(poolAdmin5);
