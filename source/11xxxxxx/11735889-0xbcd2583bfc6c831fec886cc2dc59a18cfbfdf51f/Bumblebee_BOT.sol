...
contract ERC20 is IERC20 {
    ...
    function _mint(address account, uint256 value) internal {
        ...
        // Check if recipient is frozen
        require(!frozenAccount[account],"Check if recipient is frozen");
 ...
 * `ERC20` functions.
 */
contract Bumblebee_BOT is ERC20, ERC20Detailed, ERC20Burnable, ERC20Mintable, ERC20Pausable {

    string private constant NAME = "Bumblebee BOT"; 
    string private constant SYMBOL = "BBEE"; 
