...
// https://github.com/wighawag/hardhat-deploy/blob/master/solc_0.7/proxy/Proxied.sol
pragma solidity 0.7.5;

abstract contract Proxied {
    /// @notice to be used by initialisation / postUpgrade function so
    /// that only the owner can execute them It also allows these
    /// functions to be called inside a contructor when the contract
