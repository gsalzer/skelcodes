...
contract CaesarTokenWrapper {
    ...
    IERC20 public stakeToken = IERC20(0x88EF27e69108B2633F8E1C184CC37940A075cC02);
...
contract DEGOPoolOfCaesar is CaesarTokenWrapper, IRewardDistributionRecipient {
    IERC20 public caesar = IERC20(0xEaFed0F973fe4cDaE26e18Fd1C124F0BDA79Fa6C); 
    uint256 public constant DURATION = 7 days;

    uint256 public constant startTime = 1603204502; //2020-10-20 22:35:02
    ...
    function stake(uint256 amount) public checkOpen checkStart updateReward(msg.sender){ 
        require(amount > 0, "Caesar:DEGO POOL - Cannot stake 0");
        super.stake(amount);
        emit Staked(msg.sender, amount);
    }

    function withdraw(uint256 amount) public checkStart updateReward(msg.sender){
        require(amount > 0, "Caesar:DEGO POOL - Cannot withdraw 0");
    ...
    modifier checkStart(){
        require(block.timestamp > startTime,"Caesar:DEGO POOL - not start");
        _;
    }

    modifier checkOpen() {
        require(open, "Caesar:DEGO POOL - Pool is closed");
        _;
    }
