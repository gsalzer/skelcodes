...
contract MatterWithdraw is Pausable, ReentrancyGuard {
	...
	function deposit(uint256 amount) public onlyDenMultiSig whenNotPaused() {
		_totalSupply = _totalSupply.add(amount);
		mtrToken.safeTransferFrom(_msgSender(), address(this), amount);
	}
