// contracts/HolyValorYearnUSDCVault.sol
...
interface IYearnVaultUSDC {
    ...
    // returns amount (of base asset, USDC) that is safe to withdraw
...
*/
contract HolyValorYearnUSDCVault is AccessControlUpgradeable, IHolyValor {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    function divestFromVault(uint256 _amount, bool _safeExecution) public {
        ...
        uint256 safeWithdrawAmountUSDC = vaultContract.available();
    ...
    function harvestYield(uint256 minExpectedAmount, uint256 maxAmount) public {
        ...
        uint256 safeWithdrawAmountUSDC = vaultContract.available();
        require(minExpectedAmount <= safeWithdrawAmountUSDC, "min amount larget than safe amount");
    ...
    function safeReclaimAmount() external override view returns(uint256) {
        ...
        uint256 safeAmount = vaultContract.available();
