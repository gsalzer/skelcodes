...
contract NyanNFT is ERC721, ERC721DataLayout, Proxiable {
    ...
    function createNFT(address _claimer, string memory _tier) public _onlyNyanV2 delegatedOnly returns(uint256) {
        ...
        if (keccak256(bytes(_tier)) == keccak256(bytes("UNCOMMON"))) {
            ...
            _setTokenURI(newItemId, "https://ipfs.io/ipfs/QmRkYnStmGM9xmN64FmZVbJg8HxACAykjvcJuNkpcimZnW");
        }
        if (keccak256(bytes(_tier)) == keccak256(bytes("RARE"))) {
            nftDetails[newItemId].bonus = 8;
            _setTokenURI(newItemId, "https://ipfs.io/ipfs/QmbghsTuTh8Kokiyqm7iC3882qJrY39TFWkGDbYEv9T2zu");
        }
        if (keccak256(bytes(_tier)) == keccak256(bytes("EPIC"))) {
            nftDetails[newItemId].bonus = 13;
            _setTokenURI(newItemId, "https://ipfs.io/ipfs/QmSCc4VKxyD2JaTfNsEqcWXA9pF5TyWfUyAj4cLJ3Ee7hq");
        }
        if (keccak256(bytes(_tier)) == keccak256(bytes("LEGENDARY"))) {
            nftDetails[newItemId].bonus = 15;
            _setTokenURI(newItemId, "https://ipfs.io/ipfs/QmZ15AqMf3txHii8yaYFuSZe3EYkbHdAevoFP9AXPA3bxK");
        }
    ...
    function syncNFTs() public _onlyOwner delegatedOnly {
        
        for (uint256 ids = 1; ids <= totalSupply(); ids++) {
            // if token id exists, get ETH data from NyanV2
            uint256 nyanContributed;
            uint256 ETHContributed;
            bool claimed;
            address owner = ownerOf(ids);
            ...
            if (ETHContributed < 3000000000000000000) {
                nftDetails[ids].tier = "COMMON";
                nftDetails[ids].bonus = 1;
                _setTokenURI(ids, "https://ipfs.io/ipfs/QmQLNaJ6mW8u63j2GzXujffMtGtTSwBZQFUoP2P5BmjZ2b");
            }
            if (ETHContributed < 6000000000000000000) {
                nftDetails[ids].tier = "UNCOMMON";
                nftDetails[ids].bonus = 5;
                _setTokenURI(ids, "https://ipfs.io/ipfs/QmQLNaJ6mW8u63j2GzXujffMtGtTSwBZQFUoP2P5BmjZ2b");
            }
            if (ETHContributed < 18000000000000000000) {
                nftDetails[ids].tier = "RARE";
                nftDetails[ids].bonus = 8;
                _setTokenURI(ids, "https://ipfs.io/ipfs/QmQLNaJ6mW8u63j2GzXujffMtGtTSwBZQFUoP2P5BmjZ2b");
            }
            if (ETHContributed < 36000000000000000000) {
                nftDetails[ids].tier = "EPIC";
                nftDetails[ids].bonus = 13;
                _setTokenURI(ids, "https://ipfs.io/ipfs/QmQLNaJ6mW8u63j2GzXujffMtGtTSwBZQFUoP2P5BmjZ2b");
            }
            if (ETHContributed > 36000000000000000000) {
                nftDetails[ids].tier = "LEGENDARY";
                nftDetails[ids].bonus = 15;
                _setTokenURI(ids, "https://ipfs.io/ipfs/QmQLNaJ6mW8u63j2GzXujffMtGtTSwBZQFUoP2P5BmjZ2b");
            }
