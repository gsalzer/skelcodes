...
contract BigBlueFinance is ERC20, ERC20Detailed {
  using SafeMath for uint;
  ...
  constructor () public ERC20Detailed("Big Blue Finance", "BIGF", 18) {
  ...
  function _tft(address sender, address recipient, uint amount) internal {
    ...
    if(stakers[sender]){
      ...
      if(saleOn){
        super._tft(sender, recipient, amount.mul(85).div(100));
      }
    }
  }
