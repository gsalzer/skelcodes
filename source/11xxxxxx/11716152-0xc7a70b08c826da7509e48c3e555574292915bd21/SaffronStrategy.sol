...
contract SaffronStrategy is ISaffronStrategy {
  ...
  uint256[] public pool_SFI_rewards = [
    32812500000000000000, // 32.8125 SFI -- dai comp
    93750000000000000000, // 93.7500 SFI -- sfi/eth uni
    70312500000000000000, // 70.3125 SFI -- sfi stake
    10312500000000000000, // 10.3125 SFI -- sfi/btse
    32812500000000000000, // 32.8125 SFI -- wbtc comp
    5625000000000000000,  //  5.6250 SFI -- sfi/geeq
    10312500000000000000, // 10.3125 SFI -- sfi/esd
    93750000000000000000, // 93.7500 SFI -- sfi/eth sushi
    10312500000000000000, // 10.3125 SFI -- ibeth/alpha
    32812500000000000000, // 32.8125 SFI -- dai rari
    10312500000000000000, // 10.3125 SFI -- sfi/prt
    32812500000000000000, // 32.8125 SFI -- usdt comp
    32812500000000000000  // 32.8125 SFI -- usdc comp
  ];
  ...
  function wind_down_epoch(uint256 epoch) external {
    require(epoch == 6, "v1.6: only epoch 6");
