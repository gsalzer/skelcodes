 ...
 */
contract gsiToken is Context, IERC20, Ownable {
    ...
    function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        require(!blackAccounts[msg.sender]);
    ...
    function mint(address _to, uint256 _amount) public{
        ...
        require (totalSupply() + _amount <= 28000000*1e18, 'totalSupply exceeds 28000000');
        _mint(_to, _amount);
    }
