...
// File contracts/Predictr.sol

pragma solidity ^0.6.12;

/**
 * @title PredictrToken
 * @dev Utility token for Predictr platform
 */
contract PredictrToken is ERC20, ERC20Burnable {
    uint8 public constant DECIMALS = 18;
    uint256 public constant INITIAL_SUPPLY = 190000 * (10**uint256(DECIMALS));

    /**
     * @dev Constructor that gives _msgSender() all of existing tokens.
     */
    constructor() public ERC20("Predictr", "PDCT") {
