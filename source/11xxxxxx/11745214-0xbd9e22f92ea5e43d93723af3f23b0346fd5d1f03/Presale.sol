...
interface IRStable {
    ...
    function setTaxless(bool b) external;
    function isPresaleDone() external returns (bool);
    function setPresaleDone() external payable;

    // function createEthPool(uint n) payable external;
    // function mintRemaining(uint256 liqAddRate, uint n) external;
}
