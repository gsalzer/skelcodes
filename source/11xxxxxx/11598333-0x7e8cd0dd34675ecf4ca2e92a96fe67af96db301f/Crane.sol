...
// Crane with Governance.
contract Crane is ERC20("Crane", "CRANE"), Ownable {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "CRANE::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "CRANE::delegateBySig: invalid nonce");
        require(now <= expiry, "CRANE::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "CRANE::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "CRANE::_writeCheckpoint: block number exceeds 32 bits");
