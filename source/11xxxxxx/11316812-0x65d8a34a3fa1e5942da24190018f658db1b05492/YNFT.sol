...
contract ERC721Full is ERC721, ERC721Enumerable, ERC721Metadata,ERC721MetadataMintable {
    ...
    constructor () public ERC721Metadata("Yfiearn.money", "YNFT")  {
...
contract YNFT is ERC721Full {
    ...
    constructor () public {
        ...
        function batchMintWithUri(address to,uint tokenIds,string memory uri) public onlyMinter returns(bool) {
    ...
    function batchMint(address to,uint tokenIds) public onlyMinter returns(bool) {
        require(to != address(0), "Invalid Address");
        for (uint i = 0; i < tokenIds; i++) {
        super._mint(to,id++);
