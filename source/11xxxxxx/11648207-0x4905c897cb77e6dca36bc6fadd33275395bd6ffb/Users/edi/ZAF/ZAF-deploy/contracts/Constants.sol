...
library Constants {
    ...
    /* Bonding */
    uint256 private constant INITIAL_STAKE_MULTIPLE = 1e6; // 100 ZAF -> 100M ZAFS
    ...
    uint256 private constant CURRENT_EPOCH_START = 1610496000;
    uint256 private constant CURRENT_EPOCH_PERIOD = 1800;

    /* Governance */
    uint256 private constant GOVERNANCE_PERIOD = 72; // 2 cycles
    ...
    uint256 private constant GOVERNANCE_EMERGENCY_DELAY = 24; // 12H

    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 1e20; // 100 ZAF
    ...
    /* Market */
    uint256 private constant COUPON_EXPIRATION = 4380; // 90D
