...
contract PUSDStablecoin is ERC20Custom, AccessControl {
    ...
    uint256 public constant genesis_supply = 3300e18; // 2M PUSD (only for testing, genesis supply will be 5k on Mainnet). This is to help with establishing the Uniswap pools, as they need liquidity
