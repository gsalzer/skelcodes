...
contract YGold is Ownable {
  using SafeMath for uint256;

  // standard ERC20 variables. 
  string public constant name = "Y Gold";
  string public constant symbol = "YYG";
  uint256 public constant decimals = 18;
  // the supply will not exceed 30,000 yRise
  uint256 private constant _maximumSupply = 8000000 * 10 ** decimals;
  uint256 private constant _maximumPresaleBurnAmount = 800000 * 10 ** decimals;
