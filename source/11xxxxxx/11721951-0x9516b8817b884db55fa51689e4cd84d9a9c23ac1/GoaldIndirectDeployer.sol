...
pragma solidity >=0.6.2;interface IUniswapV2Router02 is IUniswapV2Router01 {
...
contract GoaldIndirectDeployer {
    address constant PROXY_ADDRESS = 0x9eE0d74242F586ea7781F06619A3a8eE30d11709;
    ...
    function deploy(
        ...
        require(latestProxy.isAllowedDeployer(address(this)), "Not latest deployer");
