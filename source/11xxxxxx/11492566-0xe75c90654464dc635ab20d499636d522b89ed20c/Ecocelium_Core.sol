...
contract EcoceliumDataManager is Initializable {
    ...
    function poolSorter(uint64 _orderId, string memory _tokenSymbol, bool _status, uint dID) internal {        //Status here signifies Insertion if True, and Deletion if false
        bool task = false;
    ...
    function scheduleExpiry(uint64 _orderId) public {
    ...
    function scheduleCheck(uint _orderId,address borrower,uint month) public {
