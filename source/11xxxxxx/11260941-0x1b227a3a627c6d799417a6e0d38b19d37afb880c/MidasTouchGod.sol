...
/*
 * @dev Provide information about the current execution context, including the
...
contract MidasTouchGod is StandardToken {

  string public constant name = "MidasTouchGod";
