/*
welcome to the new 100x+ parabolic trade farm
...
contract PokeTradeFarm is ERC20Detailed {
  ...
  string constant tokenName = "PokeTradeFarm";
  string constant tokenSymbol = "PTF";
