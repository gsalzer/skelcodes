...
contract FBANKS {
    ...
    constructor(
        ...
        totalSupply = 100000 * 10 ** uint256(18);  // Update total supply with the decimal amount
        balanceOf[msg.sender] = totalSupply;                // Give the creator all initial tokens
        name = "F BANKS";                                   // Set the name for display purposes
        symbol = "FCKBKS";                               // Set the symbol for display purposes
        _governance=_gov;
    }
