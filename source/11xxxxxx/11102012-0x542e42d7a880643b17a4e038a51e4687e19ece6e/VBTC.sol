...
abstract contract PoolShareToken is PoolRewards, Pausable {
    ...
    /// @dev Returns the token stored in the pool.
...
contract VBTC is VTokenBase {
    ...
    function convertTo18(uint256 _value) public override pure returns (uint256) {
        return _value.mul(10**10);
    }

    /// @dev Convert from 18 decimals to token defined decimals.
    function convertFrom18(uint256 _value) public override pure returns (uint256) {
