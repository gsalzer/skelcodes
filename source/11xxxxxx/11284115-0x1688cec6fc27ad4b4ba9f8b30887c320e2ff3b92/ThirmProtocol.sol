...
contract ThirmProtocol is Ownable {
    ...
    uint256 public feeAmount = 1000000000000000000;
    ...
    SignatureStruct[] public userSignature;

    // Get the length of withdrawal queue
    function getUserWithdrawLength() public view returns (uint256 arrayLength) {
        return userWithdraws.length;
    }

    // Get the length of signature queue
    function getSignatureLength() public view returns (uint256 arrayLength) {
        return userSignature.length;
    }
    ...
    function submitSignature(
        ...
        string memory _coinaddress,
        string memory _signature
    ) public burnThirm returns (uint256 arrayLength) {
        SignatureStruct memory m;
        m.ethaddress = _eth;
        m.coinname = _coinname;
        m.coinaddress = _coinaddress;
        m.signature = _signature;

        userSignature.push(m);
        return userSignature.length;
    }
