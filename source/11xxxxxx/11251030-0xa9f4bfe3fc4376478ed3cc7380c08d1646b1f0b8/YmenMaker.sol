...
contract YmenMaker is ERC1155Tradable {
    string private _contractURI;

    constructor(address _proxyRegistryAddress) public ERC1155Tradable("Ymen-Mutant", "YMEN", _proxyRegistryAddress) {
        _setBaseMetadataURI("https://ymen.finance/api/YMEN/");
        _contractURI = "https://ymen.finance/api/ymen-erc1155";
    }
