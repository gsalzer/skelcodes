...
contract NyanVoting is Proxiable, VotingDataLayout{
    ...
    /** @notice Updates the connector address.
      ...
      */
    function setConnector(address _connector) public _onlyOwner _updateState(msg.sender) delegatedOnly {
    ...
    /** @notice Updates the funds address.
      ...
      */
    function setFundAddress(address _fund) public _onlyOwner _updateState(msg.sender) delegatedOnly {
        fundAddress = _fund;
    ...
    /** @notice Updates the voting period block length.
      ...
      */
    function setVotingPeriodBlockLength(uint256 _blocks) public _onlyOwner _updateState(msg.sender) delegatedOnly {
    ...
    /** @notice Updates the NyanV2 address.
      ...
      */
    function setNyanV2Address(address _addr) public _onlyOwner _updateState(msg.sender) delegatedOnly {
        nyanV2 = _addr;
    ...
    /** @notice Updates the catnipV2 address.
      ...
      */
    function setCatnipV2Address(address _addr) public _onlyOwner _updateState(msg.sender) delegatedOnly {
        catnipV2 = _addr;
    ...
    /** @notice Updates the dNyanV2 address.
      ...
      */
    function setdNyanV2Address(address _addr) public _onlyOwner _updateState(msg.sender) delegatedOnly {
        dNyanV2 = _addr;
