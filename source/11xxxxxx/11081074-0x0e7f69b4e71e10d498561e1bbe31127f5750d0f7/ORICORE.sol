...
contract Ownable is Context {
    ...
    uint256 public LGE_PERIOD = 2 hours;
...
contract NBUNIERC20 is Context, INBUNIERC20, Ownable {
    ...
    uint256 public constant initialSupply = 9999e18; // 9999 
    ...
    function getSecondsLeftInLiquidityGenerationEvent() public view returns (uint256) {
        ...
        return contractStartTimestamp.add(LGE_PERIOD).sub(block.timestamp);
    }
    ...
    function liquidityGenerationOngoing() public view returns (bool) {
        ...
        return contractStartTimestamp.add(LGE_PERIOD) > block.timestamp;
    }
...
contract ORICORE is NBUNIERC20 {
