...
contract NKSNToken is ERC721Full, Governance {
    // for minters
    mapping(address => bool) public _minters;
    uint256 private constant MAX_SUPPLY = 18;


    constructor() public ERC721Full("NKSN", "NKSN") {
        _setBaseURI("https://nftkkswap.com/nksn-token/");
    }
    ...
    function mint(address to, uint256 tokenId) external returns (bool) {
        ...
        require(totalSupply() < MAX_SUPPLY, "reach max supply");
        _mint(to, tokenId);
        _setTokenURI(tokenId, Util.uintToString(tokenId));
        return true;
    }
