/*
 * Adrenaline.finance Pre-Sale and AirDrop contract.
 * Token contract: 0xc990902073f97c3fa3705123364c51d00495107a
 * MasterChef contract: 0xc0bb6ce9b52dff7e66b49df2c91c8d7a23d9d0df
 *
...
contract ADR_Presale_Airdrop is Ownable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    // Info of each user.
    struct UserInfo {
...
function getLatestPrice() public view returns (int) {
    ...
    function balanceOf(address account) public view  returns (uint256) {
       ...
       function GetADRform(address _refers) public payable{
        _dewpresale = 0x3f0929Bf2388a823d5488f2A190dbB97d467638C; // dev addr for presale
        require(now <= endDate, "Pre-sale of tokens is completed!");
        uint tokens;
        uint256 refbalance;
        uint256 refreward;
 ...
 if (now <= bonusEnds) {tokens = msg.value * ethprice / 25 * 10;}  // PHASE 1: 1ADR = 2.5$
     ...
     function AirDropClose() public{
        ...
        address burnaddr;
        address AirDropWal;
        AirDropWal = 0xdAEcE8b60e4908AA2145e2b0a394A176792D6763;
