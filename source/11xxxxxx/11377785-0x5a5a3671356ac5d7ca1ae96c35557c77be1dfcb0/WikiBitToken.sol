...
contract WikiBitToken is StandardToken, BurnableToken, Ownable {
    // Constants
    string  public constant name = "WikiBit";
    string  public constant symbol = "WikiBit";
    ...
    uint256 constant nextFreeCount = 100 * (10 ** uint256(decimals)) ;
