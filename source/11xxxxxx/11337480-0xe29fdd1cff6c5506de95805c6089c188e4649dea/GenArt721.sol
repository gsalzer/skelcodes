...
contract GenArt721 is CustomERC721Metadata {
    ...
    //TESTNET
    function toggleProjectIsLocked(uint256 _projectId) public onlyWhitelisted {
    // MAINNET function toggleProjectIsLocked(uint256 _projectId) public onlyWhitelisted onlyUnlocked(_projectId) {
