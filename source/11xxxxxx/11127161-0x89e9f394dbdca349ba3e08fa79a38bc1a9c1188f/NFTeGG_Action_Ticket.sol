...
// File: openzeppelin-contracts\contracts\introspection\IERC165.sol
...
// File: openzeppelin-contracts\contracts\token\ERC721\IERC721Metadata.sol
...
// File: openzeppelin-contracts\contracts\token\ERC721\IERC721Enumerable.sol
...
// File: openzeppelin-contracts\contracts\introspection\ERC165.sol
...
// File: openzeppelin-contracts\contracts\utils\EnumerableSet.sol
...
// File: openzeppelin-contracts\contracts\utils\EnumerableMap.sol
...
// File: general\ERC20Recoverable.sol
...
// File: general\ERC721Recoverable.sol
...
// File: projects\202009 - NFT with NFT Entry\T2.sol

/**
 * @dev Most credited to OpenZeppelin ERC721.sol, but with some adjustments.
 */
contract NFTeGG_Action_Ticket is Context, Ownable, ERC165, IERC721, IERC721Metadata, IERC721Enumerable, ERC20Recoverable, ERC721Recoverable {
...
// public functions:
    ...
    */
    ...
    function buyToken10() external payable returns (bool)
    {
        uint256 paidAmount = msg.value;
        require(paidAmount == (_tokenPrice * 10), "Invalid amount for token purchase"); // price for 6 tokens is 5.5 times the price for one token
