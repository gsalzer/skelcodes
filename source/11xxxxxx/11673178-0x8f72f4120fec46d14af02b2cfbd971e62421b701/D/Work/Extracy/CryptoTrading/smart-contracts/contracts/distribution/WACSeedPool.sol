...
contract WACSeedPool {
    ...
    uint256 public cashPerBlock = 0.52 ether;
    ...
    modifier onlyOperator() {
        require(operator == msg.sender, "WACSeedPool: caller is not the operator");
        _;
    }
    ...
    function checkPoolDuplicate(IERC20 _lpToken) internal view {
        ...
        for (uint256 pid = 0; pid < length; ++pid) {
            require(poolInfo[pid].lpToken != _lpToken, "WACSeedPool: existing pool?");
        }
    }
