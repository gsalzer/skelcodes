...
contract Sintax is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Sintax.Finance";
    ...
    uint256 internal _tokenTotal = 250000 ether;
    ...
    function multiTransfer(address[] calldata addresses, uint256 amount) external {
