...
contract VoxStrategyCurveEURS is VoxStrategyCurveBase {
    // Curve stuff
    address public eurs_pool = 0x0Ce6a5fF5217e38315f87032CF90686C96627CAA;
    address public eurs_gauge = 0x90Bb609649E0451E5aD952683D64BD2d1f245840;
    address public eurs_crv = 0x194eBd173F6cDacE046C53eACcE9B953F28411d1;

    address public eurs = 0xdB25f211AB05b1c97D595516F45794528a807ad8;
    ...
    function harvest() public override restricted {
        ...
        if (_to > 0) {
            ...
            ICurveEURS(curve).add_liquidity(liquidity, 0);
        }
