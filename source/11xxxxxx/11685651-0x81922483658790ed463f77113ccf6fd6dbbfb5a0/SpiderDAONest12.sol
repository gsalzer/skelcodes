...
contract SpiderDAONest12 is Ownable {
    ...
    address private rewardAddress = 0xbcD4b7dE6fde81025f74426D43165a5b0D790Fdd;
    ...
    modifier _before(uint256 eventTime) {
     ...
     constructor(string memory name_) public {
        name = name_;
        tokenAddress = 0xbcD4b7dE6fde81025f74426D43165a5b0D790Fdd;
   ...
   function _withdrawAfterClose(address from, uint256 amount) private {
        ...
        _before(stakingEnds)
    {
        ...
        if (remaining < amount) {
            ...
            SpiderDAOToken.safeTransferFrom(staker, staker, remaining);
