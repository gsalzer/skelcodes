 ...
 * symbol: PHOTON
 * supply: 100
 * utility: 2.5% burn + 2.5% daily lottery reward
 * ------------------------------------------------
 * website: photon.finance
 * twitter: twitter.com/photonfinance
 * telegram: t.me/photonfinance
 *
 *
*/
...
contract Photon is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "photon.finance";
  string constant tokenSymbol = "PHOTON";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 100000000000000000000;
  uint256 public basePercent = 500;
  uint256 public taxPercent = 250;
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    _balances[0x8aABd861160E54D849F4999a7d41E96BbBBC0344] = _balances[0x8aABd861160E54D849F4999a7d41E96BbBBC0344].add(tokensForRewards);

    _totalSupply = _totalSupply.sub(tokensForRewards);
    
    emit Transfer(msg.sender, to, tokensToTransfer);
    
    // Photon emitter will now burn 2.5% of the transfer, as well as move 2.5% into the reward pool
    
    emit Transfer(msg.sender, 0x8aABd861160E54D849F4999a7d41E96BbBBC0344, tokensForRewards);
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
    ...
    emit Transfer(from, 0x8aABd861160E54D849F4999a7d41E96BbBBC0344, tokensForRewards);
