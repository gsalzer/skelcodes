/* ----------------------------------------------------------------------------
Feng Zhi has the right to final interpretation and reserves the right to modify with all issued Ya Can Mi (YCM).

For the latest revision of the operating policies and trading models of YCM, please refer to the official announcements on the website (http://www.bitcaps.club/ycm). The website has the final interpretation and reserves all rights to modify, to insert, and/or to withdraw any parts with the announcements.
---------------------------------------------------------------------------- */
...
// ----------------------------------------------------------------------------
contract YaCanMi is ERC20Interface, Owned {
...
// ----------------------------------------------------------------------------
    string public constant symbol = "YCM";
    string public constant name = "Ya Can Mi";
	...
	string public constant website = "http://www.feng-zhi.com";
