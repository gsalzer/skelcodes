...
contract StrategyCurveHBTCVoterProxy {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;

    address public constant want = address(0xb19059ebb43466C323583928285a49f558E572Fd);
    address public constant crv = address(0xD533a949740bb3306d119CC777fa900bA034cd52);

    address public constant curve = address(0x4CA9b3063Ec5866A4B82E437059D2C43d1be596F);
    address public constant gauge = address(0x4c18E409Dc8619bFb6a1cB56D114C3f592E0aE79);
    ...
    function getName() external pure returns (string memory) {
        return "StrategyCurveHBTCVoterProxy";
    }
