...
// File: contracts/helpers/SushiSwapV2Library.sol
...
// File: contracts/impl/ChainlinkedKeep3rV1OracleMainAsset.sol
...
contract ChainlinkedKeep3rV1OracleMainAsset is ChainlinkedOracleSimple {
    ...
    function keep3rCurrent(address tokenIn, uint amountIn) public view returns (uint amountOut) {
        address pair = SushiswapV2Library.pairFor(address(uniswapFactory), tokenIn, WETH);
        (address token0,) = SushiswapV2Library.sortTokens(tokenIn, WETH);
