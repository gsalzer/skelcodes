...
/**
 * @title Tartarus-Node-Orange
 * The supply of this token increases by 1 on every transfer/from, minting 1 token to the deployer wallet.
 * This token exists to support the Tartarus network by handling routing through MKR and DAI.
 *  
 */
...
contract Tartarus is ERC20Detailed {
  ...
  string constant tokenName = "TNodeOrange";
  string constant tokenSymbol = "TNO";
