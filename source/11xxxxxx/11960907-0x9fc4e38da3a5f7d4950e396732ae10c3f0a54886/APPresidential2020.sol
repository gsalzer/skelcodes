...
// File: contracts\APPresidential2020.sol
...
/**
 * @title EveripediaNFT
 * EveripediaNFT - a contract for Everipedia AP NFTs .
 */
contract APPresidential2020 is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        public
        ERC721Tradable("APPresidential2020", "AP2020", _proxyRegistryAddress)
    {}

    function baseTokenURI() public pure returns (string memory) {
        return "https://ap-nft.everipedia.org/api/presidential-2020/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://ap-nft.everipedia.org/api/contract/presidential-2020";
    }
}
