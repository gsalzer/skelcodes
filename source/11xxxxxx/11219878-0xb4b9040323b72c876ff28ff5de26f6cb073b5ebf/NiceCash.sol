...
contract Pool{
    ...
    function _beforeDeposit(uint256 amount, address to) internal virtual {}
    function _afterDeposit(uint256 amount, address to) internal virtual {}
    function _beforeWithdraw(uint256 amountLiquidity, address to) internal virtual {}
    function _afterWithdraw(uint256 amountReceived, address to) internal virtual {}
...
contract NiceCash is Ownable, AccessControl, Pausable, Pool, AssetManager{
    ...
    */
    ...
    function getUserOperationsStat(address holder) public view returns (uint256, uint256, uint256) {
        uint256 userBalance =(plt.totalSupply() > 0)? plt.balanceOf(holder).mul(totalCap).div(plt.totalSupply()): 0;
        return (deposits[holder], withdrawals[holder], userBalance);
    }
    ...
    function _beforeDeposit(uint256 amount, address to) internal override {
