...
contract TFI is ERC20 {
  ...
  address public TFI_minter;
  uint256 public MAX_TOKENS = 100000 ether;

  constructor (string memory name, string memory symbol) ERC20(name, symbol) {
    // Initial governance is Tauri Deployer
    governance = msg.sender;
  }

  function mint_TFI(address to, uint256 amount) public {
    require(msg.sender == TFI_minter, "must be TFI_minter");
