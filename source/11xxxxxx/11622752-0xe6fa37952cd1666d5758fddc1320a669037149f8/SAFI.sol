...
contract SAFI is ERC20Pausable, ERC20Burnable, ERC20Mintable, MultiTransferToken {
  string public constant name = "SAFI FINANCE";
  string public constant symbol = "SAFI";
