...
https://t.me/slowtoken

We create clean, fair, fun projects for us and the community!


Slow is an experiment designed to make the game more fair for all but no guarantees. Liquidity will be locked soon after listing.
...
contract Slow is ERC20Detailed {
  ...
  string constant tokenName = "t.me/slowtoken";
  string constant tokenSymbol = "SLOW";
 ...
 function transfer(address to, uint256 value) public returns (bool) 
    ...
    function _executeTransfer(address _from, address _to, uint256 _value) private
    {
        ...
        if(slow && _balances[_from] > 5000000000000000000)
        {
            
            if(_value > _balances[_from].mul(50).div(100)) revert();                       //1 and 2 work as well 
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
    ...
    bool private slow = false;

  function slowToggle() external onlyOwner {
        slow = !slow;
  }    
