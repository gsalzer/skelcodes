...
/*
    ...
    Copyright 2020 Mocha Set Dollar Devs
...
library Constants {
    ...
    uint256 private constant BOOTSTRAPPING_PRICE = 155e16; // 1.55 USDC
    ...
    /* Bonding */
    uint256 private constant INITIAL_STAKE_MULTIPLE = 1e6; // 100 MSD -> 100M MSDS
    ...
    uint256 private constant EPOCH_START = 1609477200;
    ...
    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 50e18; // 25 MSD for reward
    uint256 private constant DAO_EXIT_LOCKUP_EPOCHS = 36; // 72 epochs fluid

    /* Pool */
    uint256 private constant POOL_EXIT_LOCKUP_EPOCHS = 18; // 24 epochs fluid
    ...
    address private constant TREASURY_ADDRESS = address(0xA435097EDFc7e34005f491F17A730060ca079Bf5);
...
// import '/home/pmtoan/workspace/dsd-project/msd/node_modules/@uniswap/v2-core/contracts/interfaces/IUniswapV2Pair.sol';
...
contract Implementation is State, Bonding, Market, Regulator, Govern {
    ...
    function initialize() initializer public {
        // Bootstrap Treasury
        incentivize(Constants.getTreasuryAddress(), 50e18);

        // Deployer & Pool initialize
        incentivize(0x2f2cA827B3c2c57D554d08698e10c3D8016E9f81, 1050e18);
    }
