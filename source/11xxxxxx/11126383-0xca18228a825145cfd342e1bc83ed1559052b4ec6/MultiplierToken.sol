//
// X10 (x10.finance) is a deflationary and gambling token
...
contract MultiplierToken is ERC20("x10.finance", "X10"), Ownable {
    using SafeMath for uint256;
    ...
    function startGame(address _liquidityPool, uint _seed1) external onlyOwner {
        ...
        require(_liquidityPool != address(0), 'Need the ETH-X10 liquidity pool address');
