...
contract ZZZNAPMigrationPool is LPTokenWrapper, Ownable {
    using SafeERC20 for IERC20;

    IERC20 public rewardToken;
    IERC20 public zzznapV2;
    ...
    constructor(address _zzznapV1) public {
        setStakingToken(_zzznapV1);
        deployedTime = block.timestamp;
    }

    function setV2Address(address _v2Address) public onlyOwner {
        rewardToken = IERC20(_v2Address);
    }
    ...
    /*
    - LP Tokens are unwrapped
    - ZZZ upgraded to ZZZV2
    - NAP upgraded to NAPV2
    - ZZZV2/NAPV2 LP Token is created by adding liquidity on Uniswap
    - Transfer the LP tokens to the contract
    */
