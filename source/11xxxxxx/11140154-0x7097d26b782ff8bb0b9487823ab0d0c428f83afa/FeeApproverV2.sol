...
contract FeeApproverV2 is OwnableUpgradeSafe {
    ...
    function initialize(
        ...
        wKoreTokenAddress = _WKOREAddress;
        router = _router;
    ...
    address public koreTokenAddress;
    address public wKoreTokenAddress;
    address public router;
    address public koreVaultAddress;
    ...
    function setWKoreAddress(address _wKoreTokenAddress) public onlyOwner {
        wKoreTokenAddress = _wKoreTokenAddress;
    }
        ...
        )
    {
        ...
        // And no fee for wrapping and unwrapping wkore
        if(sender == koreVaultAddress
           || sender == tokenUniswapPair
           || recipient == wKoreTokenAddress
           || recipient == router) {
