...
contract LPTokenWrapper {
    ...
    IERC20 public LP_TOKEN = IERC20(0xB908c9D7cae7764CC0ef2E9A3EbB959eA556e32e); // Stake - NFI
...
contract NFIrewards is LPTokenWrapper, Ownable {
    IERC20 public NFI_TOKEN = IERC20(0xB908c9D7cae7764CC0ef2E9A3EbB959eA556e32e); // NFI token
    uint256 public constant DURATION = 7 days;

    uint256 public initreward = 1000 * 1e18; // 1000 NFI
    uint256 public starttime = 1611426600; // 23 January 2021 - 18:30:00 UTC
    ...
    uint256 public constant DEV_FUND_VESTING_PERIOD = 180 days;
    ...
    function getReward() public updateReward(msg.sender) checkhalve {
        ...
        if (reward > 0) {
            ...
            NFI_TOKEN.safeTransfer(msg.sender, reward);
    ...
    modifier checkhalve(){
        if (block.timestamp >= periodFinish) {
            ...
            NFI_TOKEN.mint(address(this), initreward);
        ...
        updateReward(address(0))
    {
        ...
        NFI_TOKEN.mint(address(this), reward.add(devNewAmt));
    ...
    function withdrawDevFund(uint256 amt) external
    {
        ...
        NFI_TOKEN.safeTransfer(devVestingAddr, amt);
    }
}
