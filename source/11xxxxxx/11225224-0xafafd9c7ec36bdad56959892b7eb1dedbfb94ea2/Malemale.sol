...
contract Malemale is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Malemale.io";
  string constant tokenSymbol = "Male";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 10000000000000000000000;
  uint256 public basePercent = 9300;
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    // The emitter will now burn 3% of the transfer, as well as move 3% into the reward pool
