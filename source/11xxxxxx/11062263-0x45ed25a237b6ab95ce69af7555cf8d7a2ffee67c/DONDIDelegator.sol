...
contract DONDITokenStorage {
    ...
    /**
     * @notice Reserve address of DONDI protocol
     */
    address public incentivizer;

    /**
     * @notice Total supply of DONDIs
     */
...
contract DONDIToken is DONDIGovernanceToken {
    ...
    */
    ...
    function _maxScalingFactor()
        ...
        returns (uint256)
    {
        // scaling factor can only go up to 2**256-1 = initSupply * dondisScalingFactor
        // this is used to check if dondisScalingFactor will be too high to compute balances when rebasing.
    ...
    */
    function transfer(address to, uint256 value)
        ...
        returns (bool)
    {
        // underlying balance is stored in dondis, so divide by current scaling factor

        // note, this means as scaling factor grows, dust will be untransferrable.
        // minimum transfer value == dondisScalingFactor / 1e24;
