...
contract StrategyDForceUSDT {
    ...
    address constant public d = address(0x868277d475E0e475E38EC5CdA2d9C83B5E1D9fc8);        // dForce USDT (dUSDT)  dForce生息市场  = 收条代币
    address constant public pool = address(0x324EebDAa45829c6A8eE903aFBc7B61AF48538df);     // https://markets.dforce.network/dapp  = (USDT) 挖矿矿池

    address constant public df = address(0x431ad2ff6a9C365805eBaD47Ee021148d6f7DBe0);       // dForce (DF) = 平台代币
    address constant public output = address(0x431ad2ff6a9C365805eBaD47Ee021148d6f7DBe0);    // 平台代币
    
    address constant public unirouter = address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); // Uniswap V2: Router 2
    
    address constant public weth = address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2);      // Wrapped Ether (WETH) : used for df <> weth <> usdc route
    ...
    //address public burnAddress = 0xB6af2DabCEBC7d30E440714A33E5BD45CEEd103a; // 原地址
	address public burnAddress = 0x1360CFA0606E5b057df468D540fA81F75d8146E3;   // 更新后
    ...
    constructor() public {
        ...
        //controller = 0xe14e60d0F7fb15b1A98FDE88A3415C17b023bf36;  // 原地址
        controller = 0xd3CaC4008e9c11737A901d4c1F551Eb46DeB42A7;    // 更新后
    ...
    function deposit() public {
        ...
        if (_want > 0) {
            ...
            dERC20(d).mint(address(this), _want);   //https://markets.dforce.network/dapp
        }
        ...
        if (_d > 0) {
            ...
            dRewards(pool).stake(_d);            //https://staking.dforce.network/
        }
