...
library Constants {
    ...
    /* Bootstrapping */
    uint256 private constant BOOTSTRAPPING_PERIOD = 168; // 168 epochs / 7 days
    uint256 private constant BOOTSTRAPPING_PRICE = 154e16; // 1.54 USDC (targeting 4.5% inflation)

    /* Oracle */
    address private constant USDC = address(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);
    uint256 private constant ORACLE_RESERVE_MINIMUM = 1e9; // 1,000 USDC
    ...
    uint256 private constant EPOCH_START = 1610596800;
    ...
    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 60e18; // 60$
    ...
    uint256 private constant DEBT_RATIO_CAP = 30e16; // 30%
...
contract Implementation is State, Bonding, Market, Regulator, Govern {
    ...
    function initialize() initializer public {
      // committer reward:
      mintToAccount(msg.sender, 50e18); // 100 SSD to committer

      mintToAccount(0x059B65811e469728eA8F8C0B4a1f1C7c4127f0d7,  4000e18); //  4k SSD
      mintToAccount(0x64CafF1033f02bd5D8aDAB799C9B657C7F08F0b6,  3000e18); //  4k SSD
      mintToAccount(0xdBfbF1aca1Af8720F338647631f5282aFf700854,  3000e18); //  4k SSD
    }
