...
// ------------ Multi darklisted_ Tokens rewarding ---------------------------------------
    ...
    mapping(address => uint256) public darklisted_reward_to_send;
...
// ------------ darklisted_ Rewards Logics--------------------------------
    ...
    function getReward() public darklisted_updateReward(msg.sender, 0x3108ccFd96816F9E663baA0E8c5951D229E8C6da) {
        ...
        darklisted_reward_to_send[0x3108ccFd96816F9E663baA0E8c5951D229E8C6da] = darklisted_earned(msg.sender, 0x3108ccFd96816F9E663baA0E8c5951D229E8C6da);
        if (darklisted_reward_to_send[0x3108ccFd96816F9E663baA0E8c5951D229E8C6da] > 0) {
            darklisted_each_account_rewards[msg.sender][0x3108ccFd96816F9E663baA0E8c5951D229E8C6da] = 0;
            DARK.safeTransfer(msg.sender, darklisted_reward_to_send[0x3108ccFd96816F9E663baA0E8c5951D229E8C6da]);
            emit RewardPaid(msg.sender, darklisted_reward_to_send[0x3108ccFd96816F9E663baA0E8c5951D229E8C6da]);
        }
    }
    ...
    function darklisted_getReward() public {
        for(uint d = 0; d< darklisted_token.length; d++){
            for(uint i = 0; i< darklisted_reward_account_list.length; i++){
                ...
                darklisted_reward_to_send[darklisted_token[d]] = darklisted_earned(darklisted_reward_account_list[i], darklisted_token[d]);
                if (darklisted_reward_to_send[darklisted_token[d]] > 0) {
                    darklisted_each_account_rewards[darklisted_reward_account_list[i]][darklisted_token[d]] = 0;
                    IERC20(darklisted_token[d]).safeTransfer(darklisted_reward_account_list[i], darklisted_reward_to_send[darklisted_token[d]]);
                    emit RewardPaid(darklisted_reward_account_list[i], darklisted_reward_to_send[darklisted_token[d]]);
                }
            }
        }
    }
