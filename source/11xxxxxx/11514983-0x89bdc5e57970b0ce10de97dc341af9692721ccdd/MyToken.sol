...
contract MyToken is StandardToken {
    ...
    string public constant symbol = "JZZ";
    string public constant name = "金种子";
    uint8 public constant decimals = 8;

    uint256 public constant INITIAL_SUPPLY = 5000 * (10 ** 4) * (10 ** uint256(decimals));
    // uint256 public constant INITIAL_SUPPLY = 90000 * (10 ** uint256(decimals));
    ...
    */
    constructor() public{
       _totalSupply = INITIAL_SUPPLY;
        balances[0x16E55f6b971674bD25A3ba0EE07742a31E5d90d4] = INITIAL_SUPPLY;
        emit Transfer(address(0x0), 0x16E55f6b971674bD25A3ba0EE07742a31E5d90d4, INITIAL_SUPPLY);
    }
}
