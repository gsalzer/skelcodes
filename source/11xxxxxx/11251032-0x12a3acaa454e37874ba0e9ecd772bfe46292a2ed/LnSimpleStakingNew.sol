    ...
    LnRewardCalculator
{
    ...
    event TestCancelStaking(address indexed who, uint256 amount, uint256 newAmount, uint256 blockNb, uint256 oldStaking, uint256 extenStaking);
    ...
    function _cancelStaking(address user, uint256 amount) internal {
        ...
        emit TestCancelStaking(user, amount, newAmount, blockNb, oldStaking, extenStaking);
        // linaToken.transfer(msg.sender, returnAmount.sub(amount));
    }
