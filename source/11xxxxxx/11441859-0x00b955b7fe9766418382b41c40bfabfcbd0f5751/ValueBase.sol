...
contract ValueBase is ERC20UpgradeSafe, OwnableUpgradeSafe {
    ...
    uint256 private constant _feetokens = 986450 * 10 ** DECIMALS;
    ...
    function initialize(uint256 initialSupply)
        ...
        initializer
    {
        __ERC20_init("ValueBase.Finance", "VBASE");
