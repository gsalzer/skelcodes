...
contract StrategyCurveUSDNVoterProxy {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint256;

    address public constant want = address(0x4f3E8F405CF5aFC05D68142F3783bDfE13811522);
    address public constant crv = address(0xD533a949740bb3306d119CC777fa900bA034cd52);

    address public constant curve = address(0x094d12e5b541784701FD8d65F11fc0598FBC6332);
    address public constant gauge = address(0xF98450B5602fa59CC66e1379DFfB6FDDc724CfC4);
    ...
    function getName() external pure returns (string memory) {
        return "StrategyCurveUSDNVoterProxy";
    }
