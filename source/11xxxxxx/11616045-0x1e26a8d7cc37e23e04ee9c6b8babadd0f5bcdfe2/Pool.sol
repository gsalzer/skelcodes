...
library Constants {
    ...
    /* Bootstrapping */
    uint256 private constant BOOTSTRAPPING_PERIOD = 250; // 240 epochs
    uint256 private constant BOOTSTRAPPING_PRICE = 13e17; // 1.30 USDT (expansion 30%)

    /* Oracle */
    address private constant USDT = address(0xdAC17F958D2ee523a2206206994597C13D831ec7);
    uint256 private constant ORACLE_RESERVE_MINIMUM = 1e19; // 1,000 USDT

    /* Bonding */
    uint256 private constant INITIAL_STAKE_MULTIPLE = 1e6; // 100 YSD -> 100M YSDS
    ...
    uint256 private constant EPOCH_START = 1610100000;
    ...
    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 25e18; // 25 YSD
    uint256 private constant DAO_EXIT_LOCKUP_EPOCHS = 12; // 24 epochs fluid

    /* Pool */
    uint256 private constant POOL_EXIT_LOCKUP_EPOCHS = 6; // 16 epochs fluid
    ...
    uint256 private constant SUPPLY_CHANGE_LIMIT = 30e16; // 30%
...
// Dependency file: contracts/oracle/IUSDT.sol
...
// import "contracts/oracle/IUSDT.sol";
...
// import "@openzeppelin/contracts/math/SafeMath.sol";
// import '/home/pmtoan/workspace/dsd-project/ysd/node_modules/@uniswap/v2-core/contracts/interfaces/IUniswapV2Pair.sol';
...
contract Liquidity is PoolGetters {
    ...
    function addLiquidity(uint256 dollarAmount) internal returns (uint256, uint256) {
        ...
        return (usdtAmount, IUniswapV2Pair(pair).mint(address(this)));
    }
...
contract Pool is PoolSetters, Liquidity {
    ...
    event Provide(address indexed account, uint256 value, uint256 lessUsdt, uint256 newUniv2);
    ...
    function provide(uint256 value) external onlyFrozen(msg.sender) notPaused {
        ...
        (uint256 lessUsdt, uint256 newUniv2) = addLiquidity(value);
        ...
        emit Provide(msg.sender, value, lessUsdt, newUniv2);
    }
