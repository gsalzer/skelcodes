...
// Created by wafflemakr and Sudeep. All donations will be equally divided.
// Donation address: 0xBEA91186505cE13c4D93d0756f0Aa9eC05776f2e
...
contract VNFTMulti {
        ...
        discountCHI(shouldBurn)
    {
        ...
        for (uint256 i = 0; i < ids.length; i++) {
            require(vnft.ownerOf(ids[i]) == msg.sender, "Only owner of VNFT can feed");
