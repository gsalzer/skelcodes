 ...
 *   tweeter: https://twitter.com/wise_token
 *   e-mail:  wisetokenofficial@gmail.com
 *
 *
 */
...
contract WISEv2Token is LiquidityToken {


    address public LIQUIDITY_TRANSFORMER;
    address public transformerGateKeeper;

    constructor() ERC20("WISEv2 Token", "WISEv2") {
    ...
    {
        require(
            msg.sender == transformerGateKeeper
