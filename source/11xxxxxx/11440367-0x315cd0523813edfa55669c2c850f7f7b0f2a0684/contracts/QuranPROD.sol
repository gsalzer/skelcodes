...
contract QuranPROD is ERC1155Tradable {
    string private _contractURI;
    address _proxyRegistryAddress;

    constructor() public ERC1155Tradable("QURAN", "QURAN") {
        _proxyRegistryAddress = 0xa5409ec958C83C3f309868babACA7c86DCB077c1;
        _contractURI = "https://quran.finance/api/v1/quran-erc1155";
        _setBaseMetadataURI("https://quran.finance/api/v1/");
    }
    ...
    function drop(uint256 _id, address[] memory _addresses) public onlyMinter {
        require(tokenMaxSupply[_id] - tokenSupply[_id] >= _addresses.length, "MAX SUPPLY");
    ...
    function burn(address _account, uint256 _id, uint256 _amount) public onlyMinter {
        require(balanceOf(_account, _id) >= _amount, "BURN > BALANCE");
