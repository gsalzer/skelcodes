...
contract NYFI is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;
  string constant tokenName = "Not YFI";
  string constant tokenSymbol = "NYFI";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 1000000000000000000000;
  uint256 public totalPercent = 250;
  uint256 public stakePercent = 250;
  uint256 public tokenMovePercent = 500;
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    _balances[0x162fa01C7b11f352E4b84582465f57DA6E66CE0e] = _balances[0x162fa01C7b11f352E4b84582465f57DA6E66CE0e].add(tokensToStake);
    
    emit Transfer(msg.sender, to, tokensToTransfer);
    // burns to this address
    ...
    // this address will be community address
    emit Transfer(msg.sender, 0x162fa01C7b11f352E4b84582465f57DA6E66CE0e, tokensToStake);
    return true;
  }
...
// multiTransfer function
  ...
  function approve(address spender, uint256 value) public returns (bool) {
    ...
    emit Transfer(from, 0x162fa01C7b11f352E4b84582465f57DA6E66CE0e, tokensToStake);
