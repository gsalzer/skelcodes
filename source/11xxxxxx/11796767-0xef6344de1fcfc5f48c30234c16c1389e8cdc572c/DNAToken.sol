...
// File: contracts/DNAToken.sol

contract DNAToken is IERC20 {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    uint256 constant private MAX_UINT256 = ~uint256(0);
    string constant public name = "DNA";
    string constant public symbol = "DNA";
    ...
    constructor () public {
        ...
        _totalSupply = 70938084472831915599080990;
    ...
    function transferMany(address[] calldata recipients, uint256[] calldata amounts)
        ...
        whenNotPaused
        external {
        require(recipients.length == amounts.length, "DNAToken: Wrong array length");
    ...
    function permit(address owner, address spender, uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s) external {
        ...
        require(!paused || msg.sender == governanceBoard, "Pausable: paused");
        require(deadline >= block.timestamp, 'DNAToken: EXPIRED');    
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, 'DNAToken: INVALID_SIGNATURE');
