...
contract NBUNIERC20 is Context, INBUNIERC20, Ownable {
    ...
    uint256 public constant initialSupply = 10000e18; // 10k TENS
    uint256 public constant maxRaiseCapEth = 999e18; // 999 ETH (999e18) // Test: 0.2 ETH (200000000000000000)
    ...
    function liquidityGenerationOngoing() public view returns (bool) {
        ...
        bool hasTimeRemaining = contractStartTimestamp.add(7 days) > block.timestamp;
        bool hasCapAvailable = totalETHContributed < maxRaiseCapEth;
        return hasTimeRemaining && hasCapAvailable;
    }
    ...
    function setLPGenerationCompleted(bool complete) public onlyOwner {
        LPGenerationCompleted = complete;
    }
    ...
    function addLiquidityToUniswapTENSxWETHPair() public {
    ...
    function addLiquidity(bool agreesToTermsOutlinedInLiquidityGenerationParticipationAgreement) public payable {
        ...
        require(LPGenerationCompleted == false, "Liquidity Generation is over");
    ...
    function _transfer(
        ...
        if(transferToFeeDistributorAmount > 0 && feeDistributor != address(0)){
            ...
            if(feeDistributor != address(0)){
                ITensVault(feeDistributor).addPendingRewards(transferToFeeDistributorAmount);
            }
        }
    }
