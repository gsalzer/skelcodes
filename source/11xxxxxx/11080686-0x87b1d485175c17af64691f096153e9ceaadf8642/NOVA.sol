...
UniLaunchpad is launching a new token on Uniswap every 3 days

4% token burn per transfer for NOVA

1,000,000 NVA initial supply

Each token Uniswap LP Liquidity locked on Unicrypt for 2 days
...
contract NOVA is ERC20, ERC20Detailed {
  using SafeERC20 for IERC20;
  using Address for address;
  using SafeMath for uint;

  
  constructor () public ERC20Detailed("UniLaunchpad.com | NOVA", "NVA", 18) {
      admin = msg.sender;
      addBalance(admin,1000000e18);  //Initial tokens for Uniswap Liquidity Pool
  }
