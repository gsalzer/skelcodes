    ...
    */
    fallback() external {
        ...
        assembly {
            ...
            let traceQueryResponses := /*traceQueryQesponses*/ add(context, 0x9180)

            let compositionQueryResponses := /*composition_query_responses*/ add(context, 0x12780)
            ...
            for {} lt(friQueue, friQueueEnd) {friQueue := add(friQueue, 0x60)} {
                ...
                res := add(
                    ...
                    mulmod(mulmod(/*(x - g^8189 * z)^(-1)*/ mload(add(denominatorsPtr, 0xa80)),
                                  /*oods_coefficients[195]*/ mload(add(context, 0x8fe0)),
                                  PRIME),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - z)^(-1)*/ mload(denominatorsPtr),
                                  /*oods_coefficients[196]*/ mload(add(context, 0x9000)),
                                  PRIME),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^16 * z)^(-1)*/ mload(add(denominatorsPtr, 0x200)),
                                  /*oods_coefficients[197]*/ mload(add(context, 0x9020)),
                                  PRIME),
                ...
                res := add(
                    ...
                    mulmod(mulmod(/*(x - g^80 * z)^(-1)*/ mload(add(denominatorsPtr, 0x460)),
                                  /*oods_coefficients[198]*/ mload(add(context, 0x9040)),
                                  PRIME),
                ...
                res := add(
                    ...
                    mulmod(mulmod(/*(x - g^144 * z)^(-1)*/ mload(add(denominatorsPtr, 0x5a0)),
                                  /*oods_coefficients[199]*/ mload(add(context, 0x9060)),
                                  PRIME),
                ...
                res := add(
                    ...
                    mulmod(mulmod(/*(x - g^208 * z)^(-1)*/ mload(add(denominatorsPtr, 0x6c0)),
                                  /*oods_coefficients[200]*/ mload(add(context, 0x9080)),
                                  PRIME),
                ...
                res := add(
                    ...
                    mulmod(mulmod(/*(x - g^8160 * z)^(-1)*/ mload(add(denominatorsPtr, 0x9a0)),
                                  /*oods_coefficients[201]*/ mload(add(context, 0x90a0)),
                                  PRIME),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - z)^(-1)*/ mload(denominatorsPtr),
                                  /*oods_coefficients[202]*/ mload(add(context, 0x90c0)),
                                  PRIME),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g * z)^(-1)*/ mload(add(denominatorsPtr, 0x20)),
                                  /*oods_coefficients[203]*/ mload(add(context, 0x90e0)),
                                  PRIME),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - z)^(-1)*/ mload(denominatorsPtr),
                                  /*oods_coefficients[204]*/ mload(add(context, 0x9100)),
                                  PRIME),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^2 * z)^(-1)*/ mload(add(denominatorsPtr, 0x40)),
                                  /*oods_coefficients[205]*/ mload(add(context, 0x9120)),
                                  PRIME),
                           add(columnValue, sub(PRIME, /*oods_values[205]*/ mload(add(context, 0x7120)))),
                           PRIME))
                }
                ...
                res := add(
                    ...
                    mulmod(mulmod(/*(x - z^2)^(-1)*/ mload(add(denominatorsPtr, 0xac0)),
                                  /*oods_coefficients[206]*/ mload(add(context, 0x9140)),
                                  PRIME),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - z^2)^(-1)*/ mload(add(denominatorsPtr, 0xac0)),
                                  /*oods_coefficients[207]*/ mload(add(context, 0x9160)),
                                  PRIME),
