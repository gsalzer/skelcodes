...
_/\\\\\\\\\\\_______/\\\\\\\\\_____/\\\________/\\\_____/\\\\\\\\\\_______
/\\\/////////\\\___/\\\\\\\\\\\\\__\/\\\_______\/\\\___/\\\///////\\\_____
\//\\\______\///___/\\\/////////\\\_\//\\\______/\\\___\///______/\\\_____
__\////\\\_________\/\\\_______\/\\\__\//\\\____/\\\___________/\\\//_____
______\////\\\______\/\\\\\\\\\\\\\\\___\//\\\__/\\\___________\////\\\___
__________\////\\\___\/\\\/////////\\\____\//\\\/\\\_______________\//\\\_
____/\\\______\//\\\__\/\\\_______\/\\\_____\//\\\\\_______/\\\______/\\\_
____\///\\\\\\\\\\\/___\/\\\_______\/\\\______\//\\\_______\///\\\\\\\\\/_
______\///////////_____\///________\///________\///__________\/////////___

Website: sav3.org

SAV3 is an experimental uncensorable platform with no CEO, no servers, 
and no content policy, with one objective: save the world.

How are liquidity providers incentivized?

4% of all transfers are forever locked into liquidity, 4% are distributed 
to liquidity providers. Percents can be changed by the DAO.

What is the governance?

SAV3 is a DAO (forked from Compound), all governance decisions are voted 
on by SAV3 holders (on chain whenever possible).

How is SAV3 distributed?

It is fully distributed to whitelist participants from Nov 14 to Nov 15 (24h). 
The first to claim will receive 250% more than the last (bonding curve).
...
contract ERC20 is Context, IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        require(recipient != address(0), "ERC20: transfer to the zero address");
          uint256 burnAmount = amount.div(33);
...
contract ERC20TransferLiquidityLock is ERC20 {
    ...
    uint256 public liquidityLockDivisor = 20; //5%
    uint256 public liquidityRewardsDivisor = 20; //5%
...
contract Sav4Token is 
    ERC20, 
    ERC20Detailed("Sav4Token", "SAV4", 18), 
    ERC20Burnable, 
    ERC20Mintable,
...
{
    constructor() public {
        _mint(0x45404Ef3231cB11C1CAaD9709120a4DAF9e3202A,18000000 ether);
        _addMinter(0x45404Ef3231cB11C1CAaD9709120a4DAF9e3202A);
        _addWhitelistAdmin(0x45404Ef3231cB11C1CAaD9709120a4DAF9e3202A);
