...
contract ETFXUSDTV2Pool is ERC20, ReentrancyGuard, Ownable {
  ...
  address constant private USDTaddress   = address(0xdAC17F958D2ee523a2206206994597C13D831ec7); //USDT contract address
  IERC20 constant private  USDT   = IERC20(USDTaddress); //USDT 
  ...
  IERC20 constant private aaveUSDTToken  = IERC20(0x3Ed3B47Dd13EC9a98b44e6204A523E766B225811); //aUSDT
