...
contract ERC20 is InterfaceERC20 {
     ...
     */
    function transfer(address to, uint256 value) public isBalance(value) returns (bool) {
     ...
     */
    function _mintInit(address account, uint256 value) internal {
    ...
    modifier isBalance (uint256 value) {
 ...
 */
contract ERC20Detailed is InterfaceERC20 {
...
contract Token is ERC20, ERC20Detailed {
    constructor(string memory name, string memory symbol, uint8 decimals) ERC20Detailed(name, symbol, decimals) ERC20() public {
        _mintInit(msg.sender, 100000000000* (10 ** 18));
    }
}
