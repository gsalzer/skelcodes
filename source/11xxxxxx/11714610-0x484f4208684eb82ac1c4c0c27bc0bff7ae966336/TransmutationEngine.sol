...
contract TransmutationEngine is VRFConsumerBase, OwnableOperable {
    ...
    function init_session() onlyOperator public {
        ...
        token_prices[currentSession][0] = getUniTokenPrice(tokens[0].pairAddress);
        token_prices[currentSession][1] = getUniTokenPrice(tokens[1].pairAddress);
        token_prices[currentSession][2] = getUniTokenPrice(tokens[2].pairAddress);
        token_prices[currentSession][3] = getUniTokenPrice(tokens[3].pairAddress);
        token_prices[currentSession][4] = getUniTokenPrice(tokens[4].pairAddress);
        token_prices[currentSession][5] = getUniTokenPrice(tokens[5].pairAddress);
        token_prices[currentSession][6] = 1e9;
        token_prices[currentSession][7] = getUniTokenPrice(tokens[7].pairAddress);
    ...
    function getUniTokenPrice(address  pair) public view returns(uint64 price){
