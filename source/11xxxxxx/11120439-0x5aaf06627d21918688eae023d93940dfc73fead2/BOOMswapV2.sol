...
contract ERC20 is AccessControl, IERC20 {
    ...
    string private _name = "BOOMswap2.org";
    string private _symbol = "BOOMv2";
    ...
    function setLP(address recipient) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "BOOMswapV2: must have admin role to do this");
		_lp = recipient;
    }
...
contract BOOMswapV2 is ERC20Burnable, CMERC20Snapshot {
