...
contract YMF20Farm is Ownable {
    using SafeMath for uint256;

    uint256 public farmYieldRate = 600;
    uint256 public farmDecimals = 1e8;
    ...
    constructor() {
        farmToken = IERC20(0x16bE21C08EB27953273608629e4397556c561D26);
    ...
    function adminWithdraw(uint256 _amount) public onlyOwner {
        require(yieldToken.balanceOf(address(this)) >= _amount, "Not enough balance");
        require(yieldToken.transfer(owner(), _amount), "Could not transfer yield token"); 
    }
