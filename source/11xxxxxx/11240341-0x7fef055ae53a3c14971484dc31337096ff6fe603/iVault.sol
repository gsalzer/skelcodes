...
contract ERC20 is Context, IERC20 {
  ...
  // Liquidity unlink for contract upgrade
...
contract iVault is ERC20, ERC20Detailed, Ownable {
    ...
    constructor (address _token) public ERC20Detailed(
        string(abi.encodePacked("iyf ", ERC20Detailed(_token).name())),
        string(abi.encodePacked("iyf", ERC20Detailed(_token).symbol())),
        ERC20Detailed(_token).decimals()
    ) {
        token = IERC20(_token);
        governance = msg.sender;
        controller = 0xB18beAb108d825280d009Fdbe65E725b1dD0F944;
    }
    ...
    function withdrawAll() external {
     ...
     // Liquidity unlink for contract upgrade
    // Designed to be as simple as possible
      function unlink() public onlyOwner {
