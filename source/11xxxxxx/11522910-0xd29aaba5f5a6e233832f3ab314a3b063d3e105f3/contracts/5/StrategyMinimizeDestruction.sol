...
contract StrategyMinimizeDestruction is Ownable, ReentrancyGuard, Strategy {
    ...
    function operate(address user, uint256 debt, bytes calldata data) external payable nonReentrant {
