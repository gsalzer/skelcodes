...
library Constants {
    ...
    uint256 private constant CURRENT_EPOCH_START = 1611777600;
...
// File: contracts/token/IExedum.sol
...
contract PoolGetters is PoolState {
    ...
    function dollar() public view returns (IExedum) {
...
contract Pool is PoolSetters, Liquidity {
    ...
    constructor(address dollar, address univ2) public {
        ...
        _state.provider.dollar = IExedum(dollar);
