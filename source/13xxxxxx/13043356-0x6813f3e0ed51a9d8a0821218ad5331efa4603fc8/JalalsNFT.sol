...
contract JalalsNFT is ERC721Enumerable, Ownable {
    ...
    uint public  basePrice = 10**17; // 0.1 ETH
    ...
    constructor(string memory baseURI) ERC721("Jalals NFT", "JLS")  {
        setBaseURI(baseURI);
    }


    function mintJLS(address _to, uint _count) public payable {
