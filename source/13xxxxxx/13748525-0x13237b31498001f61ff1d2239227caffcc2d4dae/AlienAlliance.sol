...
contract  AlienAlliance  is ERC721Enumerable, Ownable
{
    using SafeMath for uint256;
    uint maxSupply=10000;
    uint preSaleSupply=2000;
    ...
    uint public publicMintCounter=15;
    ...
    constructor(string memory baseURI) ERC721("Alien Alliance", "AA")  {
        setBaseURI(baseURI);
    }
