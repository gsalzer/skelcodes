...
contract UpdateParams {
  function execute(bool) public {
    ...
    // GEB_ORACLE_RELAYER - adjusting redemption rate bounds to +- 100% over 5 months (20 weeks)
    ...
    Setter(0x7df2d51e69aA58B69C3dF18D75b8e9ACc3C1B04E).modifyParameters("bidTargetValue", 69420 * 10 ** 18);
