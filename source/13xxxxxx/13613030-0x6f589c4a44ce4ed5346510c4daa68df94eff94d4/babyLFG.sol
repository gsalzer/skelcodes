...
contract babyLFG is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x4f6F95eB78EdF76C19aEaE952FB82997d08CCB73);
        _feeAddrWallet2 = payable(0x4f6F95eB78EdF76C19aEaE952FB82997d08CCB73);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x2174c73d9E36b2892C7d384c6263fC73A4d10DB1), _msgSender(), _tTotal);
    }
