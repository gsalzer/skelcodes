...
contract FacelessTotz is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    function buy() public payable nonReentrant {
        ...
        require(nextID <= maxSupply, "out of totz");
    ...
    function holderBuy() public payable nonReentrant {
        require(holderSell, "not selling");
        require(nextID <= maxSupply, "out of totz");
        require(msg.value >= _holder_price, "invalid eth");
        require(holder_quota[msg.sender] > 0, "no quota");
        holder_quota[msg.sender] -= 1;
        _safeMint(msg.sender, nextID);
        nextID += 1;
    }
    ...
    function memberBuy() public payable nonReentrant {
        require(memberSell, "not selling");
        require(nextID <= maxSupply, "out of totz");
        require(msg.value >= _member_price, "invalid eth");
        require(member_quota[msg.sender] > 0, "no quota");
        member_quota[msg.sender] -= 1;
        _safeMint(msg.sender, nextID);
        nextID += 1;
    }
    ...
    function whitelistBuy() public payable nonReentrant {
        require(whitelistSell, "not selling");
        require(nextID <= maxSupply, "out of totz");
        require(msg.value >= _price, "invalid eth");
        require(whitelist_quota[msg.sender] > 0, "no quota");
        whitelist_quota[msg.sender] -= 1;
        _safeMint(msg.sender, nextID);
        nextID += 1;
    }
