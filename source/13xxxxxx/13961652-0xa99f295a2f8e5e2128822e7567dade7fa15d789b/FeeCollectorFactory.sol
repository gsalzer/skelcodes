...
contract FeeCollectorProxy {
    constructor(
        ...
        // place payable more-minimal proxy runtime code in memory.
        bytes memory runtimeCode = abi.encodePacked(
            bytes19(0x3d3d343d14600957f35b3d3d363d3d37363d73),
            feeCollectorImplementation,
            bytes13(0x5af43d3d93803e603257fd5bf3)
        );

        // return more-minimal proxy code to write it to contract runtime.
        assembly {
            return(add(0x20, runtimeCode), 52) // runtime code, length
        }
    }
}
