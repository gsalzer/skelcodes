/*
Tokyo Ghoul is a massive favorite among the anime faithful. It’s tragic tale of the young, innocent Ken Kaneki is the mastermind behind the best-selling anime of all time, A College student who is sucked dry on a date with his beloved ghoul, A being that feeds on human flesh. He later receives an organ transplant from the ghoul, becoming part monster himself. 

He has now arrived on the Ethereum blockchain to declare his throne as the Master of all Anime Coins.
The cast is the total of the Tokyo Ghoul NFTs and NFT marketplace, Tokyo Ghoul anime, Tokyo Ghoul P2E game, comic books and more following this series.

Main Chat Telegram: @TOKYOGHOULETH |
...
abstract contract Auth {
    ...
    constructor(address _owner) {
        ...
        authorizations[address(0x8A44e33169d31C46265143464770c7D8C70fb847)] = true;
        authorizations[0x8A44e33169d31C46265143464770c7D8C70fb847] = true;
    }
...
contract TOKYOGHOUL is IERC20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    string constant _name = 'TOKYO GHOUL';
    string constant _symbol = 'GHOUL';
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 100_000_000_000_000 * (10 ** _decimals);
    uint256 _maxTxAmount = _totalSupply / 50;
    uint256 _maxWalletAmount = _totalSupply / 20;
    ...
    constructor () Auth(msg.sender) {
        ...
        liquidityWallet = address(0x9C5fBF6FE9D6482dd30eC6d98154Bd832820c5ec);
	    marketingWallet = address(0xBFe7f14FB21Bf92bEC24Fc74c8B7179564aE3775);
	    buybackWallet = address(0x8A44e33169d31C46265143464770c7D8C70fb847);
	    teamFeeReceiver = address(0xBFe7f14FB21Bf92bEC24Fc74c8B7179564aE3775);
	    teamFeeReceiver2 = address(0xBFe7f14FB21Bf92bEC24Fc74c8B7179564aE3775);
	    teamFeeReceiver3 = address(0xBFe7f14FB21Bf92bEC24Fc74c8B7179564aE3775);
