...
contract AutoBuy {
  ...
  function swapAndAddLiquidity(uint256 amount) public payable{
    ...
    uniswapRouterV2.addLiquidityETH.value(amount)(haremToken, IERC20(haremToken).balanceOf(address(this)), 0, 0, address(this), block.timestamp + 3600);
  ...
  function swap() public payable {
    ...
    path[0] = uniswapRouterV2.WETH();
    path[1] = haremToken; 
    uniswapRouterV2.swapExactETHForTokens.value(msg.value)(0, path, address(this), block.timestamp + 3600);
