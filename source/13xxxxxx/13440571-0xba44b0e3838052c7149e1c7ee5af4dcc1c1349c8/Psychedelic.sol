...
contract Psychedelic is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdTracker;

    uint256 public constant MAX_NFT = 6666;
    ...
    event CreatePsychedelic(uint256 indexed id);
	
    constructor(string memory baseURI, address payable creator, uint256 availableLimit) ERC721("The Psychedelic Symposium", "Psychedelic") {
        setBaseURI(baseURI);
