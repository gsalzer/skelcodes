...
contract Devour is ERC20, Ownable {
	...
	uint256 constant initialSupply = 100000000000000000 * (10**9);
	...
	CustomTaxPeriod private _launch2 = CustomTaxPeriod('launch2',0,3600,1,5,1,10,1,10,1,2,1,5,2,8);
	CustomTaxPeriod private _launch3 = CustomTaxPeriod('launch3',0,82800,1,5,1,5,1,5,1,2,1,3,2,5);

	// Base taxes
	CustomTaxPeriod private _default = CustomTaxPeriod('default',0,0,1,1,1,2,1,1,1,1,1,2,2,3);
	CustomTaxPeriod private _base = CustomTaxPeriod('base',0,0,1,1,1,2,1,1,1,1,1,2,2,3);

	// Alley Hour taxes
	uint256 private _alleyHourStartTimestamp = 0;
	CustomTaxPeriod private _alley1 = CustomTaxPeriod('alley1',0,3600,1,3,0,5,0,3,0,1,0,5,1,8);
	CustomTaxPeriod private _alley2 = CustomTaxPeriod('alley2',0,3600,1,3,1,5,1,3,1,1,1,5,2,8);
	...
	function _swapAndLiquify() private {
		...
		uint256 amountEthDev = EthBalanceAfterSwap.sub(amountEthLiquidity).sub(amountEthMarketing).sub(amountEthFoundation);
