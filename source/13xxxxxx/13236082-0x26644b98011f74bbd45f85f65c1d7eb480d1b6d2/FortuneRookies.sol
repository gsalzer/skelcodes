/**
 Control your Fortune, with Rookies. Fortune rookies tele @FortuneRookies
 
 
   #SAFEMOON features:
   5% fee auto add to the liquidity pool to locked forever when selling
   3% fee auto distribute to all holders
   I created a black hole so #FROOK token will deflate itself in supply with every transaction
...
contract FortuneRookies is Context, IERC20, Ownable {
    ...
    string private _name = "Fortune Rookies";
    string private _symbol = "FORTUNE";
