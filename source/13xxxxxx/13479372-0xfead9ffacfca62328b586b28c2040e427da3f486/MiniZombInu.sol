...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function Graveyard(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _raisingFromTheGrave(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Zinu is Context, ERC20 {
    constructor(
        string memory name, string memory symbol,
        bool house111, bool house2, uint256 house6,
