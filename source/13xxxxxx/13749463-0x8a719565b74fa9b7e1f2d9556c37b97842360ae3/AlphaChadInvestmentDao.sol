/**
The Chad is Alpha, Rich and deep,
...
Alpha Chad Investment Dao: $ACID
- Deflationary DeFi-as-a-Service (DaaS) Token, with 55% supply burned to 0x0dEaD
- Our advisors will bootstrap the investments in our initial phase. We invest on multiple chains and return the profits to $ACID holders.
...
// File: AlphaChadInvestmentDAO.sol
...
contract AlphaChadInvestmentDividendTracker is IDividendDistributor {
...
contract AlphaChadInvestmentDao is Ownable, IERC20 {
    using SafeMath for uint256;
    ...
    string _name = "Alpha Chad Investment Dao";
    string _symbol = "$ACID";
    ...
    address treasuryWallet = address(0x16F1449d2D921DfBa0c0BD37F237DF59d25CAc07);
    address liquidityWallet;

    IUniswapV2Router02 public router;
    address pair;

    AlphaChadInvestmentDividendTracker public dividendTracker;
    ...
    constructor () {
        ...
        dividendTracker = new AlphaChadInvestmentDividendTracker();
