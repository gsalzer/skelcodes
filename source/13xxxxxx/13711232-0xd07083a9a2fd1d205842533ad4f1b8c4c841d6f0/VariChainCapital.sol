/*
   ...
   Vari-Chain Capital: $VCC
   -We are here to expand the vision of DeFi 3.0 with superior deflationary + auto liquidity boost tokenomics and better yield farming strategy for $VCC holders.
    - You buy on Ethereum, we farm on various chains and return the profits to $VCC holders.
    - Earn the juiciest yields across the metaverse simply by holding $VCC tokens, backed by frequent, positive-sum, and compounded buybacks.

    Tokenomics:
    10% of each buy is divided into:
        5% Reflection: Distributed among existing $VCC holders.
        5% Treasury Wallet: Invest in yield farming across various chains.

    10% of each buy is divided into:
        5% Marketing Wallet: For marketing, growth and promotion of $VCC.
        5% Auto-Adds Liquidity: Automatically adds liquidity to $VCC.    

    Website: https://varichaincapital.com/
    
    Twitter: https://twitter.com/VariChainCap

    Medium: https://varichaincapital.medium.com
