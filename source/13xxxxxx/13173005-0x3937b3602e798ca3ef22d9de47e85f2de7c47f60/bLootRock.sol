...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    // Base URI
    string private _baseURI = "https://blootrock.xyz/";
 ...
 */
contract bLootRock is ERC721, ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC721("bLootRock (not for Weaks)", "bLootRock (not for Weaks)") {
    }
