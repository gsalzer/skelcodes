...
contract MrFinger is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor(string memory _initBaseURI) ERC721("Mr.Finger", "MR.F")
    {
    ...
    function preSale(uint8 mintTotal) public payable isPresaleOpen
    {
        ...
        require(msg.value >= price * mintTotal, "Minting a Mr.Finger NFT costs 0.08 Ether Each!");
