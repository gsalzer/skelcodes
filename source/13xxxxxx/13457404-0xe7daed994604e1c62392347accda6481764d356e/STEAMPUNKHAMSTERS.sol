...
contract STEAMPUNKHAMSTERS is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    constructor(address payable fundsTo_, uint256 maxSupply_, uint256 maxPerTx_, uint256 pricePer_, uint256 pricePerPre_) ERC721("STEAMPUNKHAMSTERS", "STEAMPUNKHAMSTERS") {
        fundsTo = fundsTo_;
