...
// Dependency file: @openzeppelin/contracts/token/ERC1155/extensions/ERC1155Pausable.sol
...
// import '/mnt/c/code_project/Project_Start/contract/node_modules/@openzeppelin/contracts/token/ERC1155/extensions/ERC1155Pausable.sol';
// import '/mnt/c/code_project/Project_Start/contract/node_modules/@openzeppelin/contracts/token/ERC1155/extensions/ERC1155Burnable.sol';
// import '/mnt/c/code_project/Project_Start/contract/node_modules/@openzeppelin/contracts/access/Ownable.sol';

contract Token is ERC1155Pausable, ERC1155Burnable, Ownable {
	event SetWhitelist(address indexed user, bool state);
	event MintOrder(address indexed user, uint256 indexed order);

	mapping(address => bool) public whiteList;
	mapping(uint256 => bool) public orderIdState;
	...
	function mint(
		...
		if (orderId > 0) {
			require(orderIdState[orderId] == false, '!mint');
			emit MintOrder(msg.sender, orderId);
			orderIdState[orderId] = true;
		}
