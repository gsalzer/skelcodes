...
contract OrcsBlock is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
        if(onlyWhitelisted == true) {
            ...
            require(userMintedCount + _mintAmount <= nftPerAddressLimit);
        }
  ...
  function giveaway(address winner) public onlyOwner {
        ...
        require(supply + 1 < maxSupply,   "max_token_supply_exceeded");
        _safeMint(winner, supply+1);
  }
