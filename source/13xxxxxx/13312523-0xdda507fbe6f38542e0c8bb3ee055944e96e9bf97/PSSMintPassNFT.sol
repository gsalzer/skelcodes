...
// File contracts/PSSMintPass.sol

pragma solidity ^0.8.0;

contract PSSMintPassNFT is Ownable, ERC721Enumerable, OpenSeaTradableNFT {
        ...
        returns (string memory)
    {
        ...
        return
            bytes(baseURI).length > 0
                ? string(abi.encodePacked(_baseURI(), 'metadata.json'))
                : '';
    }
