...
///////////////////////////////////////////////////////////////////////
// File: @openzeppelin/contracts@4.3.2/utils/math/SafeMath.sol
pragma solidity ^0.8.0;
...
//############################
// File: PIXEL_GHOST.sol
pragma solidity ^0.8.10;
contract PIXEL_GHOST is ERC721, ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    string private _baseTokenURI;
    uint256 public constant MAX_TOKENS = 10000;
    uint256 public constant MAX_TOKENS_PER_PURCHASE = 20;

    constructor(string memory baseURI) ERC721("PIXEL GHOST", "PXLG") {
