...
contract StealthToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "StealthToken | t.me/StealthToken";
    string private constant _symbol = "StealthToken";
