...
// File @openzeppelin/contracts-upgradeable/token/ERC721/extensions/ERC721URIStorageUpgradeable.sol@v4.3.2
...
contract SamizdatPvp is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable {
    ...
    function mint(uint256 charId) public payable {
        ...
        require((pvp.currentUnits + 3) < pvp.units, "SOLD_OUT");
        _tokenId++;
    ...
    function admint(uint256 charId, address recipient) public payable onlyOwner {
        Pvp memory pvp = pvps[charId];
        require(pvp.currentUnits < pvp.units, "SOLD_OUT");
        _tokenId++;
