...
contract MumboJumbo is ERC721Enumerable, Ownable{
    ...
    address public artist = 0xE23fD6B28725FaB4895480Bf32272DBcC06DF60f;
    address public dev = 0x8fb04ECA66171959222bB187D9703F8a6CF493e6;

    string private _baseURIExtended;
    mapping (uint256 => string) _tokenURIs;

    constructor() ERC721("Mumbo Jumbo","MUMBO"){
    }
    ...
    function mint() public payable {
        ...
        require(NFT_PRICE == msg.value, "Sent ether value is incorrect, mint cost is 0.05 ether");
        
        uint256 totalShares = 10000;
        uint256 payment = msg.value * 5000 / totalShares;

        payable(artist).transfer(payment);
    ...
    function mint3() public payable {
        require(saleIsActive, "Sale is not active at the moment");
        require(totalSupply().add(3) <= MAX_SUPPLY, "Purchase would exceed max supply");
        require(NFT_PRICE.mul(3) == msg.value, "Must Send 0.15 ETH to Mint 5 NFTs");
