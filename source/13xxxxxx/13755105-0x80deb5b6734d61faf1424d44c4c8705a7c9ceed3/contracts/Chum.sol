...
contract Chum is IChum, ERC20, Ownable {
  ...
  /**
   * mints $CHUM to a recipient
   * @param to the recipient of the $CHUM
   * @param amount the amount of $CHUM to mint
   */
  ...
  /**
   * burns $CHUM from a holder
   * @param from the holder of the $CHUM
   * @param amount the amount of $CHUM to burn
   */
  ...
  function transferFrom(
      ...
      address recipient,
      uint256 amount
  ) public virtual override(ERC20, IChum) disallowIfStateIsChanging returns (bool) {
    ...
    // For instance, someone can't just make a contract and siphon $CHUM from every account
