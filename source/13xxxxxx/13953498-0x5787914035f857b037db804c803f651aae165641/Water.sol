/*
 ...
 $WATER is a stealth/fair launch with low taxes and big reflections.  Everyone need $WATER
...
- Telegram: https://t.me/WaterTokenEth
...
contract Water is Context, IERC20, Ownable {
    ...
    constructor() {
        _feeAddrWallet1 = payable(0xE69c4448781646B1d02A69C8f1E6D72B3719B41d);
  ...
  _isExcludedFromFee[adr2] = false;
    ...
    function openTrading() external onlyOwner {
        ...
        _maxWalletAmount = 100000000000000 * 10**9;
        tradingOpen = true;
