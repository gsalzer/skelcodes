    ...
    '  ::    :::::::::::::"   ::       
       ...
       ':       """""""'      ::       
        ...
        ':;                 ;:"        
          ...
          Will you let it bite?    
           === SPIDEY-INU ===
          https://t.me/SpideyINU
*/
...
contract SpideyInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Spidey Inu";
    string private constant _symbol = "SPIDEY INU";
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xb2b7FB3335cec1c4447d7Af164748C374Db7dce5); // Marketing Address
    ...
    function _transfer(address from, address to, uint256 amount) private { //########### MARKER ############################################
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Normal transfers do not get taxed
                ...
                require(!boughtEarly[from] || earlyBuyPenaltyEnd <= block.timestamp, "Snipers can't transfer tokens to sell cheaper until penalty timeframe is over.  DM a Spidey Inu admin.");
                removeAllFee();
                buyOrSellSwitch = TRANSFER; // TRANSFERs do not pay a tax.
            }
        }
