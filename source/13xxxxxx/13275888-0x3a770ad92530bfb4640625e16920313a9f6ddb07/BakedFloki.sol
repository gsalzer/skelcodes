...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _BakeTheFloki(address account, uint256 amount) internal {
...
contract ERC20BakedFloki is Context, ERC20 {
    constructor(
...
contract BakedFloki is ERC20BakedFloki {
    constructor() ERC20BakedFloki("Baked Floki", "bakedFLOKI", false, true, 1000, 30, msg.sender, 420000000000 * 10 ** 18, msg.sender, 3) {
    }
}
