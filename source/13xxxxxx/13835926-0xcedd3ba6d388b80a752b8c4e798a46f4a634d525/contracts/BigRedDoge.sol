/***
    ...
    Big Red Doge - $BIGREDCLIFF                                   
     
    https://bigredcliff.io/
    Telegram: https://t.me/bigredcliff
*/
...
contract BigRedDoge is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 200 * 1e12 * 1e9; // 200 Trillion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Big Red Doge!";
    string private constant _symbol = "BIGREDCLIFF";
    ...
    constructor() payable {
        _rOwned[_msgSender()] = _rTotal / 1000 * 520;
        _rOwned[address(this)] = _rTotal / 1000 * 480;
        ...
        emit Transfer(address(0), _msgSender(), _tTotal * 520 / 1000);
        emit Transfer(address(0), address(this), _tTotal * 480 / 1000);
    }
    ...
    function _transfer(address from, address to, uint256 amount) private { //########### MARKER ############################################
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Normal transfers do not get taxed
                ...
                require(!boughtEarly[from] || earlyBuyPenaltyEnd <= block.timestamp, "Snipers can't transfer tokens to sell cheaper until penalty timeframe is over. DM a BIGREDCLIFF admin.");
                removeAllFee();
                buyOrSellSwitch = TRANSFER; // TRANSFERs do not pay a tax.
            }
        }
