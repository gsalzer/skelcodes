...
contract _Diners is ERC20, ERC20Detailed, ERC20Burnable {
    constructor() ERC20Detailed('The Diners Coin Token', 'TDCT', 18) public {
...
contract DinersCoin is Ownable,_Diners {
      using SafeMath for uint256;
