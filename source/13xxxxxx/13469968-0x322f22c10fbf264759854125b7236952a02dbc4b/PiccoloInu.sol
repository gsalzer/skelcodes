...
contract Ownable is Context {
    ...
    constructor() internal {
        _owner = 0x90eB2374DD9A06124aAAa630013D9459e8675b7B;
...
contract PiccoloInu is Context, IERC20, Ownable {
    ...
    uint256 internal _tokenTotal = 100_000_000_000_000e18;
    ...
    uint256 public _liquidityFee = 200; // means 2% add liquidity on each buy and sell
    uint256 private _burnFee = 0;  // means 0% it menas on burn 
    uint256 public _marketingFee=500; // means 5% marketing wallet
    
    address marketingWallet=0x90eB2374DD9A06124aAAa630013D9459e8675b7B;
    ...
    uint256 private minTokensBeforeSwap = 1_000_000_000e18;
