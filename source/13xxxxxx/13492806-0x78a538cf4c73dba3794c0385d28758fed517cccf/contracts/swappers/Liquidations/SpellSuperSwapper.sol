...
contract SpellSuperSwapper is ISwapper {
    ...
    // Local variables
    IBentoBoxV1 public constant bentoBox = IBentoBoxV1(0x476b1E35DDE474cB9Aa1f6B85c9Cc589BFa85c1F);
    ...
    function swap(
        ...
        (uint256 amountFrom, ) = bentoBox.withdraw(fromToken, address(SPELL_ETH), address(this), 0, shareFrom);
