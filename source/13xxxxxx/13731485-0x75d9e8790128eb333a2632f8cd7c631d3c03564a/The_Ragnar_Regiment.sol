...
contract The_Ragnar_Regiment is ERC721, Ownable {
    using SafeMath for uint256;

    uint256 public currentSupply = 0;
    uint256 public totalSupply = 10000;
    uint256 public mintPrice = 0.02 ether;  // ETH
    ...
    event ChangePaused(bool _value);
     ...
     constructor(string memory _baseTokenURIK) ERC721("VIK", "RR") {
        baseTokenURI = _baseTokenURIK;
    }
