//Stealth launch OHMGrow ($OHMGRO)
//OHMGrow distributes dividends in OHM to its holders. Giving you some passive yield even in times of instability in the market.
//5% auto LP 5% redistribution in $OHM 5% development & marketing tax
//Slippage 15-
//http://ohmgrow.xyz/
//https://twitter.com/ohmgrow
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 OHM = IBEP20(0x383518188C0C6d7730D91b2c03a03C837814a899);
...
contract OHMGrow is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address OHM = 0x383518188C0C6d7730D91b2c03a03C837814a899; // OHM
    address public WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "OHMGrow";
    string constant _symbol = "OHMGRO";
    ...
    address public autoLiquidityReceiver=0x8b487CE9865183Ac55F915850B86d44CA3e3A7Af;
    address public marketingFeeReceiver=0x8b487CE9865183Ac55F915850B86d44CA3e3A7Af;
