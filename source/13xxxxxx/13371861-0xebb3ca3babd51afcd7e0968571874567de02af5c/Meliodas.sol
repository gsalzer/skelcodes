/**
    ...
    2% Redistrubiton
    6% Marketing/
    1% Trivia Wallet for Trivia Thursdays at The Boar Hat
...
pragma solidity ^0.6.12;
    ...
    contract Meliodas is Context, IERC20, Ownable {
        ...
        string private constant _name = 'Meliodas';
        string private constant _symbol = 'MELIODAS';
        ...
        address payable public _triviaWalletAddress;
        ...
        uint256 private _maxTxAmount = 500000000 * 10**18;
        uint256 private constant _numOfTokensToExchangeForTeam = 700000 * 10**18;
        uint256 private _maxWalletSize = 3000000000 * 10**18;
        ...
        constructor (address payable triviaWalletAddress, address payable marketingWalletAddress) public {
            _triviaWalletAddress = triviaWalletAddress;
        ...
        function sendETHToTeam(uint256 amount) private {
            _triviaWalletAddress.transfer(amount.div(8));
            _marketingWalletAddress.transfer(amount.div(8).mul(7));
        }
        ...
        function _setTriviaWallet(address payable triviaWalletAddress) external onlyOwner() {
            _triviaWalletAddress = triviaWalletAddress;
        }
