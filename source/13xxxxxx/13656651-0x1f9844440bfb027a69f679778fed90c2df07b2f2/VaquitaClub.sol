...
contract VaquitaClub is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    address devWallet = 0x0D16eF98755de5035F1532699d2222C41aAd9949;
    address charityWallet = 0xb9337c473a80dD568E65FD5091fe2f93Bb3D2909;
    
    mapping(address => uint256) public Whitelist;

    receive() external payable {}

    constructor() ERC721('Vaquita Club', 'VQT') {}

    function reserveMints(address to) public onlyOwner {
        for (uint256 i = 0; i < 210; i++) internalMint(to);
    }
    ...
    function withdraw() public onlyOwner {
        ...
        payable(devWallet).transfer((balance * 300) / 1000);
        payable(charityWallet).transfer((balance * 700) / 1000);
    }
