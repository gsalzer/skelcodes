...
contract Zpreaders is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    event CreateZpreaders(uint256 indexed id);
	
    constructor(string memory baseURI, address payable creator) ERC721("Zpreaders", "Z") {
        setBaseURI(baseURI);
