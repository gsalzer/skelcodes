...
/*
“…I got this little miniature donkey with a lit-up sombrero.” -Fireman Chief, South Park: Post Covid
...
// GO TO LINE 1992 TO SEE WHERE THE Darryls Deformed Miniature Donkeys CONTRACT STARTS
...
contract DarrylsDeformedMiniatureDonkeys is ERC721, Ownable {
    ...
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        MINIATURE_DONKEY_PROVENANCE = provenanceHash;
    }
    ...
    function setStartingIndex() public {
        ...
        newStartingIndex = uint(blockhash(collectionStartingIndexBlock)) % MAX_MINIATURE_DONKEY;
        // Just a sanity case in the worst case if this function is called late (EVM only stores last 256 block hashes)
        if (block.number.sub(collectionStartingIndexBlock) > 255) {
            newStartingIndex = uint(blockhash(block.number - 1)) % MAX_MINIATURE_DONKEY;
        }
