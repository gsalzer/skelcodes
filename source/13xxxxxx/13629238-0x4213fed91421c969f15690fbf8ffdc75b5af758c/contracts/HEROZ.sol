...
contract HEROZ is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    address private _commissionAddress = address(0x42c7440d0b5b0b3c552232b5248fd3F03871E1C3);
    ...
    function withdrawEarnings() public onlyOwner {
        ...
        payable(_commissionAddress).transfer(address(this).balance);
    }

    function setCommissionAddress(address addr) external onlyOwner {
        _commissionAddress = addr;
    }
