...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xBd853c5d18bF96354B84d6121542Ba7Bc8e57069), 5000);
        m_DidDeploy = true;
    }
...
contract FSDBETA is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 10000000 * 10**9;
    string private m_Name = "FSDBETA";
    string private m_Symbol = "FSDBETA";
