...
contract ChowInu is Context, IERC20, Ownable {
    ...
    constructor(address routerAddress, address tokenOwner, address payable marketingWalletAddress1, address payable marketingWalletAddress2, address payable marketingWalletAddress3) {
    ...
    function setMarketingWalletAddresses(address payable marketing1, address payable marketing2)
    external onlyOwner() {
    ...
    function sendETHToTreasury(uint256 amount) private {
        ...
        _marketingWalletAddress2.transfer(amount.mul(3).div(9));
        _marketingWalletAddress3.transfer(amount.div(9));
    }
