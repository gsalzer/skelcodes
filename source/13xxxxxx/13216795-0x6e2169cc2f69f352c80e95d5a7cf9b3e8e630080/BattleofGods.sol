...
contract BattleofGods is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721('Battle Of Gods', 'BoG') {}
    ...
    function mintGod(uint numberOfTokens) public payable {
    ...
    function mintGodForFree() public mintOnlyOnce {
        require(saleIsActive, 'Sale is not active at the moment');
