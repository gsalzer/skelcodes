// File: fuzzypenguins_test_01_flat.sol
...
// File: fuzzypenguins_test_01.sol
...
contract FuzzyPenguins is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable {
    using Counters for Counters.Counter;

    uint public constant MAX_SUPPLY = 3500;
    uint public constant AIRDROP_QUANTITY = 75;
    uint public constant PRE_SALE_QUANTITY = 500;
    ...
    uint public constant SALE_PRICE = 0.06 ether;
    uint public constant PRESALE_PRICE = 0.06 ether;
    string public baseURI = "https://fuzzypenguins.com/metadata/";
    uint private airdrop_count = 0;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("FuzzyPenguins", "FUZZYP") {
    }
    ...
    function mintAirdrop(uint256 amount) public onlyOwner {
        ...
        require(currentTotalSupply < MAX_SUPPLY, "Max airdrop quantity reached");

        require(airdrop_count + amount <= AIRDROP_QUANTITY, "Max airdrop quantity reached");

        require(currentTotalSupply + amount <= MAX_SUPPLY, "Max airdrop quantity reached");

        airdrop_count = airdrop_count + amount;
    ...
    function mintPresale(uint256 amount) public payable {
        ...
        require(balanceOf(msg.sender) + amount <= MAX_MINT_AMOUNT, 'Each address may only buy 5 FuzzyPenguins in presale');
