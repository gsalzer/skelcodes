...
contract INFAMOUSSKULLZ is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    uint256 public maxWallet = 9;
    bool public presale = false;
    mapping(address => uint256) public minted; // To check how many tokens an address has minted
    constructor(address payable fundsTo_, uint256 maxSupply_, uint256 maxPerTx_, uint256 pricePer_) ERC721("INFAMOUSSKULLZ", "INFAMOUSSKULLZ") {
        fundsTo = fundsTo_;
