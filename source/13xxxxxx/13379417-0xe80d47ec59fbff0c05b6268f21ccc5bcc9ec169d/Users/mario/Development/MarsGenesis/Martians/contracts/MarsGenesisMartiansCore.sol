...
contract MarsGenesisMartiansCore is ERC721Full {
    ...
    string public constant ALL_MARTIANS = "ipfs://QmSvVHLTLXw6cqFsG5A1Y5Fc3dYsF2sVcut9mEAUxPTtHo";
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        return string(abi.encodePacked("ipfs://QmaX4HK36mY2egxPJuztnZjxPVG4jMMZ9A8amYzXys1roq/", _intToString(tokenToMartianId[tokenId])));
    }
    ...
    function setAuctionAddress(address _address) external {
        ...
        MarsGenesisMartiansAuction candidateContract = MarsGenesisMartiansAuction(_address);
        require(candidateContract.supportsInterface(InterfaceSignature_MarsGenesisMartiansAuction), "E10");
        _auctionContract = candidateContract;
    }
    ...
    function _beforeTokenTransfer(address from, address to, uint256 tokenId) internal override(ERC721Full) {
      ...
      require(address(_auctionContract) != address(0), "AUC_ADDR");
