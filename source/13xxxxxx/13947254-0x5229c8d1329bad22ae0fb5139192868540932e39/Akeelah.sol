...
contract Akeelah is Context, IERC20, Ownable {
    ...
    string private _name = "Akeelah";
    string private _symbol = "AKEELAH";
    ...
    uint public _treasuryFee = 4;
    address public treasuryWallet = 0x81e5f9Dc80C1AefD0Bc008d18e03943433C4F7a5;

    uint256 public _marketingFee = 5;
    address public marketingWallet = 0x88090868f76E2f22116e0c1652185896CD04f25f;
    ...
    function setFee(uint256 reflectionFee, uint256 liquidityFee, uint256 treasuryFee, uint256 marketingFee)external onlyOwner(){
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        _transferStandard(sender, treasuryWallet, treasuryAmt);
    ...
    function setNumOfTokensToLiquidity(uint256 _amount)external onlyOwner{
