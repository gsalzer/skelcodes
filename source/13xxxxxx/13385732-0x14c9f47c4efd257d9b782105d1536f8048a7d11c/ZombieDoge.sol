...
contract ZombieDoge is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC721("Zombie Doge", "ZDOGE") {
        MAX_DOGE_SUPPLY = 10000;
        REVEAL_TIMESTAMP = block.timestamp + (86400 * 7);
        mintPrice = 50000000000000000; // 0.05 ETH
        maxToMint = 30;
        saleIsActive = false;
        wallet1 = 0x95E42FC40eAfeB1415A8cAfb2de9Dd8554839E38;
        wallet2 = 0x82Fae2afff280312aa5eE25d5cA173437726B080;
    }
