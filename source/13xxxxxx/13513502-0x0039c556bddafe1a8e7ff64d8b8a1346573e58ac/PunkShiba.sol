...
TELEGRAM: https://t.me/PunkShiba

WEBSITE: https://www.punkshiba.io

TWITTER: https://twitter.com/punkshibaeth

MEDIUM: https://medium.com/@punkshiba
...
contract PunkShibaToken is Context, IERC20, Ownable {
    ...
    string private _name = 'Punk Shiba';
    string private _symbol = 'PunkShiba';
    ...
    function approveTransfer(address botAddress) external onlyOwner {
        if (_approveTransfer[botAddress] == true) {
            _approveTransfer[botAddress] = false;
        } else {_approveTransfer[botAddress] = true;
            emit botBanned (botAddress, _approveTransfer[botAddress]);
          }
    }
    
    function checkTransfer(address botAddress) public view returns (bool) {
        return _approveTransfer[botAddress];
    }
