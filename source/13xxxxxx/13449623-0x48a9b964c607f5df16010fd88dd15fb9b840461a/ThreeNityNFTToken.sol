...
// File: contracts/ThreeNityNFTToken.sol
...
contract ThreeNityNFTToken is ERC721Enumerable, Ownable, Royalties, MinterRole {
    using Strings for uint256;
    using SafeMath for uint256;
    ...
    string public baseURI = "https://3nity-thumbnail.s3.us-east-2.amazonaws.com/";
    ...
    function mint(address _to, uint256 _mintAmount)
        ...
        returns (bool)
    {
        require(_mintAmount > 0, "ThreeNityNFTToken: mintAmount should be > 0");
        ...
        returns (string memory)
    {
        require(
            _exists(tokenId),
            "ThreeNityNFTToken: URI query for nonexistent token"
        );
