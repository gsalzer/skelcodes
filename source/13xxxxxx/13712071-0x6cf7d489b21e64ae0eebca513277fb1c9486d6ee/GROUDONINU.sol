...
contract GROUDONINU is IERC20, Context, ERC20Ownable {
    ...
    string private constant _name = "GROUDON INU";
    string private constant _symbol = "GROUDON INU";
    uint8 private constant _decimals = 18;
    uint8 private _refTax = 0; // Fee for Reflection
    uint8 private _previousRefTax = _refTax;
    uint8 private _liqTax = 0; // Fee for Liquidity
    uint8 private _previousLiqTax = _liqTax;
    uint8 private _devTax = 10; // Fee to marketing/charity wallet
    ...
    constructor() {
        ...
        feeWallet = payable(0x3E6Df512268937bf18E3cbB555322aa0924E71F2);
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if (_limitBuys == true && to != _msgSender()) {
            require(amount <= 10000000000000 * 10**18, "Amount must be lower then 1% of total supply");
        }
