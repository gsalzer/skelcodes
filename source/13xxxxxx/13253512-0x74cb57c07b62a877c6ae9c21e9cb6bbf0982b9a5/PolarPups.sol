...
contract PolarPups is ERC721, Ownable {
    
    using SafeMath for uint256;

    uint256 public constant nftPrice = 80000000000000000; // .08 ETH
    uint256 public constant maxPerPurchase = 20;
    uint256 public constant MAX_SUPPLY = 8888; 

    bool public saleIsActive = false;

    //reserved for team / giveaways / promo
    uint public nftReserveAmount = 100;
    

    constructor() ERC721("Polar Pups", "POLAR") { }
    ...
    function mintNFT(uint numberOfTokens) public payable {
        ...
        require(numberOfTokens > 0 && numberOfTokens <= maxPerPurchase, "Can't mint that many tokens at a time");
        require(totalSupply().add(numberOfTokens) <= MAX_SUPPLY, "Purchase would exceed max supply of tokens");
        require(msg.value == nftPrice.mul(numberOfTokens), "Wrong amount of ETH sent");
