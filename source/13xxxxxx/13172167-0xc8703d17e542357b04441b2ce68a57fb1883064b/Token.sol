 ...
 */
contract ERC20PresetMinterPauser is Context, AccessControl, ERC20, ERC20Pausable {
...
contract Token is ERC20PresetMinterPauser, Ownable {    
    ...
    // _vestingBeneficiary = 0xe203Fc1b63200553B14366B901b83Fc437C818AA
    ...
    constructor(
        ...
        address _Ownership
    ) ERC20PresetMinterPauser('MECXXX', 'MECXXX') {
        _mint(_vestingBeneficiary, CreatorAmount);
        _mint(_Ownership, OwnershipAmount);
    }
}
