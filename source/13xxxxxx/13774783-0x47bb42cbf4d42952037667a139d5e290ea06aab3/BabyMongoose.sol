//Baby Moogoose
//It's Baby Mongoose, coming it's Benefit Meeting. A baby will grow oneday.
...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a BM shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract BabyMongoose is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant _symbol = "Baby Mongoose";
    ...
    address payable public marketingWallet = payable(0x6C67a6857af936BC6912C49EE0f01A9805Db4659);
    address payable public treasury = payable(0x6C67a6857af936BC6912C49EE0f01A9805Db4659);
    ...
    uint256 private maxBuy = 1000000000000000 * (10 ** _decimals);
    ...
    constructor (    ) Auth(0xc4951dFB4eE5eF530f26B045414F416620ee66bD) {
        address _owner = 0xc4951dFB4eE5eF530f26B045414F416620ee66bD;
