...
contract yWhales is ContextMixin, ERC721Enumerable, Ownable {
    ...
    struct Whale { 
      ...
      uint256 unsoldQty; 
      uint price; // in wei .2 ether = 0.2ETH
      uint256 whaleId;
      bool transferable;
      bool saleable;
   }
    ...
    constructor() 
        ERC721('YWhales Crystal Whales', "YWhales") {
        setBaseURI("https://one.ywhales.com/tokens/");
        proxyRegistryAddress = 0xa5409ec958C83C3f309868babACA7c86DCB077c1;
        saleActive = false;
        WhalesStructs = 0;
        addWhale('The YPO Whale', 999, 0, false, true);
        addWhale('The Nick', 50, .2 ether, true, true);
        addWhale('FOMO', 50, .2 ether, true, true);
        addWhale('Stephan', 50, .2 ether, true, true);
        addWhale('Gummy', 5, .2 ether, true, true);
        addWhale('Archie', 50, .2 ether, true, true);
        addWhale('Tupac', 5, .2 ether, true, true);
        addWhale('Bombay', 50, .2 ether, true, true);
        addWhale('Rare Pepe', 25, .2 ether, true, true);
        addWhale('The Rock', 50, .2 ether, true, true);
        addWhale('Ruby', 50, .2 ether, true, true);
        addWhale('Krug Rose', 50, .2 ether, true, true);
        addWhale('Lemon Drop', 50, .2 ether, true, true);
        addWhale('Chilli', 50, .2 ether, true, true);
        addWhale('Nehi', 50, .2 ether, true, true);
        addWhale('Rick', 50, .2 ether, true, true);
        addWhale('Solana', 50, .2 ether, true, true);
        addWhale('DeFi', 50, .2 ether, true, true);
        addWhale('Oz', 50, .2 ether, true, true);
        addWhale('Fendi', 50, .2 ether, true, true);
        addWhale('Hermes', 50, .2 ether, true, true);
        addWhale('Dolce', 50, .2 ether, true, true);
        addWhale('Bvlgari', 50, .2 ether, true, true);
        addWhale('DeFi Degen', 50, .2 ether, true, true);
        addWhale('Angra', 50, .2 ether, true, true);
        addWhale('The 68', 50, .2 ether, true, true);
        addWhale('Tamarillo', 50, .2 ether, true, true);
        addWhale('Barbara', 50, .2 ether, true, true);
        addWhale('David', 25, .2 ether, true, true);
        addWhale('Penny', 50, .2 ether, true, true);
        addWhale('Yin', 50, .2 ether, true, true);
        addWhale('Yang', 50, .2 ether, true, true);
        addWhale('Labyrinth', 50, .2 ether, true, true);
        addWhale('Bling', 50, .2 ether, true, true);
        addWhale('Mordor', 50, .2 ether, true, true);
        addWhale('Krakatoa', 50, .2 ether, true, true);
        addWhale('Topaz', 50, .2 ether, true, true);
        addWhale('Kat', 1, 1 ether, true, true);
        addWhale('Cassia', 50, .2 ether, true, true);
        addWhale('Euro', 50, .2 ether, true, true);
        addWhale('Iridium', 50, .2 ether, true, true);
        addWhale('Obsidian', 50, .2 ether, true, true);
        addWhale('Blue Check', 50, .2 ether, true, true);
        addWhale('Agean', 50, .2 ether, true, true);
        addWhale('Barney', 50, .2 ether, true, true);
        addWhale('Graphine', 50, .2 ether, true, true);
        addWhale('Honey Baked', 50, .2 ether, true, true);
        addWhale('The Thing', 50, .2 ether, true, true);
        addWhale('The J', 50, .2 ether, true, true);
        addWhale('Stealth', 50, .2 ether, true, true);
        addWhale('Chewy', 50, .2 ether, true, true);
        addWhale('Purple Haze', 50, .2 ether, true, true);
        addWhale('Fruity Pebbles', 50, .2 ether, true, true);
        addWhale('The Man', 50, .2 ether, true, true);
        addWhale('The Yeti', 50, .2 ether, true, true);
        addWhale('Oasis', 50, .2 ether, true, true);
        addWhale('Oasis', 50, .2 ether, true, true);
        addWhale('People Eater', 100, .2 ether, true, false);
        addWhale('Burt', 100, .2 ether, true, false);
        addWhale('Titan', 100, .2 ether, true, false);
        addWhale('Rosey', 100, .2 ether, true, false);
        addWhale('Dreamsicle', 100, .2 ether, true, false);
        addWhale('Brunnera', 100, .2 ether, true, false);
        addWhale('Hypatia', 100, .2 ether, true, false);
    }
    ...
    function mint6() public payable {
        ...
        require(msg.value >= 1 ether, 'Ether value is below 1ETH price');
        uint j = 0;
        for (uint i = 2; i < WhalesStructs; i++) {
