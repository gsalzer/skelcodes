...
contract AGLDLevSwapper {
    ...
    TetherToken public constant TETHER = TetherToken(0xdAC17F958D2ee523a2206206994597C13D83);
    ...
    function swap(
        ...
        uint256 amountIntermediate = getAmountOut(amountFirst, reserve1, reserve0);

        }

        pair.swap(amountIntermediate, 0, address(pool), new bytes(0));
