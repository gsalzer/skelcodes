...
// File: contracts/TyronWoodley.sol
...
contract TyronWoodley is ERC721, Ownable {
    ...
    constructor() ERC721("Tyron Woodley V Jake Paul", "TWDLY") {
        MAX_TOKEN_SUPPLY = 250;
        prerevealURI = "https://gateway.pinata.cloud/ipfs/QmXU9aAbEwTYKioFKsrVNmqbxxyCJ9AcL7nE99dHyHSCBs";
        whitelistMintPrice = 500000000000000000; // 0.5 Ether 
        regularMintPrice = 550000000000000000; //0.55 ether
        maxToMint = 1;
        maxWhitelistMints = 1;
        wallet1 = 0xe5C24ad2bcBBf4b547247417A8a8877dD885D029;// cosmic payout wallet
        wallet2 = 0x175606E97Be86852Cc3F2c9FA081DaE628abcD1F;// byt payout wallet
