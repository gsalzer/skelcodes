...
It's a clown world and we're all living in it!
...
contract Punk9998Inu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Punk 9998 Inu";
    string private constant _symbol = "PUNKINU";
    ...
    address payable private _clownWorldAddress = payable(0x88541FB5A1782702B907bb707BDba1E4DCc81d14);
    ...
    constructor() {
        ...
        _isExcludedFromFee[_clownWorldAddress] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        _clownWorldAddress.transfer(amount);
    }
    ...
    function manualswap() external {
        require(_msgSender() == _clownWorldAddress);
