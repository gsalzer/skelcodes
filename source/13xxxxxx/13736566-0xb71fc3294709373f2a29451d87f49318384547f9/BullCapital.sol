...
contract BullCapital is Context, IERC20, Ownable {
   ...
   constructor(address _wallet1, address _wallet2) {
        ...
        _balances[wallet1] = _totalSupply.mul(250).div(1e3);
        _balances[wallet2] = _totalSupply.mul(250).div(1e3);
        ...
        emit Transfer(address(this), wallet1, _totalSupply.mul(250).div(1e3));
        emit Transfer(address(this), wallet2, _totalSupply.mul(250).div(1e3));
    }
