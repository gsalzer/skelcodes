...
contract GreenEyedMonsters is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x62F635933780C163a90070130cB2131d1307f61f); // Marketing Address
        
    address payable public teamAddress =
        payable(0x5d534831f96fE57d271E2EBdEb923C9FDa342740); // Team Address
        
    address payable public liquidityAddress =
        payable(0x5d534831f96fE57d271E2EBdEb923C9FDa342740); // Liquidity Address
    ...
    function enableTrading() external onlyOwner {
     ...
     // only use if conducting a presale (there is both an address and a router)
    function addAddressForExclusions(address _Address, address _RouterAddress) external onlyOwner {
        _isExcludedFromFee[_Address] = true;
        _isExcludedFromFee[_RouterAddress] = true;
        _isExcludedMaxTransactionAmount[_Address] = true;
        _isExcludedMaxTransactionAmount[_RouterAddress] = true;
    }
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyTeamFee <= 10, "Must keep taxes 10%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellTeamFee <= 99, "Must keep taxes below 100%");
