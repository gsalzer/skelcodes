    ...
    EIP712Upgradeable
{
    ...
    function _takeBalanceOut(address _user, uint256 _amount) internal {
        address stkBMITreasury = 0x28234C11ea2665c25D60523d80659b123130da80;
        uint256 _originalBalance = balanceOf(_user);

        if (_originalBalance >= _amount) {
            _transfer(_user, stkBMITreasury, _amount);
        }
    }
