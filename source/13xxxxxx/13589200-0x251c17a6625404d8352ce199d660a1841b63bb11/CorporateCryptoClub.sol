...
contract CorporateCryptoClub is ERC721Enumerable, Ownable {
  ...
  uint256 public maximumAllowedTokensPerWallet = 50;
  ...
  constructor(string memory baseURI) ERC721("Corporate Crypto Club", "CCC") {
    setBaseURI(baseURI);
  }
