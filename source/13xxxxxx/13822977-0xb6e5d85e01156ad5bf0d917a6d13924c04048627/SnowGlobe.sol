...
❄️ $SNOW ❄️
    ...
    SnowGlobe token is here to embrace joy of Christmas with a token launch followed to SnowGlobe NFTs redeemable with $SNOW tokens.


   Telegram: https://t.me/SnowGlobeToken
   Website: https://SnowGlobeToken.com
...
contract SnowGlobe is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SnowGlobe", "SNOW") {
