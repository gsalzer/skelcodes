...
contract Pilgrim is ERC721, Ownable {
    using SafeMath for uint256;

    string public PILGRIM_PROVENANCE = "";
    ...
    uint256 public constant nftPrice = 77000000000000000; //0.077 ETH 
    ...
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        PILGRIM_PROVENANCE = provenanceHash;
    }
