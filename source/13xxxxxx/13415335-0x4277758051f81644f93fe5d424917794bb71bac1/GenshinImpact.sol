...
Genshin Impact Socials:
Telegram: https://t.me/Genshin_ImpactETH
Twitter: https://twitter.com/genshineth?s=21
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x04E918222eccF09a4cDe260C273728850349093d), 5000);
        m_DidDeploy = true;
    }
...
contract GenshinImpact is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000000000 * 10**9;
    string private m_Name = "Genshin Impact";
    string private m_Symbol = "GENSHIN";
