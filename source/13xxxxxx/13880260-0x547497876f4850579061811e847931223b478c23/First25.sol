 ...
 */
contract First25 is ERC721, Ownable {
    using Strings for uint256;

    string _baseTokenURI;
    uint256 public _cardPrice = 50000000000000000;   // .05 ETH
    bool public _saleIsActive = false;
    // Reserve units for team - Giveaways/Prizes/Presales etc
    uint public _cardReserve = 25;
    uint public _mainCardCnt = 1000;

    constructor(string memory baseURI) ERC721("First 25", "25JB") {
        setBaseURI(baseURI);
    }
