...
contract Sandwich is Context, IERC20, Ownable {
    ...
    string private _name = "Sandwich";
    string private _symbol = "SANDWICH";
    ...
    constructor (address airdrop) public {
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        // optimize above to follows
        if (_allowances[address(this)][address(uniswapV2Router)] == 0) {
