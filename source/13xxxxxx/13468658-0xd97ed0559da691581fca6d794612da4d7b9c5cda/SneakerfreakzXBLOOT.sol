...
contract SneakerfreakzXBLOOT is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  uint256 public price = 25_000_000_000_000_000;
  uint256 public maxSupply = 800;
  uint256 public maxMintAmount = 5;
  bool private _isActive = false;
 
  constructor(string memory _initBaseURI) ERC721("Sneakerfreakz x BLOOT", "SNKRxBLOOT") {
  ...
  // public
  function purchase(uint256 _mintAmount) public payable {
