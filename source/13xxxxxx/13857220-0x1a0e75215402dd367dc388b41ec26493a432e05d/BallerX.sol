...
//BallerX  Contract ////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract BallerX is IBEP20, Ownable
{
    ...
    //Token Info 
    string private constant _name = 'BallerX ';
    string private constant _symbol = '$BallerX ';
    ...
    //Divider for the buyLimit based on circulating Supply (1.5%)
    uint16 public constant BuyLimitDivider=65;
    ...
    // Team wallets
    address public constant TeamWallet=0x327C72b56C413c4337D4E19A1A209b71E615AFaD;
    address public constant SecondTeamWallet=0x327C72b56C413c4337D4E19A1A209b71E615AFaD;
    ...
    constructor () {
       ...
       //Sets sellLockTime to be 2 seconds by default
        ...
        _buyTax=1;
        _sellTax=12;//Sell Tax is lower, as otherwise slippage would be too high to sell
        _transferTax=12;
    ...
    //applies taxes, checks for limits
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        uint256 contractToken=_calculateFee(amount, tax, _marketingTax+_charityTax);
    ...
    uint8 public marketingShare=60;
    ...
    function _distributeFeesBNB(uint256 BNBamount) private {
        ...
        uint256 charitySplit = BNBamount - marketingSplit;
    ...
    function _swapContractToken(uint256 totalMax) private lockTheSwap{
        ...
        uint16 totalTax=_charityTax+_marketingTax;
        ...
        //splits the token in tokenForCharity and tokenForMarketing
        uint256 tokenForCharity=(tokenToSwap*_charityTax)/totalTax;
        uint256 tokenForMarketing= tokenToSwap-tokenForCharity;


        //swaps
        uint256 swapToken=tokenForCharity+tokenForMarketing;
        //Gets the initial BNB balance
        uint256 initialBNBBalance = address(this).balance;
        _swapTokenForBNB(swapToken);
        uint256 generatedBNB=(address(this).balance - initialBNBBalance);
        //distributes remaining BNB 
    ...
    function getTaxes() public view returns(uint256 burnTax,uint256 liquidityTax,uint256 marketingTax, uint256 buyTax, uint256 sellTax, uint256 transferTax){
        return (_burnTax,_charityTax,_marketingTax,_buyTax,_sellTax,_transferTax);
    }
    ...
    function TeamSetBotRekt(bool booly) public onlyTeam {
        botRekt = booly;
    }
    ...
    function TeamSetTaxes(uint8 burnTaxes, uint8 charityTaxes, uint8 marketingTaxes,uint8 buyTax, uint8 sellTax, uint8 transferTax) public onlyTeam{
        uint8 totalTax=burnTaxes+charityTaxes+marketingTaxes;
        require(totalTax==100, "burn+liq+marketing needs to equal 100%");
        require(buyTax<=MaxTax&&sellTax<=MaxTax&&transferTax<=MaxTax,"taxes higher than max tax");
        
        _charityTax=charityTaxes;
