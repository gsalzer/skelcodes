...
contract LoadOutToken is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 11000000000 * 10**18; // 11 Billion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name     = "LoadOutToken";
    string private constant _symbol   = "LOAD";
    uint8  private constant _decimals =  18;
    
    uint256 public _taxFee       = 100; // 1% of every transaction is redistributed to holders
    uint256 public _liquidityFee = 100; // 1% of every transaction is kept for liquidity
    ...
    uint256 public _maxTxAmount                   = 55000000 * 10**18; // 55 Million 0.5% ot total Supply
    uint256 public _numTokensSellToAddToLiquidity = 10000 * 10**18; // 10k
    ...
    function setMinimumTokensForSell(uint256 minTokens) external onlyOwner {
        _numTokensSellToAddToLiquidity = minTokens * 10**18;
    }
