...
contract PaladinPenguin is ERC721, Ownable {
	...
	uint public constant MAX_TOKENS = 9967;
	...
	string public CURR_ROUND_PASSWORD = "e2fc714c4727ee9395f324cd2e7f331f";
	uint public CURR_ROUND_SUPPLY = 2000;
	uint public CURR_ROUND_TIME = 1642190424000;
	...
	constructor() ERC721("Paladin Penguin Club", "PaladinPenguinClub") {
		setBaseURI("http://api.paladinpenguinclub.com/paladin/");
	}
