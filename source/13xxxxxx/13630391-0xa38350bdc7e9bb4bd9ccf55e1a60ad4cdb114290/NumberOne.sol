/*
#1, the #1 token on Eth
Telegram: https://t.me/number1token
...
contract NumberOne is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "#1";
    ...
    address payable public liquidityFeeReceiver = payable(0xb00deDF286759a65bA3B066eB76661731f6F88f5);
    address payable public marketingFeeReceiver = payable(0xb00deDF286759a65bA3B066eB76661731f6F88f5);
    ...
    constructor () {
        ...
        emit Transfer(address(0x5B19530984eCBf8eBA35F2AE59b5E0073162D267), owner(), _totalSupply);
    }
