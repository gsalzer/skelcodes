...
contract Nappa is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Nappa";
    ...
    uint256 private _taxFee = 2; // 2% reflection fee for every earthling
    uint256 private _teamFee = 10; // 10% Marketing and Saiyan Tax
    ...
    address payable private _Nappa;
    address payable private _SaiyanTax;
    ...
    constructor(address payable marketfund, address payable saiyantax, address payable nappa) {
        _Marketingfund = marketfund;
        _Nappa = nappa;
        _SaiyanTax = saiyantax;
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_Marketingfund] = true;
        _isExcludedFromFee[_SaiyanTax] = true;
        _isExcludedFromFee[_Nappa] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _SaiyanTax.transfer(amount.div(2));
    }
