...
contract ActionNFT is ERC721Enumerable {
  ...
  uint256 public rampRate = 0;
  uint256 public commonPrice = 50000000000000000;

  /* Mint Data */
  bool public canMint = true;
  uint256 public mintCap = 300;

  /* Withdraw Data */
  uint256 public adminClaimTime;
  uint256 public withdrawWindow = 0;

  string public commonUrl = 'ipfs://QmXtAHzzwe3UkgZyvbpdqAEmjfsiFfPfukimZ5d6XevA2S';
  string public contractUrl = 'ipfs://QmR7hecivwMythciAp1Em6hN2qeruCZN4sS2KhhAcVJhL8';

  constructor(address payable _beneficiary, uint256 _minPrice)
    ERC721('PACDAO ACTION', 'PAC-A1-Uncommon')
  {
