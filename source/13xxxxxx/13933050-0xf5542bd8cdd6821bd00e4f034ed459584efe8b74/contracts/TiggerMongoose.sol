...
/*
    TG: https://t.me/TiggerMongoosetoken
    WEB: https://www.TiggerMongoosetoken.com/
*/
...
contract TiggerMongoose is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "$TMG";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x86c55485E47b8619a1435b2450C08B1243D5a070);
        _feeAddrWallet2 = payable(0xaBDb8e02f9a902eC271201c47618F9F5bd46630d);
    ...
    function removeStrictTxAndWalletLimit() public onlyOwner {
        _maxTxAmount = 1e12 * 10**9;
        _maxWalletAmount = 1e12 * 10**9;
    }
