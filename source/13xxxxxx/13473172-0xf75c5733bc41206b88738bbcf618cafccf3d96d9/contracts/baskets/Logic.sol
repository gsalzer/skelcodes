...
contract Logic is Storage, Constants, IO {
    ...
    function initialize() public {
        require(_readSlot(INITIALIZED_BURNER_FIX) == 0, "initialized");

        // Accidentally deleted them on
        // https://etherscan.io/tx/0xca2ee2c594f642006747b6cde28643c1d8d1f923d7ae06cbfd8581148d5132fa
        // When rescuing funds
        _mintFix(0x2bF3cC8Fa6F067cc1741c7467C8Ee9F00e837757, 894549450535068019183);

        _writeSlot(INITIALIZED_BURNER_FIX, bytes32(uint256(1)));
    }
