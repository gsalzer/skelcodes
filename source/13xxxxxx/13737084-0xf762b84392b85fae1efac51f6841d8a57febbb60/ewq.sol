...
contract BrainLetCapitalDAO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "BrainLet Capital DAO";
    ...
    address payable public marketingWallet = payable(0x3F57D830060B255167c64790C09c286c18036654);
    address payable public treasury = payable(0x46A3963D8e8d6CE20d06550e82439ba2f5130f16);
