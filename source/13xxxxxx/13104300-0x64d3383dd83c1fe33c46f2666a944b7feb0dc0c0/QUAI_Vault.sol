...
*/
contract QUAI_Vault is ERC20Upgradeable, QuaiAccessControlDefended {
    ...
    string internal constant _defaultNamePrefix = "QUAI Vault ";
    string internal constant _symbolSymbolPrefix = "q";
    ...
    /// @notice Sums the balance in the Vault, the Controller, and the Strategy
    function balance() public view returns (uint256) {
        return token.balanceOf(address(this)).add(IController(controller).balanceOf(address(token)));
    }

    /// @notice Defines how much of the Vaults' underlying can be borrowed by the Strategy for use
    ...
    /// @notice Deposit assets into the Vault, and return corresponding shares to the user
    ...
    /// @notice Deposit assets into the Vault, and transfer corresponding shares to the recipient
    ...
    /// @notice Convenience function: Deposit entire balance of asset into the Vault, and return corresponding shares to the user
    ...
    /// @dev This is based on the realized value of underlying assets between Vault & associated Strategy
