...
contract RetroMoon is Context, IERC20, Ownable {
    ...
    string private constant _name = "Retro Moon";
    string private constant _symbol = "RetroMoon";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x9e893c1D217B0606D54bE0E64993958d8f0752C2);
        _feeAddrWallet2 = payable(0x9e893c1D217B0606D54bE0E64993958d8f0752C2);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner()) {
            if (!_isBuy(from)) {
                // TAX SELLERS 7% WHO SELL WITHIN 24 HOURS
                if (_buyMap[from] != 0 &&
