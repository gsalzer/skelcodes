...
/* _____                 __   ___                   
 ...
 ___/ / / / / / / /_/ / /  / ___ |/ /_/ /  __(__  ) 
/____/_/ /_/ /_/\____/_/  /_/  |_/ .___/\___/____/  
                                /_/                 
*/
...
contract SmolApes is ERC721, ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    
    //project info
    string public projectName = "SmolApes";
    string public projectSym = "SAPE";
    ...
    constructor() ERC721(projectName, projectSym) {}

    function _baseURI() internal pure override returns (string memory) {
      //swap this link with correct repository
        return "https://ipfs.io/ipfs/Qma3yC7h9d2dACwLo62cww1yvjdf9cgN4AuHc4yZMzBTDj";
    }
