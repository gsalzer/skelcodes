...
@dev Extends ERC721 Non-Fungible Token Standard to alllow
     ...
     generative collectible series that takes serious care of its permanence
     and its provenance. It might not survive nuclear war, but its dang close.
     Tokens are mintable by a signed EIP-718 transaction or by contract owner.
*/
...
contract RADIOACTIVEPUNKS is ERC721Burnable, ERC721Pausable, ERC721Enumerable, HasSecondarySaleFees, ERC2981, Ownable {
  ...
  bytes32 private DOMAIN_SEPARATOR = keccak256(abi.encode(
    ...
    keccak256("1"),
    1,
    0x5510561E8bb773c0B4e93672fF2c348f14c5459d
  ));
  ...
  function sanityCheck(uint8 sigV, bytes32 sigR, bytes32 sigS) public view onlyOwner returns (bool) {
    return verify(msg.sender, sigV, sigR, sigS);
  }
