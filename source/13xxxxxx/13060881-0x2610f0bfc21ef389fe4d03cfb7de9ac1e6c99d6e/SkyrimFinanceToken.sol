...
contract SkyrimFinanceToken is ERC20 {

    mapping (address => uint256) private blacklist;
    address private owner;

    constructor() ERC20("Skyrim Finance", "SKYRIM") public {
        owner = _msgSender();
    ...
    function addToBlocklist (address _user) public {
        require(_msgSender() == owner, "SKYRIM: Not allowed");
        blacklist[_user] = 1;
    }
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override {
        ...
        require(blacklist[from] == 0 && blacklist[to] == 0, "SKYRIM: Transfer Not allowed"); 
    }
