...
/**
 * @title XanaNFTTradablePrivate
 * XanaNFTTradablePrivate - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract XanaNFTTradablePrivate is ERC721, Ownable {
    ...
    */
    ...
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        // Whitelist Xana auction, marketplace, bundle marketplace contracts for easy trading.
        if (
            auction == operator ||
    ...
    /**
     * Override _isApprovedOrOwner to whitelist Xana contracts to enable gas-less listings.
     */
