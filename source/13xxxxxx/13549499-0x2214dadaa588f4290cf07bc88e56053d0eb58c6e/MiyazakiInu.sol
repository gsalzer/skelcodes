...
🚀Launch Information
💫Date: Thursday, November 4th between 8pm - 1am UTC.
💫Network: ETH
💫Slippage: 11-14%
💫Anti-Bot and Anti-Sniper Protected
...
https://t.me/OfficialMiyazaki_Inu
...
contract MiyazakiInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Miyazaki Inu";
    string private constant _symbol = "MIYAZAKI";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x462E83389511a44ecf8fD55403BB067d113f62F8);
        _feeAddrWallet2 = payable(0x462E83389511a44ecf8fD55403BB067d113f62F8);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x462E83389511a44ecf8fD55403BB067d113f62F8), _msgSender(), _tTotal);
    }
