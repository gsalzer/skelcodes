...
contract MandoOne is ERC721("MAND-0 ONE", "MANDO"), ERC721Enumerable, Ownable {
    ...
    uint256 public tokenPrice = 77000000000000000;  // 0.077 ETH
    bool public reveal;
    bool public isActive;
    bool public isPresaleActive;
    bool public isOpenSaleActive;
    ...
    */
        ...
        payable
    {
        ...
        if (!isOpenSaleActive) {
            ...
            require(totalSupply() < nftsNumber, 'All tokens have been minted');
            require(_numOfTokens <= maxTokensWhiteList, 'Cannot purchase this many tokens');
            require(whiteListClaimed[msg.sender].add(_numOfTokens) <= maxTokensWhiteList, 'Purchase exceeds max whitelisted');
        ...
        require(totalSupply().add(_numOfTokens) <= nftsNumber, "Purchase would exceed max supply of NFTs");
    ...
    /*
     * Function to mint all owner NFTs
    */
