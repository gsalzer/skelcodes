...
contract BullRun is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xee392aE6cd5552D7041bA97a55FcaBb526E6Ceca); // Marketing Address
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0xee392aE6cd5552D7041bA97a55FcaBb526E6Ceca);
    }
    ...
    function _transfer(
        ...
        if (from != address(this)) {
            if (to == uniswapV2Pair && from != address(uniswapV2Router) && ! _isExcludedFromFee[from] && cooldownEnabled) {
                // Cooldown
                require(amount <= _maxTxAmount , "you are not allowed to trade bigger than 100000000000 token in CoolDown time");
            }
        }
