...
contract squidrun is ERC721Enumerable, Ownable{
    ...
    uint256 public MAX_SUPPLY = 4560;
    ...
    constructor() ERC721("SQUIDRUN","SQUIDRUN"){
    ...
    function mint(uint numberOfTokensMax20) public payable {
        ...
        require(numberOfTokensMax20 <= MAX_NFT_PURCHASE,"Can only mint up to 20 per purchase");
        
        uint256 price = getPrice(numberOfTokensMax20);
