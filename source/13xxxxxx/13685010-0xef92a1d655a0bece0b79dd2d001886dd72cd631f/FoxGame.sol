// 8888888888 .d88888b. Y88b   d88P       .d8888b.         d8888 888b     d888 8888888888 
// 888       d88P" "Y88b Y88b d88P       d88P  Y88b       d88888 8888b   d8888 888        
// 888       888     888  Y88o88P        888    888      d88P888 88888b.d88888 888        
// 8888888   888     888   Y888P         888            d88P 888 888Y88888P888 8888888    
// 888       888     888   d888b         888  88888    d88P  888 888 Y888P 888 888        
// 888       888     888  d88888b        888    888   d88P   888 888  Y8P  888 888        
// 888       Y88b. .d88P d88P Y88b       Y88b  d88P  d8888888888 888   "   888 888        
// 888        "Y88888P" d88P   Y88b       "Y8888P88 d88P     888 888       888 8888888888 
...
contract FoxGame is ERC721, Ownable {
    uint256 public constant PRICE = 0.069420 * 1e18;
...
function currentCarrotCost() public view returns (uint256) {
        uint256 _totalSupply = totalSupply();

        if (_totalSupply <= 10000) return 1000000000000000000;
        if (_totalSupply > 10000 && _totalSupply <= 20000)
            return 1000000000000000000;
        if (_totalSupply > 20000 && _totalSupply <= 30000)
            return 2000000000000000000;
        if (_totalSupply > 30000 && _totalSupply <= 40000)
            return 3000000000000000000;
        if (_totalSupply > 40000 && _totalSupply <= 500000)
    ...
    function MINT_PublicSale(uint8 amount) public payable {
        ...
        function MINT_ReservedForWhitelist(uint8 amount) public payable {
        require(!paused);
        require(amount > 0, "Amount must be more than 0");
        require(amount <= 10, "Amount must be 10 or less");
        require(msg.value == PRICE * amount, "Ether value sent is not correct");
    ...
    function MINT_OwnerFreeMint(uint8 amount) public payable {
        require(amount > 0, "Amount must be more than 0");
        require(amount <= 2, "Amount must be 2 or less");
        require(
            minted + amount <= 75,
            "Sold out!"
        );
    ...
    function setBaseURI(string memory baseURI_) public onlyOwner {
        ...
        function setCarrotAddress(address _carrotAddress) public onlyOwner {
        carrotAddress = _carrotAddress;
    }

       function Mint_With$Carrot() public {        
        //Burn this much carrot
        ICarrot(carrotAddress).burnFrom(msg.sender, currentCarrotCost());
        return mintInternal();
    }
