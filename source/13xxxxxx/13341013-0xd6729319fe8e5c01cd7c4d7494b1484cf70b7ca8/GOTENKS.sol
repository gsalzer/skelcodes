...
contract GOTENKS is ERC20 {
    ...
    address payable public TaxWallet = 0xa131f75D37eF4216Edf29D5cd520aC9DE45e57d3;
    ...
    constructor() public ERC20("Gotenks Inu", "GOTENKS") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "The new dividend tracker must be owned by the GOTENKS token contract");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "GOTENKS: Account is already the value of 'excluded'");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "GOTENKS: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "GOTENKS: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "GOTENKS: Cannot update gasForProcessing to same value");
...
contract GOTENKSDividendTracker is DividendPayingToken {
    ...
    constructor() public DividendPayingToken("GOTENKS_Dividend_Tracker", "GOTENKS_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 5000000000000 * (10**18); 
    }
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "GOTENKS_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "GOTENKS_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main GOTENKS contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "GOTENKS_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "GOTENKS_Dividend_Tracker: Cannot update claimWait to same value");
