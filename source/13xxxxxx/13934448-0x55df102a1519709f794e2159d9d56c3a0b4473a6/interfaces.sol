...
interface ICellarPoolShare is IERC20 {
     ...
     * @member transaction0 transaction fee of token0
     * @member transaction1 transaction fee of token1
     */
    struct CellarFees {
        uint256 collect0;
        uint256 collect1;
        uint256 transaction0;
        uint256 transaction1;
    }
    ...
    /// @notice Emitted when update transaction fee
    /// @param newFee new transaction fee
    ...
    /// @param newFee new transaction fee value
