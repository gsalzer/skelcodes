...
contract FUD is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xF4829Bbb6E5B2400f4dBdd8A290a5bf47cE52c13);
    address payable private _marketingAddress = payable(0xF4829Bbb6E5B2400f4dBdd8A290a5bf47cE52c13);
    ...
    uint256 public _maxTxAmount = 40000000000000 * 10**9; //4
