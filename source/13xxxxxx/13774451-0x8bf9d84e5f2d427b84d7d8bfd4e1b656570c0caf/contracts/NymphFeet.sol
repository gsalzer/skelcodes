...
contract NymphFeet is ERC721Enumerable, ERC721Burnable, Ownable, ReentrancyGuard, VRFConsumerBase {
  ...
  */
  ...
  string private constant _uriTemplate = "/ipfs/QmPuc9am6MXQ1zpBgKbrfkpkUksfDpoYeiKjef9JfTdAFW/";  

  function tokenURI(uint256 tokenId) public view override returns (string memory) {
    require(_exists(tokenId), "URI query for nonexistent token");
    return string(abi.encodePacked(_uriTemplate, uint2str(tokenId), ".json"));
  }
