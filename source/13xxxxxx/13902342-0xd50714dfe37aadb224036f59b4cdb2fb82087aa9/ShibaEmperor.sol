...
contract  ShibaEmperor  is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "ShibaEmperor";
    string private constant _symbol = "SHIMP";
