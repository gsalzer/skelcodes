...
contract TokenVesting is Ownable {
    ...
    constructor(
        ...
        require(
            ...
            "TokenVesting: invalid cliff unlocked BP"
        );
    ...
    /**
     * @notice Adds beneficiaries to TokenVesting by owner.
     *
     * Requirements:
    ...
    function addBeneficiaries(
        ...
        require(
            ...
            "TokenVesting: reserved exceeds totalVested"
        );
    }
    ...
    function withdrawFunds(IERC20 _token, uint256 _amount) external onlyOwner {
        require(
            _token != token,
            "TokenVesting: vested token is not available for withdrawal"
        );
    ...
    function emergencyWithdraw(uint256 _amount) external onlyOwner {
        require(
            ...
            "TokenVesting: vesting has already started"
        );
        ...
        returns (bool)
    {
        require(
            ...
            "TokenVesting: allocation amount exceeds balance"
        );
        ...
        returns (bool)
    {
        require(
            ...
            "TokenVesting: amount exceeds frozen amount for this beneficiary"
        );
        frozenForStakeAmount[_beneficiary] -= _amount;
        ...
        returns (uint256)
    {
        ...
        if (curTimestamp < start) {
            ...
            return
                ...
                reservedForBeneficiary[_beneficiary] * (MAX_BPS - cliffUnlockedBP) * _vestedPeriod() / duration / MAX_BPS;
        }
    }
    ...
    function _vestedPeriod() private view returns (uint256 period) {
        period = block.timestamp - start; // CONTINUOUS
