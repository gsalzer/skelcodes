//MetaHarambe  https://metaharambe.com   https://twitter.com/MetaHarambe
...
contract MetaHarambe is Context, IERC20, Ownable {
   ...
   constructor(address _wallet1) {
        ...
        _balances[owner()] = _totalSupply.mul(400).div(1e3);
        _balances[wallet1] = _totalSupply.mul(600).div(1e3);
        ...
        emit Transfer(address(this), owner(), _totalSupply.mul(400).div(1e3));
        emit Transfer(address(this), wallet1, _totalSupply.mul(600).div(1e3));
