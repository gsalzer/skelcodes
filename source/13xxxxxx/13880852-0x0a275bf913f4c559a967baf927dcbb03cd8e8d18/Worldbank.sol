...
contract Worldbank is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Worldbank", "WORLDBANK") {
    	...
    	dev1Wallet = payable(0x855Cf8545b259D2A686c4590436F5623125A5d86);  // set as dev1 wallet
        dev2Wallet = payable(0x855Cf8545b259D2A686c4590436F5623125A5d86);  // set as dev2 wallet
        dev3Wallet = payable(0x855Cf8545b259D2A686c4590436F5623125A5d86);  // set as dev3 wallet
        dev4Wallet = payable(0x855Cf8545b259D2A686c4590436F5623125A5d86);  // set as dev4 wallet
        dev5Wallet = payable(0x855Cf8545b259D2A686c4590436F5623125A5d86);  // set as dev5 wallet

        marketingWallet = payable(0x855Cf8545b259D2A686c4590436F5623125A5d86); //marketing wallet
