...
BlackFridayToken Socials:
Telegram: t.me/BlackFriday_Token_Entry
Twitter: https://twitter.com/blackfriday1126?t=AnKcGNWJLlHzdPT8GS_xcA&s=09 
Whitepaper: https://link.medium.com/bmrXC6Q0glb

** Secured With FTP Antibot **
** Using FTP LPAdd to recycle 8.00% of ALL transactions back into the liquidity pool. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xd5644104834b42505E2Cd08D9a516242555CD4B4), 5000);
        m_DidDeploy = true;
    }
...
contract BlackFridayToken is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "BlackFridayToken";
    string private m_Symbol = "BFT";
	...
	// LP ADD
    IWETH private WETH;
    uint256 private m_LiqAlloc = 8000;
    // MISC
