...
contract CoochycooPanda is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenId;

    uint256 public MAX_SUPPlY = 7777;
    uint256 public MAX_ALLOWED = 5;
    uint256 public OWNER_RESERVED = 777;
    ...
    constructor(string memory baseURI) ERC721("Coochycoo Pandas", "CCP") {
        setBaseURI(baseURI);
    }
