...
contract SS is ERC721Enumerable, Ownable {
    using ECDSA for bytes32;

    uint256 public tokenPricePresale = 0.03 ether;
    uint256 public tokenPricePublicSale = 0.05 ether;
    
    uint256 public totalTokensLeft = 10000;

    uint256 public maxTokensPerMint = 20;
    ...
    string public tokenBaseURI = "ipfs://QmdGXMzXXkUGybG8kzGXkKp5qf2LLqutqdGGTkP434rmtT/";

    mapping(address => bool) public presaleWhitelist;
    mapping(address => uint256) public presaleWhitelistPurchased;

    constructor() ERC721("Schlong Society", "SS") {
    ...
    function gift(address[] calldata receivers) external onlyOwner {
        require(receivers.length <= totalTokensLeft, "No tokens left to gift");
