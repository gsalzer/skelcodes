...
contract PoisonPog is ERC721URIStorage, EIP712, AccessControl, Ownable {
  ...
  address payable withdrawalAddress =
      payable(0xAB40DE50438bAe2311Bb9804650fa310395E9ecF);

  mapping (address => uint256) pendingWithdrawals;

  constructor(address payable minter)
    ERC721("Poison Pog", "PPOG") 
  ...
  function withdraw() public {
    require(msg.sender == withdrawalAddress, "Unauthorized withdrawal");
