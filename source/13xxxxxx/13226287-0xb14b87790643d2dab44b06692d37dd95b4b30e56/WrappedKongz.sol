...
// File: WrappedKongz.sol

contract WrappedKongz is ERC20("Wrapped Genesis Kongz", "WGK"), Ownable {
	using SafeMath for uint256;

	IKongz constant public KONGZ = IKongz(0x57a204AA1042f6E66DD7730813f4024114d74f37);
	IBanana constant public BANANA = IBanana(0xE2311ae37502105b442bBef831E9b53c5d2e9B3b);
	...
	function _claimNanas(address _holder, address _to) internal {
		uint256 totalFarmed = globalClaimed + BANANA.getTotalClaimable(address(this));
		// share = (total * holder_score / total_score)
		uint256 userShare = totalFarmed.mul(holderScores[_holder]).div(globalScore);
	...
	function onERC721Received(address operator, address from, uint256 tokenId, bytes calldata data) external returns (bytes4) {
		return WrappedKongz.onERC721Received.selector;
	}
