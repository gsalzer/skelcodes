...
Hold Kid Buu Inu  4% redistribution 
...
contract  KidBuuInu is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "@KidBuuInu";
    string private constant _symbol = "KBI";
