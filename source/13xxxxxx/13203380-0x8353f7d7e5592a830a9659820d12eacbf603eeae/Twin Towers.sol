...
contract TwinTowers is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Twin Towers";
    string private constant _symbol = unicode"Twin Towers";
