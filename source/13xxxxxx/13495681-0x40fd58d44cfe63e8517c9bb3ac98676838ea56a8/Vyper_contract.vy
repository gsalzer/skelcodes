...
@notice renBTC/WBTC metapool implementation contract
...
BASE_POOL: constant(address) = 0x93054188d876f558f4a66B2EF1d97d16eDf0895B
...
def initialize(
    ...
    self.coins = [_coin, 0x49849C98ae39Fff122806C06791Fa73784FB3675]
    ...
    self.symbol = concat(_symbol, "/btcCRV-f")
