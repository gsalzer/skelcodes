...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a miniFLUFFY shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract miniFLUFFY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "miniFluffy Inu";
    ...
    address payable public marketingWallet = payable(0x2F1556C7Da672b9b3dbbe78B4c3C507641c19D2f);
    address payable public treasury = payable(0x2d40E11b86C8F6469F35Cf48670D379AcFE9980c);
    ...
    constructor (    ) Auth(0x57ba5F02D686f527500061691d6E2b4c21EE791F) {
        address _owner = 0x57ba5F02D686f527500061691d6E2b4c21EE791F;
