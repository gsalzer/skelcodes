...
contract Ownable is Context {
    ...
    constructor() internal {
        _owner =0xDf6F4af51A55F73f6f80d6DF3f2F58d903b62DD6;
...
contract TestNames is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Test Names";
    string private _symbol = "TNAMES";
