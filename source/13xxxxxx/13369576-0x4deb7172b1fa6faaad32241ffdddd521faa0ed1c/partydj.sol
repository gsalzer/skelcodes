 ...
 */
contract PartyDJ is Context, Ownable, ERC165,IERC721Metadata, IERC721Enumerable{
    ...
    uint256 public constant SALE_START_TIMESTAMP = 1633737300;  //Oct 8 2021 8p EST.

    uint256 public constant MAX_NFT_SUPPLY = 2000;
    
    uint256 public constant PRICE = 0.02 ether;
    
    uint256 public mintCurrentIndex = 1;
    ...
    constructor () {
        _name = "Party DJ Space Club";
        _symbol = "PDSC";
        _baseTokenUri = "https://partydjspaceclub.com/api/tokens/"; // api url
    ...
    */
    function mintNFT(uint256 numberOfNfts) public payable {
        ...
        require(mintCurrentIndex <= MAX_NFT_SUPPLY, "All Party djs sold");
