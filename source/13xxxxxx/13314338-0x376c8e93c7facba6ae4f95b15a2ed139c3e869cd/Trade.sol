...
contract Trade {
    ...
    function swapToken(Swapping memory swapMetaData,Sign memory sign) public returns(bool) {
        ...
        emit BuyAsset(swapMetaData.to ,swapMetaData.swapTokenId1, swapMetaData.sellingQty, swapMetaData.from);
        emit BuyAsset(swapMetaData.from , swapMetaData.swapTokenId2, swapMetaData.buyingQty, swapMetaData.to);
        return true;
