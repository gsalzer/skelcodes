...
// File: RainCheck/RainCheckDelegate.sol
...
contract RainCheckDelegate is ERC721Enumerable, Pausable, Ownable {
    ...
    struct CheckInfo {
        mapping(string => address) addressInfo; //erc20, from, to
        mapping(string => uint256) valueInfo;   //amount, fee, stakeTime, limitTime
        mapping(string => bool) boolInfo;       //isErc20, isEth
        mapping(string => string) stringInfo;   //memo
    }
    ...
    //constructor
    //=========================================
    constructor() ERC721("RainCheckDelegate", "RCD") {
    }
