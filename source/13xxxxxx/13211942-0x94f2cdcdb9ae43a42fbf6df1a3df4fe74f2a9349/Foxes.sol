...
// @title: Foxes From The Hood
// @author: FoxesFromTheHood Team
contract Foxes is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 public constant MAX_ITEMS = 2222;
    uint256 public MAX_PRESALE_ITEMS = 200;
    ...
    address public constant devAddress = 0x0a3552eE37835330A6d934B3B7624B313C1a8126;
    ...
    constructor(string memory baseURI) ERC721("Foxes From The Hood", "FoxesFromTheHood") {
        setBaseURI(baseURI);
        pause(true);
        presale = false;
        sale = false;
