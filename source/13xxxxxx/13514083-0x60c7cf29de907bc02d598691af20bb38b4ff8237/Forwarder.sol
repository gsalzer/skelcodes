    ...
    MixinReceiver
{
    ...
    // contract then converts the weth to eth and sends to maker after taking the fees and royalty
        ...
        )
    {
        ...
        // converting to arrays for use in function
