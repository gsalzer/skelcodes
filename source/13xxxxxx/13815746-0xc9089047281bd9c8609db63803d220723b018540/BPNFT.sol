...
contract BPNFT is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, ReentrancyGuard, Pausable, Ownable {
    ...
    /// @dev phase limit for minting - also checked by cap
    ...
    /// @dev mint restriction status - if false, nobody can mint
    ...
    /// @dev extra safety valve to flip minting access
    ...
    /// @dev flip whitelist account status
    function flipWhitelist(address account) external onlyOwner {
