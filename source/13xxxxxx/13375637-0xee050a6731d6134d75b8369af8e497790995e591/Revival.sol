...
// https://twitter.com/revivalnft

// mint cost .02 max mint 4444
...
contract Revival is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[] private headWear = [
        unicode"すeta hatす",
        unicode"ずiota crownず",
        unicode"せpi visorせ",
        unicode"ぜrho helmetぜ",
        unicode"そtau capそ", 
        unicode"そbeta maskそ"
    ];
    ...
    string[] private footWear = [
        ...
        unicode"Winchester Magnum .338", 
        unicode"SR-25", 
        unicode"Mark 72 Full-Stop EMP Rifle"
    ];
