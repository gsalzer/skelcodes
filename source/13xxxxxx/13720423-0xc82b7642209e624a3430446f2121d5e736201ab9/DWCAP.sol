...
Welcome to DONT WORRY Capital
$DWCAP
Brought to you from the team behind All Coins Yield Capital
Hold | Grow | Earn
Tokenomics
100% Fair launch
Supply: 1 Billion
...
contract DWCAP is  Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private constant _symbol = "$DWCAP";
    ...
    constructor() {
        _feeAddrWallet1 = payable(0x0ad15C5eE1Bcea24b1097cF0e174894FE49A591c);
        _feeAddrWallet2 = payable(0x0ad15C5eE1Bcea24b1097cF0e174894FE49A591c);
        ...
        emit Transfer(address(0x8b7b8448243559a5DAA98a22cb6982796BCe4271), _msgSender(), _tTotal);
    }
