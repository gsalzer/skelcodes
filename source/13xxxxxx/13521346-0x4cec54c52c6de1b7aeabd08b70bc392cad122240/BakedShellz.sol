...
// File contracts/BakedShellz.sol
...
contract BakedShellz is ERC721, Ownable {
  ...
  constructor() public ERC721("BakedShellz", "SHLZ") {
  ...
  function listForSale(bytes32[] memory assetsForSale) public onlyOwner {
  ...
  function mintItemToOwner(string memory tokenURI)
      public
      payable
      onlyOwner
      returns (uint256)
  ...
  function mintItemsToOwner(string[] memory tokenURIs)
      public
      payable
      onlyOwner
      returns (uint256)
  ...
  function setIsRevealed(bool revealed) public onlyOwner {
      isRevealed = revealed;
  }

  function setLiveTokenURI(uint256 id, string memory tUri) public onlyOwner {
