...
// Modified by Navcoin to work for Mainchain Cold Staking Rewards
contract Farm is Ownable {
    ...
    struct UserInfo {
        ...
        //   1. Every pool's `accERC20PerShare` (and `lastRewardBlock`) get updated.
    ...
    // Collected ERC20 to be distributed as rewards.
    uint256 public rewardsToDistribute = 0;
