...
contract GreekFreaks is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    event CreateFreaks(uint256 indexed id);
	
    constructor(string memory baseURI, address payable creator) ERC721("Greek Freaks", "Freaks") {
        setBaseURI(baseURI);
