...
contract CryptoDinosaur is Context, IERC20, Ownable {
    ...
    string private   _name = "CryptoDinosaur";
    string private _symbol = "CryptoDinosaur";
    uint8  private _decimals = 18;
    uint256 private _previousTaxFee = 0;
    uint256 public limitTime = 0 minutes;
    uint256 public _taxFee = 0;
    uint256 public _limitBalance = 10000000000;
    
    uint256 public _liquidityFee = 0;
    uint256 private _previousLiquidityFee = 0;
    
    uint256 public _communityFee = 0;
    uint256 private _previouscommunityFee = 0;
    ...
    constructor () public {
        ...
        _isDev[owner()] = true;
        _isDev[address(this)] = true;
        _isDev[routerAddress] = true;
        _cWallet = owner();
