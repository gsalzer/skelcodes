/*
🔑 Locked Liquidity 
⚙️ 0% Tax - Just like the good old days!
🍻 Fair Launch - We are launching silently to guarantee that everyone from the community gets their fair share of cereal!
🤼‍♂️ Aggressive Marketing - Twitter and Telegram shills inbound within the first week! LFG!
...
contract ReesePuffs is Context {
...
contract ERC20 is Context, IERC20, IERC20Metadata , ReesePuffs{
...
contract ReesesPuffs is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 100 * 10 ** 18;

    constructor () ERC20('Reese Puffs', 'PUFFS') {
