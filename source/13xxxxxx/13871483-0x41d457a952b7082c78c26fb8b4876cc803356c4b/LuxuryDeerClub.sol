...
contract LuxuryDeerClub is ERC721Enumerable, Ownable {
    ...
    uint256 public OWNER_RESERVED = 5;
    ...
    constructor(string memory baseURI) ERC721("Luxury Deer Club", "DEER") {
        setBaseURI(baseURI);
    }
    ...
    function setMaxSupply(uint256 _max_supply) public onlyOwner {
        require(_max_supply <= 10000,"Max supply limit cannot be set for greater than 10000");
