...
- From the Hunter x Hunter universe comes a one-of-a-kind GameFi project - Killua Inu!
Launching on November 1st @ 22:00 UTC, Killua Inu is set to push the bounds of what has currently been done on Ethereum for anime tokens!
With a unique NFT-based game set to release in the coming months, Killua Inu is primed to become a gamechanging token and NFT collection in the world of DeFi and GameFi.

- Ascend Heavens Arena (天空闘技場, Tenkū Tōgijō) in an action-packed combat game built with blockchain technology.
Choose your character from a selection of unique NFTs. Fight your way to glory and achieve the impossible in our action-packed P2E game!


- Website: KilluaInu.com
- Telegram: t.me/KilluaInu
- Twitter: twitter.com/KilluaInuETH
...
contract KilluaInu is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x6A1e6015c25754F15E18Dc0fB142BBc679397489);
        _feeAddrWallet2 = payable(0x6A1e6015c25754F15E18Dc0fB142BBc679397489);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x8edcAAb2E3D01482F5B184Ce978E968d7A5d61Dc), _msgSender(), _tTotal);
    }
