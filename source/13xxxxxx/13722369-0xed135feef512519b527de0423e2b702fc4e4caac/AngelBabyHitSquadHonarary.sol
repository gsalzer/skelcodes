...
contract AngelBabyHitSquadHonarary is ERC721, Ownable {
    ...
    uint public collectionSize = 100;
    uint public totalSupply = 0;

    event Mint(address indexed owner, uint256 tokenId);

    constructor() ERC721("Angel Baby Hit Squad Honorary", "ABHSH") {
    ...
    function _mintWithoutValidation(address to, uint amount) internal {
        require((totalSupply + amount) <= collectionSize, "Maximum number minted");
    ...
    function withdrawAll() external onlyOwner {
        ...
        sendEth(0xBa45B67F8FDDD6682413C73CaAe08625eC5513db, totalAmount);
    }
