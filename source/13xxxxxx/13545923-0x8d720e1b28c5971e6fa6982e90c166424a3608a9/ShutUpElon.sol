...
contract ShutUpElon is Context, IERC20, Ownable {
	...
	string private constant _name = "Shut Up Elon Token";
	string private constant _symbol = "SHUTUPELON";
