...
contract SadgApe is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "SadgApe";
    ...
    uint256 public _maxTxAmount = 2500000000000000 * 10**9; //0.25%
    uint256 public _maxWalletSize = 10000000000000000 * 10**9; //1%
    uint256 public _swapTokensAtAmount = 1000000000000000 * 10**9; //0.1%
