...
contract EvoSnails is ERC721Upgradeable, ERC721EnumerableUpgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    uint256 public constant cost = 0.00 ether;
...
contract EvoSnailsV2 is ERC721Upgradeable, ERC721EnumerableUpgradeable, PausableUpgradeable, OwnableUpgradeable {
    using CountersUpgradeable for CountersUpgradeable.Counter;
    ...
    function lootForSnail(
        ...
        require(!rollingPaused, "looting paused");
        require(!gamePaused, "game paused");
    ...
    function setRollingPaused(bool _paused) public onlyOwner {
        rollingPaused = _paused;
    }
}
