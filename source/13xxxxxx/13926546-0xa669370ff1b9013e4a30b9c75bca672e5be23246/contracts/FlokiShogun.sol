...
/*
    TELEGRAM: https://t.me/FlokiShogun
    WEBSITE: https://www.flokishogun.com/
*/
...
contract FlokiShogun is Context, IERC20, Ownable {
    ...
    uint256 public swapThreshold = 1e10 * 10**9;
    ...
    string private constant _name = "FlokiShogun";
    string private constant _symbol = "$FLOKIGUN";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xa059Fa8f79f3D4fCA71c165e19Cb538B692DCE19);
        _feeAddrWallet2 = payable(0x34440f3e98565D4460DDBb639C49c0e069Fe88d5);
        ...
        if (from != owner() && to != owner()) {
            ...
            if (
                ...
                if(!_isExcludedFromSellLock[to] && sellLock[to] == 0) {
                    ...
                    if(elapsed < 120) {
                        uint256 sellLockDuration = (120 - elapsed) * 60;
