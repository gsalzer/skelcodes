...
contract NIGHTWING is Context, IERC20, Ownable {
    ...
    string private _name = "NIGHTWING";
    string private _symbol = "NIGHTWING";
    ...
    address public marketing = 0x1284E6E411800B0492118a3447838f69Da14B41D;
    ...
    uint256 public _maxBalAmount = _tTotal.mul(4).div(100);
    ...
    constructor () {
        ...
        uint256 airDrop = _tTotal.mul(3).div(100);

        _transfer(_msgSender(), 0x8b2ca226f78a8F35e97e944a5468AF85c0a6C616, airDrop);
    ...
    function manualSwap(uint256 tokens) public lockTheSwap {        
        // capture the contract's current ETH balance.
        // this is so that we can capture exactly the amount of ETH that the
        // swap creates, and not make the liquidity event include any ETH that
        // has been manually sent to the contract
        uint256 contractTokenBalance = tokens *10**18;
        // swap tokens for ETH
