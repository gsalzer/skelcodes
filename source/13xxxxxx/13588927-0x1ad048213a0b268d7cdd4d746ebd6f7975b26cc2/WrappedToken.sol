// File @openzeppelin/contracts/utils/Context.sol@v3.4.1-solc-0.7
...
// File @openzeppelin/contracts/access/Ownable.sol@v3.4.1-solc-0.7
...
// File @openzeppelin/contracts/utils/Pausable.sol@v3.4.1-solc-0.7
...
// File @openzeppelin/contracts/token/ERC20/IERC20.sol@v3.4.1-solc-0.7
...
// File @openzeppelin/contracts/math/SafeMath.sol@v3.4.1-solc-0.7
...
// File @openzeppelin/contracts/token/ERC20/ERC20.sol@v3.4.1-solc-0.7
...
// File @openzeppelin/contracts/utils/Counters.sol@v3.4.1-solc-0.7
...
abstract contract ERC20Permit is ERC20, IERC2612Permit {
    ...
    function permit(
        ...
        assembly {
            ...
            // keccak256("Permit(address _owner,address _spender,uint256 value,uint256 nonce,uint256 _deadline)")
