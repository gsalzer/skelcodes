...
contract DarkEchelon is ERC721, ERC721Enumerable, Ownable {
    ...
    function devMint(uint256 numNFTs) public onlyOwner {
        require(numNFTs <= devReserve - devMinted, "Not enough in the dev reserve, mint a smaller ammount");
    ...
    function withdraw() public onlyOwner {
        ...
        payable(0x8066572c9c654FB48cAaD52b0Fd86bB087ac03b2).transfer(balance);
    }
