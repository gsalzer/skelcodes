...
contract CryptoSpawns is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 public constant MAX_PRESALE_ITEMS = 0;
    ...
    address public constant creatorAddress = 0x84BF848Fbf67dC89651732F37BCadd4bB23D6D00;
    address public constant devAddress = 0x08b820DeB8356C198661a2CF269d22a7bD84bD15;
    ...
    event CreateSpawn(uint256 indexed id);
    event AttributeChanged(uint256 indexed _tokenId, string _key, string _value);

    constructor(string memory baseURI) ERC721("Crypto Spawn", "CryptoSpawn") {
        setBaseURI(baseURI);
        pause(true);
        presale = false;
        sale = false;
    ...
    */
    ...
    function changeAttribute(uint256 tokenId, string memory key, string memory value) public payable {
        ...
        require(_msgSender() == owner, "This is not your Spawn.");
