...
contract TGBrawlers is ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenId;

    uint256 public MAX_SUPPLY = 4168;
    uint256 public PRESALE_RESERVED = 1168;
    uint256 public MAX_ALLOWED = 100;
    uint256 public OWNER_RESERVED = 30;
    uint256 public price = 50000000000000000; //0.05 Ether
    string baseTokenURI;
    
    address add1 = 0xB5F7cF6D12e8934cc72a45e4D8d48875D65DA772;
    address add2 = 0xA972C9C5D5e803dc4bD3c07136e75e9948c95213;
    address add3 = 0x36ED2D75A82e180e0871456b15c239b73B4EE9F4;
    address add4 = 0x0c88f0F125c59cad35c704B8044107F2E51D28Fe;
    address add5 = 0x9943f16899316D8592aF65b325cd708cE80766Be;
    address add6 = 0x43F4Df17de7b1561BDBA9b3203B06B0646c4697D;
    address add7 = 0x430376D3A4fE9bcaCd2783523Fd4CE86d55C7EF2;
    ...
    constructor(string memory baseURI) ERC721("TG Brawlers", "TGB") {
        setBaseURI(baseURI);
    }
    ...
    function splitWithdrawAll() public onlyOwner {
        
        uint256 add1_share = getPercentageShare(67);
        uint256 add2_share = getPercentageShare(10);
        uint256 add3_share = getPercentageShare(13);
        uint256 add4_share = getPercentageShare(4);
        uint256 add5_share = getPercentageShare(2);
        uint256 add6_share = getPercentageShare(1);
        uint256 add7_share = getPercentageShare(3);
        
        
        (transfer_success, ) = add1.call{value: add1_share}("");
        require(transfer_success, "Transfer 1 failed.");
        
        (transfer_success, ) = add2.call{value: add2_share}("");
        require(transfer_success, "Transfer 2 failed.");
        
        (transfer_success, ) = add3.call{value: add3_share}("");
        require(transfer_success, "Transfer 3 failed.");
        
        (transfer_success, ) = add4.call{value: add4_share}("");
        require(transfer_success, "Transfer 4 failed.");
        
        (transfer_success, ) = add5.call{value: add5_share}("");
        require(transfer_success, "Transfer 5 failed.");
        
        (transfer_success, ) = add6.call{value: add6_share}("");
        require(transfer_success, "Transfer 6 failed.");
        
        (transfer_success, ) = add7.call{value: add7_share}("");
        require(transfer_success, "Transfer 7 failed.");
