...
contract nftealandvending is ERC721Enumerable, ERC721Burnable, ReentrancyGuard, AccessControl {
    using Strings for uint;

    bytes32 merkleRoot;
    bool public saleActive;
    uint public pricePerToken = 0.00025 ether;
    uint public maxPublicMint = 1;
