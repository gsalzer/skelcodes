...
abstract contract Helpers is DSMath {
    ...
    {   
        ...
        IUniswapV3Pool pool = IUniswapV3Pool(getPoolAddress(positionInfo.token0, positionInfo.token1, positionInfo.fee));
    ...
    function singleDepositAmount(
        ...
        (, , address _token0, address _token1, , int24 tickLower, int24 tickUpper, , , , , ) = nftManager
        .positions(tokenId);
    ...
    function withdrawAmount(uint256 tokenId, uint256 liquidity, uint256 slippage)
        internal
        view
        returns (
            uint256 amount0,
