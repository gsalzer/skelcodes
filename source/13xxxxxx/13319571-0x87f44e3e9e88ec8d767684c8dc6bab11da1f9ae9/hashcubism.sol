...
contract hashcubism is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("HashCubism", "hcnft", _proxyRegistryAddress)
    {}

    string  public JsonPath="http://www.hashcubism.com/api/TokenService.asmx/GetTokenJson?id=";
