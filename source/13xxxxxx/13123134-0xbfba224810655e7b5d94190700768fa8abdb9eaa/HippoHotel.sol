...
contract HippoHotel is ERC721, Ownable {
    ...
    constructor(string memory name, string memory symbol, uint256 _maxNftSupply, uint256 _mintPrice) ERC721(name, symbol) {
        maxNftSupply = _maxNftSupply;
        mintPrice = _mintPrice;
        maxToMint = 30;
        saleIsActive = false;

        wallet1 = 0x9b9b46e803a48aB91556d2bE060e79B04D1575E4;
        wallet2 = 0xb2217593ed681bFCCA58Ef10dBd790141632419E;
    }
     ...
     * Mint by owner
     */
    function reserveHippos(address _to, uint256 _numberOfTokens) external onlyOwner {
    ...
    * Mints tokens
    */
    function mintHippos(uint256 numberOfTokens) external payable {
