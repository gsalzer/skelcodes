/*
    ...
    🐦: https://twitter.com/FrogManERC20

    🎤: https://t.me/FrogManETH

    🌎: http://frogman.live/

    As we will do for the development of our Community, we have looked to the past and into the future and created a Tokenomics system for the $Frog Man,
    where we have harvested the best of what is already out there and combined it into a system that is solid,
    safe and built for the Use Cases that will be created through our Community and with our future partners…
...
contract FrogMan is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x61047c1a026a4E81C7Cb988E1A0D1170220548CA;

    string private _name = "Frog Man";
    string private _symbol = "FROGMAN";
