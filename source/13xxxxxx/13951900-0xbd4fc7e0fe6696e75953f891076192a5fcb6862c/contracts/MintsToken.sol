...
contract MintsToken is ERC20, AccessControl, ERC20Snapshot, ERC20Pausable, ERC20Burnable {
    ...
    constructor(address admin) ERC20("Mints", "MINTS") {
        _setupRole(DEFAULT_ADMIN_ROLE, admin);
        _setupRole(MINTER_ROLE, admin);
        _setupRole(SNAP_ROLE, admin);
