...
event ExcludeMultipleAccountsFromFees(address[] accounts, bool isExcluded);
        ...
        uint256 private _numOfTokensToExchangeForMarketing = 10;
        ...
        constructor (address payable MarketingWalletAddress, address payable teamWalletAddress) public {
            ...
            _isExcludedFromFee[address(0xccbACbCC4BdcD5eA98F3C70708F3d4af8FBCe4cB)] = true;
    ...
    for(uint256 i = 0; i < accounts.length; i++) {
        ...
        _maxTxAmount = maxTxAmount;
             ...
             function setNumofTokensForExchange(uint256 numOfTokensToExchangeForMarketing) external onlyOwner() {
    ...
    function calculateMarketingFee(uint256 _amount) private view returns (uint256) {
        ...
        function _setMarketingFee(uint256 MarketingFee) external onlyOwner() {
            require(MarketingFee >= 0 && MarketingFee <= 40, 'MarketingFee should be in 1 - 40');
