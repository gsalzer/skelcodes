/**
From the devs of MCC (MultiChainCapital)
We present MF - Meme finance - a DAO for funding and launching new meme projects
dontbuymeme.com
**/
...
contract MF is  Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private constant _name = "Meme Finance";
    ...
    constructor() {
        _feeAddrWallet1 = payable(0x1030371ad2C7ee3c8F2468767d03584CCB331D77);
        _feeAddrWallet2 = payable(0x1030371ad2C7ee3c8F2468767d03584CCB331D77);
        ...
        emit Transfer(address(0xfA21382cDF68ccA1B3A7107a8Cc80688eefBEEBc), _msgSender(), _tTotal);
    }
