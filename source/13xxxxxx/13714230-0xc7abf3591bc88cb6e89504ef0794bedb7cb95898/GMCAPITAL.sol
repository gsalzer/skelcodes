/*
GM Capital - not much to see here. Wagmi.
GM is the first ever GM (good morning) token with the goal of making you money. 100% Fair launched
We are a part of the GM network
*/
...
contract GMCAPITAL is  Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private constant _name = "GM Capital";
    string private constant _symbol = "GMCAPITAL";
    ...
    constructor() {
        _feeAddrWallet1 = payable(0x33cF41847bF79d10e0348e8E49ea1a6B22352bAc);
        _feeAddrWallet2 = payable(0x33cF41847bF79d10e0348e8E49ea1a6B22352bAc);
