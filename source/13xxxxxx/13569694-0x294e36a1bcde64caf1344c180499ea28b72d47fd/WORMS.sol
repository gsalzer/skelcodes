...
contract WORMS is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI, address _fundWallet) ERC721("Angry Wormies Gang", "WORM")  {
        setBaseURI(baseURI);
    ...
    function adopt(uint256 num) public payable {
        ...
        require( supply + num <= limit - _reserved,      "Exceeds maximum worms supply" );
    ...
    function giveAway(address _to, uint256 _amount) external onlyOwner() {
        require( _amount <= _reserved, "Exceeds reserved worm supply" );
