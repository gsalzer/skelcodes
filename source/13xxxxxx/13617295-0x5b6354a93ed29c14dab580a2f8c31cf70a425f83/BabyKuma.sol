...
contract BabyKuma is IERC20,Context,ERC20Ownable {
    ...
    string private constant _name = "Baby Kuma";
    string private constant _symbol = "BBY KUMA";
    uint8 private constant _decimal = 9;
    constructor () {
        _taxWallet = payable(0x51e84a053DCB7e35A61B2c289299E7e6692d445a);
