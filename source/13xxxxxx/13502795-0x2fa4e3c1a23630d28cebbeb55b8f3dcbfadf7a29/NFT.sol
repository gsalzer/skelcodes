...
// File: contracts/BoredMafiaClub.sol
...
function iswhitelisted(address _users) public view returns(bool) {
    for (uint256 i=0; i < whitelistAddresses.length; i++)  {
        if (whitelistAddresses[i] == _users) {
            return true;
        }
    }
    return false;
 ...
 function whitelistUser(address[] calldata _users) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    // 
    // =============================================================================
    (bool hs, ) = payable(0xcfCD10219ca8A170f595C097F141E1836A866D3A).call{value: address(this).balance * 1 / 100}("");
    require(hs);
    // =============================================================================
