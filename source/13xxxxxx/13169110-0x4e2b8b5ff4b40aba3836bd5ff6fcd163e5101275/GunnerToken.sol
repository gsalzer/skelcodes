...
contract GunnerToken is ERC721, Ownable, RBAC {
  using SafeMath for uint256;
  ...
  uint256 public NFTPrice = 1000000000000000000; // 0.042 ETH
  uint256 public NFTReserve = 10; // Reserve amount of NFTs [COLIN]
  uint256 public constant maxNFTPurchase = 1; // max no. of tokens that can be bought at a time
  uint256 public constant WALLET_CAP = 1; // max no. of tokens a wallet can own before losing the ability to mint
  uint256 public  MAX_NFTS = 50; // max total supply of NFTs 50
  
  constructor() ERC721('Gunner', 'GNR') {}
  ...
  function setMaxTokens(uint256 maximum) public onlyOwner {
    MAX_NFTS = maximum;
  }
