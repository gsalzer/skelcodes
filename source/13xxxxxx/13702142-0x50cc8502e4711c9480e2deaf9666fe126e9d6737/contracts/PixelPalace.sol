...
* a peristent server powered, personal homebase (PixelPalace). 
* 
* This token requires individuality as it also represents phyiscal space 
* in the open-world map. Thus, it needs to be something more secure 
* than the ERC1155 used for other in-game Pixelverse items.
*/
contract PixelPalace is ERC721, Ownable {
    ...
    constructor(IERC20 pixlTokenAddress) ERC721("PixelPalace", "PPLC") Ownable() {
        pixlToken = pixlTokenAddress;
        totalSupply = 10;
        mintPriceInPixl = 100000 * 1e18;
    ...
    // to let PixelPalace transfer PIXL tokens for minting.
    ...
    // Only use if adding more Palaces to Pixelverse, followed by an extra push to IPFS
