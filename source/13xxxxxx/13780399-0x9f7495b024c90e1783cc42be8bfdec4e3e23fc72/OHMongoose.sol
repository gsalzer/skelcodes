...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not an OHMG shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract OHMongoose is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "OHMongoose";
    string private constant _symbol = "OHMG";
    ...
    address payable public marketingWallet = payable(0x797Ef393ad1ABbbDF752902EB949b8e669B6746b);
    address payable public treasury = payable(0x797Ef393ad1ABbbDF752902EB949b8e669B6746b);
    ...
    constructor (    ) Auth(0xd52cDB9D78AC92d698f25dd523Bf85548A651397) {
        address _owner = 0xd52cDB9D78AC92d698f25dd523Bf85548A651397;
