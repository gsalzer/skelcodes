...
contract MegaToads is ERC721EnumerableUpgradeable, OwnableUpgradeable{
    ...
    */
    function mintToad(uint[] memory frogIds, uint[] memory frogIndicesToUseForTraits) public {
        ...
        require(totalSupply() + 1 <= MAX_TOADS - MAX_SUPERS, "Purchase would exceed max supply of toads");
        uint toadAnim = 0;
        for(uint i = 0; i < 5; i++){
    ...
    function initialize() initializer public {
        ...
        saleIsActive = false;
        VOLTAGE = IVolt(0xfFbF315f70E458e49229654DeA4cE192d26f9b25);
        Frog = Ifrog(0xd668A2E001f3385B8BBC5a8682AC3C0D83C19122);
