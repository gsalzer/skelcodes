...
contract GuccinuV2 is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 22e9 * 10**6;
    ...
    string private constant _name = "GuccinuV2";
    string private constant _symbol = "GucciV2";
    ...
    constructor () {
        //fees are distributed equaly btw all 3
        _feeAddrWallet1 = payable(0x03412Ceb9C3233962e272632Ab132bAAC22426a3);
        _feeAddrWallet2 = payable(0x66dc1d47ccE298509Aa6000903DEEE7C48109bc3);
        _feeAddrWallet3 = payable(0x1093Fa3CA47A4Cade8d246310D22c4fb81109007);
    ...
    uint256 tAmount) private {
        ...
        uint256 tFee, 
        uint256 tTeam) = _getValues(tAmount);
    ...
    function _reflectFee(uint256 rFee, 
    uint256 tFee) private {
    ...
    uint256 taxFee, 
    uint256 marketingFee) private pure returns (uint256, uint256, uint256) {
