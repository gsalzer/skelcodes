// Killua Inu - Hunter x Hunter ultimate anime stealth
...
pragma solidity ^0.6.12;
    ...
    contract KilluaInu is Context, IERC20, Ownable {
        ...
        string private _name = 'Killua Inu';
        string private _symbol = 'KIINU';
        ...
        function _setTeamFee(uint256 teamFee) external onlyOwner() {
            require(teamFee >= 1 && teamFee <= 50, 'teamFee should be in 1 - 50');
            _teamFee = teamFee;
        }
