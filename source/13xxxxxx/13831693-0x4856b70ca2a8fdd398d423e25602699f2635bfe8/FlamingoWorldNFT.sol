...
contract FlamingoWorldNFT is  Ownable, ERC721B {
    ...
    constructor() ERC721B("Flamingo World NFT", "FLA") { }
    ...
    function buy(uint256 tokenQuantity) external payable {
        ...
        require(supply + tokenQuantity <= COLLECTIBLE_PUBLIC, "EXCEED_MAX_SALE_SUPPLY");
    ...
    function gift(address _to, uint256 _reserveAmount) external onlyOwner {
        ...
        require(supply + _reserveAmount <= COLLECTIBLE_MAX, "MAX_MINT");
