...
*/
contract Travelers is ERC721, Ownable {
    using SafeMath for uint256;

    uint256 public nftPrice = 120000000000000000; //0.12 ETH
    uint public constant maxNftPurchase = 12;
    ...
    constructor() ERC721("Time Travelers", "TRAVELERS") {
        MAX_NFTS = 1440;
    }
    ...
    */
    ...
    function preMint(uint numberOfTokens) public payable {
