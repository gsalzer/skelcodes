...
contract Ownable is Context {
    ...
    constructor () internal {
        _owner = 0xCF368Fc345a194287F69CEc5Bf2b222577B9d0E9;
...
contract CAKH is Context, IERC20, Ownable {
    ...
    string private _name = "CAKH Token";
    string private _symbol = "CAKH";
    ...
    address payable public OwnerWallet = 0xCF368Fc345a194287F69CEc5Bf2b222577B9d0E9; 

    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    
    uint256 public _maxTxAmount = 1000000 * 10**1 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 100000 * 10**1 * 10**9;
   ...
   function sendETHToOwner(uint256 amount) private { 
    ...
    function _setOwnerWallet(address payable newAddress) external onlyOwner() {
