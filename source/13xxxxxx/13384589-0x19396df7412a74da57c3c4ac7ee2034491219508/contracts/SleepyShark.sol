...
contract SleepyShark is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("Sleepy Shark", "SleepyShark")  {
        setBaseURI(baseURI);
    ...
    function mint(address _to, uint256 num) public payable {
        ...
        if(msg.sender != owner()) {
          ...
          require( num < (_maxMint+1),"You can adopt a maximum of _maxMint Sharks in one transcation." );
          require( msg.value >= _price * num,"Not enought Ether is sent" );
        }
