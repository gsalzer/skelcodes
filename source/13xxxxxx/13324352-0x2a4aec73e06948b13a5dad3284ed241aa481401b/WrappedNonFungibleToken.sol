...
/*
 ...
 | |____| |  | |_| | |_) | || (_) | (_| | |_| | (__|   <| |  __/\__ \
  \_____|_|   \__, | .__/ \__\___/ \__,_|\__,_|\___|_|\_\_|\___||___/
               __/ | |                                               
              |___/|_|                                               
...
contract WrappedNonFungibleToken is ERC721, Ownable, ERC1155TokenReceiver {
    ...
    */
    function wrapWithProof(uint256 legacyTokenId, bytes32[] memory merkleProof ) public returns (bool){
        ...
        IERC1155(_wrappableContract).safeTransferFrom(msg.sender,  address(this),  legacyTokenId, 1 , "");
    ...
    function unwrap(uint256 tokenId) public returns (bool){
        ...
        IERC1155(_wrappableContract).safeTransferFrom( address(this), msg.sender,  legacyTokenIdReverseRegister[tokenId], 1 , "");
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        return string(abi.encodePacked( baseURI() , uint2str(legacyTokenIdReverseRegister[tokenId]), "?format=json" ));   
    }
