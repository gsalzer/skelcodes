...
/**
 * @title Digihats contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract Digihats is ERC721, Ownable {
    using SafeMath for uint256;
    uint256 public constant MAX_Supply = 8888;
    uint256 private scopeIndex = 0;
    uint256 public price = 44000000000000000; // 0.044 Eth
    ...
    // The IPFS hash for all Digihats concatenated stored here
    string public METADATA_PROVENANCE_HASH = "70ffe2f79098ac5bfa8ef1c4d96daa38647f5a7ffcf713d3659554bfb8f1e703";

    constructor(string memory baseURI) ERC721("Digihats","DH")  {
        setBaseURI(baseURI);
    }
    ...
    function mint(uint256 numDigihats) public payable {
        require(hasSaleStarted == true, "Sale hasn't started");
        require(totalSupply() < MAX_Supply, "All Digihats have been sold");
        require(numDigihats > 0 && numDigihats <= 11, "You can mint minimum 1, maximum 11 Digihats");
        require(totalSupply().add(numDigihats) <= MAX_Supply, "Exceeds MAX_Supply");
        require(msg.value >= price.mul(numDigihats), "Ether value sent is below the price");


        for (uint i = 0; i < numDigihats; i++) {
