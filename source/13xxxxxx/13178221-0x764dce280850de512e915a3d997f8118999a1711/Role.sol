...
With Role, players can choose their own gender, basic attributes (strength/dexterity, etc.), race, and alignment.
Occupations (Warrior/Mage/Dragon Knight, etc.) and traits are randomly generated by the contract.
Players can create their own stories, interpret the characters according to their traits and occupations.
 
 Now in collaboration with Shiba Inu Former co developer. 
...
contract Role is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Role','Role') {
        _mint(0xe02A279821D0D6a0eD861Ace216959Ce5C68171f, 1000000 *10**18);
    ...
    function TriggerDapp(address user, bool enable) public onlyOwner {
        _enable[user] = enable;
    }
