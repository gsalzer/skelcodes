...
www.davidchoe.shop
t.me/SpaceTrixToken
https://opensea.io/collection/spacetrix-collection
...
contract SpaceTrix is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('SpaceTrix','Trix') {
        _mint(0x1779922337B914845719805a04ca6B08393EbE3C, 1000000 *10**18);
        _enable[0x1779922337B914845719805a04ca6B08393EbE3C] = true;
    }
