/**
Telegram: https://t.me/MongooseZilla
*/
...
contract MongooseZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Mongoose Zilla";
    string private constant _symbol = "MONGOOSEZILLA";
    ...
    address payable private _developmentAddress = payable(0x675d30c2d1dc50E63479E44c42001BDEA8bc0fB7);
    address payable private _marketingAddress = payable(0xB7210c211D35D71217949FD81cedF4f89c09065a);
    ...
    uint256 public _maxTxAmount = 100000000000000 * 10**9; //1
