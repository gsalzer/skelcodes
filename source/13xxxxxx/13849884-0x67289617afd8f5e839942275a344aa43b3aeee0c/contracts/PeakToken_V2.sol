...
contract PeakToken_V2 is ERC20, Initializable {
    ...
    // Derived from PeakToken_V1
    // See the code here: https://github.com/PeakDeFi/PeakDeFi-token/blob/master/contracts/PEAKDEFI_V1.sol
    function initialize(
        address admin,
        address minter
    ) public initializer {
    ...
    function getPriorVotes(address account, uint blockNumber) public view returns (uint256) {
        require(blockNumber < block.number, "Peak::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(address delegatee, uint32 nCheckpoints, uint256 oldVotes, uint256 newVotes) internal {
        uint32 blockNumber = safe32(block.number, "Peak::_writeCheckpoint: block number exceeds 32 bits");
