...
/** 
 * This contract was inspired/copied from berkozdemir's very attractive contract for GLICPIXXXVER002, I highly recommend you go check out their awesome projects. 
 * I own a GLICPIXXXVER002 myself and love it like a child <3 They're pretty f'ing cool.
 * Also cats cats cats cats cats cats cats cats cats
*/
...
contract metaGAN_Series2 is ERC721Enumerable, Ownable, VRFConsumerBase {

string public _baseTokenURI;

// SOMETHING SOMETHING VRF

bytes32 internal keyHash;
uint256 internal fee;

// CONTRACT STARTS INACTIVE
...
uint256 public Series0start = 1; // 17 Series 0 GAN Creatures
uint256 public Series1start = 18; // 220 Series 1 Zombie Punks
uint256 public Series2total = 237; // 237 Series 2 GAN PX Cats

// SERIES 0 and SERIES 1 ADDRESSES

address public Series0Address = 0x31C64bC232b386Fb45BfdE115b6588D054Fa087C;
address public Series1Address = 0xEFB87c8C867BA4e152dda7474dAB701Aa711a344;
...
event Series2Claimed(CollectionToClaim _collection, uint256 tokenId, uint256 Series2idBeingMinted, address _claimer);
event randomStartingIndexDrawn(uint256 mintStartIndex);

constructor()
    ERC721("metaGAN - GAN PX Cats", "mG.2")
    VRFConsumerBase(
    ...
    function startClaim() public onlyOwner {
        require(mintStartIndexDrawn, "DICE NOT ROLLED");
        claimRunning = true;
    }
    ...
    // CALL A RANDOM NUMBER AND SHIFT THE TOKEN IDS
   
    /**
     * Requests randomness
     */
    function rollthedice() public onlyOwner returns (bytes32 requestId) {
        require(!mintStartIndexDrawn , "DICE ALREADY ROLLED");
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        mintStartIndex = randomness % Series2total;
        if(mintStartIndex == 0) {
            mintStartIndex = 1;
        }
