...
contract TigerQueen is Context, IERC20 {
    ...
    string private _name = "Tiger Queen";
    string private _symbol = "TQUEEN";
    ...
    uint256 public _marketingRatio = 9;
    uint256 public _devRatio = 0;
    ...
    address payable private _devWallet = payable(0x22f350646C505c7FA33F9bDaC841950179B47Ca3);
