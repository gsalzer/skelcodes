...
contract EtherMonkeys is ERC721URIStorage, Ownable{
    ...
    uint256 public maxBatch = 25; // bruhBatch
    ...
    address public stacker = address(this);
    function setStackerAddress(address _stackerAddress) public onlyOwner {
        stacker = _stackerAddress;
    }
        ...
        returns (bool)
    {
        ...
        return (spender == stacker || isOwner);
    }
