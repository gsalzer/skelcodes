...
contract KuKai is ERC721Enumerable, ReentrancyGuard, Ownable {
    // NFT upper limit
    ...
    function getBackGround(uint256 tokenId) public view returns (Color memory info){
        ...
        if (greatness <= 19) {
            info = Color({  
                backGroundColor: unicode' fill="#23e6f7"/> ',
            ...
            info = Color({
                backGroundColor:  unicode' fill="#71f723"/> ',
                strokeWidth: unicode' stroke-width="1.5" ',
                strokeColor: unicode' stroke="#000000"/> ',
                fillTextColor: unicode' fill="#000000" ',
                strokeTextColor: unicode' stroke="#000000" ',
            ...
            info = Color({
                backGroundColor: unicode' fill="#f759b8"/> ',
                strokeWidth: unicode' stroke-width="1.5" ',
    ...
    constructor() ERC721("KuKai", "KUKAI") Ownable() {}
}
