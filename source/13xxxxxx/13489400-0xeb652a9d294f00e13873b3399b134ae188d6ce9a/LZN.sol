...
library SafeMath {
 ...
 contract LZN is ERC721Enumerable, Ownable {
    ...
    address private constant BAddress = 0x950059d627690B32A7eaD528640CCAA54ba516F2;
    address private constant CAddress = 0xCA7767e52e72852025Aa6bdf4F498620F211C5B8;
    ...
    function withdrawAll() public payable onlyOwner {
        ...
        require(balance > 0);
        _withdraw(AAddress, balance.mul(32).div(100));
        _withdraw(BAddress, balance.mul(34).div(100));
        _withdraw(CAddress, balance.mul(34).div(100));
