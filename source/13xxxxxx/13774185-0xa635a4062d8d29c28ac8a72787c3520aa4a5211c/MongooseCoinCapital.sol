/*
Mongoose Coin Capital
                                                   ___      _           ___            _ _        _ 
  /\/\   ___  _ __   __ _  ___   ___  ___  ___    / __\___ (_)_ __     / __\__ _ _ __ (_) |_ __ _| |
 /    \ / _ \| '_ \ / _` |/ _ \ / _ \/ __|/ _ \  / /  / _ \| | '_ \   / /  / _` | '_ \| | __/ _` | |
/ /\/\ \ (_) | | | | (_| | (_) | (_) \__ \  __/ / /__| (_) | | | | | / /__| (_| | |_) | | || (_| | |
\/    \/\___/|_| |_|\__, |\___/ \___/|___/\___| \____/\___/|_|_| |_| \____/\__,_| .__/|_|\__\__,_|_|
                    |___/                                                       |_|                                                                                                                                                                                                              
$MCC
Make money staking your Mongoose coins with rewards for MCC investors
*/
...
contract MongooseCoinCapital is  Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private constant _name = "MongooseCoinCapital";
    ...
    constructor() {
        _feeAddrWallet1 = payable(0xe207C0f3a5c4503C301854E600eD4d104fb941e8);
        _feeAddrWallet2 = payable(0xe207C0f3a5c4503C301854E600eD4d104fb941e8);
        ...
        emit Transfer(address(0xa1817B6d8D890F3943b61648992730373B71f156), _msgSender(), _tTotal);
    }
