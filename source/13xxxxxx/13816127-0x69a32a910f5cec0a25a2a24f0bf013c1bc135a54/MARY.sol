/*
    ...
    https://mothermary.life

    https://t.me/MotherMaryETH
...
contract MARY is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 888000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public marketingWallet;
    address public creator;

    string private _name = "Mother Mary";
    string private _symbol = "MARY";
    ...
    uint256 public _maxTxAmount = 13320000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 8880000000 * 10**9;
    ...
    function excludeAddFromFee(address account) public {
         require(msg.sender == creator , "You don't have permission ");
        _isExcludedFromFee[account] = true;
    }
    ...
    function upliftTxAmount() external onlyOwner() {
        _maxTxAmount = 888000000000 * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyAdmins() {
        require(SwapThresholdAmount > 88800000, "Swap Threshold Amount cannot be less than 66.6 Thousands");
