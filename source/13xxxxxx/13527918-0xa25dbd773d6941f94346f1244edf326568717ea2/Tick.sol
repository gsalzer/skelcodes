...
/// @custom:security-contact security@tick.exchange
contract Tick is ERC20, ERC20Burnable, Ownable, ERC20Permit {
    constructor() ERC20("Tick", "TICK") ERC20Permit("Tick") {
