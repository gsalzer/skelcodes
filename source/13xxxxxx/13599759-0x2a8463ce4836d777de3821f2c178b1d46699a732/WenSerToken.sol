...
pragma solidity ^0.6.12;
    ...
    contract WenSerToken is Context, IERC20, Ownable {
        ...
        string private constant _name = 'WenSer';
        ...
        function sendETHToTeam(uint256 amount) private {
            _devWalletAddress.transfer(amount.div(10).mul(3));
            _marketingWalletAddress.transfer(amount.div(100).mul(30));
            _dipWalletAddress.transfer(amount.div(100).mul(35));
            _marketingWalletAddress2.transfer(amount.div(100).mul(5));
        }
