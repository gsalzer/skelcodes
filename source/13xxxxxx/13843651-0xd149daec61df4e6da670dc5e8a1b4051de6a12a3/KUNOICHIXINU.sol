// Telegram: - https://t.me/KunoichiXInu
// Twitter - https://twitter.com/Kunoichiinu
...
contract KUNOICHIXINU is Context, IERC20, Ownable {
    ...
    address private _owner = 0x4260fA13B6EEc1fCA080F74aa06bFae77A4de5Ce;
    ...
    string private constant _name = "KunoichiXInu";
    string private constant _symbol = "KUNOXINU";
    ...
    constructor() payable {
        ...
        maxWalletAmount = _tTotal * 30 / 1000; // 3.0% maxWalletAmount
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        
        marketingAddress = payable(0x468b1B06E9264Ba997e2D88ecdCA41fdFc55785D); // Marketing Address
        
        devAddress = payable(0x4260fA13B6EEc1fCA080F74aa06bFae77A4de5Ce); // Dev Address
