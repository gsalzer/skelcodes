...
contract Swirls is ERC721Enumerable, Ownable{
    ...
    constructor() ERC721("0xAI Swirls","SWIRLS"){
    }
    ...
    function mint() public payable {
        ...
        require(NFT_PRICE == msg.value, "Sent ether value is incorrect, mint cost is 0.01 ether");
    ...
    function mint5() public payable {
        ...
        require(NFT_PRICE.mul(5) == msg.value, "Must Send 0.05 ETH to Mint 5 NFTs");
