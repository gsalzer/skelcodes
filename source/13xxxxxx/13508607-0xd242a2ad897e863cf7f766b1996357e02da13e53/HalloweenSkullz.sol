...
// File @openzeppelin/contracts/token/ERC721/extensions/ERC721Burnable.sol@v4.2.0
...
contract HalloweenSkullz is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
    ...
    uint256 public maxPreMint = 3333;
    uint256 public maxWallet = 6;
    bool public presale = false;
    bool public checkPrePrice = false;
    mapping(address => uint256) public minted; // To check how many tokens an address has minted
    constructor(address payable fundsTo_, uint256 maxSupply_, uint256 maxPerTx_, uint256 pricePer_, uint256 pricePerPre_) ERC721("Halloween Skullz", "Halloween Skullz") {
        fundsTo = fundsTo_;
    ...
    function flipCheckPrePrice() public onlyOwner {
        checkPrePrice = !checkPrePrice;
    }
    ...
    function _totalMints() public view  returns (uint256)
    {
