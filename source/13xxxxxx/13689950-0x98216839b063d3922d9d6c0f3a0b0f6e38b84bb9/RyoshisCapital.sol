/**
Ryoshis Capital: $RYOSHICP
- You buy on Ethereum, I farm on OLYMPUS DAO fork and return the profits to $RYOSHICP holders.

Tokenomics:
- 10% of each buy goes to existing holders.
- 13% of each sell goes into multi-chain farming to add to the treasury.

WAIT, THERE IS MORE. It's not just a copy paste contract 
+ Added Max wallet to prevent whale buying too much and dump on you
+ Added Special Anti-Dumping. Y'all want this moonshot, Right ?
+ Contract will be renounced right after locking LP 

Telegram: 
https://t.me/RyoshisCapital

Contract renounce + LP lock you can check on Telegram 
Later we'll also have a website if this token doing good !
...
pragma solidity ^0.8.7;
    ...
    contract Ownable is Context {
        ...
        */
        ...
        function transferOwnershipWithLockTime(uint256 time) public virtual onlyOwner {
    ...
    contract RyoshisCapital is Context, IERC20, Ownable {
        ...
        uint256 _tTotal = 1000000000000 * 10**9;
        uint256 _rTotal = (MAX - (MAX % _tTotal));
        uint256 _tFeeTotal;
        
        uint256 _maxWallet = (_tTotal * 2) / 100; //Max Wallet 2% of total supply

        string _name = 'Ryoshis Capital';
        string _symbol = 'RYOSHICP';
        uint8 _decimals = 9;
        ...
        uint256 _previousTeamFee = _teamFee;
        ...
        uint256 rule = 33;
        uint256 restrictionDuration = 86400;
        ...
        uint256 _maxTxAmount = 100000000000000e9;
        // We will set a minimum amount of tokens to be swaped => 5M
        uint256 _numOfTokensToExchangeForTeam = 5 * 10**3 * 10**9;
        ...
        constructor () public {
            _MCCWalletAddress = payable(0x2714E852C188e99c88c7A2fCe28244d119E1C27b);
            _marketingWalletAddress = payable(0x7fAb6146aB44bC2dc6a59f7F95c56CAe928817f2);
            ...
            if(sender != owner() && recipient != owner()){
                ...
                if (sender == uniswapV2Pair){
                    if (recipient != address(this)  && recipient != address(DEAD)){
                        ...
                        require(_isExcludedFromFee[recipient] || (currentBalance + amount <= _maxWallet));
                    }
                }
                
                else if(forceEop && !_isExcludedFromFee[sender]){
        ...
        */
        ...
        function setAntiDumpSetting(uint256 _rule, uint256 _restrictionDuration) public onlyOwner{
            rule = _rule;
