...
contract Pixelabz is ERC721Enumerable
{
 using Address for address;
 using Strings for uint256;
 ...
 uint256 private salesPrice = 0.1 ether;

 uint256 private totalTokens = 3333;
 uint256 private leftTokenCount = totalTokens;
 uint256 private mintedTokenCount = 0;

 string private baseURI = 'https://ipfs.io/ipfs/QmayjRs1DkJVcott86A4D3S5pvFPxS4PZp6F9ge1sVLVCz/';
 ...
 constructor() ERC721("Pixelabz", "LABZ") // temporary Symbol and title
 {
