...
// File contracts/adapters/VesperLinkVaultAdapter.sol
...
contract VesperLinkVaultAdapter is IVaultAdapterV2 {
  ...
  constructor(IVesperPool _vault, IPoolRewards _vspPool, address _admin,
              IUniswapV2Router02 _uniV2Router, IDetailedERC20 _vesperToken) public {
    vault = _vault;
    vspPool = _vspPool;
    admin = _admin;
  ...
  function updateApproval() public {
    ...
    IDetailedERC20(_token).approve(address(vault), uint256(-1));
...
// File contracts/adapters/VesperLinkVaultAdapterWithIndirection.sol
