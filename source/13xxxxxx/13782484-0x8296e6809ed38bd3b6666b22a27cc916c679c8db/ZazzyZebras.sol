...
// File: contracts/ZazzyZebras.sol
...
contract ZazzyZebras is ERC721Enumerable, Ownable {
    ...
    constructor(string memory _baseUrl, string memory _notRevealedUrl) ERC721("ZazzyZebras", "Zazz") {
        baseURI = _baseUrl;
