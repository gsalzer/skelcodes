...
contract DigiDicks is ERC721, Ownable {
    ...
    function mintDigiDicks(uint256 numberOfTokens) public payable {
        require(isSaleActive, "Sale is not active");
        require(numberOfTokens <= maxPerTx, "No more than 20 tokens per transaction");
        require(totalSupply().add(numberOfTokens) <= maxNFT, "Purchase would exceed max supply of NFTs");
        require(pricePerNFT.mul(numberOfTokens) == msg.value, "Ether value is not correct");
