...
2) 4% tax is collected for dev fees
...
contract DLOOT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x00000070AA962d289F5aC55E67E44881a41A2A26); // dev Address
    ...
    string private _name = "DOONT LOOT";
    string private _symbol = "DLOOT";
