...
contract BOOLISH is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BOOLISH";
    ...
    address payable public liquidityFeeReceiver = payable(0xfDb747bbd451Db461D51AFCd4B5D7a72bf9AE15B);
    address payable public marketingFeeReceiver = payable(0xfDb747bbd451Db461D51AFCd4B5D7a72bf9AE15B);
