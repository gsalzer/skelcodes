...
contract CEOofMoneyNFT is Context, Ownable, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable {
        ...
        ERC721(name, symbol) 
    {
        ...
        __bytecodechange = "CEO of Money Cap NFT"; // this is to provide bytecode uniqueness (otherwise ES shows first deployed version with constructor parameters)
    }
