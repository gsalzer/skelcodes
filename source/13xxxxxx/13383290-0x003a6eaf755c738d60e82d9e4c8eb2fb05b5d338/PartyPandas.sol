...
// File: contracts/PartyPandas.sol

pragma solidity ^0.8.0;

contract PartyPandas is ERC721, Ownable {
  using Address for address;
  using Counters for Counters.Counter;

  Counters.Counter private _tokenCount;

  string public baseURI = "https://api.partypandas.co/metadata/";
  ...
  constructor() ERC721("Party Pandas ", "PARTYPANDAS") {}
