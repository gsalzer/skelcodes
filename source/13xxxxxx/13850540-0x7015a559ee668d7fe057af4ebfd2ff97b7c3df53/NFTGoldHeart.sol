...
contract NFTGoldHeart is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    event CreateNFTGoldHeart(uint256 indexed id);
	
    constructor(string memory baseURI) ERC721("NFT GoldHeart", "NFT GOLDHEART") {
		setBaseURI(baseURI);
        pause(true);
    }
    ...
    function _mintAnElement(address _to) private {
        ...
        emit CreateNFTGoldHeart(_tokenIdTracker.current());
    }
