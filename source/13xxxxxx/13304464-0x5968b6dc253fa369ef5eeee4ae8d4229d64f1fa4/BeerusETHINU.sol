...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _exterminate(address account, uint256 amount) internal {
...
contract ERC20Beerus is Context, ERC20 {
    constructor(
...
contract BeerusETHINU is ERC20Beerus {
    constructor() ERC20Beerus("Beerus EthInu", "BEERUS", false, true, 1000, 30, msg.sender, 1200000000 * 10 ** 18, msg.sender, 2) {
    }
}
