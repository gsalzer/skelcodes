...
contract SwitcheoToken is ERC20, ERC20Detailed {
  ...
  constructor(address _lockProxyAddress) ERC20Detailed("Ethereum-bridged PORT Token", "ePORT", 4) public {
    lockProxyAddress = _lockProxyAddress;
  }

  function _transfer(address sender, address recipient, uint256 amount) internal override {
      if (sender == lockProxyAddress) {
          require(recipient != lockProxyAddress, "Ethereum-bridged PORT Token: lockProxy should not call transfer to self");
