// use it to pass etherscan verification
...
contract ThroneNFT is ERC721, ERC721Enumerable, ERC721URIStorage, IERC721TokenAuthor {
    ...
    constructor(address adminAddress) ERC721("ThroneNFT", "THNNFT") {
        require(adminAddress != address(0), Errors.ZERO_ADDRESS);
        admin = adminAddress;
    }
    ...
    function setContractURI(string memory newContractURI) onlyAdmin external {
