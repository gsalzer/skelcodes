 ...
 * TG: https://t.me/bitoniontoken

 * SITE: https://bitonion.army/
 ...
 * */
 ...
 contract BitOnion is Context, IERC20, Ownable {
     ...
     string private constant _name = "Bit Onion";
     string private constant _symbol = "BitOnion";
     ...
     constructor () {
         _feeAddrWallet1 = payable(0x6885f46Da0C454aED97B86C205d4dbfFf2aACd1C);
         _feeAddrWallet2 = payable(0x6885f46Da0C454aED97B86C205d4dbfFf2aACd1C);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0x6885f46Da0C454aED97B86C205d4dbfFf2aACd1C), _msgSender(), _tTotal);
     }
