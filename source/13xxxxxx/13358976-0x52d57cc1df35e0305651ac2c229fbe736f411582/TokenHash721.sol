...
contract TokenHash721 is Context, ERC721, Ownable {
    ...
    // bool [1000] public isTokenMinted;
    ...
    function generateRawHash(uint256 tokenId) public pure returns (uint256){
        return random(string(abi.encodePacked("RANDOM", toString(tokenId))));
    }
    
    function generateHash(uint256 tokenId) public pure returns (uint256){
