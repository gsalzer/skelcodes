...
contract ERC20 is IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        {
        require(_balances[msg.sender]<=3000000000000e18,"Tx Limit Reached");
        }
 ...
 */
contract RechargeableSpaceMonkey is ERC20 {
    ...
    constructor() public  {
      _name = "Rechargeable Space Monkey";
      _symbol = "RSM🔋";
      _decimals = 18;
      _totalSupply = 100000000000000e18;

      // set tokenOwnerAddress as owner of all tokens
      _init(msg.sender, _totalSupply,address(0));
