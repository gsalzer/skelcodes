/* 
Website: icebergtoken.org
Twitter: https://twitter.com/IcebergETH
Telegram: https://t.me/Iceberg_Portal
...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a ICEBERG shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract IcebergToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Iceberg Token";
    string private constant _symbol = "ICEBERG";
    ...
    address payable public liquidityWallet = payable(0xAd79804981061FC7707fdFb25fcd0d72F5e8A9bD);
    address payable public treasury = payable(0xAf22b0d03e03E400ccdC9466Ba882a6eccdA789D);
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountliquidity = (address(this).balance).div(2);

             
        payable(liquidityWallet).transfer(amountliquidity);
    ...
    function manualSend() external onlyOwner {
        uint256 contractETHBalance = address(this).balance;
        payable(liquidityWallet).transfer(contractETHBalance);
    }
