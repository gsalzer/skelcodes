...
// Contract: PowerPlantsNFT
// Created By: Metaverse Solutions, LLC 
// Visit us at: metaversesolutions.ai
// ---- CONTRACT BEGINS HERE ----

pragma solidity ^0.8.0;

contract PowerPlantsNFT is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public walletLimit = 5000;
  ...
  constructor(
    ...
    // change the number in the mint(msg.sender, 5) method below
    // to any other number you want. The default is
    // 5 reserve tokens for the owner.
    // mint(msg.sender, 5);
