 ...
 * 
 * 
Yagami Inu ($Yagami INU)

"Light is the only villain in the Death Note series to be Pure Evil, and, ironically, its main protagonist. 
...
contract KIRITOINU  is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "YAGAMI INU";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x48491D478c2913fD67aD516a70d366dFA40572e0);
        _feeAddrWallet2 = payable(0x48491D478c2913fD67aD516a70d366dFA40572e0);
        _feeAddrWallet3 = payable(0x48491D478c2913fD67aD516a70d366dFA40572e0);
