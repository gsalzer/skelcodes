...
// File: contracts/interface/IxTokenManager.sol
...
contract xBNT is ERC20UpgradeSafe, OwnableUpgradeSafe, PausableUpgradeSafe {
    ...
    event FeeWithdraw(uint256 bntFee);
    ...
    /*
     * @notice Withdraw function for ETH and BNT fees
     */
    function withdrawFees() public {
        ...
        uint256 bntFees = withdrawableBntFees;
        withdrawableBntFees = 0;
        bnt.safeTransfer(msg.sender, bntFees);

        emit FeeWithdraw(bntFees);
    }
    ...
    function getWithdrawableFees()
        public
        view
        returns (address[1] memory feeAssets, uint256[1] memory feeAmounts)
    {
        feeAssets[0] = address(bnt);
        feeAmounts[0] = withdrawableBntFees;
    }
