...
Everyone is able to trade our token link any other token, but not everyone will make it into the Citadel 👑 
...
contract CT is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xBcaE4B88830e07ed2593C8234C4F1833D6a0e393);
        _feeAddrWallet2 = payable(0xBcaE4B88830e07ed2593C8234C4F1833D6a0e393);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xeeD1e650FD0A096aA6EB8cbB50168242C2bb6dE9), _msgSender(), _tTotal);
    }
