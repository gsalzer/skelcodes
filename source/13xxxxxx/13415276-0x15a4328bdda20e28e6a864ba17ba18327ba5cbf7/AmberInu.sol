...
contract AmberInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Amber Inu";
    string private constant _symbol = "AMBER";
    ...
    address payable private _developmentAddress = payable(0x0CE0eF5D42006518057bDE52B2D149b9861eE7D8);
    address payable private _marketingAddress = payable(0x0CE0eF5D42006518057bDE52B2D149b9861eE7D8);
    ...
    uint256 public _maxWalletSize = 17500000000000 * 10**9; //1
