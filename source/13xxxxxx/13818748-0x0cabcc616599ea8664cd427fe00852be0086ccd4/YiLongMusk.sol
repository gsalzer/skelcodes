...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x6E0aFE8B5b3Fa2e86aee24065b34d1cd7873ACa6), 5000);
        m_DidDeploy = true;
    }
...
contract YiLongMusk is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "Yi Long Musk";
    string private m_Symbol = "YLM";
