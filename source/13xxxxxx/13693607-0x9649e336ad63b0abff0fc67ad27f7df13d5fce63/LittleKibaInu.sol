...
contract LittleKibaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "LittleKibaInu";
    string private constant _symbol = "$LILKIBA";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x305Adb7d07A93958028B686020538Ce753a18a93);
        _feeAddrWallet2 = payable(0x305Adb7d07A93958028B686020538Ce753a18a93);
