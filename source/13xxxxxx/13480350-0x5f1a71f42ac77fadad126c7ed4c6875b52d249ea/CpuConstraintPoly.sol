...
contract CpuConstraintPoly {
    ...
    // [0x30a0, 0x35c0) - expmods.
    // [0x35c0, 0x38e0) - denominator_invs.
    // [0x38e0, 0x3c00) - denominators.
    // [0x3c00, 0x3dc0) - numerators.
    // [0x3dc0, 0x3e80) - expmod_context.
    ...
    fallback() external {
        ...
        assembly {
...

            {
              ...
              // denominators[15] = point^(trace_length / 64) - 1.
              mstore(0x3ac0,
              ...
              // denominators[16] = point^(trace_length / 128) - 1.
              mstore(0x3ae0,
              ...
              // denominators[17] = point^(trace_length / 32768) - trace_generator^(251 * trace_length / 256).
              mstore(0x3b00,
                     addmod(
              ...
              // denominators[18] = point^(trace_length / 32768) - trace_generator^(255 * trace_length / 256).
              mstore(0x3b20,
                     addmod(
                       /*point^(trace_length / 32768)*/ mload(0x31e0),
                       sub(PRIME, /*trace_generator^(255 * trace_length / 256)*/ mload(0x32c0)),
              ...
              // denominators[19] = point^(trace_length / 16384) - trace_generator^(251 * trace_length / 256).
              mstore(0x3b40,
                     addmod(
              ...
              // denominators[20] = point^(trace_length / 16384) - trace_generator^(255 * trace_length / 256).
              mstore(0x3b60,
                     addmod(
                       /*point^(trace_length / 16384)*/ mload(0x31a0),
                       sub(PRIME, /*trace_generator^(255 * trace_length / 256)*/ mload(0x32c0)),
              ...
              // denominators[21] = point^(trace_length / 32768) - 1.
              mstore(0x3b80,
...

            {
              ...
              let prod := 1
              let partialProductEndPtr := 0x38e0
              for { let partialProductPtr := 0x35c0 }
              ...
              let firstPartialProductPtr := 0x35c0
              ...
              let currentPartialProductPtr := 0x38e0
...

            {
              ...
              // numerators[7] = point - trace_generator^(512 * (trace_length / 512 - 1)).
              mstore(0x3ce0,
                     addmod(
                       point,
              ...
              // numerators[8] = point - trace_generator^(256 * (trace_length / 256 - 1)).
              mstore(0x3d00,
                     addmod(
                       point,
              ...
              // numerators[9] = point^(trace_length / 16384) - trace_generator^(255 * trace_length / 256).
              mstore(0x3d20,
                     addmod(
                       /*point^(trace_length / 16384)*/ mload(0x31a0),
                       sub(PRIME, /*trace_generator^(255 * trace_length / 256)*/ mload(0x32c0)),
              ...
              // numerators[10] = point^(trace_length / 32768) - trace_generator^(255 * trace_length / 256).
              mstore(0x3d40,
                     addmod(
                       /*point^(trace_length / 32768)*/ mload(0x31e0),
                       sub(PRIME, /*trace_generator^(255 * trace_length / 256)*/ mload(0x32c0)),
              ...
              // numerators[11] = point - trace_generator^(32768 * (trace_length / 32768 - 1)).
              mstore(0x3d60,
                     addmod(
                       point,
              ...
              // numerators[12] = point^(trace_length / 1024) - trace_generator^(3 * trace_length / 4).
              mstore(0x3d80,
                     addmod(
                       /*point^(trace_length / 1024)*/ mload(0x3200),
              ...
              // numerators[13] = point - trace_generator^(1024 * (trace_length / 1024 - 1)).
              mstore(0x3da0,
                     addmod(
                       point,
...

            {
              ...
              let val := addmod(
                /*column4_row0*/ mload(0x1960),
                sub(
                  PRIME,
                  addmod(/*column4_row1*/ mload(0x1980), /*column4_row1*/ mload(0x1980), PRIME)),
                PRIME)
              mstore(0x2e80, val)
              }
              ...
              {
              // ecdsa/signature0/exponentiate_generator/bit_0 = column8_row98 - (column8_row226 + column8_row226).
              let val := addmod(
                /*column8_row98*/ mload(0x2820),
                sub(
                  PRIME,
                  addmod(/*column8_row226*/ mload(0x28c0), /*column8_row226*/ mload(0x28c0), PRIME)),
                PRIME)
              mstore(0x2fe0, val)
              }
              ...
              {
              // ecdsa/signature0/exponentiate_key/bit_0 = column8_row28 - (column8_row92 + column8_row92).
              let val := addmod(
                /*column8_row28*/ mload(0x26c0),
                sub(
                  PRIME,
                  addmod(/*column8_row92*/ mload(0x2800), /*column8_row92*/ mload(0x2800), PRIME)),
                PRIME)
              mstore(0x3020, val)
              }
              ...
              {
              // Constraint expression for pedersen/hash0/ec_subset_sum/bit_unpacking/last_one_is_zero: column8_row82 * (column4_row0 - (column4_row1 + column4_row1)).
              let val := mulmod(
              ...
              {
              // Constraint expression for pedersen/hash0/ec_subset_sum/bit_unpacking/zeroes_between_ones0: column8_row82 * (column4_row1 - 3138550867693340381917894711603833208051177722232017256448 * column4_row192).
              let val := mulmod(
                /*column8_row82*/ mload(0x27e0),
                addmod(
                  /*column4_row1*/ mload(0x1980),
                  sub(
                    PRIME,
                    mulmod(
                      3138550867693340381917894711603833208051177722232017256448,
                      /*column4_row192*/ mload(0x19a0),
                      PRIME)),
                  PRIME),
                PRIME)
              ...
              {
              // Constraint expression for pedersen/hash0/ec_subset_sum/bit_unpacking/cumulative_bit192: column8_row82 - column3_row255 * (column4_row192 - (column4_row193 + column4_row193)).
              let val := addmod(
                /*column8_row82*/ mload(0x27e0),
                sub(
                  PRIME,
                  mulmod(
                    /*column3_row255*/ mload(0x1940),
                    addmod(
                      /*column4_row192*/ mload(0x19a0),
                      sub(
                        PRIME,
                        addmod(/*column4_row193*/ mload(0x19c0), /*column4_row193*/ mload(0x19c0), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                /*column3_row255*/ mload(0x1940),
                addmod(
                  /*column4_row193*/ mload(0x19c0),
                  sub(PRIME, mulmod(8, /*column4_row196*/ mload(0x19e0), PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := addmod(
                ...
                sub(
                  ...
                  mulmod(
                    addmod(
                      /*column4_row251*/ mload(0x1a20),
                      sub(
                        PRIME,
                        addmod(/*column4_row252*/ mload(0x1a40), /*column4_row252*/ mload(0x1a40), PRIME)),
                      PRIME),
                    addmod(
                      /*column4_row196*/ mload(0x19e0),
                      sub(
                        PRIME,
                        addmod(/*column4_row197*/ mload(0x1a00), /*column4_row197*/ mload(0x1a00), PRIME)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              let val := mulmod(
                addmod(
                  ...
                  PRIME),
                addmod(
                  /*column4_row197*/ mload(0x1a00),
                  sub(PRIME, mulmod(18014398509481984, /*column4_row251*/ mload(0x1a20), PRIME)),
                  PRIME),
                PRIME)
              ...
              let val := /*column4_row0*/ mload(0x1960)
              ...
              let val := addmod(/*column5_row7*/ mload(0x1b60), sub(PRIME, /*column4_row0*/ mload(0x1960)), PRIME)
              ...
              let val := addmod(
                ...
                sub(PRIME, /*column4_row256*/ mload(0x1a60)),
                PRIME)
              ...
              {
              // Constraint expression for ecdsa/signature0/doubling_key/slope: ecdsa__signature0__doubling_key__x_squared + ecdsa__signature0__doubling_key__x_squared + ecdsa__signature0__doubling_key__x_squared + ecdsa/sig_config.alpha - (column8_row36 + column8_row36) * column8_row20.
              let val := addmod(
                addmod(
                  addmod(
                    addmod(
              ...
              {
              // Constraint expression for ecdsa/signature0/doubling_key/x: column8_row20 * column8_row20 - (column8_row4 + column8_row4 + column8_row68).
              let val := addmod(
                mulmod(/*column8_row20*/ mload(0x26a0), /*column8_row20*/ mload(0x26a0), PRIME),
                sub(
                  PRIME,
                  addmod(
              ...
              {
              // Constraint expression for ecdsa/signature0/doubling_key/y: column8_row36 + column8_row100 - column8_row20 * (column8_row4 - column8_row68).
              let val := addmod(
              ...
              {
              // Constraint expression for ecdsa/signature0/exponentiate_generator/bit_extraction_end: column8_row98.
              let val := /*column8_row98*/ mload(0x2820)
              ...
              {
              // Constraint expression for ecdsa/signature0/exponentiate_generator/zeros_tail: column8_row98.
              let val := /*column8_row98*/ mload(0x2820)
              ...
              {
              // Constraint expression for ecdsa/signature0/exponentiate_generator/add_points/slope: ecdsa__signature0__exponentiate_generator__bit_0 * (column8_row66 - ecdsa__generator_points__y) - column8_row34 * (column8_row2 - ecdsa__generator_points__x).
              let val := addmod(
                mulmod(
                  /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_0*/ mload(0x2fe0),
                  addmod(
              ...
              {
              // Constraint expression for ecdsa/signature0/exponentiate_generator/add_points/x: column8_row34 * column8_row34 - ecdsa__signature0__exponentiate_generator__bit_0 * (column8_row2 + ecdsa__generator_points__x + column8_row130).
              let val := addmod(
                mulmod(/*column8_row34*/ mload(0x26e0), /*column8_row34*/ mload(0x26e0), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_0*/ mload(0x2fe0),
              ...
              {
              // Constraint expression for ecdsa/signature0/exponentiate_generator/add_points/y: ecdsa__signature0__exponentiate_generator__bit_0 * (column8_row66 + column8_row194) - column8_row34 * (column8_row2 - column8_row130).
              let val := addmod(
                mulmod(
                  /*intermediate_value/ecdsa/signature0/exponentiate_generator/bit_0*/ mload(0x2fe0),
                  addmod(/*column8_row66*/ mload(0x2780), /*column8_row194*/ mload(0x28a0), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
              ...
              {
              // Constraint expression for ecdsa/signature0/exponentiate_key/bit_extraction_end: column8_row28.
              let val := /*column8_row28*/ mload(0x26c0)
              ...
              {
              // Constraint expression for ecdsa/signature0/exponentiate_key/zeros_tail: column8_row28.
              let val := /*column8_row28*/ mload(0x26c0)
              ...
              {
              // Constraint expression for ecdsa/signature0/exponentiate_key/add_points/slope: ecdsa__signature0__exponentiate_key__bit_0 * (column8_row12 - column8_row36) - column8_row44 * (column8_row52 - column8_row4).
              let val := addmod(
                mulmod(
                  /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_0*/ mload(0x3020),
                  addmod(/*column8_row12*/ mload(0x2660), sub(PRIME, /*column8_row36*/ mload(0x2700)), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column8_row44*/ mload(0x2720),
                    addmod(/*column8_row52*/ mload(0x2740), sub(PRIME, /*column8_row4*/ mload(0x2620)), PRIME),
                    PRIME)),
                PRIME)
              ...
              {
              // Constraint expression for ecdsa/signature0/exponentiate_key/add_points/x: column8_row44 * column8_row44 - ecdsa__signature0__exponentiate_key__bit_0 * (column8_row52 + column8_row4 + column8_row116).
              let val := addmod(
                ...
                sub(
                  ...
                  mulmod(
                    /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_0*/ mload(0x3020),
                    addmod(
                      addmod(/*column8_row52*/ mload(0x2740), /*column8_row4*/ mload(0x2620), PRIME),
              ...
              {
              // Constraint expression for ecdsa/signature0/exponentiate_key/add_points/y: ecdsa__signature0__exponentiate_key__bit_0 * (column8_row12 + column8_row76) - column8_row44 * (column8_row52 - column8_row116).
              let val := addmod(
                mulmod(
                  /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_0*/ mload(0x3020),
                  addmod(/*column8_row12*/ mload(0x2660), /*column8_row76*/ mload(0x27c0), PRIME),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    ...
                    addmod(
                      ...
                      sub(PRIME, /*column8_row116*/ mload(0x2860)),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              {
              // Constraint expression for ecdsa/signature0/exponentiate_key/add_points/x_diff_inv: column8_row60 * (column8_row52 - column8_row4) - 1.
              let val := addmod(
                mulmod(
              ...
              {
              // Constraint expression for ecdsa/signature0/exponentiate_key/copy_point/x: ecdsa__signature0__exponentiate_key__bit_neg_0 * (column8_row116 - column8_row52).
              let val := mulmod(
              ...
              {
              // Constraint expression for ecdsa/signature0/exponentiate_key/copy_point/y: ecdsa__signature0__exponentiate_key__bit_neg_0 * (column8_row76 - column8_row12).
              let val := mulmod(
                /*intermediate_value/ecdsa/signature0/exponentiate_key/bit_neg_0*/ mload(0x3040),
                addmod(/*column8_row76*/ mload(0x27c0), sub(PRIME, /*column8_row12*/ mload(0x2660)), PRIME),
                PRIME)
              ...
              {
              // Constraint expression for ecdsa/signature0/init_key/x: column8_row52 - ecdsa/sig_config.shift_point.x.
              let val := addmod(
                /*column8_row52*/ mload(0x2740),
                sub(PRIME, /*ecdsa/sig_config.shift_point.x*/ mload(0x3a0)),
                PRIME)
              ...
              {
              // Constraint expression for ecdsa/signature0/init_key/y: column8_row12 - ecdsa/sig_config.shift_point.y.
              let val := addmod(
              ...
              {
              // Constraint expression for ecdsa/signature0/add_results/slope: column8_row32706 - (column8_row16332 + column8_row32674 * (column8_row32642 - column8_row16372)).
              let val := addmod(
                /*column8_row32706*/ mload(0x2a20),
                sub(
                  PRIME,
                  addmod(
                    /*column8_row16332*/ mload(0x28e0),
                    mulmod(
                      /*column8_row32674*/ mload(0x2a00),
                      addmod(
                        /*column8_row32642*/ mload(0x29c0),
                        sub(PRIME, /*column8_row16372*/ mload(0x2940)),
                        PRIME),
                      PRIME),
                    PRIME)),
                PRIME)
              ...
              {
              // Constraint expression for ecdsa/signature0/add_results/x: column8_row32674 * column8_row32674 - (column8_row32642 + column8_row16372 + column8_row16388).
              let val := addmod(
                mulmod(/*column8_row32674*/ mload(0x2a00), /*column8_row32674*/ mload(0x2a00), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(/*column8_row32642*/ mload(0x29c0), /*column8_row16372*/ mload(0x2940), PRIME),
              ...
              {
              // Constraint expression for ecdsa/signature0/add_results/y: column8_row32706 + column8_row16420 - column8_row32674 * (column8_row32642 - column8_row16388).
              let val := addmod(
                addmod(/*column8_row32706*/ mload(0x2a20), /*column8_row16420*/ mload(0x29a0), PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column8_row32674*/ mload(0x2a00),
              ...
              {
              // Constraint expression for ecdsa/signature0/add_results/x_diff_inv: column8_row32658 * (column8_row32642 - column8_row16372) - 1.
              let val := addmod(
                mulmod(
              ...
              {
              // Constraint expression for ecdsa/signature0/extract_r/slope: column8_row32716 + ecdsa/sig_config.shift_point.y - column8_row16364 * (column8_row32756 - ecdsa/sig_config.shift_point.x).
              let val := addmod(
                addmod(
                  /*column8_row32716*/ mload(0x2a40),
                  /*ecdsa/sig_config.shift_point.y*/ mload(0x3c0),
                  PRIME),
                sub(
                  PRIME,
                  mulmod(
                    /*column8_row16364*/ mload(0x2920),
                    addmod(
              ...
              {
              // Constraint expression for ecdsa/signature0/extract_r/x: column8_row16364 * column8_row16364 - (column8_row32756 + ecdsa/sig_config.shift_point.x + column8_row28).
              let val := addmod(
                mulmod(/*column8_row16364*/ mload(0x2920), /*column8_row16364*/ mload(0x2920), PRIME),
                sub(
                  PRIME,
                  addmod(
                    addmod(
              ...
              {
              // Constraint expression for ecdsa/signature0/extract_r/x_diff_inv: column8_row32748 * (column8_row32756 - ecdsa/sig_config.shift_point.x) - 1.
              let val := addmod(
                mulmod(
                  /*column8_row32748*/ mload(0x2a60),
                  addmod(
                    /*column8_row32756*/ mload(0x2a80),
                    sub(PRIME, /*ecdsa/sig_config.shift_point.x*/ mload(0x3a0)),
                    PRIME),
              ...
              {
              // Constraint expression for ecdsa/signature0/z_nonzero: column8_row98 * column8_row16380 - 1.
              let val := addmod(
                mulmod(/*column8_row98*/ mload(0x2820), /*column8_row16380*/ mload(0x2960), PRIME),
                sub(PRIME, 1),
                PRIME)
              ...
              {
              // Constraint expression for ecdsa/signature0/r_and_w_nonzero: column8_row28 * column8_row16340 - 1.
              let val := addmod(
                mulmod(/*column8_row28*/ mload(0x26c0), /*column8_row16340*/ mload(0x2900), PRIME),
                sub(PRIME, 1),
                PRIME)
              ...
              {
              // Constraint expression for ecdsa/message_value0: column5_row16775 - column8_row98.
              let val := addmod(
                /*column5_row16775*/ mload(0x1ea0),
                sub(PRIME, /*column8_row98*/ mload(0x2820)),
                PRIME)
