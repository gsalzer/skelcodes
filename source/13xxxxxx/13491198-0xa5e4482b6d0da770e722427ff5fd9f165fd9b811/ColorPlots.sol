...
contract ColorPlots is ERC721Enumerable, Ownable, ERC721Burnable {
    ...
    uint256 public GENESIS_SALE_PRICE = 0; // will be set later
    uint256 public PUBLIC_SALE_PRICE = 0; // will be set later
    ...
    function mint(uint256 _count) public payable {
        ...
        require(_count <= MAX_BY_MINT, "2 max per tx");
    ...
    //Set price for Public Sale. Will also be used for Presale
    function setPublicPrice(uint256 amount) public onlyOwner {
        PUBLIC_SALE_PRICE = amount;
    }
