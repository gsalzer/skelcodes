...
contract EGGTOMATONS is ERC721Enumerable, Ownable, Payment, Guard {
	...
	//maxmint
	uint256 public maxMP = 10;
	uint256 public maxWL = 10;
	...
	require( s + _tokenAmount <= maxSupply - mintPassReserve, "Mint less");
	...
	require( _tokenAmount <= maxMP, "Mint less");
	require( s + _tokenAmount <= maxSupply - mintPassReserve, "Mint less");
	require(msg.value >= priceMP * _tokenAmount, "ETH input is wrong");
	delete b;
	for (uint256 i = 0; i < _tokenAmount ; ++i) {
