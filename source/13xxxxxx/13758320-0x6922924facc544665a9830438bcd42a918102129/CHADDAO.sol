...
/*
    ...
    oooooooo8 ooooo ooooo      o      ooooooooo   
    o888     88  888   888      888      888    88o 
    888          888ooo888     8  88     888    888 
    888o     oo  888   888    8oooo88    888    888 
    888oooo88  o888o o888o o88o  o888o o888ooo88          


    ChadDAO - Capital House Aggregated Dao

    The Chads managed investment fund
    Unleashing the untapped potential of chads and their alpha mindset.

    🌐 https://www.chaddaoeth.com/

    🗣 https://t.me/ChadDAOeth

    🐧 https://twitter.com/ChadDAOeth

    Treasury ✅

    Roadmap Q4 2021:
    DAO Platform (Claim profits)

    Tokenomics made by chads for chads:
    2% autoreflection after each transaction 
    5% autoadding liquidity to create a stable pricefloor
...
contract CHADDAO is Context, IERC20, Ownable {
    ...
    string private _name = "Capital House Aggregated Dao";
    string private _symbol = "ChadDAO";
