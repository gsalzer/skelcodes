...
contract FILST is ERC20,Poster{

    constructor(string memory name, string memory symbol) ERC20(name, symbol){

    }
    function mint(address account, uint256 amount) external onlyPoster{
        _mint(account, amount);
    }

    function burn(address account, uint256 amount) external onlyPoster{
