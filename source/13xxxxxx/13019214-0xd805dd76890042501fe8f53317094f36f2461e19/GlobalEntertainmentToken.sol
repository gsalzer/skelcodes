...
contract ERC20 is Context, IERC20 {
    ...
    constructor (string memory name, string memory symbol) public {
        ...
        _symbol = symbol;
        _decimals = 8;
        _motto = "You can't win unless you share";
    }
    ...
    /**
    * @dev Returns the motto in Turkish 
    */
    function motto() public view returns (string memory) {
        return _motto;
    }
...
contract GlobalEntertainmentToken is Ownable, ERC20Pausable, Blacklist {
    using SafeMath for uint256;
    
    uint256 constant totalFreeSupply = 100000000000000000;
    uint8 	constant numDecimals = 8;
    
    constructor() Ownable() ERC20('GlobalEntertainmentToken','GET') public
    {
