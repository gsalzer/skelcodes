...
contract Avocato is IERC20, Context, ERC20Ownable {
    ...
    string private constant _name = "AVOCATO";
    string private constant _symbol = "AVOCATO";
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if (_limitBuys == true) {
            require(amount <= 1000000000000 * 10**9);
        }
