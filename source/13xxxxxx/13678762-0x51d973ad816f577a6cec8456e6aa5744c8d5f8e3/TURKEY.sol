...
contract TURKEY is Context, IERC20, Ownable {
    ...
    string private constant _name = "Turkey Dinner Inu";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xfC0e625A05a8ee55d0e067E39BBBf74119B114ad);
        _feeAddrWallet2 = payable(0xf2DD4979886BC6e5930335a021Eb1d9f41E1Db40);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isBuy(from)) {
            // TAX SELLERS 40% WHO SELL WITHIN 24 HOURS
            if (_buyMap[from] != 0 &&
