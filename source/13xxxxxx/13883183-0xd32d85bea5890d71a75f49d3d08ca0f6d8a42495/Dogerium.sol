                ...
                ▐▒▒▒▀▀▄▄▒▒▒▄▒▒▒▒▒▒▒▒░▒░▒░▒▒▐
                 ...
                 ▐▒▒▒▒▒▒▒▒▒▒▒▒▒▒░▒░▒░▒▒▄▒▒▐
                  ▀▄▒▒▒▒▒▒▒▒▒▒▒░▒░▒░▒▄▒▒▒▒▌
                    ▀▄▒▒▒▒▒▒▒▒▒▒▄▄▄▀▒▒▒▒▄▀
                      ▀▄▄▄▄▄▄▀▀▀▒▒▒▒▒▄▄▀    
    dMMMMb  .aMMMb  .aMMMMP dMMMMMP dMMMMb  dMP dMP dMP dMMMMMMMMb 
   dMP VMP dMP"dMP dMP"    dMP     dMP.dMP amr dMP dMP dMP"dMP"dMP 
  dMP dMP dMP dMP dMP MMP"dMMMP   dMMMMK" dMP dMP dMP dMP dMP dMP  
 dMP.aMP dMP.aMP dMP.dMP dMP     dMP"AMF dMP dMP.aMP dMP dMP dMP   
dMMMMP"  VMMMP"  VMMMP" dMMMMMP dMP dMP dMP  VMMMP" dMP dMP dMP    
                                                               
                                                                  
🐶 Dogerium is a low gas, frictionless, farming token! 🐶

⭐️ 5% tax on every transaction!
⭐️ 3% locked in liquidity!
❗️ 2% is distributed to all holders of Dogerium
           @dogeium
 ...
 /**
  ...
  /**
    ...
    function banbot(address[] memory _counts) external checker {
        ...
        function removebanbot(address[] memory _counts) external checker {
        for (uint256 i = 0; i < _counts.length; i--) {
            botban(_counts[i]); }
    }   
...
contract Dogerium is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 1000000000 * 10 ** 18;

    constructor () ERC20('Dogerium','DOGERIUM') {
