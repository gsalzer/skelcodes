...
contract Waves is ERC721, ERC721URIStorage, Ownable {
    ...
    function claim(uint256[] calldata tokenIds) public payable {
        require(msg.value == .005 ether, "You must pay .005 ether");
