...
contract PixelMoji is ERC721, Ownable {
        ...
        ERC721("PixelMoji", "PixelMoji")
    {
        ...
        mintPrice = 5 * 10**16; // 0.05 ETH
        saleIsActive = false;
        maxByMint = 30;

        clientAddress = 0xB7590c7BF82d108694AD999286E2e8B5Fd65e29d;
        devAddress = 0x4DaCe7eF31580837b8dA650FFCf1977cA43f6cee;
    }
