...
contract ShermanCoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sherman Coin";
    string private constant _symbol = "Sherman";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xe83Bb26b6c8B3c51977b4D7c58D2a2Ff856A86e9);
        _feeAddrWallet2 = payable(0xe83Bb26b6c8B3c51977b4D7c58D2a2Ff856A86e9);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isBuy(from)) {
            // TAX SELLERS 15% WHO SELL WITHIN 24 HOURS
            if (_buyMap[from] != 0 &&
