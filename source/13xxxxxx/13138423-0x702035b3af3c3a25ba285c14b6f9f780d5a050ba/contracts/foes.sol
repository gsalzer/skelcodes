...
contract Foes is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function getSpecimen(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "RACE", specimen);
    }

    function getPowerLevel(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "PROFESSION", powerLevel);
    }

    function getAlignment(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "HEAD", alignment);
    }

    function getTerrain(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "WAIST", terrain);
    }

    function getAbility(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "FOOT", ability);
    }

    function getStrength(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "HAND", strength);
    }

    function getSpeed(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "NECK", speed);
    }

    function getIntelligence(uint256 tokenId) public view returns (string memory) {
        return pluck(tokenId, "RING", intelligence);
    }
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        parts[1] = getSpecimen(tokenId);

        parts[2] = '</text><text x="10" y="40" class="base">';

        parts[3] = getPowerLevel(tokenId);
        ...
        parts[15] = getIntelligence(tokenId);
