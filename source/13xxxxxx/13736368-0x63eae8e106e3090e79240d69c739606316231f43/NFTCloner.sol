...
contract NFTCloner {
  ...
  function cloneERC721(
    ...
    uint256 price) external {
      ...
      IERC721Clone(newClone).initialize(msg.sender, name, symbol, cap, maxPerTx, price);
  ...
  function cloneERC1155(
    ...
    string memory symbol
      ...
      IERC1155Clone(newClone).initialize(msg.sender, name, symbol);
