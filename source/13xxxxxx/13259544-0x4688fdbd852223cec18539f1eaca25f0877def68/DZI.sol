// DesertedZebras.com
// 40% to dev, 55% to artist, 5% to social media
...
contract DZI is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(
        address _devAddress
    ) ERC721("Deserted Zebra Island", "DZI") {
    ...
    function withdraw() public onlyOwner {
        ...
        payable(devAddress).transfer(balance.div(10).mul(4));
    }
