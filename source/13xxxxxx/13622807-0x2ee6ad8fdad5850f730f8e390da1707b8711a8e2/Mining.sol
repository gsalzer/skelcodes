...
contract TurboPool is StakingPool {
    ...
    function __TurboPool_init_unchained(uint turboMax_, uint turboSpan_) public virtual governance {
...
contract CompoundTurboPool is CompoundPoolStakedToken, TurboPool {
    ...
    function stakeTo(uint256 amount, address to) virtual override(CompoundPoolStakedToken, TurboPool) public {
        super.stakeTo(amount, to);
    }
