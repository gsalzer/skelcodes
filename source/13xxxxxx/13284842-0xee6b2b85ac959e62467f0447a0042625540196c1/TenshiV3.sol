...
contract TenshiV3 is Context, IERC20, Ownable {
    ...
    string private _name = 'Tenshi V3';
    ...
    uint256 private _numOfTokensToExchangeForKishu = 2500000000 * 10**9;
    ...
    function _setKishuFee(uint256 kishuFee) external onlyOwner() {
        require(kishuFee >= 1 && kishuFee <= 99, 'kishuFee should be in 1 - 99');
        _kishuFee = kishuFee;
    }
