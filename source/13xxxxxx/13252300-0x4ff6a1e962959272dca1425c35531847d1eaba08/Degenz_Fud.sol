...
contract Degenz_Fud is ERC721, Ownable {
    ...
    uint256 public immutable MAX_FUDZ;

    address public constant regenz = 0xAFd867667eC6D2Be5BdCd41D76Da7e96A1f67F18;

    bool public mintIsActive = false;

    mapping(uint256 => bool) public hasMintedFUDRegenzId;


    constructor(string memory name, string memory symbol, uint256 maxNftSupply) ERC721(name, symbol) {
        MAX_FUDZ = maxNftSupply;
    }
