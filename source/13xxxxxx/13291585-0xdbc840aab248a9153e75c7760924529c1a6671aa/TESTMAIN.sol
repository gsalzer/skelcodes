...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  //address public RVPToken = address(0x3B00Ef435fA4FcFF5C209a37d1f3dcff37c705aD);
...
contract TESTMAIN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable public marketingWallet = 0xc0372e3527C5fBebe6812f97fdDBB712a685A8c2;
    ...
    constructor() public ERC20("TESTMAIN", "TESTMAIN") {
        dividendTracker = new TESTMAINDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "TESTMAIN: The dividend tracker already has that address");

        TESTMAINDividendTracker newDividendTracker = TESTMAINDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "TESTMAIN: The new dividend tracker must be owned by the TESTMAIN token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "TESTMAIN: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "TESTMAIN: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "TESTMAIN: The UNISWAP pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "TESTMAIN: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "TESTMAIN: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "TESTMAIN: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "TESTMAIN: Cannot update gasForProcessing to same value");
...
contract TESTMAINDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public  DividendPayingToken("TESTMAIN_Dividend_Tracker", "TESTMAIN_Dividend_Tracker") {
        claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "TESTMAIN_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "TESTMAIN_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main TESTMAIN contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "TESTMAIN_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "TESTMAIN_Dividend_Tracker: Cannot update claimWait to same value");
