...
interface ILazyDelivery is IERC165 {
     ...
     * 
     *  @param caller         The address that triggered deliver
     ...
     *     However, even if this is the case, the caller can wrap its mint in a contract that checks 
     *     post mint completion and reverts if unsuccessful.
     *  2. Ensure that "caller" is not a contract address. This prevents a contract from doing the lazy 
