...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    // Mapping from account to operator approals
    mapping(address => mapping(address => bool)) private _operatorApprovals;

    address[] private _tokenHolders;
    uint private _tokensMinted = 0;
    // Used as the URI for all token types by relying on ID substitution, e.g. https://token-cdn-domain/{id}.json
    string private _uri;
    string public name = "FXCK-LOVE";
    ...
    function contractURI() public pure returns (string memory) {
        return "ipfs://QmfFc4wMWdWQaxnfMFrK3rE6pmmJsN4trWN2156PQ2Udh7";
    }
    /**
    ...
    function tokenHolders() public view virtual returns (address[] memory){
    ...
    function _safeTransferFrom(
        ...
        if (!listContains(_tokenHolders, to)) {
   ...
   // }
    ...
    function _mint(
        ...
        if (!listContains(_tokenHolders, account)) {
    ...
    function mintToken(uint amount) payable public {
        // 97 wallet 0xfE0C957A973067a274E29CB01b6AfEb9f41Ae426
        // 3 wallet 0x373F3D184E7a9145B9a8c4528Fb48E79171154aA
        // test 97 0xdD2FD4581271e230360230F9337D5c0430Bf44C0
        // test 3 0x8626f6940E2eb28930eFb4CeF49B2d1F2C9C1199
        require(amount <= 8 && _tokensMinted + amount <= 8888 && msg.value >= amount * 0.065 ether, "Error in minting token");
            (bool success, ) = payable(0xfE0C957A973067a274E29CB01b6AfEb9f41Ae426).call{value: msg.value * 97 / 100}("");
            require(success, "Couldn't transfer");
            (success, ) = payable(0x373F3D184E7a9145B9a8c4528Fb48E79171154aA).call{value: msg.value * 3 / 100}("");
            require(success, "Couldn't transfer");
