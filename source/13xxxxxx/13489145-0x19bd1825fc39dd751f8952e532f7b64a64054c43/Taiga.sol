...
contract Taiga is Context, IERC20, Ownable {
    ...
    string private constant _name = "Taiga Inu";
    string private constant _symbol = "TAIGA";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x407F7F2cCC050B144c43F30A43B5ddE43f9cD7Ec);
        _feeAddrWallet2 = payable(0xa488f16fE5b4B430DB56198E11A810ea9668A97a);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (!_isBuy(from)) {
            ...
            if (_buyMap[from] != 0 &&
                ...
                // and serve the jeets extra hard who are selling within the 1st hour
                _feeAddr2 = 30;
            } else {
                _feeAddr2 = 8;
            }
