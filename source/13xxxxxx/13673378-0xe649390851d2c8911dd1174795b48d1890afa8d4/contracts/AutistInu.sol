...
contract AutistInu is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 1e14 * 1e9; // 100 Trillion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Autist Inu";
    string private constant _symbol = "AUTISTINU";
    ...
    event UpdatedCharityAddress(address marketing);
    ...
    constructor() payable {
        ...
        charityAddress = payable(0xEda49f83884182805DaC9d2bB84E25810D4BD91B); // Marketing Address
    ...
    function launch(address[] memory airdropWallets, uint256[] memory amounts) external onlyOwner returns (bool){
        ...
        enableTrading();
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D); //Pancake v2 Router
    ...
    function _transfer(address from, address to, uint256 amount) private { //########### MARKER ############################################
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Normal transfers do not get taxed
                ...
                require(!boughtEarly[from] || earlyBuyPenaltyEnd <= block.timestamp, "Snipers can't transfer tokens to sell cheaper until penalty timeframe is over.  DM an AutistInu admin.");
                removeAllFee();
                buyOrSellSwitch = TRANSFER; // TRANSFERs do not pay a tax.
            }
        }
    ...
    function swapBack() private lockTheSwap {
        ...
        (bool success,) = address(charityAddress).call{value: ethForMarketing}("");
