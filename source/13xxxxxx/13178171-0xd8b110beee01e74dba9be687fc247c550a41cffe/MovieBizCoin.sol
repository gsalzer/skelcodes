...
/**
 * @title Movie Biz Coin 
 * @dev Token representing MBZ.
 */
 contract MovieBizCoin is  MintableToken{
     using SafeMath for uint256;
     
    uint public totalTokensAmount = 410000000;

    string public name = "MovieBizCoin";
