...
/**
 * @title AptCoin contract
 */
contract AptCoin is ERC20Capped, ERC20Detailed {
    uint noOfTokens = 8_800_000_000; // 8.8B

    // Address of apt coin vault
    // The vault will have all the apt coin issued.
    address internal vault;

    // Address of apt coin owner
    // The owner can change admin and vault address.
    address internal owner;

    // Address of apt coin admin
     ...
     *
     * The _from's apt balance should be larger than the reserved amount(reserves[_from]) plus _value.
     *
    ...
    function getOneAptCoin() public view returns (uint) {
