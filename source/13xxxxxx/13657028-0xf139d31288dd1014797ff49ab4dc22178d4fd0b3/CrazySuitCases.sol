...
contract CrazySuitCases is ERC721Pausable, PaymentSplitter, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    address[] _team = [ 0x5323C615A6581FfAE74D3a81Aaf2c60374965218, 0x1ea7350d6428AA2E6FcD1a979884794a3f484fB0 ];
    uint[] _shares = [ 90, 10 ];
    
    uint256 private constant _maxTokens = 10000;
    uint256 private constant _maxMint = 20;
    uint256 private constant _maxPresaleMint = 20;
    ...
    constructor() PaymentSplitter( _team, _shares ) ERC721("Crazy SuitCases", "CSC") {
        _pause();
    }
