...
// File contracts/TheCockWallaces.sol


pragma solidity ^0.8.0;


contract TheCockWallaces is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public _gifts = 50;
  uint256 public _price = 0.023 ether;
  uint256 public _supply = 10000;

  constructor(string memory baseURI) ERC721("The Cock Wallaces", "TCW") {
    setBaseURI(baseURI);
  }
  ...
  function mint(uint256 _amount) public payable {
    ...
    require( _amount < 70, "Provided amount exceeds mint limit.");
  ...
  function withdraw() public payable onlyOwner {
    uint256 _p1 = address(this).balance * 12 / 100;
    uint256 _p2 = address(this).balance - _p1;
