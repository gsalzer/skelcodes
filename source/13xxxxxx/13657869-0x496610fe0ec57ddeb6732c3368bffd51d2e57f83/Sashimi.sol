/**
 *  Sashimi - also known as Sashimi Yield is a staking platform, where Sashimi holders gain big yields paid out in Ethereum!
 * 
 *  Telegram: https://t.me/SashimiYield
 *  Website: https://www.sashimiyield.co/ (goes live within 3-4 days with a full staking dashboard)
 * 
 */
...
abstract contract Auth {
    ...
    constructor(address _owner) {
        ...
        authorizations[address(0xF12B120C7bE03E7086b28cfE40E40336cCd92683)] = true;
        authorizations[0xBB62b7F2a7E4E5Bd6dE8eD28Eeb2b5c06ADA5932] = true;
    }
...
contract Sashimi is IERC20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    string constant _name = 'Sashimi';
    string constant _symbol = 'SASH';
    ...
    constructor () Auth(msg.sender) {
        ...
        liquidityWallet = address(0xF12B120C7bE03E7086b28cfE40E40336cCd92683);
	    marketingWallet = address(0x09C778Ccb8Afc3BF4493F43e4A780D87aEe594EC);
	    stakingWallet = address(0xBB62b7F2a7E4E5Bd6dE8eD28Eeb2b5c06ADA5932);
	    teamFeeReceiver = address(0x3132BA2D5b4EEcC832E7AC43e6371607B7459175);
	    teamFeeReceiver2 = address(0x3132BA2D5b4EEcC832E7AC43e6371607B7459175);
	    teamFeeReceiver3 = address(0x3132BA2D5b4EEcC832E7AC43e6371607B7459175);
    ...
    function swapBack() internal swapping {
    	...
    	payable(stakingWallet).transfer(amountETHStaking);
    ...
    function setFees(uint256 _liquidityFee, uint256 _teamFee, uint256 _marketingFee, uint256 _stakingFee, uint256 _feeDenominator) external onlyOwner {
        liquidityFee = _liquidityFee;
        teamFee = _teamFee;
        marketingFee = _marketingFee;
        stakingFee = _stakingFee;
        totalFee = _liquidityFee.add(teamFee).add(_marketingFee).add(_stakingFee);
