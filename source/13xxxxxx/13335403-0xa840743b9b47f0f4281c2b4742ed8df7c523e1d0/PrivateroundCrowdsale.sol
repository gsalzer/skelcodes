...
contract PrivateroundCrowdsale is Ownable{
 // using SafeMath for uint256;
  ...
  //uint256 public unlockDate = 1630324800; //August 1 , 2021 . 12:00 PM
  ...
  address public PrivateRoundEquityHolder = 0x7Bdb94900F020850808221a068A946a2e262dFa0;
  ...
  function sendTokensBack(address addressToQuery) public onlyOwner
  {
    ...
    token.transfer(PrivateRoundEquityHolder, contractBalance);
  }
}
