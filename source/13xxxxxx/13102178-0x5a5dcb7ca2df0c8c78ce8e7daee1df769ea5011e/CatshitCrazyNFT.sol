...
contract CatshitCrazyNFT is ERC721, ERC721Enumerable,ERC721URIStorage, Ownable {
   using Counters for Counters.Counter;
    ...
    uint256 public _freemintStartDate = 1630018800;
    uint256 public _freemintStopDate = 1630062000;
    ...
    function getFreeMintableCount() public view returns(uint256) {
    ...
    function mintForPreOwners(uint8 _quantityToMint) public{
        ...
        require(getFreeMintableCount() >= _quantityToMint, "Not enough frens.");
