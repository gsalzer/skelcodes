...
// File @openzeppelin/contracts/access/IAccessControl.sol@v4.3.0
...
// File @openzeppelin/contracts/access/AccessControl.sol@v4.3.0
...
// File contracts/JuraToken.sol

contract JuraToken is ERC20, AccessControl {
    using SafeMath for uint256;
    bytes32 public constant OWNER_ROLE = keccak256("OWNER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    uint256 public maxSupply;

    constructor() ERC20("Jura Token", "JURA") {
        _setupRole(OWNER_ROLE, _msgSender());
        maxSupply = 20 * (10**24);
        _mint(_msgSender(), 2 * (10**24));
    }
    ...
    function remainMintable() public view returns (uint256) {
    ...
    function _mint(address account, uint256 amount) internal override {
        require(
            ...
            "remain mintable jura token is not enough"
        );
