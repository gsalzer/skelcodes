...
// File @openzeppelin/contracts/token/ERC721/extensions/ERC721Burnable.sol@v4.3.0
...
// File contracts/PunkRocks.sol

pragma solidity ^0.8.0;

contract PunkRocks is Ownable, ERC721Enumerable, ERC721Burnable, ReentrancyGuard {
    ...
    string public constant IPFS_METADATA_BASIC_URL = "ipfs://QmUwhcSWSM92ANsX2kQ3G4xBzpB4MDznoKKkwjHW7WWeN6";
    string private _baseTokenURI = IPFS_METADATA_BASIC_URL;

    address public constant DEV1 = 0xe74f008AB37F60f2F3f6be7aC6C64738Ea2301c1;
    address public constant DEV2 = 0x7fB97E6442667a9084F2F7D9258b025e8886fa85;
    mapping(uint256 => uint256) public listings; // id to price

    bool public opened;

    constructor() ERC721("PunkRocks", "PRK") {}
    ...
    function open() public onlyOwner {
        ...
        // Supporters
        _preMint(0x193c82adf4e514d443735710Fdc79F50DE6f58A0);
        ...
        _preMint(0x829DdDD599d751059668Ce17bfedFc2669B12b81);
        _preMint(0xe16c0E1Bf3B75F67E83C9e47B9c0Eb8Bf1B99CCd);
        _preMint(0x12075928bA81a22a13204b6d08714fD9241EfDB5);

        // 2 more for devs
        _preMint(DEV2);
        _preMint(DEV1);

        // 2 more for giveaways
        _preMint(DEV2);
        _preMint(DEV2);
    ...
    function listPunkRock(uint256 tokenId, uint256 price) public {
        require(msg.sender == ownerOf(tokenId), "Must own PunkRock to sell");
        require(price > 0);
    ...
    function delistPunkRock(uint256 tokenId) public {
        require(msg.sender == ownerOf(tokenId), "Must own PunkRock to delist");

        listings[tokenId] = 0;
        emit Delist(tokenId);
    }

    function buyPunkRock(uint256 tokenId) public payable nonReentrant {
        require(msg.sender != ownerOf(tokenId), "It's already your PunkRock bro");
        require(listings[tokenId] > 0, "PunkRock must be for sale to buy");
        require(msg.value >= listings[tokenId], "Must pay enough for PunkRock");
