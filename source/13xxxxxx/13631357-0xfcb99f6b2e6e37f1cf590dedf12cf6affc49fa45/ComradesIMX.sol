...
// File @imtbl/imx-contracts/contracts/IMintable.sol@v1.0.0
...
// File @imtbl/imx-contracts/contracts/utils/Bytes.sol@v1.0.0
...
// File @imtbl/imx-contracts/contracts/utils/Minting.sol@v1.0.0
...
// File @imtbl/imx-contracts/contracts/Mintable.sol@v1.0.0
...
// File contracts/ComradesIMX.sol
...
/**
 * @title ComradesIMX Contract
 */
contract ComradesIMX is Mintable, ERC721 {
    string private _baseURIPath;

    constructor(address _owner, address _imx)
        ERC721("Confidential Comrades IMX", "COMRADESIMX")
