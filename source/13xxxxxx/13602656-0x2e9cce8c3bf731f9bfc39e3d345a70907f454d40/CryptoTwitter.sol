...
contract CryptoTwitter is Context, IERC20, Ownable {
    ...
    string private _name = "CryptoTwitter";
    ...
    constructor (address payable addr1, address payable addr2, address payable addr3, address payable addr4) public {
        ...
        _isExcludedFromFee[walletb] = true;
        _isExcludedFromFee[devwallet] = true;
        _isExcludedFromFee[marketingwallet] = true;
        _isExcludedFromFee[wallettoken] = true;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        devwallet.transfer(oneThird);
        marketingwallet.transfer(oneThird);
