...
contract NGMI is Context, IERC20, Ownable {
    ...
    string private constant _name = "NotGonnaMakeIt";
    ...
    address payable private _opAddress = payable(0x473419382E9A7F1c8a22BaE3c2372D09ef435f8d);
    ...
    uint256 public _maxWalletSize = 5000000000000 * 10**9; //5
