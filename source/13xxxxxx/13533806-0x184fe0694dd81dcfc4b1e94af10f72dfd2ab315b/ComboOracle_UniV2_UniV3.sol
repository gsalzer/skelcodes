...
contract ComboOracle_UniV2_UniV3 is Owned {
    ...
    address public fxs_address = 0x3432B6A60D23Ca0dFCa7761B7ab56459D9C964D0;
    address public collateral_address = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48;

    // Oracle info
    ComboOracle public combo_oracle = ComboOracle(0xbdCB57c9d35e8D41babCBcA67416ee6622274caf);
    ...
    ISwapRouter public univ3_router = ISwapRouter(0xE592427A0AEce92De3Edee1F18E0157C05861564);
    ...
    function uniV2LPBasicInfo(address pair_address) public view returns (UniV2LPBasicInfo memory) {
        ...
        return UniV2LPBasicInfo(
            ...
            the_pair.token1(),
            missing_decimals,
            missing_decimals_multiplier,
            reserve0,
            reserve1,
            the_pair.totalSupply()
        );
    }
