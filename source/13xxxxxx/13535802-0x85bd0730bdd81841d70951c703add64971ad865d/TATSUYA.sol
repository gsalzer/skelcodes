...
contract TATSUYA is Context, IERC20, Ownable {
    ...
    string private _name = "Tatsuya Shiba";
    string private _symbol = "TATSUYA";
    ...
    address public marketing = 0x6583D7e74C542c05a6484977D74a10A2e3bEf31F;
    ...
    uint256 public _maxBalAmount = _tTotal.mul(6).div(1000);
