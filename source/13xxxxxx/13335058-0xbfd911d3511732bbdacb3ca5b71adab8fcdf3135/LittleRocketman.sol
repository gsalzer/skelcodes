...
// File contracts/LittleRocketMan.sol

pragma solidity ^0.8.0;

/**
 * @title LittleRocketman contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract LittleRocketman is ERC721Enumerable, Ownable {
    using SafeMath for uint256;

    uint256 public ethPrice = 80000000000000000; // 0.08 ETH
    uint256 public maxPurchase = 25;
    uint256 public maxSupply = 9999;
    uint256 public maxReserved = 99;
    ...
    constructor() ERC721("LittleRocketman", "LRM") { }
