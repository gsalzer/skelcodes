...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a McDAO shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract McDAOnalds is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "McDAOnalds";
    string private constant _symbol = "McDAO";
    ...
    address payable public marketingWallet = payable(0x43747147A2Fb9a8A61E341c0744Da33562c0bA5B);
    address payable public treasury = payable(0x43747147A2Fb9a8A61E341c0744Da33562c0bA5B);
    ...
    constructor (    ) Auth(0xD841d3DdF80754b8b09570A64F399E0484BEb448) {
        address _owner = 0xD841d3DdF80754b8b09570A64F399E0484BEb448;
