...
/**
 * @title ArtTradablePrivate
 * ArtTradablePrivate - ERC1155 contract that whitelists an operator address, 
    ...
    Ownable
{
    ...
    {
        // Whitelist  marketplace, bundle marketplace contracts for easy trading.
