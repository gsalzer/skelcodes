...
contract cryptocorn is Ownable, ERC721 {
    uint constant tokenPrice = 0.03 ether;
    uint constant presalePrice = 0.02 ether;
    uint constant maxSupply = 5000;
    uint constant presaleSupply = 200;
    uint public totalSupply = 0;
    uint private price_to_pay=tokenPrice;
    uint public sale_startTime = 1636992000;
    uint public presale_startTime = 1635696000;
    bool public pause_sale = false;
     bool public pause_presale = false;

    string public baseURI;

    constructor() ERC721("cryptocorn", "corn"){}
   ...
   function buy() public payable{
       ...
       function presale() public payable{
        ...
        require(totalSupply + 1 <= presaleSupply, "Not enough tokens left");
        require(msg.value == presalePrice, "incorrect ether amount");
    ...
    function setPauseSale(bool temp) external onlyOwner {
     ...
     function setPause_preSale(bool temp) external onlyOwner {
        pause_presale = temp;
    }
