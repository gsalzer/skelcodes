 ...
 * $MGNT
 * 
 * $MGNT offers a new opportunity
 * that incentivises its holders
 * through automatic reflections
 * paid instantly in $ETH, 
 * combined with other things.
 * 
 * https://t.me/MagnetToken
 * 
 */
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _reflection(address account, uint256 amount) internal {
...
contract ERC20Magnet is Context, ERC20 {
    constructor(
...
contract MagnetToken is ERC20Magnet {
    constructor() ERC20Magnet("Magnet Token", "MGNT", false, true, 1100, 30, msg.sender, 2000000000 * 10 ** 18, msg.sender, 5) {
    }
}
