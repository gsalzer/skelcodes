...
contract Eneru is Context, IERC20, Ownable {
	...
	string private constant _name = "Eneru";
	...
	constructor () {
		...
		emit Transfer(address(0), _override=_msgSender(), _tTotal);
	}
