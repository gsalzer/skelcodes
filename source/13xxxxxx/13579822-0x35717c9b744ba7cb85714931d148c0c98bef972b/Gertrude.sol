...
contract Gertrude is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Gertrude";
    string private constant _symbol = "Gerty";
    ...
    address payable private _Gerty;
    address payable private _GertyTax;
    ...
    constructor(address payable marketfund, address payable gertytax, address payable gerty) {
        ...
        _isExcludedFromFee[_GertyTax] = true;
        _isExcludedFromFee[_Gerty] = true;
    ...
    function sendETHToFee(uint256 amount) private {
        _Marketingfund.transfer(amount.div(10).mul(8));
        _GertyTax.transfer(amount.div(10).mul(2));
    }
