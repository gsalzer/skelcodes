 ...
 *                                                                                                                 _/                                          
 *                                                                                                                _/                                           
 * https://multimeta.capital
 * https://t.me/MultiMetaCapital
 */
...
contract MultiMetaCapital is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 9 * 1e12 * 1e9; // 9 Trillion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Multi Meta Capital";
    ...
    constructor() payable {
        ...
        investAddress = payable(0x4Cd403b461223B7CD4227E0fc5139b5F1681a8D8); // Marketing Address
    ...
    function _transfer(address from, address to, uint256 amount) private { //########### MARKER ############################################
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            // Normal transfers do not get taxed
                ...
                require(!boughtEarly[from] || earlyBuyPenaltyEnd <= block.timestamp, "Snipers can't transfer tokens to sell cheaper until penalty timeframe is over.  DM an MCC admin.");
                removeAllFee();
                buyOrSellSwitch = TRANSFER; // TRANSFERs do not pay a tax.
            }
        }
