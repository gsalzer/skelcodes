...
// Mint via contract or website @ www.chibikaijus.com 

// 0.08 ETH - 3333 SUPPLY
...
contract ChibiKaiju is ERC721, Ownable {
    using Strings for uint256;
    ...
    event CreateChibiKaiju(uint256 indexed id);

    constructor() ERC721("ChibiKaiju", "CBK") {}
    ...
    function setRoyalties(address _address) public onlyOwner {
