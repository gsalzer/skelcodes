...
/** 
 * Top Dog - $TOPDOG
 * Website: https://topdogmeta.com/
 * TG: https://t.me/topdogmeta
 * Twitter: https://twitter.com/topdog_meta
 * 
 * 
...
contract TopDog is Context, IERC20, Ownable {
    ...
    string private constant _name = "Top Dog";
    string private constant _symbol = "TOPDOG";
    ...
    address payable private _marketingAddress = payable(0x4bB17d2Bfb129a73f6FfccBAE50Cb12e3058e76A);
    ...
    uint256 public _swapTokensAtAmount = 0 * 10**9; //0%
