/*
        ...
        Telegram: https://t.me/GuiltyMaxwell
...
contract GuiltyMaxwell is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xb4Fc1e8950C3bE84B1BB4a2C1D9d6e2658338Fa6);    
    address payable public teamAddress = payable(0xb4Fc1e8950C3bE84B1BB4a2C1D9d6e2658338Fa6);   
    address payable private ownerAddress = payable(0xb4Fc1e8950C3bE84B1BB4a2C1D9d6e2658338Fa6);    
    ...
    string private constant _name = "Guilty Maxwell";
    string private constant _symbol = "Guilty Maxwell";
