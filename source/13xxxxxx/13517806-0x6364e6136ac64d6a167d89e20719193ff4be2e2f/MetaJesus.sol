...
contract MetaJesus is ERC721, ERC721Enumerable, Pausable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint256 public mintRate = 0.05 ether;
    uint256 public MAX_SUPPLY = 183;

    constructor() ERC721("Meta Jesus", "JESUS") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://inwiththeold.art/api/tmj/tokens/";
    }
    ...
    function safeMint(address to) public payable {
        require(totalSupply() < MAX_SUPPLY, "Tokens sold out! Buy on Opensea");
