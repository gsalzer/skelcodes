...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a GM shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract GoodMongoose is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address payable public marketingWallet = payable(0x86b97837974d7269A5715Ec3cA4272cb657d52dC);
    address payable public treasury = payable(0x86b97837974d7269A5715Ec3cA4272cb657d52dC);
    ...
    constructor (    ) Auth(0x9b8b3f32CE08908e1F06a620f5050b5a85Ba9573) {
        address _owner = 0x9b8b3f32CE08908e1F06a620f5050b5a85Ba9573;
