...
contract Chameleon is IERC721, Ownable, Functional {
     ...
     */
    constructor() {
        _name = "Chameleon Collective";
        _symbol = "CCNFT";
        _baseURI = "https://chameleoncollective.io/metadata/";
        _hideTokens = true;
        
        totalTokens = 10000; // 0-9999
        price = 45 * (10 ** 15); // Replace leading value with price in finney
        whitelistPrice = 40 * (10 ** 15);
        discountPrice = 35 * (10 ** 15);
        maxPerWallet = 100;
        whitelistMax = 100;
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return  interfaceId == type(IERC721).interfaceId ||
                ...
                interfaceId == Chameleon.onERC721Received.selector;
    }
    ...
    // Improved Withdraw function that implements approved wallets
    /*
    ...
    */
    ...
    function discountMint(uint256 qty) external payable reentryLock {
        ...
        require(checkForDiscount(_msgSender()), "Discount Not Active"); //check for holders
        ...
        uint256 cashChange = cashIn - (qty * discountPrice);
    ...
    function mint(uint256 qty) external payable reentryLock {
        ...
        if(!mintActive){
            ...
            require((_tokensMintedby[_msgSender()] + qty) <= whitelistMax, "Mint: Cannot mint more at this time");
