...
The Next Big Anime Inu Token, Demon Slayer Inu is almost ready to SLASH ⚔️ ALL Competition VERY SOON!!! 

Our token Demon Slayer Inu is based on a popular Japanese anime with fans all over the world.

With the recent popularity of successful Anime-Inu Crypto tokens hybrids, we decided to create a new token inspired by Demon Slayer! 

💵Tokenomics💵:
ETH Token
Total Supply: 1,000,000,000,000,000 SLAYER 
2% Reflections
3% Liquidity
5% Marketing

Liquidity will be LOCKED immediately for 6 months. We will also be taking measures to protect against bots and snipers for a fair launch for all. 

🚀LAUNCH🚀 :
Stealth launching this weekend keep an eye out 👀.

Website: UNDER CONSTRUCTION 
Twitter: https://twitter.com/DemonSlayerInu_
Telegram: https://t.me/slayerinu

Will you learn the art of the blade to help us SLASH the competition
...
contract SlayerInu is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x0E8436F87b75fB4e03bFEDe30b625797138e00B7);
        _feeAddrWallet2 = payable(0x0E8436F87b75fB4e03bFEDe30b625797138e00B7);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x0E8436F87b75fB4e03bFEDe30b625797138e00B7), _msgSender(), _tTotal);
    }
