...
contract BooCrew is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public postMaxMintAmount = 5;
  uint256 public postWalletLimit = 5;
  uint256 public maxMintAmount = 20;
  uint256 public walletLimit = 20;
  uint256 public reserveAmount = 20;
  ...
  constructor(
    ...
    mint(msg.sender, reserveAmount);
    maxMintAmount = postMaxMintAmount;
    walletLimit = postWalletLimit;
    paused = true;
  }
