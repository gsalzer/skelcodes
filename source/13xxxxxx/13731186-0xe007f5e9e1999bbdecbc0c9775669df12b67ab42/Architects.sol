...
contract Architects is ERC721Enumerable, Ownable {
    ...
    modifier saleIsOpen {
        require(totalSupply() <= MAX_ArchitectSUPPLY, "Achitects have been fully constructed.");
        _;
    }

    modifier onlyAuthorized() {
        require(lightAddress == msg.sender || owner() == msg.sender);
        _;
    }

    function setMaximumAllowedTokens(uint256 _count) public onlyAuthorized {
        maximumAllowedArchitectsPerPurchase = _count;
    }
    ...
    function getMaximumAllowedArchitects() public view onlyAuthorized returns (uint256) {
        return maximumAllowedArchitectsPerPurchase;
    }
    ...
    function reserveNft() public onlyAuthorized {
        require(reservedCount <= maxReserveCount, "Max Architects Reserved!");
    ...
    function mint(address _to, uint256 _count) public payable saleIsOpen {
        ...
        require(totalSupply() + _count <= MAX_ArchitectSUPPLY, "Total Architects supply has been exceeded.");
  ...
  function withdraw() external onlyAuthorized {
    ...
    payable(lightAddress).transfer(balance * 1500 / 10000);
    payable(architectureAddress).transfer(balance * 7000 / 10000);
    payable(avatarAddress).transfer(balance * 1400 / 10000);
