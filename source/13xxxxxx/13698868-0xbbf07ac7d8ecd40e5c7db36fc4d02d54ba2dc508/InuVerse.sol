...
contract InuVerse is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "InuVerse";                                           // name
    string private _symbol = "IVSE";                                            // symbol
    ...
    address payable public marketingWallet = payable(0xbE9Ae36f945F29eECf655B02FfB37fF6c9220896);
