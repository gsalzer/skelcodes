...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a Katana shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract Katana is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant _symbol = "Katana";
    ...
    address payable public marketingWallet = payable(0x5Acd86BCFe1b2DFFc125F7F6062C6EEd7f743073);
    address payable public treasury = payable(0xf1FC2ADAbF3a0c97717817a228F32B2506e6fC02);
    ...
    uint256 private maxBuy = 15000000000 * (10 ** _decimals);
    ...
    constructor (    ) Auth(0xE6267752eF42FE2844204F83eFF368114C157EC1) {
        address _owner = 0xE6267752eF42FE2844204F83eFF368114C157EC1;
