...
// hevm: flattened sources of src/PhononToken.sol
 ...
 */
contract PhononToken is ERC20, ERC20Permit, ERC20Votes, Ownable {
    ...
    constructor(
        ...
        ERC20("Phonon DAO", "PHONON")
        ERC20Permit("Phonon DAO")
    {
    ...
    function mint(address dest, uint256 amount) external onlyOwner {
        require(amount <= (totalSupply() * mintCap) / 10000, "PHONON: Mint exceeds maximum amount");
        require(block.timestamp >= nextMint, "PHONON: Cannot mint yet");
