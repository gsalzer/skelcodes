...
abstract contract Context {
    ...
    address msgSender = 0x3eDDb12271A76016793f178891EB36811b18ef01;
...
contract NFCards is ERC721, ERC721Enumerable, Ownable {

    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private _tokenIdCounter;
    uint256 private constant tokenPrice = 50000000000000000; // 0.05 ETH
    uint private constant maxTokenPurchase = 10;
    uint256 public maxSupply = 2652;
    ...
    address private constant airdrop1 = 0xBc17F01f35f316D985054D69b8b607C99E8c2365;
    address private constant airdrop2 = 0xf0321C9bf4ED5821eA2d35317e20b1Ee11dC2F31;
    address private constant airdrop3 = 0x96CB72711e7950E71c5CE2026fd5191E6F29DdA7;
    address private constant airdrop4 = 0x8FdA0Ae3F9D91e95f60A631eAE417615c6EAE130;

    address private constant devAddress = 0xCf1d544C1827F653652e34beCf748bBEE58BC1E2;

    
    constructor(string memory baseURI, string memory _notrevealURI) ERC721("NFCards", "NFC") { 
    ...
    function numAvailableToFreeMint(address addr) external view returns (uint8) {
    ...
    function mintAirDrop() external onlyOwner {
        for(uint i = 0; i < 3; i++) {    
            internalMint(airdrop1);
        }
         for(uint i = 0; i < 2; i++) {    
            internalMint(airdrop2);
        }
        internalMint(airdrop3);
        internalMint(airdrop4);
    }

    function withdraw() public onlyOwner soldOut {
