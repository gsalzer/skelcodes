/**
 *Original FlokiPunks NFT collection
 * FlokiPunks
 * t.me/FlokiPunks
 * www.flokipunks.live
 * Will be randomized and revealed after mint ! That makes your FlokiPunk even more special !
*/
...
contract FlokiPunks is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721('Floki Punks', 'FlokiPunks') {}
    ...
    function mintFlokiPunks(uint numberOfTokens) public payable {
