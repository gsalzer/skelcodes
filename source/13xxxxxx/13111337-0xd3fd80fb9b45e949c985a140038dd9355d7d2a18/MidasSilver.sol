...
Midas Silver Socials:
Telegram: t.me/midasreflect
Twitter: twitter.com/midasreflect
Website: https://midasreflect.com
Whitepaper: https://midasreflect.com/whitepaper

** Secured With FTPAntibot **
** Using FTPEthReflect to give 10.00% of ALL transactions to holders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xF5aF15E11460cC56890DdE8F2188E15D44aE9930), 4000);
        m_DidDeploy = true;
    }
...
contract MidasSilver is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 7500000000 * 10**9;
    string private m_Name = "Midas Silver";
    string private m_Symbol = "MSVR";
    ...
    function _walletCapped(address _recipient) private view returns (bool) {
        return _recipient != m_UniswapV2Pair && _recipient != address(m_UniswapV2Router) && block.timestamp <= m_Launched.add(176 hours);
    }
