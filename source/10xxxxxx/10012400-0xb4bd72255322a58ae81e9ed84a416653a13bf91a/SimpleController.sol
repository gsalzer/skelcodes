...
// File: contracts\assettoken\SimpleController.sol
...
/** @title mocked controller for tests. */
contract SimpleController is Ownable, ICRWDControllerTransfer {
    ...
    function transferParticipantsVerification(
    ...
    function addToWhitelist(address _wallet) public onlyOwner {
        ...
        emit WalletWhitelisted(_wallet, whitelisted[_wallet]);
    }
    ...
    function checkWhitelisted(address _wallet) public returns (bool) {
