...
contract KimbapMigrator {
    ...
    function migrate(address account, uint256 amount) internal {
        ...
        uint256 newAmount = amount.div(17); //New KIMBAP emission is 50 tokens per block (So new:old ratio is 1:20). This gives the early supporters a slight bonus.
        newToken.transfer(account, newAmount);
        totalMigrated = totalMigrated.add(newAmount);
    }
