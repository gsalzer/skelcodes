...
contract VNTToken is ERC777Pausable, Ownable {
    string constant NAME    = 'InventoryClub Token';
    string constant SYMBOL  = 'VNT';
    //uint8 constant  DECIMALS= 18;   //Required by ERC777

    constructor(address[] memory defaultOperators, uint256 totalSupply) ERC777(NAME, SYMBOL, defaultOperators) public {
