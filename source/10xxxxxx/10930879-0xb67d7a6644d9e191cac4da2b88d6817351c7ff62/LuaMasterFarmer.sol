...
// File: contracts/LuaMasterFarmer.sol
...
contract LuaMasterFarmer is Ownable {
    ...
    // Deposit LP tokens to LuaMasterFarmer for LUA allocation.
    ...
    // Safe lua transfer function, just in case if rounding error causes pool to not have enough LUAs.
