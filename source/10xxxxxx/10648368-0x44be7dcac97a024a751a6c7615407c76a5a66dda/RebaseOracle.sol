...
contract RebaseOracle is Ownable {
    ...
    uint256 public timeBetweenRebases = 1 minutes;
    ...
    // Only owner operated manual rebasing
    ...
    // Allows anyone to call the rebase function
    ...
    // Transfers the rebase token to a new owner
    function transferTokenOwnership(address newOwner) public onlyOwner {
        token.transferOwnership(newOwner);
    }
    
    // Syncs the exchange rate and rebase to the current transaction state
