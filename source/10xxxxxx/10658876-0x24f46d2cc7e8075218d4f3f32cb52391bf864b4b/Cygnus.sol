...
abstract contract StakeCygnusToken {
    ...
    function updateStakes(address staker, uint256 balance, uint256 totalSupply) external virtual returns (uint256);
}



contract Cygnus is Ownable, IERC20 {
    ...
    string public constant _name = "Cygnus";
    string public constant _symbol = "CYGN";
    uint8 public constant _decimals = 18;
    
    StakeCygnusToken public _stakingContract;
    ...
    function updateMyStakes() public {
        ...
        try _stakingContract.updateStakes(msg.sender, _balances[msg.sender], _totalSupply) returns (uint256 numTokens) {
    ...
    function updateStakingContract(StakeCygnusToken stakingContract) external onlyOwner {
