...
contract Governance is GovernanceStorage, MGovernance {
    ...
    */
    ...
    /*
      ...
      This may be a problem in an upgrade situatoin, in a case that the upgrade-to impelementation
    ...
    */
        ...
        internal
    {
        string memory tag = getGovernanceTag();
        GovernanceInfoStruct storage gub = governanceInfo[tag];
        // TODO(Remo,01/09/2020): Consider un-commenting lines below.
        // if (gub.initialized == false) {
        //     return;
        // }
