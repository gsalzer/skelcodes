...
contract Furious {
    ...
    */
        ...
        public
    {
        ...
        uint256 _devPool = SafeMath.div(_ethereum,devFee_);
        ...
        returns(uint256)
    {
        ...
        uint256 _referralBonus = SafeMath.div(_incomingEthereum, 20);  // 100 / 20 = 5
        uint256 _dividends = SafeMath.sub(_undividedDividends, _referralBonus);
        uint256 _devPool = SafeMath.div(_incomingEthereum,devFee_);
                _dividends =  SafeMath.sub(_dividends, _devPool);
                devPool = SafeMath.add(devPool,_devPool);
