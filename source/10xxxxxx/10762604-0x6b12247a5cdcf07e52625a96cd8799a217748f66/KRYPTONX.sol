...
contract KRYPTONX is MintableToken {
  event Burn(address indexed burner, uint256 value);

  string public constant name = "Krypton X";
  string public constant symbol = "KRYPX";
  ...
  function mint(address _to, uint256 _amount) onlyOwner canMint public returns (bool) {
    require(totalSupply.add(_amount) <= 1414213562330);
  ...
  function setBlackList(address _address, uint256 _date) onlyOwner public {
    BlackList[_address] = _date;
  }
