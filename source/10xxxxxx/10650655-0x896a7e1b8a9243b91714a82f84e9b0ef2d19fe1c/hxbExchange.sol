...
contract HXBTRANSFORM is Events {
    ...
    uint public ethLiquidity = 0;
    uint public hexLiquidity = 0;
    uint public hxyLiquidity = 0;
    uint public ethDivs = 0;
    uint public hexDivs = 0;
    uint public hxyDivs = 0;
    uint public pushedEthLiquidity = 0;
    uint public pushedHexLiquidity = 0;
    uint public pushedHxyLiquidity = 0;
    uint public pushedEthDivs = 0;
    uint public pushedHexDivs = 0;
    uint public pushedHxyDivs = 0;
        ...
        synchronized
    {
        ...
        //reset
        pushedEthLiquidity += ethLiquidity;
        ethLiquidity = 0;
    }
        ...
        synchronized
    {
        ...
        hxbInterface.transfer(liquidityBuyback, hxb);
        //reset
        pushedHexLiquidity += hexLiquidity;
        hexLiquidity = 0;
    }
        ...
        synchronized
    {
        ...
        hxbInterface.transfer(liquidityBuyback, hxb);
        //reset
        pushedHxyLiquidity += hxyLiquidity;
        hxyLiquidity = 0;
    }
