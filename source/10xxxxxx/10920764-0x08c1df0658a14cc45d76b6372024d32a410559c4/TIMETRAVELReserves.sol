...
contract TIMETRAVELReserves {

    // Token that serves as a reserve for TIMETRAVEL
        ...
        onlyGov
    {
        ...
        TIMETRAVELTokenInterface(timetravelAddress).decreaseAllowance(oldRebaser, uint256(-1));
        rebaser = rebaser_;
        TIMETRAVELTokenInterface(timetravelAddress).approve(rebaser_, uint256(-1));
