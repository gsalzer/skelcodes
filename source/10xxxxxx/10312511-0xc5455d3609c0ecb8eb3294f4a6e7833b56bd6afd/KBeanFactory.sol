...
// File: openzeppelin-solidity\contracts\token\ERC20\ERC20Capped.sol
...
contract KBeanERC20 is ERC20Capped {
    ...
    /// @dev Custom KBean ERC20 Token.
    /// @param name String for token name.
    /// @param symbol String for token symbol.
    /// @param artUri String for artwork original location. This uri is also the unique identifier of the token.
    /// @param artHash String for artwork original hash.
    /// @param licenseUri String for kbean license terms page.
    /// @param cap uint. Total capacity of this token definition.
...
// File: contracts\KBeanFactory.sol
...
contract KBeanFactory {
    ...
    /// keep a mapping of deployed token address against the unique artwork uri.
    ...
    /// @param artUri String unique uri identifier of the token
