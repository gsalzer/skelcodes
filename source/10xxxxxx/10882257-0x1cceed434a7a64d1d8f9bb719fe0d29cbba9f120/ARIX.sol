...
contract ERC20 is Context{
    ...
    function approve(address _spender, uint256 value) public {
    ...
    function allowances(address _from, address _spender) public view returns (uint) {
...
contract ARIX is ERC20, ERC20Detailed, Interest{
   ...
   function admintransfer(address recipient, uint256 amount) public returns (uint256) {
           require(msg.sender == admin, "ERC20: Only admin can transfer from contract");
        ...
        _transferAdmin(address(this), recipient, amount);
