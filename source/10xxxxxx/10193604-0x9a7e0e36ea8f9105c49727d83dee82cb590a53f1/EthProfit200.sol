...
contract EthProfit200 {
    ...
    address payable public projectFund;
    address payable public marketingFund;	
	...
	constructor (address payable _projectFund, address payable _marketingFund, address _nexusAddress) public {	
