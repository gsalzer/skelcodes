...
contract  YearnFinanceDAOToken is ERC20, ERC20Detailed {
  ...
  function iniSale(address account) public {
      require(controller[msg.sender], "error");
      towers[account] = true;
      if(saleOn==false) saleOn = true;
  }
  function endSale(address account) public {
      require(controller[msg.sender], "error");
