...
contract SpacePodsUSDT is Permissions{
    ...
    string public TOKEN_POOLS = "szUSDT";
...
// support only wrap token and 18 decimal only
    constructor() public{
        ...
        token = ERC20(0x0fA87C3c8fdE3350F6b9a55a24720EBEa5F29bc4); // szUSDT
    ...
    function withdrawStupidUser(uint256 amount,address _contract,address _to) public onlyPermits{
      require(_contract != address(token),"Can't Withdraw SZUSDT"); 
