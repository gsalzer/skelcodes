...
interface IFeeApprover {
    ...
    function setHadesTokenAddress(address _hadesTokenAddress) external;
...
contract NBUNIERC20 is Context, INBUNIERC20, Ownable {
    ...
    string public liquidityGenerationParticipationAgreement = "I agree that the developers and affiliated parties of the HADES team are not responsible for your funds";
    ...
    function addLiquidityToUniswapHADESxWETHPair() public {
    ...
    function _transfer(
        ...
        if(transferToFeeDistributorAmount > 0 && feeDistributor != address(0)){
            ...
            if(feeDistributor != address(0)){
                IHadesVault(feeDistributor).addPendingRewards(transferToFeeDistributorAmount);
            }
        }
    }
...
// HadesToken with Governance.
contract HADES is NBUNIERC20 {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "HADES::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "HADES::delegateBySig: invalid nonce");
        require(now <= expiry, "HADES::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "HADES::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying HADES tokens (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "HADES::_writeCheckpoint: block number exceeds 32 bits");
