...
contract Offer {
  ...
  function getLine6Users(address[] memory users) internal view returns(address[] memory) {
  ...
  function getEachLevelUsers(address[] memory users, uint limit) internal view returns(address[] memory) {
