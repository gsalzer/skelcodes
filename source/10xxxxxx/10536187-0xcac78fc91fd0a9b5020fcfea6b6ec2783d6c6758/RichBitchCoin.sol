...
contract RichBitchCoin {
    ...
    function add(
        ...
        bool newArrival = isNewArrival(investor);
    ...
    function hasReferrer(address a) public view returns (bool) {
        address referrer = referrers[a];
        return referrer != address(0) && isInvestor(referrer);
    }

    function isNewArrival(address a) public view returns (bool) {
