...
contract Trader2 {
    ...
    function getKyberSellPrice(string tokenName) constant returns (uint256) {
        return orfeed.getExchangeRate("ETH", tokenName, "SELL-KYBER-EXCHANGE", 1000000000000000000);
    }

    function getUniswapSellPrice(string tokenName) constant returns (uint256) {
        return orfeed.getExchangeRate("ETH", tokenName, "SELL-UNISWAP-EXCHANGE", 1000000000000000000);
    }
