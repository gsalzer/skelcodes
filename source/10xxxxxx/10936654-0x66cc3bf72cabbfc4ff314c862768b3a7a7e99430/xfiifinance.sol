...
contract xfiifinance is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "XFII.finance";
  string constant tokenSymbol = "XFII";
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    emit Transfer(msg.sender, 0x9Ab2b1e91163426C500B594D208aF49736baD06f, tokensToBurn);
    return true;
  }
