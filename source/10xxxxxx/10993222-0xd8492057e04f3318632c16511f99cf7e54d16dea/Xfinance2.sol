...
/*****************************************************************************
 * @title Xfinance v2
 * @dev Xfinance v2 is an ERC20 implementation of the Xfinance v2 ecosystem token. 
...
contract Xfinance2 is Ownable, ERC20Pausable {
    string public constant name = "Xfinance v2";
    string public constant symbol = "XFII";
    uint8 public constant decimals = 18;

    uint256 public constant initialSupply = 50000*10**uint256(decimals);
