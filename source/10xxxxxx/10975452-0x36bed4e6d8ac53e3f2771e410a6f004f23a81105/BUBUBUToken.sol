...
contract  BUBUBUToken is ERC20Detailed {
  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "bububu.finance";
  string constant tokenSymbol = "BUBUBU";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 24000000000000000000000; //240k
