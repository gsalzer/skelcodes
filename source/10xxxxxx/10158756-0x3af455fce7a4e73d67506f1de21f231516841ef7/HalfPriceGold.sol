...
// File: contracts\HalfPriceGold.sol

pragma solidity ^0.5.0;


contract HalfPriceGold is IndividualLockableToken {
	using SafeMath for uint256;

	string public constant name     = "Half Price Gold";
	string public constant symbol   = "HAPG";
