...
// File: contracts/InvictusToken.sol
...
/**
 * Contract for standard Invictus tokens such as the Invictus Bitcoin Alpha (IBA) fund.
 *
 */
contract InvictusToken is Initializable, ERC20Detailed, ERC20Burnable, Ownable, Pausable, MinterRole {
     ...
     * @param decimals The number of decimals used to get its user representation, typically 18.
     */
