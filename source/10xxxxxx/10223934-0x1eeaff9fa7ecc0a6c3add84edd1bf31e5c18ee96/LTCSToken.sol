...
/**
 * @title Ownable
 * @dev The Ownable contract has an owner address, and provides ltcs authorization control
...
contract ERC20 is IERC20, Blacklist, Pausable {
    ...
    */
    function transfer(address to, uint256 value) public whenNotPaused returns (bool) {
        ...
        require(!frozenAccount[msg.sender], "Is in Blacklist");
        require(!frozenAccount[to], "Is in Blacklist");
    ...
    */
    function transferFrom(address from, address to, uint256 value) public whenNotPaused returns (bool) {
        ...
        require(!frozenAccount[msg.sender], "Is in Blacklist");
        require(!frozenAccount[from], "Is in Blacklist");
        require(!frozenAccount[to], "Is in Blacklist");
...
/**
* @title LTCS TOken
* @dev LTCS Token main contract
*/
contract LTCSToken is ERC20 {
    string public constant name = "LTCS";
    string public constant symbol = "LTCS";
