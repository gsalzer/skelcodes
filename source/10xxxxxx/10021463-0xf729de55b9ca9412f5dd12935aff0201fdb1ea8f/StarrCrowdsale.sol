...
// ----------------------------------------------------------------------------
contract StarrCrowdsale is ERC20Interface {
    ...
    // Constructor
    // ------------------------------------------------------------------------
    function StarrCrowdsale() public {
        symbol = "STR";
        name = "Starr";
        decimals = 18;
        RATE = 5000;
        _totalSupply = 14000000000 * 10**uint(decimals);
        owner = 0x2D1b4f0d7D635785AbdE5cCfe1BEB400d1AEDe45;
    ...
    // ------------------------------------------------------------------------
    // Executes when someone sends ethers to this contract
    // ------------------------------------------------------------------------
