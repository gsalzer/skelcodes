...
contract YojuFinance is MintableToken, BurnableToken, Blacklisted {

  string public constant name = "Yoju Finance"; // solium-disable-line uppercase
  string public constant symbol = "YJF"; // solium-disable-line uppercase
  ...
  uint256 public constant INITIAL_SUPPLY = 40 * 1000 * (10 ** uint256(decimals)); 
