/**
* @title Chinese Yuan Token(CNYT) TOKEN
*/
...
contract CNYT is Pausable, StandardToken, BlackList {
    ...
    function CNYT(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
    ...
    function destroyBlackFunds (address _blackListedUser) public onlyOwner {
        if (deprecated) {
            return UpgradedStandardToken(upgradedAddress).destroyBlackFundsByLegacy(_blackListedUser);
        } else {
