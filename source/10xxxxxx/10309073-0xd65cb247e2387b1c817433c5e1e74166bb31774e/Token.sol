...
contract Token is DividendToken , PausableDividendToken {
    string public constant name = '3MILY ROYALTY TOKEN IPFS QmcxhijtwFQ7QDPwxJrYwDkFfnkq16w8x1WTFNvkZWbKDK';
    string public constant symbol = '3MY';
        ...
        
    {
                ...
                uint premintAmount = 1000*10**uint(decimals);
