...
// MasterChef was the master of nova. He now governs over NOVAS. He can make Novas and he is a fair guy.
//
// Note that it's ownable and the owner wields tremendous power. The ownership
// will be transferred to a governance smart contract once NOVAS is sufficiently
...
contract MasterChef is Ownable {
    ...
    // Deposit LP tokens to MasterChef for NOVA allocation.
