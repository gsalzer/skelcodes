...
contract SwapXLPStaking is Ownable {
    ...
    struct UserInfo {
        ...
        // Basically, any point in time, the amount of SWP
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint;       // How many allocation points assigned to this pool. SWP to distribute per block.
        uint256 lastRewardBlock;  // Last block number that SWP distribution occurs.
        uint256 accSwpPerShare; // Accumulated SWP per share, times 1e12. See below.
    }

    // The SWP TOKEN!
    ISwapXToken public swp;
