    ...
    function executeOperation(
        ...
        if (_reserve != _underlyingBorrow) {
            ...
            if (_reserve == ethAddress) {
                ...
                reserve2BorrowRouting = new address[](3);
                reserve2BorrowRouting[0] = _reserve;
                reserve2BorrowRouting[1] = weth;
                reserve2BorrowRouting[2] = underlyingCollateral;
        ...
        if (_reserve != underlyingCollateral) {
            if (underlyingCollateral == ethAddress) {
                ...
                swap2TokenRouting = new address[](3);
                swap2TokenRouting[0] = underlyingCollateral;
                swap2TokenRouting[1] = weth;
                swap2TokenRouting[2] = _reserve;
