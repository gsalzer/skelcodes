 ...
 * @dev FoodFightFinance is an ERC20 implementation of the FoodFightFinance ecosystem token. 
...
contract FoodFightFinance is Ownable, ERC20Pausable {
    string public constant name = "Food Fight Finance";
    string public constant symbol = "FFF";
    uint8 public constant decimals = 18;

    uint256 public constant initialSupply = 14000*10**uint256(decimals);
