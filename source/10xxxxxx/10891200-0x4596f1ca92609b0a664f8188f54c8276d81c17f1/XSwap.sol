...
// XSwap with Governance.
contract XSwap is ERC20("XSwap", "XSP"), Ownable {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying XSwaps (not scaled);
