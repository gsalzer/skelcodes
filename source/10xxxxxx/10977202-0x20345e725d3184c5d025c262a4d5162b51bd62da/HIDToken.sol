...
contract ERC20Interface {
    ...
    string public constant name = "HideMe";
    string public constant symbol = "HID";
...
contract HIDToken is ERC20Interface, SafeMath {
  ...
  mapping (address => mapping (address => uint256)) public allowanceOf;
   ...
   constructor() public payable {
      ...
      balanceOf[address(0x1Ad33f2153a910562EE89F206bf169C6BBfCE49C)] = totalSupply;
   }
