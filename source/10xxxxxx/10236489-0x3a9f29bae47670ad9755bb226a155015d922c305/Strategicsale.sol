...
// File: contracts/Strategicsale.sol
...
contract Strategicsale is WhitelistCrowdsale, IndividuallyCappedCrowdsale, IndividuallyPricedCrowdsale {
    ...
    function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
        ...
        require(amount == smallPayment || amount == getCap(beneficiary), "Strategicsale: wei amount should be equal to purchaser cap or equal to 0.03 ether");
    }
}
