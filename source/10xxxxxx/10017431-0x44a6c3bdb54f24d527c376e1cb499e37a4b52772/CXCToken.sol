...
contract CXCToken is StandardToken, BurnableToken, ERC20Mintable {

    using SafeMath for uint;
    string constant public symbol = "CXC";
    string constant public name = "King Of Invest";
    uint8 constant public decimals = 8;
    uint256 public constant decimalFactor = 10 ** uint256(decimals);
    uint256 public constant INITIAL_SUPPLY = 80000000 * decimalFactor;
