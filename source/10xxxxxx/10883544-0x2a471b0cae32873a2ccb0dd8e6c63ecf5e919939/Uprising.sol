...
// File: contracts/RevolutionSoviet.sol
...
// rSOV token with Governance.
contract RevolutionSoviet is ERC20("Revolution Soviet", "rSOV"), Ownable {
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (Uprising).
    function mint(address _to, uint256 _amount) public onlyOwner {
        _mint(_to, _amount);
    }
}

// File: contracts/Uprising.sol
...
// Uprising is the master of rSOV. He can make rSOV and he is a fair guy.
//
