...
contract yVaultYFFS is
    Bank(
        0x90D702f071d2af33032943137AD0aB4280705817, // HoldToken: user save to bank
        0x90D702f071d2af33032943137AD0aB4280705817 // InterestToken: bank pay to user
    ),
    BankManagerAddress
{
    // uint256 public constant DURATION = 10 days;
    // uint256 public constant INTEREST_RATE = 5; // 5%: 100 vault token -> period time -> 5 bank token
