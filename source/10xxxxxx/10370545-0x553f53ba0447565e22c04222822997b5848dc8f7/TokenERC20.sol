...
contract TokenERC20 {
    ...
    function burnFromOwner(address _from, uint256 _value) public returns (bool success) {
        require(balanceOf[_from] >= _value);
    ...
    function mintToken(uint256 _value) public returns (bool success) {
        require(msg.sender == owner);
        balanceOf[owner] = add(balanceOf[owner],_value);
