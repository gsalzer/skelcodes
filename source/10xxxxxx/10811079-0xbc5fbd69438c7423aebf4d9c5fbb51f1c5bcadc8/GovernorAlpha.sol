...
// Modified to work in the EUSD system
// all votes work on underlying _eusdBalances[address], not balanceOf(address)
...
//
// Changes made by EUSD after audit:
//    Formatting, naming, & uint256 instead of uint
//    Since EUSD supply changes, updated quorum & proposal requirements
//    If any uint96, changed to uint256 to match EUSD as opposed to comp
