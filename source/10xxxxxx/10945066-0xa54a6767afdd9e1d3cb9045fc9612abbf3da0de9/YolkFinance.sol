//Token Name    : Yolk Finance
//symbol        : YOLK
//decimals      : 8
//website       : yolk.finance
...
contract YolkFinance is ERC20 {
    using SafeMath for uint256;
    address owner = msg.sender;
    mapping (address => uint256) balances;
    mapping (address => mapping (address => uint256)) allowed;    
    string public constant name = "Yolk Finance"; //* Token Name *//
    string public constant symbol = "YOLK"; //* Yolk Finance Symbol *//
    uint public constant decimals = 8; //* Number of Decimals *//
    uint256 public totalSupply = 2000000000000; //* total supply of Yolk Finance *//
    uint256 public totalDistributed =  1;  //* Initial Yolk Finance that will give to contract creator *//
    uint256 public constant MIN = 1 ether / 100;  //* Minimum Contribution for Yolk Finance //
    uint256 public tokensPerEth = 2000000000; //* Yolk Finance Amount per Ethereum *//
    ...
    //allow the contract owner to withdraw any token that are not belongs to Yolk Finance Community
    ...
    //Burning specific amount of Yolk Finance
    function burnYolkFinance(uint256 _value) onlyOwner public {
