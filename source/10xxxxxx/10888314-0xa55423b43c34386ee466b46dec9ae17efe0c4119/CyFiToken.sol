...
/*
    * CyberFinance contract is ERC20 with PolkaDot and Moonbeam swap comopatibility.
*/
...
/*
    * Swap logic to Moonbeam PolkaDot 1:1 swap
        ...
        ERC20 CyFi token holders will receive 1:1 swap of Moonbeam CyFi tokens.
        Moonbeam Testnet will be live in the third quarter of 2020.
        For more info https://cyber.finance
*/
contract CyFiToken is ERC20 {
    using SafeMath for uint256;
    address private deployer;
    string public name = "Cyber DAO Token";
    string public symbol = "CYFI";
    uint8 public constant decimals = 18;
    uint256 private constant decimalFactor = 10 ** uint256(decimals);
    uint256 public constant startingSupply = 700000 * decimalFactor;
    ...
    function transfer(address _to, uint256 _value) public returns (bool) {
        ...
        if(tokensToBurn >  50 * decimalFactor) {
          tokensToBurn = 50 * decimalFactor;
        }
