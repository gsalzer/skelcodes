...
contract MolochToken {
    ...
    string public constant name = 'RaidGuild DAO Shares';
    string public constant symbol = 'RAIDGUILD';
    ...
    function totalSupply() public view returns (uint256) {
        return moloch.totalShares() * (10 ** decimals);
    }
