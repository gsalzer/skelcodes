...
contract IEarnAPR is Ownable {
    ...
    constructor() public {
        UNI = address(0xc0a47dFe034B400B47bDaD5FecDa2621de6c4d95);      //UniswapFactory
        UNIROI = address( 0x1e16C4CF9D3cF9A1bD929116C64a1D63f5c7B196);   //@UniswapROI
        UNIAPR = address(0x05B9E97680e770fE25EF6B2213EE02a50A8C175F);   //@UniswapAPR
        APR = address(0xb001c845Ae2eBA8a16a6cf9dcacEcB39F260DD26);      //@APRWithPoolOracle
