...
contract Freeze is Ownable {
     ...
     */
    constructor (address _owner) internal Ownable(_owner) {
        _frozen = true;
    }
...
contract CTItoken is StandardToken, Freeze {
    ...
    address constant wallet = 0x9ED362b5A8aF29CBC06548ba5C2f40978ca48Ec1;
    ...
    // Constructors
    constructor (ERC20CLI _cti) public Freeze(wallet) {
        CTItoken = _cti;
    ...
    function setBounceAddr(address _bounce) public onlyOwner {
        require(_bounce != address(0));
        bounce = _bounce;
    }
