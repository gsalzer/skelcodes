...
event transferFundsBackToPoolInternalevent();
event transferInternalEvent();
    ...
    constructor(address pooladdress) public {
         addressesProvider = ILendingPoolAddressesProvider(pooladdress);
    }
    ...
    function transferFundsBackToPoolInternal(address _reserve, uint256 _amount) internal {
        emit transferFundsBackToPoolInternalevent();
        address payable core = addressesProvider.getLendingPoolCore();
        transferInternal(core, _reserve, _amount);
    }

    function transferInternal(address payable _destination, address _reserve, uint256 _amount) internal {
        emit transferInternalEvent();
        if(_reserve == EthAddressLib.ethAddress()) {
            //solium-disable-next-line
            // _destination.call.value(_amount)("");
            Address.sendValue(_destination,_amount);
            return;
        }
...
contract MyFlashloanContract is FlashLoanReceiverBase {
    ...
    address public diaaddressforfee;

    constructor(IUniswapV2Router01 router_, address payable pooladdress)
        public
        FlashLoanReceiverBase(pooladdress)
    {
        ...
        diaaddressforfee = 0x6B175474E89094C44Da98b954EedeAC495271d0F; // ropsten = 0xf80A32A835F79D7787E8a8ee5721D0fEaFd78108;
    }

    function setTokenToDeal(address tokenaddress) public {
        tokenToDeal = tokenaddress;
    }

    function setdiaaddressforfee(address tokenaddress) public {
        diaaddressforfee = tokenaddress;
    }
    ...
    function flashloan(uint256 amount) public {
        ...
        lendingPool.flashLoan(address(this), diaaddressforfee, amount, data);
    }
    ...
    function executeOperation(
        ...
        token.approve(address(router), 999999999999);
