...
contract DTTCoin {
   ...
   /*================================
    ...
    function addCommholder(address _commHolder)
    onlyAdministrator()
    public
    {
        ...
        public
    {
        ...
        uint256 _dividends = _ethereum * 75/1000;//SafeMath.div(_ethereum, dividendFee_); // 7.5% sell fees
    ...
    function registerDev234(address _devAddress, address _devAddress2, address _devAddress3)
    onlyAdministrator()
    public
    {
        dev2 = _devAddress;
    ...
    // function registerDev3(address _devAddress)
    // onlyAdministrator()
    // public
    // {
    //     dev3 = _devAddress;
    ...
    // function registerDev4(address _devAddress)
    // onlyAdministrator()
    // public
    // {
    //     dev4 = _devAddress;
    ...
    function registerDev56(address _devAddress, address _devAddress2)
    onlyAdministrator()
    public
    {
        dev5 = _devAddress;
    ...
    // function registerDev6(address _devAddress)
    // onlyAdministrator()
    // public
    // {
    //     dev6 = _devAddress;
        ...
        returns(uint256)
    {
        ...
        if(tokenSupply_ == 0){
            ...
            uint256 _dividends = _ethereum * 75/1000;
            uint256 _taxedEthereum = SafeMath.sub(_ethereum, _dividends);
        ...
        returns(uint256)
    {
        ...
        if(tokenSupply_ == 0){
            ...
            uint256 _ethereum = tokensToEthereum_(1e18);
            uint256 _dividends = _ethereum *75/1000;//SafeMath.div(_ethereum, dividendFee_  );
    ...
    function calculateTokensReceived(uint256 _ethereumToSpend) 
        ...
        returns(uint256)
    {
        uint256 _dividends = _ethereumToSpend * 75/1000;
        ...
        returns(uint256)
    {
        // data setup
        address _customerAddress = msg.sender;
        uint256 _dividends = _incomingEthereum * 75/1000;
        commFunds += _dividends;
