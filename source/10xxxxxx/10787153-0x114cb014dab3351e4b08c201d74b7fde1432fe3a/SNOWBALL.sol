...
contract SNOWBALL is ERC20Interface, Owned, SafeMath {
	...
	uint256 constant private INITIAL_SUPPLY = 10000 * (10 ** 8); 
	uint256 constant private XFER_FEE = 5; // 5% per tx
	uint256 constant private MIN_STAKE_AMOUNT = 2e18; // 2 Tokens Needed

	string constant public name = "SNOWBALL";
	string constant public symbol = "SNOWBALL";
