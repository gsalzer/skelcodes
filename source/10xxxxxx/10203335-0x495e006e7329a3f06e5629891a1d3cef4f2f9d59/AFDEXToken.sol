 ...
 * @title AVN
 */
contract AFDEXToken is StandardToken, ERC677Token {

  string public constant name = 'AFDEX';
  string public constant symbol = 'AFDEX';
  uint8 public constant decimals = 6;
  uint256 public constant totalSupply = 7200*10**15; // 
