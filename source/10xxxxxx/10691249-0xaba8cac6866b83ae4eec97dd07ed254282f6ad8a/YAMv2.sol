...
// YAMv2: a temporary token in the evolution of the YAM protocol that allows the holder to vote for the future of the protocol in v3
...
contract YAMv2 is Context, IERC20 {
    ...
    constructor (string memory name, string memory symbol, address minter_) public {
        _name = name;
        _symbol = symbol;
        _setupDecimals(24); // match internalDecimals of YAMv1
