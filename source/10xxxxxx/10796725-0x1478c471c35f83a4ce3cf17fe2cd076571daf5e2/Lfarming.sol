...
contract Lfarming is BurnableToken {

    string public constant name = "3Lfarming";
    string public constant symbol = "Yf3L";
    uint public constant decimals = 18;
    // there is no problem in using * here instead of .mul()
    uint256 public constant initialSupply = 21600 * (10 ** uint256(decimals));
