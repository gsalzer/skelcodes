...
contract PlenaryChain is StandardToken {

    string public constant name = "PlenaryChain";
    string public constant symbol = "xPC";
    uint8 public constant decimals = 8;
    uint256 public constant INITIAL_SUPPLY = 1 * 10**6 * (10**uint256(decimals));
