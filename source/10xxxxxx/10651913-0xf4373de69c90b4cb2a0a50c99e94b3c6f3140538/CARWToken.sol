...
contract CARWToken is PausableToken {
    string  public  constant name = "Consumption AI intelligence Blockchain in the World";
    string  public  constant symbol = "CARW";
    ...
    function CARWToken(address _admin, uint _totalTokenAmount) public
    {
        admin = _admin;
