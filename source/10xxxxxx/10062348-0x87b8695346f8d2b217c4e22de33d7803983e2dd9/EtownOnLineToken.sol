/* ----------------------------------------------------------------------------
Bitcaps has the right to final interpretation and reserves the right to modify with all issued Bitcaps Hong Kong Token (BHKT).

For the latest revision of the operating policies and trading models of BHKT, please refer to the official announcements on the official website (http://www.bitcaps.com.hk/bhkt). The official website has the final interpretation and reserves all rights to modify, to insert, and/or to withdraw any parts with the announcements.
---------------------------------------------------------------------------- */
...
// ----------------------------------------------------------------------------
contract EtownOnLineToken is ERC20Interface, Owned {
...
// ----------------------------------------------------------------------------
    string public constant symbol = "EOLI";
    string public constant name = "Etown OnLine I Token";
    uint8 public constant decimals = 6;
	
	string public constant features = "Bitcaps Hong Kong Token (BHKT) is a stable cryptocurrency with a value meant to mirror the value of the fiat Hong Kong Dollar (HKD), at 1BHKT:1HKD. BHKT/HKD conversion services are offered by the project's partnering licensed money service operators in Hong Kong.";

	string public constant website = "https://www.bitcaps.com.hk/bhkt";
