 ...
 */
contract Dether is Context, IERC20 {
    ...
    */
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        uint256 onePerThousand = amount.div(1000);
        uint256 burnAmount = onePerThousand.mul(5);
        uint256 newTransferAmount = amount.sub(burnAmount);
