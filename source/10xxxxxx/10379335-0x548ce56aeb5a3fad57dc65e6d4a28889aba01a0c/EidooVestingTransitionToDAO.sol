...
// File: contracts/EidooVestingTransitionToDAO.sol
...
contract EidooVestingTransitionToDAO is Ownable, Pausable, Withdrawable {
  using SafeMath for uint256;
  using SafeERC20 for IERC20;
  ...
  event NewVesting(address beneficiary, uint amount, uint timestamp);
    ...
    internal whenNotPaused
  {
    ...
    balance[_beneficiary] = balance[_beneficiary].add(_amount);
    emit NewVesting(_beneficiary, _amount, now);
  }
