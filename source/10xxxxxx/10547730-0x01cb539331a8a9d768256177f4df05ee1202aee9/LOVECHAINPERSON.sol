...
/**
 * DNC Token, totalSupply 90000000000000000000000000
 */
contract LOVECHAINPERSON is BurnableToken, CappedToken(900000000000000000000000000) {
    string public name = "LOVE CHAIN PERSON";
