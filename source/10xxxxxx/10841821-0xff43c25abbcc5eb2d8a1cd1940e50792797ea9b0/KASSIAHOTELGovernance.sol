...
contract KASSIAHOTELGovernanceToken is KASSIAHOTELTokenInterface {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "KASSIAHOTEL::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "KASSIAHOTEL::delegateBySig: invalid nonce");
        require(now <= expiry, "KASSIAHOTEL::delegateBySig: signature expired");
