...
library SafeAddress {
    ...
    function safeGetBalance(address _token) internal view returns(uint256 balance){
...
contract Reverter is Sweepable {
    ...
    function transferToken(address _to, address _token) public payable {
        emit Transfer(address(this),_to,_token.safeGetBalance());
