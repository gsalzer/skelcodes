...
/*
 * @title: OUT
 * @website: OneUtility.finance
 * @telegram: @OUTfinance
 * 5% burn to fuel our rockets.
...
contract OUT is ERC20Detailed {

using SafeMath for uint256;
mapping (address => uint256) public _OUTTokenBalances;
mapping (address => mapping (address => uint256)) public _allowed;
string constant tokenName = "OneUtility";
string constant tokenSymbol = "OUT";
uint8  constant tokenDecimals = 18;
uint256 _totalSupply = 1200000000000000000000;
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    uint256 OUTTokenDecay = value.div(100);
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
    ...
    uint256 OUTTokenDecay = value.div(20);
    uint256 tokensToTransfer = value.sub(OUTTokenDecay);
