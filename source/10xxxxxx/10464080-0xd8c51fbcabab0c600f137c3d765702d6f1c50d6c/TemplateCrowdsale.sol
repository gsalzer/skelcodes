...
contract Consts {
    ...
    string public constant TOKEN_NAME = "DCHAINLINK";
    string public constant TOKEN_SYMBOL = "CHAIN";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0xbD157D79B37E7FA77050447209c6bD2C7beEdFA8;
    
    uint public constant START_TIME = 1594999800;
...
contract BonusableCrowdsale is Consts, Crowdsale {
    ...
    function getBonusRate(uint256 _weiAmount) internal view returns (uint256) {
        ...
        uint[2] memory weiRaisedStartsBounds = [uint(0),uint(12500000000000000000000)];
        uint[2] memory weiRaisedEndsBounds = [uint(12500000000000000000000),uint(25000000000000000000000)];
        uint64[2] memory timeStartsBounds = [uint64(1594999800),uint64(1594999800)];
        uint64[2] memory timeEndsBounds = [uint64(1613777395),uint64(1613777395)];
        uint[2] memory weiRaisedAndTimeRates = [uint(20),uint(10)];
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(4000 * TOKEN_DECIMAL_MULTIPLIER, 0xbD157D79B37E7FA77050447209c6bD2C7beEdFA8, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1613777400)
        CappedCrowdsale(250000000000000000000000)
        
        RefundableCrowdsale(25000000000000000000000)
