// File: localhost/smart-contracts/bucket-sale/contracts/EntryBot.sol
...
contract EntryBot
{
    ...
    function agreeToTermsAndConditionsListedInThisBucketSaleContractAndEnterSale(
        ...
        public
    {
        bucketSale.tokenSoldFor().transferFrom(msg.sender, address(this), _totalBuyAmount * _numberOfBuckets);
