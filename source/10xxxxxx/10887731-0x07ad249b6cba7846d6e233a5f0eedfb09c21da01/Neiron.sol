...
contract Neiron is ERC20Token
{
    bool public isTokenSale = false;
    uint256 public price;
    uint256 public limit;

    address walletOut = 0x411b2d65283b7ec94d204bbf5fbfe8d50053f872;
    ...
    function () external payable  {
        ...
        uint256 tokenAmount = (msg.value  * 10000) / price;
    ...
    function Neiron()
    {
        totalSupply = 2700000000000;
        balances[msg.sender] = 2700000000000;  // Передача создателю всех выпущенных монет
        name = 'Neiron';
        decimals = 4;
        symbol = 'NEIRO';
