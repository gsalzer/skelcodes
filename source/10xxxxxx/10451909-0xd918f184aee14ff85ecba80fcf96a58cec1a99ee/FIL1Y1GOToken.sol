...
contract FIL1Y1GOToken is ERC20Pausable, ERC20Burnable {
  string public constant name = "FIL1Y1GO token";
  string public constant symbol = "FIL1Y1GO";
  uint8 public constant decimals = 8;
  uint256 public constant INITIAL_SUPPLY = 10240 * (10 ** uint256(decimals));
