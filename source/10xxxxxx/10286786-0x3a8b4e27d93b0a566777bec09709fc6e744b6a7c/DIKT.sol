 ...
 */
contract DIKT is IERC20, IMint, IBurn, Ownable, Freezer, Pauser, Locker, Minter {
    using SafeMath for uint256;

    string public constant name = "Dokdo is korean territory";
    string public constant symbol = "DIKT";
    uint8 public constant decimals = 4;
    uint256 public totalSupply = 3300000000;
    ...
    function transferFrom(address from, address to, uint256 value)
        ...
        returns (bool)
    {
        require(from != address(0), "Token/Not-Allow-Zero-Address");
        require(to != address(0), "Token/Not-Allow-Zero-Address");
    ...
    function approve(address spender, uint256 value) external isPause returns (bool) {
        require(spender != address(0), "Token/Not-Allow-Zero-Address");
