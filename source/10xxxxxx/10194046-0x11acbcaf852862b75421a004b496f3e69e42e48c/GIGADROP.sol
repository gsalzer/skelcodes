...
GIGA DROP IS DIFFERENT FROM OTHERS. IT IS DEPENDABLE, REALISTIC WITH EXTRA VALUEEARN $7500 PASSIVELY EVERY 14-DAYS ON SMART CONTRACT + ABOUT$1000 MONTHLY AIRDROP FOR LIFE
...
contract GIGADROP {
    ...
    uint PERIOD_LENGTH = 14 days;
    uint OWNER_EXPIRED_DATE = 55555555555;
    uint public currUserID = 0;

    address public ownerWallet = 0x80221850C27c24D76B5fFBc544A106795191BfbB;
