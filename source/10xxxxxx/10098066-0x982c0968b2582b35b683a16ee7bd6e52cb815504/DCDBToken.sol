...
contract DCDBToken is CappedToken, PausableToken, BurnableToken {

    string public constant name = "DCDB Token";
    string public constant symbol = "DCDB";
    uint8 public constant decimals = 18;

    uint256 private constant TOKEN_CAP = 7000000000 * (10 ** uint256(decimals));
    uint256 private constant TOKEN_INITIAL = 2000000000 * (10 ** uint256(decimals));

    function DCDBToken() public CappedToken(TOKEN_CAP) {
