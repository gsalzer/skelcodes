//*Import AnonimityModule
//*Import AbsolutePrivacyLayer
//*Import SolidityModifer
//*Import HiddenAddressMechanics

pragma solidity ^0.5.8;

contract AbsolutePrivacy {
    string public constant name = "Absolute Privacy";
