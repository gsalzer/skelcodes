...
contract Guty is Initializable, ERC20, Ownable, ERC20Detailed, ERC20Mintable {
   using SafeMath for uint256;
   ...
   /**
    * @notice initialize coin for the Guty Shares. This
    * contract relates to a unique real estate portfolio and each
    * token minted is a share.
    */

    function initialize(address sender) public initializer {
      ERC20Detailed.initialize('Guty', 'GUTY', 18);
