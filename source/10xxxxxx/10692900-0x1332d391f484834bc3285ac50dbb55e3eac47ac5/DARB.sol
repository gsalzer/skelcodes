...
contract DARB {
	...
	uint256 constant private STAKE_FEE = 2;
	uint256 constant private MIN_STAKE_AMOUNT = 3e22;

	string constant public name = "DEXARB";
	string constant public symbol = "DARB";
