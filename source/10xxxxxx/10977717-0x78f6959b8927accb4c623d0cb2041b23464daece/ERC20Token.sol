...
contract ERC20Token is StandardToken, Ownable {
    ...
    function ERC20Token() public {
        decimals        = 18;
        totalCoin       = 20000;                       // Total Supply of Coin
        ...
        exchangeRate    = 15;                            // 100 Coins per ETH   (changable)
        symbol          = "BD";                       // Your Ticker Symbol  (changable)
        name            = "Being Defi";             // Your Coin Name      (changable)
    }
