...
/**
  ...
  The `assetData` is a byte array, with a size depending on the token type.
  For ETH, assetData is 4 bytes long. For ERC20 tokens, it is 36 bytes long.
    ...
    */
        ...
        internal
    {
        ...
        if (tokenSelector == ERC20_SELECTOR) {
            ...
            msg.sender.transfer(amount); // NOLINT: arbitrary-send.
        } else {
            revert("UNSUPPORTED_TOKEN_TYPE");
        }
    }
