...
contract Pivvr3D {
    ...
    uint8 internal constant dividendFee_ = 5; // 5% buy fee 
    uint8 internal constant sellFee_ = 20; // 20% sell fee 
    ...
    uint256 public stakingRequirement = 10e18; // 10 Pivvr minimum 
