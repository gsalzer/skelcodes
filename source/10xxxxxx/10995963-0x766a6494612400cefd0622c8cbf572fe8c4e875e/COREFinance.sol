...
/*****************************************************************************
 * @title COREFinance v1.2
 * @dev COREFinance v1.2 is an ERC20 implementation of the COREFinance v1.2 ecosystem token. 
...
contract COREFinance is Ownable, ERC20Pausable {
    string public constant name = "CORE Finance 1.2";
    string public constant symbol = "CORF";
