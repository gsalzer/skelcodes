...
// File: contracts/spfi.sol

// SPDX-License-Identifier: Spores.Finance

/**
 * @author  Spores.Finance
 *
 * @dev     Contract for Spores.Finance token with burn support
 */
...
// Spores.Finance erc20 Token Contract.
contract SPFI is DeligateERC20, Ownable {
    ...
    constructor() public ERC20("Spores", "SPR") { }
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(_addMinter != address(0), "Spores.Finance: _addMinter is the zero address");
        
        return EnumerableSet.add(_minters, _addMinter);
    }

    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "Spores.Finance: _delMinter is the zero address");
    ...
    modifier onlyMinter() {
        require(isMinter(msg.sender), "Spores.Finance: caller is not the minter");
        _;
    }
}
