...
contract EMDXToken is ERC20Detailed, ERC20Capped, ERC20Burnable {
    string public constant NAME = "iEMDX Token";
    string public constant SYMBOL = "iEMDX";
    ...
    {
        require(mint(msg.sender, INITIAL_SUPPLY), "Mint is not possible");
    }
}
