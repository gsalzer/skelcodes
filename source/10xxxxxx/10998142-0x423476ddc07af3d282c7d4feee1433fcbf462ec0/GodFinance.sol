...
/*****************************************************************************
 * @title GodFinance
 * @dev GodFinance is an ERC20 implementation of the GodFinance ecosystem token. 
...
contract GodFinance is Ownable, ERC20Pausable {
    string public constant name = "God Finance";
    string public constant symbol = "GOD";
    uint8 public constant decimals = 18;

    uint256 public constant initialSupply = 42000*10**uint256(decimals);
