...
contract MciCoin is ERC20Capped, ERC20Detailed {
     ...
     *
     * The _from's mci balance should be larger than the reserved amount(reserves[_from]) plus _value.
     *
    ...
    function getOneMciCoin() public view returns (uint) {
