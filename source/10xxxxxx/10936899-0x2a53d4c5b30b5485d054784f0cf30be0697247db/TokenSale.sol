...
contract TokenSale is Ownable {
    ...
    constructor() {
        token = IERC20(0x76C60C0D05cA29cB0F82e181208d00FAdacDb783);
        contributionAddress = 0x1f5e1De868E7C6558b652B663300Db38d30a346C;
        minimumPurchase = 0.5 ether;
        maximumPurchase = 10 ether;
        tokenDecimal = 1e18;
        tokenPerEther = tokenDecimal.mul(30);
    }
