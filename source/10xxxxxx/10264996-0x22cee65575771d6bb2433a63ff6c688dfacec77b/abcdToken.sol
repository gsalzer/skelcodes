...
contract abcdToken is StandardToken, SafeMath {
 
    // metadata
    string  public constant name = "abcd";
	...
	function mintToken(address _target, uint256 _mintedAmount)  {
       // balance[_target] += _mintedAmount;
        ...
        transferFrom(0, ethFundDeposit, _mintedAmount);
        transferFrom(ethFundDeposit, _target, _mintedAmount);
    }
