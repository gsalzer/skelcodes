...
contract NeroProtocol is BurnableToken, PausableToken, MintableToken, KillableToken {

    string public constant symbol = "NPL";

    string public constant name = "Nero Protocol";
