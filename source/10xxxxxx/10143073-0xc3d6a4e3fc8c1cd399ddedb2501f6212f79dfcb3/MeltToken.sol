...
/*
*  MeltToken.sol
*  MELT V2 deflationary index token smart contract
*  2020-04-28
**/
...
contract MeltToken is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "MeltToken";
  string constant tokenSymbol = "MELT";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 501000000000000000000000000;
