...
contract PausableToken is StandardToken, WE5Paused {
...
contract WE5Token is PausableToken {
    string public constant name = "WE FIVE";
    string public constant symbol = "WE5";
