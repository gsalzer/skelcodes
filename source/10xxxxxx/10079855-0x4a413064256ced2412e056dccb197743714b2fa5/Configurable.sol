 ...
 **/
contract Perfectrite is ERC20Basic {
...
contract StandardToken is ERC20, Perfectrite {
 ...
 **/
contract PerfectriteToken is CrowdsaleToken {
    string public constant name = "Perfectrite";
