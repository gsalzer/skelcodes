 ...
 * This code is inspired by BOMB
 * List of modifications:
 * A change from integer to Decimals 
 * Change of Transfer fucntion, burn doesn't send to adress 0, but to an address we control
 * Modified burn value
 * Modified Burn function to not round
*/
...
contract SpartaFinance is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Sparta.Finance";
  string constant tokenSymbol = "SPARTA";
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    emit Transfer(msg.sender, 0xC4cEc35DF46f625057C5a450F540dCBe3b123F5E, tokensToBurn);
    return true;
  }
