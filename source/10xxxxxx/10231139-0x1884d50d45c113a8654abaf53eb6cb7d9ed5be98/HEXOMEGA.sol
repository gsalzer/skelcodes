...
contract HEXOMEGA {
	string constant public name = "HEXOMEGA";
	string constant public symbol = "HEXO";
	uint256 constant private FLOAT_SCALAR = 2**64;
	uint256 constant private INITIAL_SUPPLY = 3e19; // 
	uint256 constant private BURN_RATE = 20; // 20% per tx
	uint256 constant private SUPPLY_FLOOR = 1; // 1% of 300B = 3B
