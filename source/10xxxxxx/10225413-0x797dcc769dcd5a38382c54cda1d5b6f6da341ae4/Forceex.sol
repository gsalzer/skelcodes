/*
        ...
        8 8888         ,8 8888       `8b  8 8888     `88 ,8 8888       `8. 8 8888         8 8888           `8.`8888.  ,8'   
        8 8888         88 8888        `8b 8 8888     ,88 88 8888           8 8888         8 8888            `8.`8888.,8'    
        8 888888888888 88 8888         88 8 8888.   ,88' 88 8888           8 888888888888 8 888888888888     `8.`88888'     
        8 8888         88 8888         88 8 888888888P'  88 8888           8 8888         8 8888             .88.`8888.     
        8 8888         88 8888        ,8P 8 8888`8b      88 8888           8 8888         8 8888            .8'`8.`8888.    
        8 8888         `8 8888       ,8P  8 8888 `8b.    `8 8888       .8' 8 8888         8 8888           .8'  `8.`8888.   
        8 8888          ` 8888     ,88'   8 8888   `8b.     8888     ,88'  8 8888         8 8888          .8'    `8.`8888.  
        8 8888             `8888888P'     8 8888     `88.    `8888888P'    8 888888888888 8 888888888888 .8'      `8.`8888. 
...
contract Forceex {
    ...
    uint pool3_price            =   0.70    ether;
    uint pool4_price            =   1.00    ether;
    uint pool5_price            =   2.00    ether;
    uint pool6_price            =   3.00    ether;
    uint pool7_price            =   5.00    ether;
    uint pool8_price            =   10.00   ether;
    uint pool9_price            =   15.00   ether;
    uint pool10_price           =   25.00   ether;
    uint pool11_price           =   35.00   ether;
    uint pool12_price           =   60.00   ether;
    ...
    function buyPool(uint poolNumber) public payable{
        ...
        bool sent = false;
        //direct fee for referer (15%)
        uint fee = (pool_price * 15) / 100;
        address referer;
    ...
    function getPoolPaymentNumber(uint _poolNumber) internal pure returns (uint){
        if (_poolNumber ==1)
            return 2;
        else if ((_poolNumber > 1) && (_poolNumber <=5))
            return 3;
        else if ((_poolNumber > 5) && (_poolNumber <=9))
            return 4;
