...
contract AngryHippo is ERC20("AngryHippo", "aHIPPO"), Ownable {
    using SafeMath for uint256;
    ...
    function stakeLP(uint256 amount) public updateStakingRewardLP(msg.sender) {
        ...
        emit StakedLP(msg.sender, amount, totalStakedAmountLP);
    }

    // Unstake $HIPPO/ETH
    function unstakeLP(uint256 amount) public updateStakingRewardLP(msg.sender) {
        require(isStart, "not started");
        require(amount <= staked[msg.sender].stakedHippoLP, ":unstakeLP: Fund ERROR");
