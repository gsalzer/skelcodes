 ...
 */
contract TradeableERC721Token is ERC721Full, MultiOwned {
  ...
  /**
    ...
    */
  function mintTo(address _to, uint256 _tokenId) public onlyMultiOwners {
    _mint(_to, _tokenId);
  }
...
contract ERC721FullBatchMint is TradeableERC721Token {
  ...
  function setBaseTokenURI(string memory uri) public onlyMultiOwners {
    _baseTokenURI = uri;
  }

  /* mint multiple tokens at a time */
  function batchMint(address[] calldata receivers, uint256[] calldata tokenIds) external onlyMultiOwners {
