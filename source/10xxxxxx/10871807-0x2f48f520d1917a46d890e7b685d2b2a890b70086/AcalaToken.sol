...
contract BasicToken is ERC20Basic, Ownable {
    ...
    function unableTransfers() public onlyOwner {
...
contract AcalaToken is ParameterizedToken {

    function AcalaToken() public ParameterizedToken("Acala", "ACA", 18, 1000000000) {
