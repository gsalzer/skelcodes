...
contract VEGETAReserves {

    // Token that serves as a reserve for VEGETA
    ...
    constructor(
        ...
        address vegetaAddress_
    )
        public
    {
        reserveToken = reserveToken_;
        vegetaAddress = vegetaAddress_;
        gov = msg.sender;
    }
        ...
        onlyGov
    {
        ...
        VEGETATokenInterface(vegetaAddress).decreaseAllowance(oldRebaser, uint256(-1));
        rebaser = rebaser_;
        VEGETATokenInterface(vegetaAddress).approve(rebaser_, uint256(-1));
