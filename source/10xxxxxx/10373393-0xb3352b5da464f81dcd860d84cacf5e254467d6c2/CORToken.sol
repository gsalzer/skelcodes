...
// -------------------------------------------------
// (Final release) Coronavirus Economic Relief fund
// 1:1 swaps for any future migration to new ERC version(s) guaranteed
// -------------------------------------------------
contract safeMath {
...
contract CORToken is safeMath, ERC20Interface {
  ...
  string  public constant name                  = "Coronavirus Economic Relief Fund";
