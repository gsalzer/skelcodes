...
/**
 * @title DARB token implementation
 * @dev this contract is a Pausable ERC20 token, with 
...
contract DARB {
    ...
    string public constant name = "DEXARB";
    string public constant symbol = "DARB";
    ...
    /**
     * @dev sets 1B initials tokens and the owner.
     */
