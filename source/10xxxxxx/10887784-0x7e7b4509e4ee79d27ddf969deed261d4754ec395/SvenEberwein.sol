...
contract SvenEberwein is MemeTokenWrapper, Ownable {
	ERC1155Tradable public memes;

	uint256 public periodStart = 1600459200;
	...
	function stake(uint256 amount) public updateReward(msg.sender) {
		...
		require(amount.add(balanceOf(msg.sender)) <= 500000000, "Stake between 1-5 meme");
