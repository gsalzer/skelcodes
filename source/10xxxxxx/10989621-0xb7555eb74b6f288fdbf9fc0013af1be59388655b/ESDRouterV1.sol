...
// Inspired by the CORE contract here: 0x48ad04e9302e79dd5760eaf3eaec5335b8abd0fd
contract ESDRouterV1 {
    ...
    address public esdUsdcUniswapPairAddr;
    ...
    constructor() public {
        ...
        esdTokenAddr = 0x443D2f2755DB5942601fa062Cc248aAA153313D3;
        esdLpPoolAddr = 0xA5976897BC0081e3895013B08654DfEc50Bcb33F;
        usdcTokenAddr = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48;
        esdUsdcUniswapPairAddr = 0x88ff79eB2Bc5850F27315415da8685282C7610F9;
        minUsdcDeposit = 0;
        
        esdUsdcUniswapPair = IUniswapV2Pair(esdUsdcUniswapPairAddr);
        usdcToken = IERC20(usdcTokenAddr);
        esdToken = IERC20(esdTokenAddr);
    }

    function addLiquidityUSDCOnly(uint256 usdcAmountToAdd) public {
        require(msg.sender != address(0), "Invalid sender address.");
        require(usdcAmountToAdd > minUsdcDeposit, "Deposit amount insufficient.");
        ...
        uint256 esdAmount = outEsd;
        uint256 usdcAmount = esdBuyAmount;
        ...
        if (optimalEsdAmount > esdAmount) {
            optimalUsdcAmount = UniswapV2Library.quote(esdAmount, esdReserves, usdcReserves);
            optimalEsdAmount = esdAmount;
        }
        else {
