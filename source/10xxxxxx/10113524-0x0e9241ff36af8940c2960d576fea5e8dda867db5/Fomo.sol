...
contract Fomo {
    ...
    address internal administrator;
		...
		// ambassadors
		uint256 ambassadorLimit = HEX * 100000; // 100k hex max per ambassador
		mapping(address => bool) public ambassadors; // who the ambassadors are

		address[9] ambassadorList = [
    ...
    */
    constructor(address usernameAddress, uint256 when_start)
        public
    {
			  ambassadors[0x3c64507cc305DC151988F11070cd88C7d738C1Bc] = true;
    		ambassadors[0xAA7A7C2DECB180f68F11E975e6D92B5Dc06083A6] = true;
    		ambassadors[0x11e52c75998fe2E7928B191bfc5B25937Ca16741] = true;
    		ambassadors[0xb7159F2a8380c8c84a6664916B59B1588670E6ec] = true;
    		ambassadors[0x368C788AC5313FB235d588a5058D6a9F4e9102E2] = true;
    		ambassadors[0xeBF896297a7136d3DE542C099dB52C06abb99f5B] = true;
    		ambassadors[0x39E00115d71313fD5983DE3Cf2b5820dd3Cc4447] = true;
    		ambassadors[0xEe54D208f62368B4efFe176CB548A317dcAe963F] = true;
				ambassadors[0x5138240E96360ad64010C27eB0c685A8b2eDE4F2] = true;
