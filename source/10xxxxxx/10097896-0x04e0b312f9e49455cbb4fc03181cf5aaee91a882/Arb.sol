...
contract Swappable{
    ...
    function tokenToEth(address AssetAddress, uint amountIn) internal returns (uint){
        ...
        uint[] memory amounts = Uniswap(UniswapV2Router01Address).swapExactTokensForETH(amountIn,1, path, address(this), INF);
    ...
    function ethToToken(address AssetAddress) internal returns (uint){
        ...
        uint[] memory amounts = Uniswap(UniswapV2Router01Address).swapExactETHForTokens.value(msg.value)(1, path, msg.sender, INF);
    ...
    function tokenToToken(uint amountIn, address inputAddress, address outputAddress) internal returns (uint){
        ...
        uint[] memory amounts = Uniswap(UniswapV2Router01Address).swapExactTokensForTokens(amountIn, 1, path, msg.sender, INF);
