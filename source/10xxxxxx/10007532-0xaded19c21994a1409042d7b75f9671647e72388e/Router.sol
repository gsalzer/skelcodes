...
contract Router {
    ...
    address internal uniETHHEX = address(0x05cDe89cCfa0adA8C88D5A23caaa79Ef129E7883);
    ...
    payable
    {
        ...
        //get HEX price
        uint heartsForEth = uniHEXInterface.getEthToTokenInputPrice(msg.value);
        //mint HEX Money
        require(hexMoney.mintHXY(heartsForEth, msg.sender), "could not mint HXY");
        emit LobbyJoined(
