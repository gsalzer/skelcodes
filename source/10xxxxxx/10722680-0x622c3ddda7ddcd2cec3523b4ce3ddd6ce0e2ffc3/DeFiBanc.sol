...
contract DeFiBanc is StandardToken {
    string public constant name = "Defi Banc";
    string public constant symbol = "DeFic";
    uint256 public constant decimals = 18;
    uint256 public constant INITIAL_SUPPLY = 20000 * (18**decimals);
