 ...
 * @dev Token that can be irreversibly minted (generated).
 */
...
contract KRWTOSS is MintableToken {

    string public constant name = "KRWTOSS";
    string public constant symbol = "KRWTS";
