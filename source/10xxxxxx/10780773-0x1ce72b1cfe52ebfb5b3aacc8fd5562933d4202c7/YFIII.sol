...
/**
 * DFII.Money smart contract.
 */
contract YFIII is AbstractToken {
  /**
  ...
  uint256 constant MAX_TOKEN_COUNT = 30000 * (10**8);
  ...
  string constant public name = "DFII.Money";
  string constant public symbol = "YFIII";
