...
contract TapeMob is BurnableToken {

    string public constant name = "TapeMob";
    string public constant symbol = "X2B";
    uint public constant decimals = 18;
    // there is no problem in using * here instead of .mul()
    uint256 public constant initialSupply = 2100000 * (10 ** uint256(decimals));
