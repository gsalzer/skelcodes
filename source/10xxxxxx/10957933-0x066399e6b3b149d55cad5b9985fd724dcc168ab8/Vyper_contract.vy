...
TETHERED: constant(bool[N_COINS]) = [True, False, False]
ZERO256: constant(uint256) = 0  # This hack is really bad XXX
ZEROS: constant(uint256[N_COINS]) = [ZERO256, ZERO256, ZERO256]  # <- change
LENDING_PRECISION: constant(uint256) = 10 ** 18
PRECISION: constant(uint256) = 10 ** 18
PRECISION_MUL: constant(uint256[N_COINS]) = [convert(1000000000000, uint256), convert(1, uint256), convert(1000000000000, uint256)]
...
@public
@nonreentrant('lock')
def initialize(_coins: address[N_COINS], _underlying_coins: address[N_COINS],
