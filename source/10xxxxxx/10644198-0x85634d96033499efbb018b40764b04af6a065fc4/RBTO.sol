...
contract RBTO is BurnableToken, DetailedERC20, ERC20Token, TokenLock {
  using SafeMath for uint256;

  // events
  event Approval(address indexed owner, address indexed spender, uint256 value);

  string public constant symbol = "RBTO";
  string public constant name = "Reliability Based Token Optimization";
  uint8 public constant decimals = 18;
  uint256 public constant TOTAL_SUPPLY = 5*(10**8)*(10**uint256(decimals));
