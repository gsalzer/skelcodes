...
// File: contracts/implementations/strategy/StrategyBaselineBenzeneCurveBTC.sol
...
contract StrategyBaselineBenzeneCurveBTC is StrategyBaselineBenzene {
    ...
    function GetPriceE18OfRecvInWant() public override view returns (uint256) {
        ...
        return ICurveFiBTC(curve).get_virtual_price();
    }
}

// File: contracts/instances/StrategyBaselineBenzeneCurveBTCwBTC.sol
