...
contract Bexpress is ERC20Interface, ERC20, MinterRole {
    using SafeMath for uint8;
    string public constant name = "Bexpress";
    string public constant symbol = "BEC";
    uint8 public constant decimals = 8;

    uint256 public constant mintValue = 5000000000 * 10 ** 8;
    uint8 public mintLeft = 4;
    ...
    function mint() public onlyMinter returns (bool) {
        require(mintLeft > 0, "Error can't mint anymore");

        _mint(mintValue);
        mintLeft = uint8(mintLeft.sub(1));
        return true;
    }
