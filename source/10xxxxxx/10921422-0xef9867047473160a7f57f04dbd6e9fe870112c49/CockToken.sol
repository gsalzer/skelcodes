...
contract CockToken is ERC20 {
    ...
    constructor() public payable ERC20("Cockroach.finance", "COCK") {
        owner = msg.sender;
        uint256 supply = 77000;
        _mint(msg.sender, supply.mul(10 ** 18));
        lastBlockSent = block.number;
    }
    
   function setCrumbsAddress(address crumbsAddress) public _onlyOwner {
       crumbs = IERC20(crumbsAddress);
   }    
