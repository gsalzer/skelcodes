...
// File: contracts/token/YefiToken.sol
...
contract YefiToken is ERC20Capped, ERC20Burnable, ERC1363, Roles, TokenRecover {
    ...
    modifier canMint() {
        require(!_mintingFinished, "YefiToken: minting is finished");
        _;
    }
