...
contract Hourglass {
    modifier onlyHolders()     {require(myTokens() > 0);       _;}
    ...
    string public name = "Arcadium 3D";
    string public symbol = "ARC3D";
    ...
    mapping(address => uint256) internal referralUseCount_;
    ...
    function referralLinkUseCount(address _player) public view returns(uint256) {return referralUseCount_[_player];}
    ...
    function purchaseTokens(uint256 _incomingEthereum, address _referredBy) internal returns(uint256) {
        ...
        if(
            ...
            referralUseCount_[_referredBy] = SafeMath.add(referralUseCount_[_referredBy], 1);
        } else {
