...
contract Yumm is MintableToken, HasNoEther 
{
    // Using libraries 
    using SafeMath for uint;

    //////////////////////////////////////////////////
    /// State Variables for the Yumm token contract
    //////////////////////////////////////////////////
    ...
    */
    ...
    // Human token state
    //////////////////////
    string public constant name = "Yumm.finance";
    string public constant symbol = "YUMM";
    ...
    //////////////////////////////////////////////////
    /// Begin Yumm token functionality
    //////////////////////////////////////////////////

    /// @dev Yumm token constructor
    function Yumm() public
    {
        // Define owner
        owner = msg.sender;
        // Define initial owner supply. (ether here is used only to get the decimals right)
        uint _initOwnerSupply = 20000 ether;
    ...
    function stakeYumm(uint _stakeAmount) external
    {
    ...
    function stakeYummSplit(uint _stakeAmount, address _stakeSplitAddress) external
    {
        // Require that a Yumm split actually be split with an address
    ...
    function claimYumm() external returns (bool success)
    {
        /// Sanity checks: 
        ...
        // Subtract stake balance from totalYummStaked
        totalYummStaked -= stakeBalances[msg.sender].initialStakeBalance;
    ...
    function stakeTokens(uint256 _value) private returns (bool success)
    {
        ...
        totalYummStaked += _value;

        /// Determine percentage of global stake
        stakeBalances[msg.sender].initialStakePercentage = calculateFraction(_value, totalYummStaked, decimals);
    ...
    function calculateStakeGains(uint _timePassedSinceStake) view private returns (uint mintTotal)
    {
        ...
        uint _finalMintRate;            // store our calculated final mint rate (in Yumm-per-second)
        ...
        if (_timePassedSinceStake > _secondsPerDay) {
            ...
            // First, calculate our final stake percentage based upon the total amount of Yumm staked
            _finalStakePercentage = calculateFraction(stakeBalances[msg.sender].initialStakeBalance, totalYummStaked, decimals);
            ...
            // Finally, calculate our final mint rate (in Yumm-per-second)
