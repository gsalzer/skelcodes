...
contract LPTokenWrapper {
    ...
    IERC20 public uniswapLP = IERC20(0x674eF879898a30d4739edc376556f3E8624486D5);
...
contract UniswapRewards is LPTokenWrapper, IRewardDistributionRecipient {
    ...
    IERC20 public xdna = IERC20(0x8e57c27761EBBd381b0f9d09Bb92CeB51a358AbB);
    uint256 public constant DURATION = 90 days;

    uint256 public initreward = 1000000000*1e18;
    ...
    function getReward() public updateReward(msg.sender) checkhalve {
        ...
        if (reward > 0) {
            ...
            xdna.safeTransfer(msg.sender, reward);
