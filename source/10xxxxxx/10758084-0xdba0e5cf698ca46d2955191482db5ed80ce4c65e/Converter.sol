...
contract Converter {
    ...
    function getPrice() public view returns (uint256) {
        ...
        return convert(price1Average);
    }
    
    function convert(uint224 _x) pure public returns (uint256) {
        FixedPoint.uq112x112 memory price1Average = FixedPoint.uq112x112(_x);
        return price1Average.mul(SCALE).decode144();
    }
}
