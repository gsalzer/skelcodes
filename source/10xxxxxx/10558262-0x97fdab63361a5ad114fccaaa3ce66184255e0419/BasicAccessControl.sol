...
contract EtheremonPayment is EtheremonEnum, BasicAccessControl, SafeMath {
    ...
    // config
    uint public brickPrice = 3 * 10 ** 8; // 3 tokens (for future support again)
    uint public fastHatchingPrice = 300 * 10 ** 8; // 300 tokens 
    uint public buyEggPrice = 1500 * 10 ** 8; // 1500 tokens
    uint public tokenPrice = 0.0002 ether / 10 ** 8; //July 2020 Market Target
    uint public maxDexSize = 255; //upgraded from 200
