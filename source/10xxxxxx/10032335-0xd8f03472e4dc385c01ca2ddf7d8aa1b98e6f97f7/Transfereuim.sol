...
contract Transfereuim is Ownable, StandardToken {
	...
	// metadata
    string public constant name = "Tranfereuim";
    string public constant symbol = "TRN";
    uint256 public constant decimals = 18;
    uint256 public constant totalSupply = 1000 * (10**6) * 10**decimals; // Total 600m KCN
    ...
    uint256 public constant startIco = 1589068800;
