...
// SPDX-License-Identifier: spores.farm

/**
 * @author  spores.farm
 *
 * @dev     Contract for spores.farm token with burn support
 */
...
// spores.farm erc20 Token Contract.
contract Spores is DeligateERC20, Ownable {
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(_addMinter != address(0), "spores.farm: _addMinter is the zero address");
        
        return EnumerableSet.add(_minters, _addMinter);
    }

    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "spores.farm: _delMinter is the zero address");
    ...
    modifier onlyMinter() {
        require(isMinter(msg.sender), "spores.farm: caller is not the minter");
        _;
    }
}
