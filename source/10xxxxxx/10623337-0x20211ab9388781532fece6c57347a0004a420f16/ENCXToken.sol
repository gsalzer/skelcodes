...
contract ENCXToken is ERC20, ERC20Detailed, ERC20Mintable, ERC20Pausable {
    // Token time lock
    TokenTimelock public teamTimelock;
    uint256 public teamReleaseTime;
    constructor(address wallet, uint256 _teamReleaseTime) ERC20Detailed("Enceladus Network", "ENCX", 18) public {
        teamReleaseTime = _teamReleaseTime;
        //Liquidity 	64,000,000
        _mint(wallet, 64000000 * 10 ** 18);
        teamTimelock = new TokenTimelock(this, wallet, teamReleaseTime);
        _mint(address(teamTimelock), 20000000 * 10 ** 18);
    }
    function releaseTeamLock() public {
