...
contract TestTokenA is BurnableToken, MintableToken {
  ...
  uint256 public constant INITIAL_SUPPLY = 65000000 * (10 ** uint256(decimals));    // number of tokens in reserve
...
contract TestTokenAPreICO is CappedRefundableCrowdsale {
  ...
  */
//  function createTokenContract(address _tokenAddress) internal returns (MintableToken) {
//    return TestTokenA(_tokenAddress);
//  }
