...
contract AdvCoin is StandardToken, Pausable {

  string public constant name = 'AdvCoin';                              // Set the token name for display
  string public constant symbol = 'ADV';                                  // Set the token symbol for display
  uint8 public constant decimals = 8;                                     // Set the number of decimals for display
  uint256 public constant INITIAL_SUPPLY = 21000000 * 10**uint256(decimals); // supply specified in Grains
