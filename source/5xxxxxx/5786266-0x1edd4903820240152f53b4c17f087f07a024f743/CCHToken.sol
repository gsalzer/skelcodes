...
contract TokenERC20 {
    ...
    string public name = "CryptoCashPay";
    string public symbol = "CCH";
    uint8 public decimals = 18;
    // 18 decimals is the strongly suggested default, avoid changing it
    uint256 public totalSupply = 788000000 * 10 ** uint256(decimals);
...
contract CCHToken is owned, TokenERC20 {
    using SafeMath for uint;
