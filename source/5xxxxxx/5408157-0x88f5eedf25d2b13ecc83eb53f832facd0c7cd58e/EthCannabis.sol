...
contract EthCannabis is StandardToken {
    ...
    function EthCannabis(address _owner) public {
    ...
    /**
    * If the user sends 0 ether, he receives 1000tokens.
    * If he sends 0.001 ether, he receives 4000tokens
    */
    function getTotalAmountOfTokens(uint256 _weiAmount) internal pure returns (uint256) {
        ...
        if( _weiAmount == 0.001 ether){
            amountOfTokens = 4 * 10**3 * (10**uint256(decimals));
        }
