...
contract RhodonToken is StandardToken {

    string public constant name = "Rhodon Token";
    string public constant symbol = "RHDO";
    ...
    function RhodonToken(address _owner) public {
