...
contract DocnotaPresale is Ownable, Pausable {
  ...
  uint256 public constant startTime = 1522584000;   // 01 Apr 2018 12:00:00 GMT
  uint256 public constant endTime   = 1525089600;   // 30 Apr 2018 12:00:00 GMT
  
  // Maximum amount of funds to be raised in weis
  uint256 public constant cap = 620 ether;
 
  // Pricing in [ DCNT / ETH ]
  uint256 internal constant rate = 7000;    // 5000 + 40% presale bonus
  
  // Minimum and maximum purchase sum in weis
  ...
  // is presale finish method invoked
  bool isFinalized;
