...
contract ArbitrageMarsTerminal is MintableToken {
    
    string public constant name = "ArbitrageMarsTerminal";
...
contract Crowdsale is Ownable {
    ...
    ArbitrageMarsTerminal public token = new ArbitrageMarsTerminal();
