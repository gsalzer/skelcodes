...
// File: contracts\SuperOceanStory.sol

pragma solidity ^0.5.0;


contract SuperOceanStory is IndividualLockableToken {
	using SafeMath for uint256;

	string public constant name     = "Super Ocean Story";
	string public constant symbol   = "SOS";
	uint8  public constant decimals = 18;

	uint256 public constant INITIAL_SUPPLY = 7200000000 * (10 ** uint256(decimals));
