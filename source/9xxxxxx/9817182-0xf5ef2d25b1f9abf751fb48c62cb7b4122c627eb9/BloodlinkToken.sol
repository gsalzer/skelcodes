...
// File: contracts \ BloodlinkToken.sol

contract BloodlinkToken is DetailedERC20, StandardToken, Ownable {
 string public name = "Bloodlink Token";
 string public symbol = "MEDB";
 uint8 public decimals = 18;
 uint public initialSupply = 1000000000 * 10 ** uint256(decimals);
