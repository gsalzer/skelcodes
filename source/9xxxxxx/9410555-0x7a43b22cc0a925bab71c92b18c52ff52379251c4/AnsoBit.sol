...
contract AnsoBit is Ownable, ERC20Burnable {
  using SafeMath for uint256;

    string public name = "AnsoBit";
    string public symbol = "ANSO";
    uint public decimals = 8;

    uint public INITIAL_SUPPLY = 100 * (10**6) * (10 ** uint256(decimals)) ; // 100 Million
