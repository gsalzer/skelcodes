...
// File: contracts/Interfaces/Bancor.sol

pragma solidity ^0.5.15;

interface IBancorNetwork {
  function etherTokens(address _token) external view returns(bool);       // list of all supported ether tokens
...
// File: contracts/BancorTokenSwap.sol
