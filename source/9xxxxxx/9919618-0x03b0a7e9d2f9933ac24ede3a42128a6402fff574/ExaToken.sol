 ...
 * `ERC20` functions.
 */
contract ExaToken is ERC20, ERC20Detailed {
    using SafeMath for uint256;
     ...
     */
    constructor (address econSupportAddress) public ERC20Detailed("Exa", "EXA", DECIMALS) {
        uint256 econSupportAmount = INITIAL_SUPPLY;
