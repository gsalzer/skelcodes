...
contract InternationalBusinessMachinesCorpNYSEIBM is ERC20
{using SafeMath for uint256;
   string public constant symbol = "International.Business.Machines.Corp(NYSE:IBM)";
     string public constant name = "International Business Machines Corporation(NYSE.IBM):The International Business Machines Corporation (IBM) is an American multinational information technology company headquartered in Armonk, New York, with operations in over 170 countries. The company began in 1911, founded in Endicott, New York, as the Computing-Tabulating-Recording Company (CTR) and was renamed International Business Machines in 1924. IBM is incorporated in New York";
