...
contract Portal is  Pausable, Initializable {
    ...
    */
    function removePortal(uint256 _portalId) public onlyOwner whenNotPaused returns(bool) {
        ...
        portalData[_portalId] = PortalData(_portalId, 0x0000000000000000000000000000000000000000, 0x0000000000000000000000000000000000000000, "NONE", xioAmount);
        return true;
    }
    ...
    */
    ...
    function fixPortal() public onlyOwner whenNotPaused {
        portalData[6].xioStaked = 1000000000000000000000;
    }
