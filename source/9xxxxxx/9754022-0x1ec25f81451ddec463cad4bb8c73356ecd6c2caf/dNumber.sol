...
// d̵ecentralized number by Berk Özdemir (http://berkozdemir.com)
// d̵ is a decentralized number living on Ethereum blockchain, represented as a decimal number. Each decimal place of d̵ is owned by its users, as unique ERC721 tokens.
// users can generate new decimal places or change the digit value of the decimal places they own by interacting with the smart contract.

// @title Strings
// @dev Strings library for TokenURI
...
// d
// d is a decentralized number, represented as a decimal number built on Ethereum blockchain, 
// consisting of decimal places representing a digit value, which are owned by users as ERC721 tokens
...
contract dNumber is Ownable, ERC721Full {
	...
	constructor(address _proxyRegistryAddress) 
        ...
        ERC721Full("d̵  Number","DNUM") public {

        proxyRegistryAddress = _proxyRegistryAddress;

	}
	
	// User generates a new decimal place by choosing a digit value on the Web App.
	...
	// GENERATES NEW DECIMAL PLACE FOR USER
	...
	// Cost calculation = 1 + 2 + 3 + ..... + "dPlace amount" * NewDecPlaceFee
	...
	// MINT A NEW DECIMAL PLACE FOR A LUCKY PERSON
    ...
    // User can change the digit of a decimal place they own by leveling it up
    ...
    /**
    * @dev Returns an URI for a given token ID
    * Throws if the tokxen ID does not exist. May return an empty string.
    * @param tokenId uint256 ID of the token to query
    */
    function tokenURI(uint256 tokenId) external view returns (string memory) {
