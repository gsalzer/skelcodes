/*******************************************************
* Copyright (C) 2020 CyberToad cybertoad69@gmail.com
* 
* This file is part of LuckyNumbers project.
* 
* LuckyNumbers can not be copied and/or distributed without the express
* permission of CyberToad
*******************************************************/
...
contract LuckyNumbers is usingNRE {
    ...
    function qR(address addr) private view returns (bool) {
      uint size;
