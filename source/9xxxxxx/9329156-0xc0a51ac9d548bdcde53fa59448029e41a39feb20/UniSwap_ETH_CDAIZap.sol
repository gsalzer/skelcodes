...
contract UniSwap_ETH_CDAIZap is Initializable {
    ...
    function set_OneSplitInterfaceAddress(IOneSplitInterface _new_OneSplitInterfaceAddress) public onlyOwner {
        OneSplitInterfaceAddress = _new_OneSplitInterfaceAddress;
    }
