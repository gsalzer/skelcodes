...
//The contract has an address 0x101010166569dfcb0208b4b564b3d93776c5ba19, it is generated before the contract is uploaded to the network, all other addresses have nothing to do with us
contract MiningExpert is MiningExpertToken{
   ...
   MiningExpertToken public token = new MiningExpertToken();
    ...
    address payable constant DEVELOPER_WALLET  = 0x100000ab6f3099D39E8009e1f30Ce1fC51D63fd4;
