...
// File: contracts/Interfaces/IChaiToken.sol
...
contract ChaiSwap is WrappedTokenSwap
{
  ...
  /**
   * @dev Contract constructor.
   * @param _chaiTokenAddress  The chai token address.
   * @param _wallet The wallet for fees.
   * @param _spread The initial spread (in millionths).
   */
  constructor(
  ...
  // --- override abstract methods from WrappedTokenSwap
