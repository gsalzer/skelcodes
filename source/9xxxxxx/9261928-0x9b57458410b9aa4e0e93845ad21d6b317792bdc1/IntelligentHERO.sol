...
/**
 * @title Intelligent HERO
 * @dev Token representing Intelligent HERO.
 */
contract IntelligentHERO is BurnableToken {
  ...
  */
  constructor(address wallet) public {
    owner = wallet;
    totalSupply = uint(10000).mul(2 ** uint256(decimals)); //Update total supply with the decimal amount
    name = "HEREO COIN";
    symbol = "hr88";
