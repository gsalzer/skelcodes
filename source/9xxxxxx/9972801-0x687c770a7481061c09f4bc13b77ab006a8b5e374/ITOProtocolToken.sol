...
/**
 * @title ITOProtocolToken
 * @dev Version 1 of the ERC20 token contract for ITO Protocol.
 */
contract ITOProtocolToken is ERC20, ERC20Detailed, ERC20Mintable, ERC20Burnable, ERC20SwappableInput, ERC20SwappableOutput {
    using SafeMath for uint256;

    /**
     * @dev After the token is constructed, we will mint 3,211,260 ITO as a team reserve.
     */
    constructor () public ERC20Detailed("ITO Protocol", "ITO", 3) { }
}
