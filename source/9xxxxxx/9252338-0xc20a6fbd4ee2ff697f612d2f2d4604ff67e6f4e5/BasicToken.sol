...
contract Builtcoin is BurnableToken, DetailedERC20, ERC20Token, TokenLock {
  using SafeMath for uint256;
  ...
  string public constant name = "Builtcoin";
  uint8 public constant decimals = 18;
  uint256 public constant TOTAL_SUPPLY = 10000000000*(10**uint256(decimals));
