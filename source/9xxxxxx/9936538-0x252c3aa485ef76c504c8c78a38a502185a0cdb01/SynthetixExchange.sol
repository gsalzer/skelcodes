...
// File: original_contracts/lib/synthetix/ISynthetix.sol
...
interface ISynthetix {
    ...
    function synthsByAddress(address synth) external view returns(bytes32 currencyKey);
...
// File: original_contracts/lib/synthetix/SynthetixExchange.sol
...
contract SynthetixExchange is IExchange, TokenFetcher {
    ...
    */
    ...
    function swap(
        ...
        ISynthetix snx = ISynthetix(exchange);

        bytes32 sourceCurrencyCode = snx.synthsByAddress(address(fromToken));
        bytes32 destinationCurrencyCode = snx.synthsByAddress(address(toToken));

        snx.exchange(sourceCurrencyCode, fromAmount, destinationCurrencyCode);
