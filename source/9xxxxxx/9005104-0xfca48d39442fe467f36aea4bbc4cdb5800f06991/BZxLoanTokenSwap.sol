 ...
 */
  ...
  {
    if (_isRedeem) {
      // fee is always in LoanToken, when redeeming the LoanToken is the offered token
      ...
      // fee is always in LoanToken, when minting the LoanToken is the received token
