...
contract DfWallet {
    ...
    address public constant DF_FINANCE = address(0x0dab4c7016D394B67f966C2ED3549C67D6D0a1b5);  // TODO: DfFinance address


    // **MODIFIERS**

    modifier auth {
        require(msg.sender == DF_FINANCE, "Permission denied");
        _;
    }
