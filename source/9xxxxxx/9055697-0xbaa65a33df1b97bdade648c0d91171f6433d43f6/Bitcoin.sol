...
/**
 * @title Geniuz Coin
 * @dev ERC20 Geniuz Coin (GENC)
 *
 * All initial GENCs are assigned to the creator of
 * this contract.
 *
 */
contract Bitcoin is PausableToken {
  ...
  uint256 public constant INITIAL_SUPPLY = 20000;    // 10 billion GENC

  /**
  * @dev GeniuzCoin Constructor
