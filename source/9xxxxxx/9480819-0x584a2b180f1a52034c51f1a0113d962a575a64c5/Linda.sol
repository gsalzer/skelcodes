...
/**
 * This smart contract is for Small Linda, from vgu in 2020, version 1
 *
...
contract Linda {
    ...
    function Linda( uint256 initialSupply, uint8 decimalUnits) public {
        balanceOf[msg.sender] = initialSupply; // Give the creator all initial tokens
        totalSupply = initialSupply; // Update total supply
        name = "Small Linda Token";   // Set the name for display purposes
        symbol = "Linda";    // Set the symbol for display purposes
