...
contract Pyramid {
    ...
    function registration(address userAddress, address referrerAddress) private {
        ...
        require(size == 0, "user cannot be a contract");
    ...
    function updateX3Referrer(address userAddress, address referrerAddress, uint8 level) private {
        require(users[referrerAddress].activeX3Levels[level], "Referrer level is inactive");
    ...
    function updateX6Referrer(address userAddress, address referrerAddress, uint8 level) private {
        ...
        if (users[referrerAddress].x6Matrix[level].closedPart != address(0)) {
            if ((users[referrerAddress].x6Matrix[level].firstLevelReferrals[0] == 
                ...
                updateX6_2(userAddress, referrerAddress, level);
                ...
                updateX6_1(userAddress, referrerAddress, level);
                return updateX6ReferrerSecondLevel(userAddress, referrerAddress, level);
            }
        }
    ...
    function updateX6_1(address userAddress, address referrerAddress, uint8 level) private {
    ...
    function updateX6_2(address userAddress, address referrerAddress, uint8 level) private {
    ...
    function sendETHDividends(address userAddress, address _from, uint8 matrix, uint8 level) private {
        ...
        if (!address(uint160(receiver)).send(value)) {
            emit CannotSendMoney(receiver, value);
