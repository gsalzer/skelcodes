...
contract Vesting is GSNRecipient {
    ...
    function claim(uint256 _id) external {
        ...
        uint256 amountAfter = (schedule.amount - schedule.amountClaimed - amountClaimable);

        require(amountClaimable > 0, "no amount claimable");
        require((amountAfter > 10000) || (amountAfter == 0), "remainder after claim is less than minmum amount");
