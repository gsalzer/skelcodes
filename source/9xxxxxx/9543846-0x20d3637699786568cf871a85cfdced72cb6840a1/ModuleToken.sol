...
// File: contracts/ModuleToken.sol
...
contract ModuleToken is Initializable, ERC721Full, Ownable, MinterRole {
     ...
     */
    function mintWithTokenURIWithData(address to, uint256 tokenId, string memory tokenURI, bytes memory data) public onlyMinter returns (bool) {
