...
contract GeneralElectricCoNYSEGE is ERC20
{using SafeMath for uint256;
   string public constant symbol = "General.Electric.Co(NYSE:GE)";
     string public constant name = "General Electric Corporation(NYSE:GE):General Electric Company (GE) is an American multinational conglomerate incorporated in New York City and headquartered in Boston. As of 2018, the company operates through the following segments: aviation,healthcare, power, renewable energy, digital industry, additive manufacturing, venture capital and finance and lighting";
