...
contract FacebookIncClassACommonStockNASDAQFB is ERC20
{using SafeMath for uint256;
   string public constant symbol = "Facebook.Inc.Class.A.Common.Stock(NASDAQ:FB)";
     string public constant name = "Facebook, Inc. is an American social media and technology company based in Menlo Park, California. It was founded by Mark Zuckerberg, along with fellow Harvard College students and roommates Eduardo Saverin, Andrew McCollum, Dustin Moskovitz and Chris Hughes, originally as TheFacebook.com—today's Facebook, popular global social networking website. It is considered one of the Big Four technology companies along with Amazon, Apple, and Google";
