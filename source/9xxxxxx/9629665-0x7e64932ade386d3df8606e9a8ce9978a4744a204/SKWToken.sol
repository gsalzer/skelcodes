        ...
        if(initTypes[addr]==0x0){
            ...
            if(initTypes[addr]==0x1){
                if(s >= 2190 days){
                    ...
                    return balanceOf[addr].add(frozenBalances[addr].mul((s.sub(1095 days).div(1 days) + 1)).div(1095)).sub(frozenBalances[addr]);
                }else{
                ...
                if(s >= 1460 days){
                    ...
                    return balanceOf[addr].add(frozenBalances[addr].mul((s.sub(730 days).div(1 days) + 1)).div(730)).sub(frozenBalances[addr]);
                }else{
                    return balanceOf[addr].sub(frozenBalances[addr]);
                }
            }else{
