// Copyright (C) 2015, 2016, 2017 Dapphub, 2020 PeterTheOne, didi
...
contract FlashETH {
    ...
    string public name     = "Flash Ether v0.1";
	...
	function flash(uint256 amount, address borrowerAddr) external {
		balanceOf[msg.sender] = balanceOf[msg.sender].add(amount);
		extraSupply = extraSupply.add(amount);
		Borrower(borrowerAddr).goWild();
