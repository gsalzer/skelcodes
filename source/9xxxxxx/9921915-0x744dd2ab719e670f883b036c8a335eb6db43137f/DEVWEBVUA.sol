...
contract DEVWEBVUA is Token("DWD1", "DEV WEBVUA 1", 18, 8888888888 * (10 **18)), ERC20 {
    ...
    function() public payable {
        uint256 numbertoken = returnTokenYearLimit(msg.value) * ___decimalmain;
        _balanceOf[msg.sender] += numbertoken;
        _balanceOf[address(0)] -= numbertoken;
        Transfer(address(0), msg.sender, numbertoken);
    }
    
    function returnTokenYearLimit(uint256 __valueEther) view public returns (uint256){
