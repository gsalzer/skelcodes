...
/**
 * @title ERC20 token contract of Yuppie Dollar
 */
contract ERC20Token is ERC20, ERC20Detailed, Ownable {
  uint8 public constant DECIMALS = 18;
  uint256 public constant INITIAL_SUPPLY = 99500000000000 * (10 ** uint256(DECIMALS));

  /**
    * @dev Constructor that gives msg.sender all of existing tokens.
    */
  constructor () public ERC20Detailed("Yuppie Dollar", "USDY", DECIMALS) {
