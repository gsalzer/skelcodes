...
contract StandardToken is Token ,ZMStop{
...
contract ZMToken is StandardToken{

	string public name = "ZM";                                   /// Set the full name of this contract
	uint256 public decimals = 18;                                 /// Set the decimal
	string public symbol = "ZM";                                 /// Set the symbol of this contract
