...
The actual code on the mainnet is at here:
    https://etherscan.io/address/0xcb9a11afdc6bdb92e4a6235959455f28758b34ba#code
========================================================================
*/
...
contract DelegateERC20 is CompliantDepositTokenWithHook {
    ...
    address constant DELEGATE_FROM = 0x0d72b21226f887B337F49eDf6FAE8D928A254074;
...
DelegateERC20 {
    ...
    function allocateTo(address _to, uint256 _value) public {
        require(_to != address(0), "to address cannot be zero");
        bool hasHook;
        address originalTo = _to;
        (_to, hasHook) = _requireCanMint(_to);
