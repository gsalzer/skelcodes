...
// File: contracts\NaturalEcoCarbonGold.sol

pragma solidity ^0.5.0;


contract NaturalEcoCarbonGold is IndividualLockableToken {
  using SafeMath for uint256;

  string public constant name = "Natural Eco Carbon Gold";
  string public constant symbol = "NECD";
  uint8  public constant decimals = 18;

  uint256 public constant INITIAL_SUPPLY = 316000000 * (10 ** uint256(decimals));
