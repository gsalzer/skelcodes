...
contract VerizonCommunicationsIncNYSEVZ is ERC20
{using SafeMath for uint256;
   string public constant symbol = "Verizon.Communications.Inc(NYSE:VZ)";
     string public constant name = "Verizon.Communications.Inc(NYSE.VZ)is an American multinational telecommunications conglomerate and a corporate component of the Dow Jones Industrial Average.[9] The company is based at 1095 Avenue of the Americas in Midtown Manhattan, New York City,[3] but is incorporated in Delaware";
