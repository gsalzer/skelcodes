...
contract PositionTokenLogic_WBTCShort is SplittableToken {
        ...
        returns (uint256)
    {
        ...
        _checkTradeSize(loanTokenAddress, loanAmountOwed);
