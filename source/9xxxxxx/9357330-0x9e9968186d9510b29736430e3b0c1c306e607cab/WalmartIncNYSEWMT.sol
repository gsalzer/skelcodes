...
contract WalmartIncNYSEWMT is ERC20
{using SafeMath for uint256;
   string public constant symbol = "Walmart.Inc(NYSE:WMT)";
     string public constant name = "Walmart.Inc(NYSE:WMT):Walmart Inc.is an American multinational retail corporation that operates a chain of hypermarkets, discount department stores, and grocery stores, headquartered in Bentonville, Arkansas.The company was founded by Sam Walton in 1962 and incorporated on October 31, 1969";
