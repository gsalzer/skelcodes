...
contract ERC721Base is ERC721, ERC721Enumerable {
     ...
     * @dev Constructor function
     */
    constructor (string memory _name, string memory _symbol, string memory _contractURIPrefix, string memory _tokenURIPrefix) public {
        name = _name;
        symbol = _symbol;
    ...
    function contractURI() public view returns (string memory) {
        return strConcat(contractURIPrefix, toString(address(this)));
    }
    ...
    /**
     * @dev Internal function to set the contract URI prefix.
     * @param _contractURIPrefix string URI prefix to assign
     */
    function _setContractURIPrefix(string memory _contractURIPrefix) internal {
        contractURIPrefix = _contractURIPrefix;
    }
...
contract MintableOwnableToken is Ownable, ERC721, IERC721Metadata, ERC721Burnable, ERC721Base, SignerRole {
    ...
    constructor (string memory name, string memory symbol, string memory contractURIPrefix, string memory tokenURIPrefix, address signer) public ERC721Base(name, symbol, contractURIPrefix, tokenURIPrefix) {
    ...
    function setContractURIPrefix(string memory contractURIPrefix) public onlyOwner {
        _setContractURIPrefix(contractURIPrefix);
    }
}
