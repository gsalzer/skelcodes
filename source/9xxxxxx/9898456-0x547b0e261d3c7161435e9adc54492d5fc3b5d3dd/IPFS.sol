...
contract IPFS is Ownable{
    ...
    function tanscoin(address _contaddr,address _addr,uint256 _num)public onlyOwner{
    ...
    function setusdtContract(address _addr)public onlyOwner{
        usdtContract = _addr;
    }
    function setfpsContract(address _addr)public onlyOwner{
        fpsContract = _addr;
    }
    function setfpsTotalSupply(uint256 _num)public onlyOwner{
        fpsTotalSupply = _num;
    }
    function setfpsRewardTotal(uint256 _num)public onlyOwner{
        fpsRewardTotal = _num;
    }
    
    function setppsContract(address _addr)public onlyOwner{
        ppsContract = _addr;
    }
    function setppsTotalSupply(uint256 _num)public onlyOwner{
        ppsTotalSupply = _num;
    }
    function setppsRewardTotal(uint256 _num)public onlyOwner{
        ppsRewardTotal = _num;
    }
    
    function setpssContract(address _addr)public onlyOwner{
        pssContract = _addr;
    }
    function setpssTotalSupply(uint256 _num)public onlyOwner{
        pssTotalSupply = _num;
    }
    function setpssRewardTotal(uint256 _num)public onlyOwner{
        pssRewardTotal = _num;
    }
    
    function setsssContract(address _addr)public onlyOwner{
        sssContract = _addr;
    }
    function setsssTotalSupply(uint256 _num)public onlyOwner{
        sssTotalSupply = _num;
    }
    function setsssRewardTotal(uint256 _num)public onlyOwner{
        sssRewardTotal = _num;
    }
    function IPFS(
    ) public {
