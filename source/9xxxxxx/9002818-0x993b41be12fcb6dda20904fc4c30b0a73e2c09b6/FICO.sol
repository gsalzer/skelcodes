...
contract FICO {
    ...
    event set_user(address admin ,address refferer,address menber, string name );
    ...
    function add_menber(address refferer ,address set_menber , string name)public {
        require(owner == msg.sender,"你沒有權限");
        ...
        require(refferer != set_menber,"推薦人與被推薦人不能相同");
        require(age[refferer] != 0);
        
        superior[set_menber]=refferer;
        ...
        emit set_user( msg.sender,refferer,set_menber,name);
    }
