...
//    function priceBuyEthOnUniswapForToken(string tokenSymbol, uint tokenAmount) public view returns (uint256) {
//        return _orfeed.getExchangeRate("ETH", tokenSymbol, "BUY-UNISWAP-EXCHANGE", tokenAmount);
//    }
//
//    function priceBuyEthOnKyberForToken(string tokenSymbol, uint ethAmount) public view returns (uint256) {
//        return _orfeed.getExchangeRate("ETH", tokenSymbol, "BUY-KYBER-EXCHANGE", ethAmount);
//    }
//
//    function priceSellEthOnUniswapForToken(string tokenSymbol, uint tokenAmount) public view returns (uint256) {
//        return _orfeed.getExchangeRate("ETH", tokenSymbol, "SELL-UNISWAP-EXCHANGE", tokenAmount);
//    }
//
//    function priceSellEthOnKyberForToken(string tokenSymbol, uint ethAmount) public view returns (uint256) {
...
//    }
    ...
    function setupFundingToken(string tokenSymbol, address tokenAddress, address uniswapExchangeAddress, uint allowedSlippage) public onlyOwner {
        ...
        // Pre-Approve Exchanges to Transfer Token
