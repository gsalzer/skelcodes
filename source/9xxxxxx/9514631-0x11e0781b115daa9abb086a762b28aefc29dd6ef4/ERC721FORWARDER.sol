...
contract ERC721FORWARDER is Ownable, ERC721Full {
        ...
        returns (bytes4)
    {
     ...
     function forwardTo(address _contract, bytes memory _data) public onlyOwner {
        (bool success, bytes memory res) = _contract.call(_data);
