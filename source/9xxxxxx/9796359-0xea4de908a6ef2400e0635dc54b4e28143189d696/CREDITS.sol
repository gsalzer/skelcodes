...
contract CREDITS is Ownable{
    string public name = 'Tomatoo';
    string public symbol = 'totoo';
    uint8 public constant decials = 8;//18
    uint256 public totalSupply = 100 * (10**uint(decials));
  ...
  modifier IsNotLock{
    ...
    function setAccountIsLock(address _address, bool _IsLock) public isCanChange{
    ...
    function setAccountIsNotLock(address _address, bool _IsLock) public isCanChange{
