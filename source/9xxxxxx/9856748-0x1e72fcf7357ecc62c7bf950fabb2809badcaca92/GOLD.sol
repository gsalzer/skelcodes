...
/**
 * @title MinterRole
 * @dev List of users who allowed to mint new tokens
 */
 ...
 */
contract ERC20Detailed is ERC20Mintable, ERC20Burnable {
...
/**
 * @dev Contract for meta transactions
 */
...
/**
 * @dev Digital crypto asset of OroPocket Gold
 */
contract GOLD is ERC20Meta, ERC20Detailed {
    constructor () public ERC20Detailed("OroPocket Gold", "GOLD", 18) {}
}
