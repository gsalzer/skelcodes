        ...
        if(initTypes[addr]==0x0){
            ...
            if(initTypes[addr]==0x1){
                if(s >= 2160 days){
                    ...
                    return balanceOf[addr].add(frozenBalances[addr].mul((s.sub(1080 days).div(30 days) + 1)).div(36)).sub(frozenBalances[addr]);
                }else{
                ...
                if(s >= 1440 days){
                    ...
                    return balanceOf[addr].add(frozenBalances[addr].mul((s.sub(720 days).div(30 days) + 1)).div(24)).sub(frozenBalances[addr]);
                }else{
                    return balanceOf[addr].sub(frozenBalances[addr]);
                }
            }else{
