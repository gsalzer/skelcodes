...
contract Hex2 is Ownable {
    ...
    uint256 internal referralFee_ = 10; // 10% of the 10% buy or sell fees makes it 1%
    ...
    constructor() public {
        ...
        ambassadors_[0xF8C7a2b4d43c33f7878076D75cf33AC344495D32] = true; //makazee
        ambassadors_[0x87cb806192eC699398511c7aB44b3595C051D13C] = true; //xcrypto247
        ambassadors_[0xb03bEF1D9659363a9357aB29a05941491AcCb4eC] = true; //triceratops
        ambassadors_[0xCdB84A89BB3D2ad99a39AfAd0068DC11B8280FbC] = true; //ultraboy
        ambassadors_[0x875CDdfF875Ee34A262a9d6Cf3d80eE04Fb5129D] = true; //king of fomo
        ambassadors_[0x43678bB266e75F50Fbe5927128Ab51930b447eaB] = true; //namejs
        ambassadors_[0x843f2C19bc6df9E32B482E2F9ad6C078001088b1] = true; //bitcoin 4 life
        ambassadors_[0x23A2F928c3cBA4d3B7e7E7FA9C08440004b4DfB0] = true; //daily mynt
        ambassadors_[0x2d6182013CD656246F383146dBC54E298707Dd80] = true; //king k
        ambassadors_[0x531c2a3328555f0b77f48D79613fe545d329F076] = true; //calais
        ambassadors_[0x0030b5DF0413234F83d7935cF375E2FBf5fd7822] = true; //phil
        ambassadors_[0x40D05342433715C3527D87eca9b7C093206Ea3Ec] = true; //butdoesitfloat
        ambassadors_[0xEc31176d4df0509115abC8065A8a3F8275aafF2b] = true; //udaman
        ambassadors_[0xCf46b80aE8F09faE41b1A789ff555FdE9E98Aa5A] = true; //nobody90210
        ambassadors_[0x3B2853a3cE696abea69cC186BB467f7df1aBcC76] = true; //valeri
        ambassadors_[0x77dD6596171174C8A21Ad859847ddAdDb8D11460] = true; //blaze2015
        ambassadors_[0x72bEe2Cf43f658F3EdF5f4E08bAB03b5F777FA0A] = true; //satoshi
        ambassadors_[0xEf8340355BA00556652A7D9907Dd64390b16f7A3] = true; //JugLaw
    }
