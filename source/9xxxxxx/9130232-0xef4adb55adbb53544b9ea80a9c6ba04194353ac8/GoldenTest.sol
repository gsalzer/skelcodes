...
contract GoldenKingdom is Events {
    ...
    mapping(address => mapping(uint256 => uint256)) private playerExtraEarnings_;
    mapping (uint256 => DataStructs.Round) public round_;   // (rID => data) round data

    mapping(address => uint256) public referralBalance_;
    mapping(address => address) public firstReferrer;

    uint256 private keyHolderFees_;
    uint256 public treasureAmount_;
    uint256 public adminKeyVault_;
    uint256 public luckyDrawVault_;
    uint256 private tokenInvestorsSupply_ = 0;
    uint256 public totalSupply_ = 0;

    uint256 private lastLuckyDrawTime = 0;
    uint256 public lastLuckyDrawAmt = 0;
    uint256 private luckyDrawDuration = 24 hours;
    bool private luckyDrawEnabled = true;

    uint256 private lastPromoterDistTime = 0;
    uint256 private lastInvestorDistTime = 0;
    uint256 private topleaderboardDuration = 7 days;
    ...
    uint256 private promoterDistRound;
    uint256 public topPromotersVault = 0;
    mapping(address => mapping(uint256 => uint256)) private promoters; // get promotional earnings by player and investment round
    address[3] public lastTopPromoters;

    //Investors Datastructures
    Leaderboard[3] public topInvestors;
    uint256 private investorDistRound;
    uint256 public topInvestorsVault = 0;
    mapping(address => mapping(uint256 => uint256)) private investors; // get investment by player and investment round
        ...
        public
    {
        ...
        treasureAmount_ = 20;
        _owner = msg.sender;
        luckyDraw = ILuckyDraw(address(0xc7791F3d62009A22686a849C71142dcc187efA76));
...
//-------------------------------------------------------------------------------------------------------//
    ...
    function updateLuckDrawContract(address _contractAddress)
        ...
        onlyOwner()
    {
        luckyDraw = ILuckyDraw(_contractAddress);
    }*/
