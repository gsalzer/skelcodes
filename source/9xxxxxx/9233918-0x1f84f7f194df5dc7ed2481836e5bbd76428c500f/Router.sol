...
contract Router {
    ...
    payable
    {
        ...
        if(affiliate != address(0) && affiliateSplit > 0){
            ...
            isAffiliate = true;
            hx.xfLobbyEnter.value(affiliateSplit)(affiliate);
            if(msg.value - affiliateSplit > 0){
                hx.xfLobbyEnter.value(msg.value - affiliateSplit)(splitter);
            }
        } else {
    ...
    operatorOnly
    {
        ...
        require(affiliateRankPercentages[affiliateRank] > 0 && affiliateRankPercentages[affiliateRank] <= 100,
