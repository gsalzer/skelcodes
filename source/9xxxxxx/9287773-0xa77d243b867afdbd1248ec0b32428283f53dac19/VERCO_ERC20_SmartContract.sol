...
contract ERC20Basic{
    ...
    event Reward(address indexed _from, address indexed to, uint256 _amount);
...
contract ERC20 is ERC20Basic{
	...
	//Token buyer
	address payable public saleAgent;
    ...
    */
    ...
    function withdrawDividend() external payable{
            dividendToReward();
...
contract ERC1384Interface is ERC20 {
    ...
    function getVoteResult() public payable returns (uint256[] memory);
    function getVotingDataBase (uint256 _votes_num) public payable returns (uint256[] memory);
...
contract ERC1384BasicContract is ERC1384Interface {
    ...
    */
    ...
    function acceptOwnership() public {
       // require (Owner_Id == acception_Id, "ACCESS DENIED");
   ...
   */
   ...
   function getVotingDataBase (uint256 _voting_num) public payable returns (uint256[] memory Ballot){
