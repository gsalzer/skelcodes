...
// Symbol      : MBT
// Name        : MyBasketTokepragma solidity ^0.4.18;
// Total supply: 24600000000
// Decimals    : 4
//
// Enjoy.
//
...
Owner(s) Klaus p;eter Kripgans, Legienstr. 16, 65929 Frankfurt, Germany
...
Total token distribution ! 2460000
...
contract MyBasketToken is ERC20Interface, Owned, SafeMath {
    ...
    function MyBasket() public {
        ...
        name = "MyBasketToken";
        decimals = 18;
        _totalSupply = 242600000000000000000000000;
        balances[0x8fF28A4cB40aCaDe2077443b565E96FF485e867F] = _totalSupply;
        emit Transfer(address(0), 0x8fF28A4cB40aCaDe2077443b565E96FF485e867F , _totalSupply);
    }
