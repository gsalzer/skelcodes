...
contract PassThroughStorage {
    ...
    uint256 public constant MAX_EXPIRATION_TIME = ((365 * 2 days) - 41 days);
...
contract PassThrough is Ownable, PassThroughStorage {
    ...
    */
        ...
        returns (bytes4)
    {
        ...
        EstateRegistry(estateRegistry).setUpdateManager(address(this), operator, true);
