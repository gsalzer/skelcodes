...
contract TLCoin is ERC777 {
    /**
     * no default operators set
     * initial supply is 100M
     */
    constructor()
        ERC777("TL Coin", "TLC", /* defaultOperators = [] */ new address[](0))
        public
    {
        _mint(msg.sender, msg.sender, /* initialSupply = 100M */ 100000000 * 10 ** 18, "", "");
    }
}
