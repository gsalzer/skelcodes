...
/**
 * @title Sog
 * Sog - a contract for my non-fungible sogcard.
 */
contract Sog is TradeableERC721Token {
  constructor(address _proxyRegistryAddress) TradeableERC721Token("Spells of Genesis Askian Card", "SOG", _proxyRegistryAddress) public {  }
