...
contract DfFinanceCompound is Initializable, DSMath, ConstantAddresses, FundsMgrUpgradable {
    ...
    // before call approve USDC to this contract (TODO: warning: without owner – test function)
    ...
    function dealInternal(
        ...
        IDfWallet(dfWallet).deposit.value(valueEth + extraEth)(ETH_ADDRESS, CETH_ADDRESS, valueEth + extraEth, USDC_ADDRESS, CUSDC_ADDRESS, extractUsdc);
