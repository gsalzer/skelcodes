...
contract Vesting_60 is Ownable, WhitelistAdminRole {
    ...
    function calcUnlock(uint fund, uint cliff, uint listing, uint firstUnlockRate, uint unlockTerm, uint unlockRate, uint target) public pure returns (uint256) {
        ...
        uint cliff_days = cliff * 60;  //86400; // 864000 = 24h * 60min * 60sec;
        uint unlock_days = unlockTerm * 60; //86400; // 864000 = 24h * 60min * 60sec;
