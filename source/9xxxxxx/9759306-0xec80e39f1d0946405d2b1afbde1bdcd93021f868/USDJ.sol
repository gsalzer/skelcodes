...
contract USDJ is StandardToken {

    string public constant name = "JACK USD";
    string public constant symbol = "USDJ";
    ...
    uint256 public priceToken = 500000;
    uint256 public priceClaim = 0.0002 ether;
    uint256 public numberClaimToken = 500 * (10**uint256(decimals));
    uint256 public startTimeDay = 0;
    uint256 public endTimeDay = 82800;
