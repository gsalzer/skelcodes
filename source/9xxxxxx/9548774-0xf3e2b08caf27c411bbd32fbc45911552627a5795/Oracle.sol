...
// There may be bugs, corona viruses, etc. No warranty.
/// it's set up for szabos, so change all szabo to ether, and change all 1e9 (gwei) to finney
...
contract Oracle {
    ...
    event AssetSwapContractsChanged(
    ...
    */
    ...
    function addReaders(address newReader)
        ...
        onlyAdmin
    {
        require(now > lastSettleTime + 2 hours && now < lastSettleTime + 3 hours, "only 2-3 hrs after settle");
    ...
    */
        ...
        onlyAdmin
    {
        ...
        readers[newAS1] = true;
        readers[newAS2] = true;
        emit AssetSwapContractsChanged(newAS0, newAS1, newAS2);
    }
