...
interface IERC20 {
    ...
    function appTransfer(address to, uint256 value) external returns (bool);
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    constructor() public {
        feeShare = 10; //10% in-app transfer fee by default
    }
    ...
    /**
     * @dev Sets `feeShare` for share percentage for every app transaction.
     *
     * Requirements:
     *
     * - `value` integer.
     */
    function setTransferFee(uint value) onlyOwner public returns (bool) {
        require(value < 100);
        feeShare = value;
    }
...
contract FenixToken is Context, ERC20, ERC20Detailed {

    /**
     * @dev Constructor that gives _msgSender() all of existing tokens.
     */
    constructor () public ERC20Detailed("FENIX", "FNX", 18) {
        _mint(_msgSender(), 2790000000 * (10 ** uint256(decimals())));
    }
}
