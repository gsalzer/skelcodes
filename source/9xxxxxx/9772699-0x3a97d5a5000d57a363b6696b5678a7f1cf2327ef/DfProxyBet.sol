...
contract DfProxyBet is Initializable, DSMath, FundsMgrUpgradable {
    ...
    uint256 public curNewBetDuration;  //  in sec - new Bet instances – now + curNewBetDuration
    uint256 public minBetDuration;  //  in sec - bet in cur Bet instance – now < now + minBetDuration
    ...
    function initialize() initializer public {
        ...
        swapRatio = 110 * 1e12;  // sai/usdt – in percents (sai - 1e18, usdt - 1e6)
